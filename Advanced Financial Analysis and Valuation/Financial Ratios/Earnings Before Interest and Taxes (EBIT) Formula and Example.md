...
- II = Interest Income
A company can exclude one-time expenses. In this case, the company was continuing to operate in the country through subsidiaries. Due to capital controls in effect $\$a_t$$ the time, Company X took a one-time hit to remove foreign assets and liabilities from its balance sheet.
