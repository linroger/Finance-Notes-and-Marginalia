...
When determining the value of a business based on [[Comps Definition, How They're Used in Analysis, and Example|comparable company analysis]],  an analyst will utilize a ratio based on a value metric such as [[Price-to-Sales Ratios in Stock Valuation|market capitalization]] or enterprise value (EV) compared to a performance metric,  such as sales,  EBITDA,  or earnings/earnings per share. A determination on performance can be made under the assumption that companies that are similar should trade at similar multiples.
