...
A leverage ratio is any one of several financial measurements that look $\$a_t$$ how much capital comes in the form of debt (loans) or assesses the ability of a company to meet its financial obligations. The leverage ratio category is important because companies rely on a mixture of equity and debt to finance their operations, and knowing the amount of debt held by a company is useful in evaluating whether it can pay off its debts as they come due.
...
Another leverage ratio is the consumer leverage ratio. This ratio looks $\$a_t$$ the level of consumer debt compared to disposable income and is used in economic analysis and by policymakers.
...
There are many different leverage ratios. Below, we look $\$a_t$$ some of the more common ones.
...
For example, assume that Macy's has assets valued $\$a_t$$ $19.85 billion and stockholder equity of $4.32 billion. The equity multiplier would be:
