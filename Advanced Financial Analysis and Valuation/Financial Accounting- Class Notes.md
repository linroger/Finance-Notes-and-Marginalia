...
- **The Income Statement**
    ...
    - **Balance Sheet vs. Income Statement**
        - Income statement links the balance sheet $\$a_t$$ the beginning of the period with the balance sheet $$a_t$$ the end of the period
...
- **Three types**
    - **Acquisition or Historical Cost (adv: verifiable/reliable; disadv: may not reflect economic value)**
        - Valued $\$a_t$$ the amount of resources paid to acquire it
    - **Fair Market Value (adv: closer to market value; disadv: hard to measure)**
        - Replacement cost - entry price (valued $\$a_t$$ the cost of replacing the asset)
        - Net Realizable Value - exit price (valued $\$a_t$$ the net cash received on selling the asset)
...
- **GAAP on Valuation**
    ...
    - **Nonmonetary Asset** - all other assets
        ...
        - Exception: marketable securities (valued $\$a_t$$ Net Realizable Value)
...
- Firms can optionally elect to use fair values to measure eligible assets and liabilities in their financial statements
    - Fair value is the amount a firm would receive if it sold an asset or would pay if it settled a liability $\$a_t$$ the measurement date
...
- **Disclosures Related to the Fair Value Option (FVO)**
    - Balance Sheet
        - Identify the financial assets/liabilities for which it used the FVO and disclose the reasons for choosing to measure those items $\$a_t$$ FV
...
- Every transaction must have $\$a_t$$ least one debit and $$a_t$$ least one credit
...
- **Accrual Accounting**
    ...
    - **Disadvantages**
        - More difficult conceptually ($\$a_t$$ what point is revenue earned?)
        - Cash is still king
