...
- $$\text{Value}= \frac{\text{NOPAT}_{CAP+1} \times (1-\text{growth/ROIC})}{\text{WACC} - g}$$
  - Where:
     ...
     - $\text{ROIC}$= Return on incremental [[An Asset Allocation Primer|investment]]
     - $\text{WACC}$= Weighted average cost of capital
  - NOPAT is an acronym for net [[Operating Income vs. Net Income What's the Difference|operating profit]] after tax.

This method is identical to the [[Free Cash Flow Valuation of Companies|free cash flow]] (FCF) in perpetuity approach when the underlying assumptions are the same. Here's the FCF in perpetuity approach:
...
- $$\text{ROIC} \times \text{[[An Asset Allocation Primer|investment]]}_1 = \Delta\text{NOPAT}_{2-1}$$
- A $5\%$ NOPAT growth rate tells us that NOPAT is going from $100 to $105. So the change in NOPAT is $5. Year 2 NOPAT of $105 minus Year 1 NOPAT of $100 = $5. We also know ROIC is $12\%$. So:
  - $$12\% \times \text{[[An Asset Allocation Primer|investment]]} = 5$$
  - $$\text{[[An Asset Allocation Primer|Investment]]}= \frac{5}{12\%} = 41.67$$

Now, we know that FCF$= 58.33. [\text{NOPAT of } 100 \text{ minus [[An Asset Allocation Primer|Investment]] of } 41.67 = 58.33].$
...
The same is true for the FCF in perpetuity model. First, we need to recalculate the [[An Asset Allocation Primer|investment]]:
...
5 Eugene F. Fama and Kenneth R. French, "The Cross-section of Expected Stock [[Assets|Returns]], "

Journal of Finance 47, 1992, 427-465; and Eugene F. Fama and Kenneth R. French, "The [[2. Forwards, Swaps, Futures, and Options|Capital Asset Pricing Model]]: Theory and Evidence, " *The Journal of Economic Perspectives*, Vol. 18, 3, Summer 2004, 25-46.

6 See www.jeremysiegel.com.

7 Aswath Damodaran, [[An Asset Allocation Primer|Investment]] Valuation: Tools and Techniques for Determining the Value of Any Asset, 2nd ed. (New York: John Wiley & Sons, 2002), 161-162. Also, Bradford Cornell, The Equity Risk Premium: The Long-Run Future of the [[Hedge Fund Strategies|Stock Market]] (New York: John Wiley & Sons,
...
11 Alfred Rappaport and Michael J. Mauboussin, [[FORWARD RATES AND TERM STRUCTURE|Expectations]] Investing: Reading Stock Prices for Better [[Assets|Returns]] (Boston, MA: Harvard Business School Press, 2001), 40-46.