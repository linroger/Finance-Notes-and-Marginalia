...
- Poor investor protection, poor governance and poor transparency often go hand in hand (see Week 7 $\$a_t$$ the end)
Governance problems are often $\$a_t$$ the heart of accounting shenanigans or, worse, $$a_t$$ the core of accounting scandals
...
!Political risk correlation chart

## Karolyi EM Book: Six Institutional Risk Factors
!Six institutional risk factors diagram

## How Do Emerging Markets Rank Overall?
!Emerging markets ranking chart
...
!Cost of equity differences chart
...
!Global valuation process diagram

## Global Valuation: Step 1
!Global valuation step 1 diagram
...
!Global valuation step 2 diagram
...
- Even if you forecast and discount in local currency, you can still convert NPV into home currency $\$a_t$$ spot exchange rate (after Step 5)
...
!Global valuation step 3 diagram
...
[^2]: Estimate $\$a_t$$ what point in time these risks are most likely to occur
...
!Scenario vs risk premium comparison
...
!Global valuation step 4 diagram
...
!Global valuation step 5 diagram
...
!Historical equity premium by country
...
!Historical vs implied premia comparison

## Implied Cost of Capital $\$a_t$$ Market Level (Using DDM)
!Implied cost of capital calculation
...
- Estimates of Hail/Leuz (2006) and EHV approach are highly correlated: ≈ 0.64
...
- Higher scores are better – highest possible is 100
!Country credit risk ratings chart
