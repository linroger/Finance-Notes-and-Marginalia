...
## BACKGROUND ON DOW AND PBB
 ...
 - Dow's first Latin American [[An Asset Allocation Primer|investment]] was in 1957
	- Investments in Colombia, Chile, Brazil, and Argentina
	- Largest [[An Asset Allocation Primer|investment]] is in Brazil where it has a petrochemical complex
 - What spurred the [[Week 8- Dow Chemical Case- Assignment Review|privatization of PBB]]?
...
## PLAN FOR DEVELOPMENT OF PE BUSINESS IN ARGENTINA
 - Vignart (VP business development for LatAm) believed bringing all of Bahia Blanca's PE activity under Dow's control would be consistent with [[Week 8- Dow Chemical Case- Assignment Review|Dow's business model]]
 - There are 3 project stages:
	- Stage 1: [[Week 8- Dow Chemical Case- Assignment Review|PBB acquisition]] (1 ethylene facility, 1 polyethylene facility) and upgrading of facilities to make them internationally competitive
...
## STAGE 1 FORECASTS REFLECT INTERDEPENDENCIES
 - Stage 1 already includes some upgrading and two separate cash flows:
	- 1) Ethylene cracker
		 ...
		 - Dow will operate cracker more efficiently due to the $72.9MM capital [[An Asset Allocation Primer|investment]]
...
## WHAT RISKS DOES DOW FACE? (QUESTION 1)
 - Given the [[Preview of the Book|cash flow]] estimates, the next step is to think about potential risks
 - What risks does Dow face in Argentina from PBB [[An Asset Allocation Primer|investment]]?
	- We need to diagnose the critical risks of this [[An Asset Allocation Primer|investment]]
	- Business risks and country risks
 - Thereafter: How should the risks be incorporated into the valuation analysis?
	- Discuss whether these risks are captured in the cash flows or need to be added to the [[PSET 7- Kohler|discount rate]]
...
## WHAT ARE CRITICAL BUSINESS FACTORS AND RISKS?
 ...
 - Utilization of cracker
	- Massive fixed cost/capital [[An Asset Allocation Primer|investment]]
 ...
 - Output price determined by market (little [[Arbitrage Pricing of Derivatives|pricing]] power)
 - Question: Are these business factors specific to Argentina?
 - Have they built them into the cash flows?
	 - Forecasted cash flows are [[FORWARD RATES AND TERM STRUCTURE|expectations]] and include planned operational changes
	 - Cyclicality of demand and various prices built into the forecasts
	 - Are there other risks?

## POTENTIAL COUNTRY RISKS
 - [[Forwards and Futures Notes|Currency]] risk
	- Argentina has a long history of sovereign defaults and [[Forwards and Futures Notes|currency]] crises
 - Expropriation risk
	- Argentine government takes all or part of [[An Asset Allocation Primer|investment]]
 - Tax risk
 ...
 - Regulatory risk
	- Could impose [[Arbitrage Pricing of Derivatives|pricing]] or supplier restrictions

## HOW SHOULD WE INCORPORATE THE VARIOUS RISKS?
 - Do the forecasted cash flows capture these risks?
 - In U.S., Dow uses a [[PSET 7- Kohler|discount rate]] of 8-10% (already captures beta)
	- Would anyone use a [[PSET 7- Kohler|discount rate]] of 10% for Argentina in 1995?
	- What risk premium would you add to debt, equity or WACC (as in Goldman model)?
 - Let's take a poll
 - What information do we have in the case to adjust the [[PSET 7- Kohler|discount rate]]?
...
## SCENARIO
 - Core idea: Consider explicit risks
	- Bad outcome: Expropriation or [[Forwards and Futures Notes|currency]] crisis and drop in demand
 ...
 - Scenario 2: Assume a [[Forwards and Futures Notes|currency]] crisis
 - How did you handle these?
 - Scenario 1: Could be handled in the cash flows
 - Scenario 2: [[Forwards and Futures Notes|Currency]] risk is tied to Argentina's sovereign and difficult to model in the cash flows
	- [[PSET 7- Kohler|Discount rate]] adjustments for [[Forwards and Futures Notes|currency]] risk are common
	- But let's think some more about the [[Forwards and Futures Notes|currency]] risks

## RISKS REVISITED: CURRENCY CRISIS
 - What would be the impact of a [[Forwards and Futures Notes|currency]] devaluation in this case?
	- Inputs and outputs are all international [[Futures Not Subject to Cash-And-Carry|commodities]] with prices in dollars
	- Variable costs of plant are in local [[Forwards and Futures Notes|currency]]
	 - So, variable costs would even decrease
 - More generally: During a [[Forwards and Futures Notes|currency]] or [[Squam Lake Group Letter|financial crisis]], would you rather own a sovereign bond or a plant in Argentina?
	- Relevant risks are quite different
 - What might we be missing?
	- [[Forwards and Futures Notes|Currency]] crisis likely affects local demand negatively
	- What option would Dow have?
	 - Export backstop
	 - Impact on profitability?
 - What [[PSET 7- Kohler|discount rate]] did you use for the scenarios?
...
## OUTCOME OF DOW'S BID FOR PBB
 ...
 - Dow's total [[An Asset Allocation Primer|investment]] in the [[Week 8- Dow Chemical Case- Assignment Review|Bahia Blanca complex]], including all three stages of the project, was $1.5 billion
 - In 2002, Argentina faces [[Forwards and Futures Notes|currency]] crisis:
...
## WHAT ELSE COULD ONE CONSIDER?
 ...
 - Dow treated it like a [[Class Note 1- Borrower-Lender conflicts and implied agency problems|capital budgeting]] project from the parent shareholder
perspective, and not like buying a private company

## SURVEY OF WHAT PEOPLE DO
 - [[PSET 7- Kohler|Discount rate]] adjustments are common (see table below)
	- Risks need to be handled consistently, either in cash flows or the [[PSET 7- Kohler|discount rate]]
...
## SUMMING UP
 ...
 - In many settings, foreign investors (FDI or [[An Asset Allocation Primer|portfolio]]) are better positioned because of their access to global product or capital markets
	 - Export backstop
	- Foreign multinationals are often not expropriated because they would be a "prominent victim"
 - Thus, some of the typical country risks might not apply to your [[An Asset Allocation Primer|investment]]
...
## SUMMING UP (CONT.)
 ...
 - Increasing the [[PSET 7- Kohler|discount rate]] penalizes long-term investments and skews incentives in favor of short-term ones
 - Given how difficult it is to properly adjustthe [[PSET 7- Kohler|discount rate]], try hard to first handle risks in the [[Week 6 Assignment Review|expected cash flows]] using scenarios
	- It might be better to have "messy" conversations about specific risks that your foreign [[An Asset Allocation Primer|investment]] faces
	- Modelling risks in the cash flows brings people in operations into the conversation
	- But: Remember to then "dial-down" [[Discount Factors|discount factor]] (double counting)