...
[[Week 3 [[Week 3 Financial Risk Analysis|Financial Risk Analysis]]|[[Week 3 [[Week 3 Financial Risk Analysis|Financial Risk Analysis]]|[[Week 3 Financial Risk Analysis|risk analysis]]]]]]
...
### FINANCIAL RISK ANALYSIS
- Valuation Process
	- [[Week 3 Financial Risk Analysis|Forecast cash flows]] (or earnings)
	- Build valuation model and discount CFs
		- Today:
			- Finish [[Week 3 Financial Risk Analysis|Risk Analysis]]
			- focus on financial risk
			- Start with [[Week 2 Fundamentals Of Forecasting|forecasting]] (mechanics)
...
- Risk-Incentive Problem (Ex Post)
	- Subsequent increases in [[A Primer on Structured Finance|credit risk transfer]] wealth from the lender to the borrower
	- Analyze whether risk or strategy has changed
	- Place [[Class [[Slides Note 9 Bidask.not New 2020|Slides]] 2 Discussion of [[Class Slides 2 Discussion of Loan Covenants Vs. Bond Covenants|Loan Covenants]] Vs. Bond Covenants|Covenants]] into the lending agreement
- Information And [[Week 3 Financial Risk Analysis|Risk Analysis]] Are Critical With Respect To Both Problems

### FINANCIAL RISK ANALYSIS TOOLBOX
- [[Week 1 Ratio Analysis + Valuation Review|Ratio Analysis]]
	- [[Class Note 10 Liquidity and Class Note 10 Liquidity and Liquidity Managementliquidity management|Liquidity]],  profitability and solvency ratios
- Cash-flow analysis
	- Understand business model
	- Understand financing needs
	- Analyze [[Preview of the Book|cash flow]] statements (and other financials)
	- Assess financial flexibility (e.g.,  could they sell assets?)
- Pro-forma financial statements
	- Predict [[Advanced Derivatives Pricing Methodology|future cash flows]]
	- Assess ability to meet [[Notes on Currency Swaps|interest and principal]] payments
- Ratings

### BANKRUPTCY PREDICTION MODELS
- [[Credit Market Session 2|Credit Default Swap]] (CDS) Spreads
...
- [[Class Note 10 Liquidity and Class Note 10 Liquidity and Liquidity Managementliquidity management|Liquidity]] index
...
- [[Preview of the Book|Cash flow]] adequacy ratio
...
- Balance sheet [[Lecture 6-Leverage, Tail Risk, Volatility Products|leverage]]
...
- Variants of interest coverage ratio
	...
	- Use [[Preview of the Book|cash flow]] in numerator
- [[Notes on Currency Swaps|Debt service]] coverage ratio
	- $$\text{Debt service coverage ratio} = \frac{\text{EBITDA} + \text{discretionary expenses}}{\text{interest} + \text{principal and lease payments}}$$
- Variants of [[Notes on Currency Swaps|debt service]] coverage
	- Use operating [[Preview of the Book|cash flow]] rather than EBITDA
...
- What Could The Firm Do To Improve Its [[Preview of the Book|Cash Flow]] Situation?
- Consider Various Actions By Essentially Going Through The Line Items In The [[Preview of the Book|Cash Flow]] Statement
...
- Using observable yields (as an approximation):
	- If publicly traded: $\text{R}_d = \text{Yield to maturity on long-term debt}$
		- (yield = IRR such that bond price = PV of _promised_ future [[Notes on Currency Swaps|interest and principal]] payments)
	- If not publicly traded,  but rated:
		- Yield on [[Corporate Bonds and Loans|corporate debt]] with similar rating
	- If not public and not rated: Estimate what rating would be (e.g.,  based on financial risk ratios) and then use yield on [[Corporate Bonds and Loans|corporate debt]] with similar rating
- However:
	- Yield to maturity can be a poor proxy for the cost of debt as the debt becomes riskier or more distressed
	- Cost of debt is the IRR such that bond price = PV of _expected_ future [[Notes on Currency Swaps|interest and principal]] payments
...
- Present Value Of Expected Costs Resulting From Risky [[Contemporary Financial Intermediation Notes|Debt Financing]]
- Includes potential costs to firm as it approaches default AND costs to firm if defaults
- Costs of distress are a reduction in the [[Week 6 Assignment Review|expected cash flows]]
...
- Fire-sale of assets
- Potential underinvestment (shareholders' unwilling to fund new projects since benefits will accrue to bondholders,  and since debt [[Class [[Slides Note 9 Bidask.not New 2020|Slides]] 2 Discussion of [[Class Slides 2 Discussion of Loan Covenants Vs. Bond Covenants|Loan Covenants]] Vs. Bond Covenants|Covenants]] prohibit additional borrowing)
- Management time spent in discussions with creditors and [[Primary Issuance and Secondary Resale Markets|investment bankers]] about refinancing and reorganization (instead of running the business)
- Costs Of [[Southland Corp. (c)|Financial Distress]] Likely Vary Across Industries And Over Time
...
- Recall third-party conflicts
	- Rating agencies need to "gain access" to information to have a [[Week 6 Bank Analysis and Valuation|competitive advantage]] over other agencies
...
- [[Note on The [[Credit Derivative Indexes|Dodd-Frank Act]] and Its Impact|[[Note on The Dodd-Frank Act and Its Impact|Dodd-Frank]]]] eliminates reference to ratings for capital requirements
...
- Financial Ratios (Profitability,  [[Class Note 10 Liquidity and Class Note 10 Liquidity and Liquidity Managementliquidity management|Liquidity]] And Solvency)
...
- Stock [[Assets|returns]] and return volatility (e.g.,  Shumway model,  JoB 2001)
- Contingent claim (or [[Credit Markets Session 5|Merton]]) model and KMV
- CDS spreads
...
|-------|-----------------|
| Z-Score = 1.2 [working capital/ total assets] | ST [[Class Note 10 Liquidity and Class Note 10 Liquidity and Liquidity Managementliquidity management|liquidity]] |
...
- Extension Of [[Credit Markets Session 5|Merton]]'s Bond [[Arbitrage Pricing of Derivatives|Pricing]] Model (1974)
- Based on contingent-claim framework and option [[Arbitrage Pricing of Derivatives|pricing]] theory
	- Equity = Call option on the firm's assets
	- Debt = [[Call and Put Payoffs at Expiry|Strike price]] of the option
...
- For more details on KMV model:
	- See Additional Readings folder on Chalk: e.g.,  [[An Asset Allocation Primer|primer]] on KMV by Moody's
...
- There are basically three steps to derive the actual probabilities of default:
	...
	1. Calculate the distance to default,  an index measure of [[Default Risk and Credit Derivatives 183|default risk]]
	1. Scale of the distance to default to actual [[Credit Markets Session 3|default probabilities]] using a default database

### MOODY'S BOUGHT KMV IN 2002
- There are some differences between Moody's KMV model and [[8. Credit Modeling and Credit Derivatives|Merton's model]]
	...
	- Moody's model is a generalization of [[8. Credit Modeling and Credit Derivatives|Merton's model]] allowing for various classes and maturities of debt
### RATINGS VS. EDF
...
- Think about adjusting the accounting numbers:
	- Earnings management
	- Differences in accounting choices or [[Week 6 Bank Business Model, Regulation, and Accounting Rules|accounting rules]]
...
- A [[Credit Market Session 2|credit default swap]] (CDS) is a contract in which the _buyer_ of the CDS makes a series of payments to the _seller_ and,  in exchange,  receives a payoff if a credit instrument (typically a bond or loan) undergoes a pre-defined [[Valuation of Credit Default Swaps|credit event]]
- [[Valuation of Credit Default Swaps|Credit event]] is generally default,  i.e.,  a failure to pay
...
- The "spread" of a CDS is the annual amount the [[Credit Default Swaps|protection buyer]] must pay the [[Credit Default Swaps|protection seller]] over the length of the contract,  expressed as a percentage of the notional amount
	- For example,  if the [[Cds-Equivalent Bond Spread|CDS spread]] is 50 basis points,  or 0.5%,  then an investor buying $10 million worth of protection from a bank must pay the bank $50,  000 per year
	- Spread is essentially a market-based measure of [[Quantitative Trading Strategies Lecture Notes|credit risk]]
