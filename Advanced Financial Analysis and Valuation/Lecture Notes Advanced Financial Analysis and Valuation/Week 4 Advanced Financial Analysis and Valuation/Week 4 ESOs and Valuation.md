...
- Stock-based compensation $\$a_t$$ Google
...
- Assumes options exercised $\$a_t$$ beginning of period
- Proceeds used to buy back shares $\$a_t$$ average price
