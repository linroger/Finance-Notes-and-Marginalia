...
- Cash and short-term investments represent the bulk of their assets
  - No financial debt $\$a_t$$ this stage of the life-cycle
...
- Assumption needed: How long does it take for R&D to be converted, on average, into commercial product?
  ...
  - R&D expenses (or research assets) $\$a_t$$ a pharmaceutical company should have fairly long lives
  - R&D expenses (or research assets) $\$a_t$$ software firms should have shorter lives
...
- If all the companies in the sector operate under the same accounting rules (expensing R&D), why should we adjust for intangibles?
  - Life-cycle: Effects of capitalization are generally much greater $\$a_t$$ young companies vs. mature companies
