...
- How to account for information problems?
  ...
  - We come back to this $\$a_t$$ the end and next week
...
E.g., CP = 25% relative to minority shares is equivalent to minority shares valued $\$a_t$$ MD = 20% relative to controlling shares

Discount (or premium) is applied to base valuation

> [!NOTE]
> "Often there is more money $\$a_t$$ stake in determining what discounts or premiums are applicable to some business valuations than there is arriving $$a_t$$ the base value." (S. Pratt, Business Valuations and Discounts, 2001)
...
- Large variation in the average discount: approx. 20-40%
  - Probably much smaller today ($\$a_t$$ least in the U.S.)
> [!NOTE]
...
Apply valuation adjustment $\$a_t$$ the end?
