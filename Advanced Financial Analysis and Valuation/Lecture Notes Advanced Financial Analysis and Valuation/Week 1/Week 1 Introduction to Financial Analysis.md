...
- Analyzing financial statements is $\$a_t$$ the core of valuation
...
- Economic profit declines on average
	- But not necessarily for all companies ($\$a_t$$ the same rate)
