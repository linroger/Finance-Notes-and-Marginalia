...
- **Week**: 9
- **Topics**: International Accounting Standards, Information Risks, Platform Business Valuation
...
!IFRS implementation complexity

## 'Apples to Apples' Approach $\$a_t$$ Morgan Stanley
...
- Adopted "apples to apples approach" prior to worldwide IFRS adoption
  - Made adjustments by industry so that we are $\$a_t$$ least comparing green apples to red apples, rather than apples to oranges
...
## Accounting Differences and Valuation (Continued)
...
- Back to the information risks with foreign investments
  - The core issue is not (and never was) the standards, but differences in companies' willingness to provide information
...
- How pervasive are accounting shenanigans by U.S. companies compared to the rest of the world?
## Earnings Opacity Around the World
!Earnings opacity scores
...
!Transparency scores update 1

Higher score means LESS transparent

## Updated Transparency Scores (Continued)
!Transparency scores update 2
...
- Uneven Adoption
  ...
  - HSBC 2012 Annual Report: "Group financial statements have been properly prepared in accordance with IFRSs **as adopted by the EU**"
...
!Growing GAAP vs non-GAAP spread
...
!Non-GAAP exclusions example

# Non-GAAP Reporting Revisited
## How Should We Think About Non-GAAP Reporting?
- This practice leads to "new" accounting differences
...
- SEC basically recognizes the tradeoff between:
  ...
  - Shenanigans targeted $\$a_t$$ investors' impressions, interpretations and expectations
# Dropbox: Investor Presentation Highlights Non-GAAP
!Dropbox presentation example

## Dropbox: Reconciliation
!Dropbox GAAP reconciliation
...
!Subscription business growth chart
...
- Then, we can aggregate these components to determine the overall value of the firm
...
!CBCV framework diagram

## Valuation Example: Blue Apron $\$a_t$$ IPO
- CAC = Total Marketing Expense / Total Customers Acquired in Period = $94$
- Lifetime value (LTV) = Revenue × Gross Margin = $939 × 31.2\% = $293
  - Assume cohort lasts for 3 years and gross margin stays $\$a_t$$ Q1'17 levels
- LTV / CAC = 3.1x
!Blue Apron metrics
...
$\$\text{Total Customers} = \frac{\text{TAM of market in future} \times \text{assumed market share}}{\text{Average annual spend}}$$
...
- TAM estimate for meal kit market = $10B in 2024$
  ...
  - Total number of customers ≈ 5.66M (=10B×0.34/606)
  - Future customers ≈ 4.62M
...
- Ask: Does it matter to me if my neighbor or friend uses Blue Apron?
  - Neighbor: Economies of scale ≠ network effects
  - Friend: CAC benefits from word-of-mouth ≠ network effects
...
## Core Themes of the Class (Continued)
