...
[[Week 6 Bank Business Model, Regulation, and Accounting Rules|Banks: Business Model, Regulation]] and [[Week 6 Bank Business Model, Regulation, and Accounting Rules|Accounting Rules]]
...
- Risk-sharing services
	   - [[Moody's Approach to Assessing the Adequacy of Liquidity Risk Insurance|Liquidity insurance]] (e.g., demand deposits)
	   - [[Financial Mathematics Course|Risk management]]
- Proprietary trading (restricted under [[The Dodd Frank Act and Its Impact|Dodd Frank]])
- Obviously, not all banks offer all functions or services

## ECONOMICS OF BANKING: LENDING

- [[Week 6 Bank Business Model, Regulation, and Accounting Rules|Banks are financial intermediaries]]
	   - Receive funds from customers (deposits) or investors (e.g., [[When Safe Proved Risky Commercial Paper During the Financial Crisis of 2007 2009|short-term debt]])
	   - Lend funds to customers (e.g., mortgages, consumer and corporate loans,
credit cards)
	   - Earn [[Week 6 Bank Business Model, Regulation, and Accounting Rules|interest rate spread]]
		- Given their business model, banks are highly leveraged
- Banks normally have a [[Week 6 Assignment Review|duration mismatch]]:
	   - [[Key Rates O1s Durations and Hedging|Duration]] of assets is longer than the [[Key Rates O1s Durations and Hedging|duration]] of liabilities
	   - E.g., mortgages vs. checking or savings accounts
- Given the [[Week 6 Assignment Review|duration mismatch]], banks hold positions in fixed-income securities
 - Bank lending involves basically three risks
	   - Credit, [[Class Note 10 Liquidity and Class Note 10 Liquidity and Liquidity Managementliquidity management|liquidity]] and interest rate
...
- Equivalent to a top line in [[HKS The Banking Industry|banking]] is interest income (or combined interest and
non-interest income)        - Equivalent to COGS is interest expense
- Think of deposits as raw material
	   - If they were debt, then [[[[BMW Valuation|Operating Income]] vs. Net Income What's the Difference|[[BMW Valuation|Operating Income]]]] should before interest expense
...
- Bank invest heavily in [[Week 5 Accounting Recap- R&D, Intangibles, M&A & Goodwill#[[Week 5 Accounting Recap- R&D, Intangibles, M&A & Goodwill|INTANGIBLE AMORTIZATION]] AND NON‐GAAP REPORTING|intangible]] assets
	   - At the core, banks are a mix of brand & reputation, human capital, and
technology (or IT)

## PRIMER ON BANK REGULATION BANKING REGULATION 101

- Providing a detailed exploration of [[Week 6 Bank Business Model, Regulation, and Accounting Rules|banking regulation]] goes beyond the scope of
this lecture, but I will introduce some important concepts
- Due to the [[Week 6 Assignment Review|duration mismatch]] between banks' assets and liabilities, banks are
...
primary reasons for [[Week 6 Bank Business Model, Regulation, and Accounting Rules|bank regulation & deposit insurance]]
...
- Bank regulation broadly consists of:
	   - [[Week 6 Bank Business Model, Regulation, and Accounting Rules|Capital requirements & leverage]] restrictions
	   - Supervision & reporting requirements        - New: [[Class Note 10 Liquidity and Class Note 10 Liquidity and Liquidity Managementliquidity management|Liquidity]] requirements
...
[[Chapter 5 - Index Futures|market risk]] in their securities [[An Asset Allocation Primer|portfolio]] when computing RWA        - p VaR is defined as the probability of a loss greater than VaR is (at most) p
...
- Basel III also includes a (simple) [[[[Lecture 6-Leverage, Tail Risk, Volatility Products|Leverage]] Ratio|[[Lecture 6-Leverage, Tail Risk, Volatility Products|leverage]] ratio]] of equity to assets (including offbalance sheet exposures): Equity/Total assets > 3%        - Not based on [[Credit Markets Session 4|risk models]]
- [[Class Note 10 Liquidity and Class Note 10 Liquidity and Liquidity Managementliquidity management|Liquidity]] ratios
	   - LCR ([[Liquidity Management and Currentregulatory Iss|Liquidity Coverage Ratio]])
...
- Most [[HKS The Banking Industry|banking]] jurisdictions are moving from provision models based on "incurred
losses" to models based on "expected losses" (CECL):        - IFRS 9
	   - U.S. GAAP (ASC 326)

## HIGH-LEVEL DIFFERENCES BETWEEN IFRS AND US GAAP
 - Fasb And Iasb Both Adopted An Expected [[Default Rates Recovery Rates and Credit Losses|Credit Loss]] Approach And Replaced The Incurred Loss Approach. However, Some Differences Remain:
...
- In the U.S.:
	   - "**The [[Squam Lake Group Letter|financial crisis]] revealed a distinct flaw in the incurred loss model.** By requiring banks to
wait for an "incurred" loss event to recognize the resulting impairment, the model precludes banks from taking appropriate provisions for emerging risks that the bank can reasonably anticipate to occur. The result too often has been the need for banks to make large [[Week 6 Assignment Review|loan loss provisions]] in the midst of a credit downturn, often when earnings and lending capacity are already stressed. **This leads to pro-cyclicality and results in delayed loss recognition**."
Comptroller of the [[Forwards and Futures Notes|Currency]]: Remarks by Thomas J. Curry, before the AICPA [[HKS The Banking Industry|Banking]] Conference
(September 16, 2013)
- IFRS:
...
IFRS Foundation: Report of the [[Squam Lake Group Letter|Financial Crisis]] Advisory Group (2009)
...
[[Week 9-Information Risks and (International) Accounting Differences, Platform Businesses|International Accounting]] Standards Board (IASB), and the SEC
 - should review accounting
standards to determine how [[Squam Lake Group Introduction|financial firms]] should be required to employ more forwardlooking loan loss provisioning practices that incorporate a broader range of available credit information. " (Department of Treasury, 2009)
- GAAP: Current Expected [[Default Rates Recovery Rates and Credit Losses|Credit Loss]](CECL) Estimation
...
- IFRS: Expected [[Default Rates Recovery Rates and Credit Losses|Credit Loss]](ECL) Calculation
	   - Expected Credit Losses are calculated based on the following components: Exposure at
Default, Loss Given Default, **Marginal Probability of Default**, and [[Discount Factors|Discount Factor]] (KPMG,
