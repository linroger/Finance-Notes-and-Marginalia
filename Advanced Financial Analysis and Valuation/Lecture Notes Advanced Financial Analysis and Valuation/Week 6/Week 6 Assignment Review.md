...
- Assets: $2.188 trillion $$a_t$$ the end of 2007$
  ...
  - Trading account assets $539 billion (25\% of total assets)$
    ...
    - Reported $\$a_t$$ fair value; unrealized gains and losses affect the P&L
- Liabilities
...
### Tier 3 Capital
- Subordinated debt ($\$a_t$$ least two-year maturity)
...
- Why is Citigroup seeking to sell the portfolio of leveraged loans?
  ...
  - Bridge loans have escalating financing costs but they were issued $\$a_t$$ the peak of the credit cycle with loosening credit standards
...
- Why not raise capital instead of selling assets?
  - Dilution of existing shareholders due to "fire sale" of equity $\$a_t$$ depressed stock prices
...
- In retrospect, the timing of the deal was probably not ideal for Blackstone
  - Subsequently, CDS skyrocketed, secondary loan market prices fell and loans were marked to 70 cents on the dollar $\$a_t$$ their low point (March 2009)
