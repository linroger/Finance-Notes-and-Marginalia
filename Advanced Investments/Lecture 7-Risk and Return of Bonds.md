...
funds rate hit zero and could not fall any further. This constraint by the zero lower bound (ZLB) was the motivation for the Federal Reserve to engage in unconventional [[Lecture 7-[[Lecture 7-Risk and Return of Bonds|Risk and Return]] of Bonds#7.6 [[A Preview of Alternative Formulations|Asset price]] reactions to [monetary policy](The Economist Regime Change.md) surprises|[monetary policy](The Economist Regime Change.md)]] measures such as [[Negative Rates and Qe in Europe and Japan|quantitative easing]].

One important detail in the construction of the plot in Figure 7.10 is that the [inflation](War Economies and Hyperinflation.md) and [[Topics in Fiscal and Monetary Policies and Stabilization- Empirical Issues|output gap]] measures are based on real-time data as it was available at the time the FOMC made decisions. Macroeconomic data such as [inflation](War Economies and Hyperinflation.md) rates and GDP often gets substantially revised during the quarters following the initial announcement of an estimate. But if the FOMC makes a decision based on the most recently observed [inflation](War Economies and Hyperinflation.md) rates and output gaps,  these revised data are not available yet. So if one wants to understand how macroeconomic data drives [[Lecture 7-[[Lecture 7-Risk and Return of Bonds|Risk and Return]] of Bonds#7.6 [[A Preview of Alternative Formulations|Asset price]] reactions to [monetary policy](The Economist Regime Change.md) surprises|[monetary policy](The Economist Regime Change.md)]] decisions,  it's important to look at data that was actually available at the time when the FOMC decided on [[Lecture 7-[[Lecture 7-Risk and Return of Bonds|Risk and Return]] of Bonds#7.6 [[A Preview of Alternative Formulations|Asset price]] reactions to [monetary policy](The Economist Regime Change.md) surprises|[monetary policy](The Economist Regime Change.md)]].

Let's circle back to assessing risks of long-term bonds. We figured out earlier that long-term bond price changes reflect changing [expectations](FORWARD RATES AND TERM STRUCTURE.md) of future short-term [interest rates](Interest Rate Quotations.md). Now we know,  through the [[Topics in Fiscal and Monetary Policies and Stabilization- Empirical Issues|Taylor rule]],  that these [expectations](FORWARD RATES AND TERM STRUCTURE.md) of future changes in short-term [interest rates](Interest Rate Quotations.md) must ultimately boil down to [expectations](FORWARD RATES AND TERM STRUCTURE.md) about future [inflation](War Economies and Hyperinflation.md) and future output gaps.

### 7.8 Yield curve and the business cycle

That bond market investors' [[The Gauss Model|short-term interest rate]] [expectations](FORWARD RATES AND TERM STRUCTURE.md) should be closely related to their [expectations](FORWARD RATES AND TERM STRUCTURE.md) of future [inflation](War Economies and Hyperinflation.md) and output gaps implies that the shape of the yield curve may be informative about the future state of the [[Business Cycles- Introduction, Characteristics, and History|business cycle]].

For example,  consider a situation where the economy is in a boom. [[War Economies and Hyperinflation|Inflation]] may be a little elevated and the output is high. As a consequence,  short-term [interest rates](Interest Rate Quotations.md) are relatively high. But bond market investors anticipate a downturn that will set in soon. As a consequence,  they expect the Federal Reserve to lower [[Monetary Policy with Abundantreserves|the fed]] fund rate target in the coming quarters. So long-term bond yields should be relatively low,  perhaps even lower than short-term [interest rates](Interest Rate Quotations.md) if the long-term bond risk premium is not too big. In other words,  the yield curve should be inverted,  or close to inversion,  if bond market investors think that a recession is approaching.
...
Let's go back to our earlier expression (7.18) that relates bond [returns](Assets.md) to surprises in future short-term yields:
$$
...
The longer the maturity $n$ of the bond,  the more terms of future expected [[Volatility and Convexity|short-term rates]] are there in the summation in the last term of this equation,  and hence the bigger are typically the changes in the [expectations](FORWARD RATES AND TERM STRUCTURE.md) of this sum,  and hence the more volatile is the bond return.

So if long-term bonds have more volatile [returns](Assets.md),  does this mean that long-term bonds should also earn a higher risk premium than short-term bonds? While this may seem plausible,  it's not obvious. Note that we are looking at the volatility of short-term [returns](Assets.md) here. But recall that for a long-term investor,  a long-term bond is actually a risk-free [[An Asset Allocation Primer|investment]] - at least it's risk-free if the long-term investor cares about nominal payoffs,  without adjusting for [inflation](War Economies and Hyperinflation.md). So if this kind of long-term view dominates among investors,  it's also possible that long-term bond earn a smaller risk premium than short-term bonds. Let's see what the data says.

In our analysis of bond [returns](Assets.md),  we have so far focused on log [returns](Assets.md),  due to the convenience of working with logs. But investors' care about simple,  not log [returns](Assets.md). So in the data,  we will look at simple [returns](Assets.md) in excess of short-term bond [returns](Assets.md). However,  the differences are quite small. For example,  if $R_{n,             t+1}$ is log-normal,  $\mathbb{E}\left[r_{n,             t+1}\right]$ $=0.02$ and $\operatorname{var}\left(r_{n,             t+1}\right)=0.05^{2}$ (which is empirically realistic,  as we will see shortly),  then $\mathbb{E}\left[R_{n,             t+1}\right] \approx \exp \left(0.02+0.05^{2} / 2\right)-1 \approx 0.0215$.
...
Table 7.2 takes a first look at this by showing the annualized average [returns](Assets.md) of portfolios of U.S. Treasury bonds of various maturities in excess of the average 1-year bond return,  along with the standard deviation of these [returns](Assets.md) and the Sharpe ratio. The estimates are based on data spanning five decades from 1971 to 2023.

The table shows that mean [returns](Assets.md) and standard deviations increase with maturity. The standard deviation result is sensible. As we discussed,  bonds are exposed to the risk of changing [expectations](FORWARD RATES AND TERM STRUCTURE.md) of future short-term [interest rates](Interest Rate Quotations.md). And for a long-term bond,  with its final [cash flow](Preview of the Book.md) far into the future,  this [[PSET 7- Kohler|discount rate]] effect is bigger. This is consistent with our discussion above following equation (7.21). The fact that the mean return is increasing in maturity suggests that the long-term bond risk premium is increasing in maturity.

The last row of Table 7.2 shows Sharpe ratios. They are almost the same for all three maturities and they are quite high! For comparison,  the CRSP value-weighted [stock market](Hedge Fund Strategies.md) index earned a Sharpe ratio of about 0.43 during the same time period. We still have to investigate more the correlation of bond [returns](Assets.md) with other assets to figure out how much bonds contribute to [portfolio](An Asset Allocation Primer.md) risks,  but these high Sharpe ratios seem suggestive that bonds could be good for [portfolio](An Asset Allocation Primer.md) [risk and return](Lecture 7-Risk and Return of Bonds.md) performance.
...
Figure 7.11 illustrates the consequences of this unanticipated fall in [interest rates](Interest Rate Quotations.md) for the return of long-term bonds. The figure shows five-year moving averages of annualized monthly [returns](Assets.md) of 10-year bonds in excess of 1-year bond [returns](Assets.md). Until the mid-1980s,  these five-year moving average excess [returns](Assets.md) were negative,  as bond investors suffered from rising [interest rates](Interest Rate Quotations.md). But then,  during the decades that followed,  none of the five-year moving averages was ever negative. This was surely luck for long-term bond investors. Even if long-term bonds earn a higher risk premium than short-term bonds,  we would expect that sometimes long-term bonds underperform short-term bonds for an extended period of time. But during these usual decades since the early 1980s,  bonds benefited again and again from further falls in [interest rates](Interest Rate Quotations.md). Almost surely nobody could have seen this coming in the early 1980s. For this reason,  the high Sharpe ratios of bonds that we see in Table 7.2 must have a substantial luck component that we should not expect to show up again in the coming years.
...
Under the [[Lecture 7-[[Lecture 7-Risk and Return of Bonds|Risk and Return]] of Bonds#7.4 [[The Expectation Hypothesis|Expectations hypothesis]]|[[The Expectation Hypothesis|expectations hypothesis]]]],  the expected [returns](Assets.md) of investing in bonds of different maturities are equal,  up to differences due to a constant risk premium. Hence,  an upward-sloping yield curve does not necessarily mean that long-term bonds have higher expected [returns](Assets.md) than short-term bonds. At least part of the upward slope could also reflect [expectations](FORWARD RATES AND TERM STRUCTURE.md) that short-term yields are going to rise in the future.

The [[Lecture 7-[[Lecture 7-Risk and Return of Bonds|Risk and Return]] of Bonds#7.4 [[The Expectation Hypothesis|Expectations hypothesis]]|[[The Expectation Hypothesis|expectations hypothesis]]]] gave us a theory of the yield curve that at least roughly seems to be true,  based on eyeballing the yield curve history. The way the slope of the yield curve forecasts the future path of short-term [interest rates](Interest Rate Quotations.md) and the [[Business Cycles- Introduction, Characteristics, and History|business cycle]] seems roughly in line with the [[Lecture 7-[[Lecture 7-Risk and Return of Bonds|Risk and Return]] of Bonds#7.4 [[The Expectation Hypothesis|Expectations hypothesis]]|[[The Expectation Hypothesis|expectations hypothesis]]]]. But this does not mean the [[Lecture 7-[[Lecture 7-Risk and Return of Bonds|Risk and Return]] of Bonds#7.4 [[The Expectation Hypothesis|Expectations hypothesis]]|[[The Expectation Hypothesis|expectations hypothesis]]]] holds exactly.

One way in which we can check for deviations from the [[Lecture 7-[[Lecture 7-Risk and Return of Bonds|Risk and Return]] of Bonds#7.4 [[The Expectation Hypothesis|Expectations hypothesis]]|[[The Expectation Hypothesis|expectations hypothesis]]]] is by checking whether we can predict the excess return of long-term bonds over short-term bonds. The [[Lecture 7-[[Lecture 7-Risk and Return of Bonds|Risk and Return]] of Bonds#7.4 [[The Expectation Hypothesis|Expectations hypothesis]]|[[The Expectation Hypothesis|expectations hypothesis]]]] says that we should not be able to do this. To see this,  subtract the short-term yield from both sides of (7.21) and take conditional [expectations](FORWARD RATES AND TERM STRUCTURE.md). This yields
$$
...
in which the right-hand side is constant over time,  and hence the left-hand side must be constant,  too. Therefore,  under the [[Lecture 7-[[Lecture 7-Risk and Return of Bonds|Risk and Return]] of Bonds#7.4 [[The Expectation Hypothesis|Expectations hypothesis]]|[[The Expectation Hypothesis|expectations hypothesis]]]],  there is no scope for generating superior [returns](Assets.md) from market-timing the bond market. (As before,  the caveat about differences between expected simple and expected log [returns](Assets.md) applies here.)

In contrast,  if the [[Lecture 7-[[Lecture 7-Risk and Return of Bonds|Risk and Return]] of Bonds#7.4 [[The Expectation Hypothesis|Expectations hypothesis]]|[[The Expectation Hypothesis|expectations hypothesis]]]] is not entirely correct because the risk premium bond investors demand from bonds is time-varying,  or because bond investors have [[Lecture 4- Investor Sentiment|time-varying sentiment]] that [[Week 2 Fundamentals Of Forecasting|biases]] their [expectations](FORWARD RATES AND TERM STRUCTURE.md) of future short-term [interest rates](Interest Rate Quotations.md) sometimes upward,  sometimes downward,  then we should be able to predict [returns](Assets.md) of long-term bonds in excess of short-term yields. For example,  suppose investors are currently very averse to the risks of holding long-term bonds. This should,  simultaneously,  raise yields of long-term bonds and the slope of the yield curve,  and generate high [returns](Assets.md) of long-term bonds going forward. In other words,  if bond risk premia are time-varying,  the yield curve slope might be able to tell us when we can expect high or low excess [returns](Assets.md) of long-term bonds.

To check this empirically,  we'll focus on the excess return of a [portfolio](An Asset Allocation Primer.md) that averages [returns](Assets.md) of bonds with different maturities from $n=2$ to $n=10$. I run the regression
$$
...
by including the dummy variable $\mathbb{1}_{82 t o 21}$ that simply takes values equal to zero in months before 1981,  a value of one from 1982 to 2021 and zero in all remaining months. This basically allows the intercept of the regression to be different from 1982 to 2021 (where it is $a+d$ ) and the rest of the sample (where it is just $a$ ). This effectively removes the difference in average [returns](Assets.md) between the 1982 to 2021 period and the rest of the sample,  which,  as I have argued,  investors likely could not have anticipated.

As the second block of rows in Table 7.3 shows,  this has a big effect on the estimate of the slope coefficient $b$ : it drops to about half in magnitude and it is quite far from being statistically significant. So the earlier result that bond excess [returns](Assets.md) can be predicted with the yield curve slope is quite fragile! At least some of it seems to be due to the low slope/low [returns](Assets.md) before 1982,  high slope/high [returns](Assets.md) from 1982 to 2021 pattern.

As we did a few lectures ago when we discussed [stock market](Hedge Fund Strategies.md) excess return [[Week 2 Fundamentals Of Forecasting|forecasting]] with the [price-dividend ratio](Lecture 4- Investor Sentiment.md),  we can also ask here how the bond excess return predictability looks like out of sample. The predictive regressions we looked at so far in the table above using the full sample of data are not regressions that an actual investor without the luxury of hindsight could have run.
...
Figure 7.12: Cumulative standardized excess [returns](Assets.md) of different out-of-sample [[Lecture Notes Bonds,  Preferred Stock,  and Structured Products|portfolio strategies]]

Once I have the full time-series of [portfolio](An Asset Allocation Primer.md) [returns](Assets.md),  I cumulate them and then by divide by the full-sample standard deviation (recall that this turns the cumulated [returns](Assets.md) into a cumulated "realized Sharpe ratio"). The blue line in Figure (7.12) shows the result.

As in our earlier analysis of [stock market](Hedge Fund Strategies.md) return predictability,  I compare the results to a trading strategy that uses just the trailing mean bond excess return instead of the predictive regression forecast as the [portfolio](An Asset Allocation Primer.md) weight. [[Assets|Returns]] are again cumulated and standardized. The red line shows the result for this trailing mean strategy. The result is quite different from what we found for [stock market](Hedge Fund Strategies.md) excess return predictability where predictive regression and trailing mean strategy delivered almost exactly the same cumulative standardized [returns](Assets.md). Here the predictive regression is clearly better.

This looks like a resounding victory for a market-timing strategy based on the yield curve slope. Unfortunately,  this conclusion is pre-mature. The trailing mean strategy in this case is just a very poorly performing strategy. This is related to the problem we discussed earlier that bond [returns](Assets.md) during much of the past five decades werestrongly influenced by a decade-long rise in yields followed by a multi-decade fall in yields,  neither of which could really be anticipated by investors. These two trends have a very unfortunate impact in the trailing mean strategy: following the rise in yields in the 1970s,  it takes a short position in bonds just when bond yields start to fall and long-term bonds start to earn high [returns](Assets.md). It takes until the 1990s for the strategy to finally take a [[Chapter 4 - Futures: Hedging and Speculation|long position]] in long-term bonds. It then still benefits from this [[Chapter 4 - Futures: Hedging and Speculation|long position]],  but not enough to catch up with the trailing mean strategy.

For this reason,  it's useful to examine a second benchmark strategy,  as we did in the [stock market](Hedge Fund Strategies.md) return predictability analysis,  one that is always keeping a constant [portfolio](An Asset Allocation Primer.md) weight in the bond [portfolio](An Asset Allocation Primer.md) without trying to time the bond market. Unlike in the [stock market](Hedge Fund Strategies.md) return predictability analysis,  here this constant-weight [portfolio](An Asset Allocation Primer.md) (which simply puts $100/% into the long-term bond [portfolio](An Asset Allocation Primer.md)) does much better than the predictive regression. This shows that the relative success of the predictive regression strategy relative to the trailing mean strategy is not due to successful market timing because the constant-weight strategy doesn't do any market timing!
...
To assess the [risk and return](Lecture 7-Risk and Return of Bonds.md) consequences of allocating part of a [portfolio](An Asset Allocation Primer.md) to bonds,  we need to understand not only the expected [returns](Assets.md) and standard deviations of [returns](Assets.md) of bonds that we examined so far,  but also the correlation of [returns](Assets.md) with other assets. We focus here in particular on the correlation with a domestic [stock market](Hedge Fund Strategies.md) index.

In lecture 2 we discussed that the attractiveness of an asset as an addition to a [portfolio](An Asset Allocation Primer.md) depends on the systematic risk that the asset brings to the [portfolio](An Asset Allocation Primer.md),  as measured by the asset's beta with respect to the [portfolio](An Asset Allocation Primer.md)'s return. So consider an investor who has the risky asset portion of their [portfolio](An Asset Allocation Primer.md) fully invested in the [stock market](Hedge Fund Strategies.md) and is considering an addition of bonds to the [portfolio](An Asset Allocation Primer.md). The [stock market](Hedge Fund Strategies.md) [portfolio](An Asset Allocation Primer.md) return is $R_{m}$ and the bond return is $R_{b}$. In line with our earlier notation when we discussed [[Lecture 5- Dynamic [[An Asset Allocation Primer|Portfolio]] Choice|[portfolio](An Asset Allocation Primer.md) choice]],  let's denote the yield on a Treasury bill with one period to maturity with $R_{f}$. The optimality condition (2.29) in lecture 2 then becomes
$$
...
Therefore,  whether bonds are an attractive addition to the [portfolio](An Asset Allocation Primer.md) depends on the bond-stock beta. As it turns out,  this beta has undergone dramatic changes over the years. Figure 7.13 illustrates this. I take daily [returns](Assets.md) of the CRSP value-weighted [stock market](Hedge Fund Strategies.md) index and daily [returns](Assets.md) of 10-year zero coupon bonds (i.e.,  [returns](Assets.md) based on synthetic zero-coupon bond prices extracted from coupon-paying U.S. Treasury bond prices). Then I estimate the beta within three-month windows,  starting at the beginning,  with the first three months of available data. Once I have the first estimates,  I move the window forward by one day and repeat the estimation. Then I move it forward one more day,  and so on. The blue line in the figure shows the resulting time series of beta estimates. I then repeat the same procedure using the daily [returns](Assets.md) on 2-year zero coupon bonds. The resulting time series of betas is shown by the red line.

Let's focus first on the 10-year bond's beta. In the 1970s,  the beta started out close to zero. Hence,  in this environment,  adding some bonds to a stock [portfolio](An Asset Allocation Primer.md) would make sense even if the [[Lecture 1- Probability Distributions of Returns|expected return]] on bonds is just slightly above the yield on Treasury bills. But throughout the 1970s and 1980s,  the beta went up,  eventually fluctuating around 0.5 . This means that bonds at that time brought substantial systematic risk to a stock [portfolio](An Asset Allocation Primer.md). When the [stock market](Hedge Fund Strategies.md) fell,  bond prices would fall substantially,

too. With $\beta_{t}=0.5$,  bonds would have to offer more than half the [[Theory Meets Data - Asset Pricing Puzzles|equity premium]] $\mathbb{E}_{t}\left[R_{m,             t+1}\right]-R_{f,             t}$ to be an attractive asset to add to a [portfolio](An Asset Allocation Primer.md) that is fully invested in the [stock market](Hedge Fund Strategies.md).

Then,  in the late 1990s,  the beta dropped dramatically,  often into negative territory. Now bonds were a hedge of [stock market](Hedge Fund Strategies.md) risk: a falling [stock market](Hedge Fund Strategies.md) coincided with rising bond prices during these years. Adding bonds to a [stock market](Hedge Fund Strategies.md) [portfolio](An Asset Allocation Primer.md) could be valuable even if bonds offered less [[Lecture 1- Probability Distributions of Returns|expected return]] than Treasury bills.
...
From an [[An Asset Allocation Primer|investment]] viewpoint,  a crucial question is whether expected excess [returns](Assets.md) of Treasury bonds have moved in line with the movements in the bond-stock beta in Figure 7.13. If a high bond-stock beta pushed up the risk premium for long-term bonds so that investors are enticed to hold the outstanding supply of bonds despite the higher systematic risk,  this would show up as a rise in the yields of long-term bonds. As Figure 7.13 shows,  the beta of shorter-maturity bonds also rises when the beta of long-term bonds rise,  but to a much smaller extent. Hence,  everything else equal (e.g.,  [expectations](FORWARD RATES AND TERM STRUCTURE.md) about the path of future short-term yields) the yield curve should get steeper. And the steeper slope should then predict higher excess [returns](Assets.md) on long-term bonds.

But one take-away from our earlier discussion of bond excess [returns](Assets.md) predictability was that bond excess [returns](Assets.md) are difficult to predict. The yield curve slope may have some predictive power,  but the evidence on this looked quite fragile and weak. So we could take an approach were we regard the conditional expected excess [returns](Assets.md) of longterm bonds as constant (since we can't predict its time-variation) and try to exploit the changing systematic [[Risk Preferences|riskiness]] of long-term bonds (that we can capture quite reliably: it's quite persistent,  so if we estimate it to be high today,  based on data from the past three months or so,  it's also likely to be high going forward over the next quarter or next year).

Table 7.4: Annualized [risk and return](Lecture 7-Risk and Return of Bonds.md) properties of a bond-stock beta timing strategy
![300](Keep%20It%202024-10-24%2010.47.27.png)

In Table 7.4 I show a quick back-of-the-envelope approach to this. I consider a [portfolio](An Asset Allocation Primer.md) that combines the CRSP value-weighted [stock market](Hedge Fund Strategies.md) index and 10-year bonds. To try to exploit the time-variation in the systematic risk of long-term bonds,  I use a timing strategy that varies the weight on bonds as a function of the beta of 10-year bonds:
$$
...
But once [inflation](War Economies and Hyperinflation.md) seemed firmly under control in the late 1990s,  investors switched their views about how bonds and stock prices would comove in a recession. This shift in views was confirmed by the recessions around 2001 and 2008. In both cases,  stock markets fell strongly and [[Monetary Policy with Abundantreserves|the Fed]] strongly lowered [interest rates](Interest Rate Quotations.md),  leading to rising bond prices,  and a negative bond-stock beta.

Another part of the answer is that [[Monetary Policy with Abundantreserves|the Fed]] seems to have started paying more attention to the [stock market](Hedge Fund Strategies.md). [[Monetary Policy with Abundantreserves|The Fed]]'s motivation for doing this seems to have been,  in part,  that a falling [stock market](Hedge Fund Strategies.md) is an early indicator for a future decline in economic growth,  and,  in part,  that a [stock market](Hedge Fund Strategies.md) fall could also cause a decline in economic activity if [stock market](Hedge Fund Strategies.md) investors experience a loss of wealth and are less willing to consume. That [stock market](Hedge Fund Strategies.md) participation of retail investors had grown over the years,  e.g.,  through the spread of defined-benefit retirement accounts,  may have contributed to this concern gaining more relevance.

Figure 7.14 presents some evidence on [[Monetary Policy with Abundantreserves|the Fed]]'s increasing attention to the stock

market. This is from a paper that analyzed the transcripts of FOMC meetings in which the members of the FOMC discuss how [[Lecture 7-[[Lecture 7-Risk and Return of Bonds|Risk and Return]] of Bonds#7.6 [[A Preview of Alternative Formulations|Asset price]] reactions to [monetary policy](The Economist Regime Change.md) surprises|[monetary policy](The Economist Regime Change.md)]] should be set,  such as the target level for the [[Topics in Fiscal and Monetary Policies and Stabilization- Empirical Issues|federal funds rate]]. The figure shows the count of how much stockmarket related phrases appeared in the transcripts in each FOMC meeting. Strikingly,  the count goes up strongly just around the time,  in the late 1990s,  when the bond-stock beta dropped sharply.

This policy of [[Monetary Policy with Abundantreserves|the Fed]] reacting to [stock market](Hedge Fund Strategies.md) falls by lowering [interest rates](Interest Rate Quotations.md) and thereby boosting the economy and the [stock market](Hedge Fund Strategies.md) came to be known as the "Fed put,  " the idea being that [[Monetary Policy with Abundantreserves|the Fed]] can be relied on to prevent,  or moderate,  falls in the [stock market](Hedge Fund Strategies.md),  sort of like having a put option that hedges against [stock market](Hedge Fund Strategies.md) crashes. This in turn has given rise to concerns that this "Fed put" may encourage excessive risk-taking in [[Financial Markets and Institutions Lecture Notes|financial markets]].