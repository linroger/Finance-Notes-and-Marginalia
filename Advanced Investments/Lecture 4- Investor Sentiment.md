...
Note also that we can interpret the [[Equity Commodity and Currency Math|dividend growth]] rates $\Delta d_{t+j}$ and [[Assets|returns]] $r_{t+j}$ as real [[Assets|returns]]. After all,  the [[War Economies and Hyperinflation|inflation]] part of a nominal $\Delta d_{t+j}$ cancels with the [[War Economies and Hyperinflation|inflation]] part
...
In our discussion last lecture we assumed,  as a benchmark,  that a rational investor,  who is not influenced by sentiment,  would price the [[Hedge Fund Strategies|stock market]] under the belief that [[Equity Commodity and Currency Math|dividend growth]] is constant,  $\mathbb{E}_{t}\left[\Delta d_{t+j}\right]=g$,  and expected [[Assets|returns]] are constant as well,  $\mathbb{E}_{t}\left[r_{t+j}\right]=\theta$,  which yields the valuation
$$
...
while the actual investors' valuation is subject to [[Lecture 4- [[Lecture 4- Investor Sentiment|Investor Sentiment]]|[[Lecture 4- Investor Sentiment|investor sentiment]]]],  $s_{t}$,
$$
...
We now have two possibilities regarding the nature of [[Lecture 4- [[Lecture 4- Investor Sentiment|Investor Sentiment]]|[[Lecture 4- Investor Sentiment|investor sentiment]]]].

First,  sentiment could reflect time-varying optimism and pessimism about [[Equity Commodity and Currency Math|dividend growth]]. Suppose investors' growth rate expectation is $\tilde{g}_{t} \neq g$,  but sentiment investors' expected rate of return that they demand from a [[Hedge Fund Strategies|stock market]] [[An Asset Allocation Primer|investment]] is the same as the rate $\theta$ that investors not subject to sentiment would demand. More precisely,  at time $t$ actual investors are valuing the [[Hedge Fund Strategies|stock market]] as if dividends were to grow at an expected rate of $\tilde{g}_{t}$ forever,  while the correct expectation is $g$. In the next period,  $t+1$,  investors may change their mind and their new growth rate expectation may be a different number $\tilde{g}_{t+1}$,  but at time $t$ they do not anticipate that they will change their mind in the future. The resulting valuation then would be
$$
...
Both stories could explain variation in [[Lecture 4- Investor Sentiment|price-dividend ratio]]. Furthermore,  both stories imply that the [[Lecture 4- Investor Sentiment|price-dividend ratio]] should predict future [[Hedge Fund Strategies|stock market]] [[Assets|returns]],  but for very different reasons: In the first story,  a high [[Lecture 4- Investor Sentiment|price-dividend ratio]] indicates that investors are too optimistic about [[Advanced Derivatives Pricing Methodology|future cash flows]] and the low return that follows subsequently is a consequence of the correction of this overvaluation. In the second story,  a high [[Lecture 4- Investor Sentiment|price-dividend ratio]] indicates that investors,  possibly for entirely rational reasons,  are happy to take on [[Hedge Fund Strategies|stock market]] risk for a relatively small risk premium. The low subsequent return that follows afterwards is a consequence of this small risk premium priced into stocks.

By looking only at data of valuation ratios and [[Assets|returns]],  we cannot tell these stories apart. But data on investor [[FORWARD RATES AND TERM STRUCTURE|expectations]] can help.

The first story would say that a high [[Lecture 4- Investor Sentiment|price-dividend ratio]] should be associated with high [[FORWARD RATES AND TERM STRUCTURE|expectations]] of future [[Preview of the Book|cash flow]] growth that are not matched,  on average,  by actual strong future [[Preview of the Book|cash flow]] growth,  as the sentiment-driven forecast was overly optimistic. In this story,  investors' [[FORWARD RATES AND TERM STRUCTURE|expectations]] of the risk premium that they expect to earn from stocks should not vary with the level of the [[Lecture 4- Investor Sentiment|price-dividend ratio]].
...
We start by looking at sell-side equity analysts earnings forecasts. Ideally,  we would want to look at the [[Preview of the Book|cash flow]] [[FORWARD RATES AND TERM STRUCTURE|expectations]] of investors directly,  but such data does not exist. But analysts' forecasts do seem to influence investors. There is also a large literature documenting that stock prices respond to analysts' opinions when analysts release their forecasts.
...
Figure 4.1 shows long-term expected real earnings growth rates for the aggregate [[Hedge Fund Strategies|stock market]] based on data from I/B/E/S,  expressed as annualized growth rate. Longterm means that these are average growth rates expected over a horizon of about 3 to 5 years in the future.

The I/B/E/S database has forecasts of long-term growth of earnings per share (EPS) from multiple analysts for each stock. I start the aggregation into [[Hedge Fund Strategies|stock market]] level [[FORWARD RATES AND TERM STRUCTURE|expectations]] by taking the median forecast for each stock each month. To form a market-level forecast,  I calculate a weighted average expected growth rate of all stocks each month,  using the earnings forecasted for the current year as weights. In this way,  we get the implied forecasted long-term growth rate of aggregate earnings of stocks in the market [[An Asset Allocation Primer|portfolio]]. Finally,  to get the growth rate forecast in real terms,  I subtract a long-term [[War Economies and Hyperinflation|inflation]] forecast obtained from the Survey of Professional forecasters.

As the figure shows,  the forecasted long-term earnings growth align quite well with movements in the [[Hedge Fund Strategies|stock market]]'s $\log$ [[Lecture 4- Investor Sentiment|price-dividend ratio]]. When the $\log P / D$ ratio went up by one log point from 1985 to 1999,  which means that $P / D$ more than doubled,  the long-term real earnings growth rate expected by analysts doubled. During the [[Squam Lake Group Letter|financial crisis]] in 2008,  the $\log P / D$ ratio fell to low levels and so did analysts long-term real growth [[FORWARD RATES AND TERM STRUCTURE|expectations]]. The subsequent fluctuations in $\log P / D$ are also matched by movements in real growth rate [[FORWARD RATES AND TERM STRUCTURE|expectations]] in the same direction.

So to the extent that time-variation in analyst [[FORWARD RATES AND TERM STRUCTURE|expectations]] is a good proxy for timevariation in investor [[FORWARD RATES AND TERM STRUCTURE|expectations]],  it looks like a large part of $P / D$ movements during the past four decades can be explained by changing [[FORWARD RATES AND TERM STRUCTURE|expectations]] about future long-term real growth. Perhaps changes in risk aversion or changes in perceptions of risk are not needed to explain why the [[Hedge Fund Strategies|stock market]] cycles through boom and bust periods with very different $P / D$ ratio.

Now there are two possibilities. First,  analysts' [[FORWARD RATES AND TERM STRUCTURE|expectations]] could be good forecasts of future earnings growth and future growth in payouts,  i.e.,  dividends and repurchases (the cash flows that ultimately matter to investors). In this case,  we should see that forecasts of high earnings growth are,  on average,  followed by actual high earnings growth. Second,  it could be that analysts' varying optimism and pessimism are just fluctuations in sentiment that do not really a have a fundamental justification. If so,  we should see that forecasts of high earnings growth are,  on average,  followed by low [[Hedge Fund Strategies|stock market]] [[Assets|returns]],  as investors eventually realize that the earlier forecasts were too optimistic.

Figure 4.2 presents some evidence on this question. The $x$-axis in these plots shows the analyst growth rate expectation in a given period. In the top panel,  the $y$-axis shows the realized real growth in earnings during the five years following the quarter in which the earnings forecast was made. The bottom panel shows the average realized [[Hedge Fund Strategies|stock market]] return in excess of T-bill [[Assets|returns]] during the five years following the quarter in which the earnings forecast was made.
...
Figure 4.2: Relationship between analyst forecasts of long-term real earnings growth and subsequently realized real earnings growth and excess [[Assets|returns]] (both annualized)

between analyst forecasts and future realized real earnings growth in the top panel,  but there is a clear negative relationship between analyst forecasts and future excess [[Assets|returns]] in the bottom panel. This is consistent with (i) analyst earnings long-term growth forecasts proxying for investor long-term [[Preview of the Book|cash flow]] growth [[FORWARD RATES AND TERM STRUCTURE|expectations]]; (ii) these forecasts are too optimistic in some times,  too pessimistic in others,  which shows up in a price correction in subsequent [[Assets|returns]].

On caveat though is that the statistical confidence in these relationships is not great. I used almost 40 years of data for this analysis,  but since I analyze five-year averages of future earnings growth and excess [[Assets|returns]],  there are really only 8 independent observations of these 5 -year averages in the data set. Quarterly observations of 5 -year moving averages of future earnings growth and [[Assets|returns]] are highly autocorrelated because these 5 -year windows largely overlap. Because of this autocorrelation,  a regression of quarterly observations of these 5-year moving averages on analyst forecasts in the quarter prior to the 5 -year measurement window requires some adjustment in the calculation of standard errors and $t$-statistics. Using the ordinary least squares regression outputs for standard errors and $t$-statistics would produce wildly inflated $t$-statistics,  because these outputs are calculated under the assumption that the autocorrelation of regression residuals is zero-which they are not,  in this case.
...
with absolute value bigger than 1.96 suggests that the negative relation between analyst long-term real growth forecasts and future real [[Assets|returns]] is unlikely to be due to chance. But it's not far away from 1.96,  so there is still substantial statistical uncertainty about the magnitude of the effect. The coefficient estimate of -1.67 suggests a large effect: A one percentage point higher expectation of annualized long-term real growth is associated with 1.67 percentage points lower annualized excess [[Assets|returns]] over the next five years.

To summarize,  over these roughly 40 years,  analyst forecasts of long-term earnings growth explain [[Lecture 4- Investor Sentiment|price-dividend ratio]] movements well,  but these growth [[FORWARD RATES AND TERM STRUCTURE|expectations]] have largely proven to be wrong in the long run,  which led to price corrections. To the extent that analyst forecasts are a good proxy for investor [[FORWARD RATES AND TERM STRUCTURE|expectations]] of future earnings,  this
...
In contrast,  the estimated coefficients for the one-year lagged excess return are very different. Professional forecasters are strongly contrarian with respect to lagged one-year [[Assets|returns]],  individual investors are extrapolative,  and CFOs are roughly neutral. For example,  if the excess return in the last year is higher by 10 percentage points,  professional forecasters expect a 2 percentage point lower excess return in the next year. In the same situation,  individual investors expect 0.25 percentage points higher [[Assets|returns]].
...
[[Assets|returns]] and macroeconomic variables have found a common regularity. Investors and forecasters tend to be influenced relatively strongly by recently experienced data. For [[Preview of the Book|cash flow]] forecasts,  this means that a string of high [[Preview of the Book|cash flow]] growth realizations during an economic boom leads investors and forecasters to be overly optimistic about future [[Preview of the Book|cash flow]] growth. Conversely,  a sequence of disappointing [[Preview of the Book|cash flow]] growth realizations in a persistent downturn leads them to be overly pessimistic.
...
with $k=0.982$,  where the [[Equity Commodity and Currency Math|dividend growth]] observations are quarterly and measured in real terms. ${ }^{5}$. I label this weighted average as experienced payout growth because it is meant to summarize investors' memory of recent payout growth history. I set the weight parameter $k$ to a value that has worked well for summarizing experienced data and using it to explain [[FORWARD RATES AND TERM STRUCTURE|expectations]] data in a number of settings,  including [[War Economies and Hyperinflation|inflation]] [[FORWARD RATES AND TERM STRUCTURE|expectations]] of households and of members of the Federal Open Market Committee that sets [[Lecture 7-[[Lecture 7-Risk and Return of Bonds|Risk and Return]] of Bonds#7.6 [[A Preview of Alternative Formulations|Asset price]] reactions to [[The Economist Regime Change|monetary policy]] surprises|[[The Economist Regime Change|monetary policy]]]] in the U.S.,  as well as [[Lecture 2- [[Lecture 2- Asset Allocation with Multiple Risky Assets|Asset Allocation]] with [[Lecture 2- Asset Allocation with Multiple Risky Assets|Multiple Risky Assets]]|[[Lecture 2- Asset Allocation with Multiple Risky Assets|asset allocation]]]] decisions (stocks vs. bonds) of individual investors. ${ }^{6}$ Importantly,  the value of $k$ was not picked to make the resulting series of experienced payout growth fit well the analyst forecasts or [[Lecture 4- Investor Sentiment|price-dividend ratio]] series that we will now look at. The estimate of $k$ was obtained by relating [[FORWARD RATES AND TERM STRUCTURE|expectations]] to experienced data in completely different settings.

Figure 4.4 shows the resulting time series of the experienced payout growth in comparison with the analyst long-term earnings growth forecast series. The series are clearly positively correlated,  although the correlation is of course not perfect. Times of high experienced payout growth such as the late 1990s,  or the last couple of years in the data,  are also years in which analysts are optimistic. In contrast,  in the depth of the [[Squam Lake Group Letter|financial crisis]] around 2009 both experienced payout growth was low and analysts were pessimistic.

Figure 4.5 compares the payout growth series to the $\log P / D$ series. It is apparent that there is similar [[Week 3 Cyclical Industries (and Advanced [[Week 2 Fundamentals Of Forecasting|Forecasting]])|cyclicality]] in both series,  although with some big deviations,  especially in the years immediately before the [[Squam Lake Group Letter|financial crisis]] and in the early 1990s.

If the experienced payout growth series is a proxy for [[Lecture 4- [[Lecture 4- Investor Sentiment|Investor Sentiment]]|[[Lecture 4- Investor Sentiment|investor sentiment]]]],  then it should forecast [[Hedge Fund Strategies|stock market]] [[Assets|returns]] in excess of the [[Black Scholes Derivation|risk-free rate]]. Figure 4.6 shows
...
Figure 4.6: Experienced real payout growth and subsequent 5-year log excess [[Assets|returns]]

a series of the negative of subsequent 5 -year excess [[Assets|returns]]. This means that in every quarter $t$,  the figure shows the experienced payout growth series that uses data up to quarter $t$ and then the negative of the average excess [[Assets|returns]] during the subsequent quarters $t+1$ to $t+20$. I take the negative of these future average excess [[Assets|returns]] because high experienced payout growth should mean positive sentiment and hence low future [[Assets|returns]]. If I take the negative of the future [[Assets|returns]],  the series should then be positively correlated (which is visually easier to see than a negative correlation). As the figure shows,  the two series are quite highly positively correlated. Hence,  high experienced payout growth forecasts low future excess [[Assets|returns]].

Let's also check whether we can forecast next quarter's [[Hedge Fund Strategies|stock market]] [[Assets|returns]] with the experienced payout growth series. Table 4.2 reruns the same regressions that we ran in the last lecture,  but now with experienced payout growth instead of $\log P / D$ as the predictor of $t+1$ [[Assets|returns]]. The slope coefficient $b$ captures the strength of the predictive relationship. As the table shows,  compared with the $\log P / D$ regressions from the last lecture,  the predictive relationship is actually a little stronger than for the log $P / D$ ratio: the $t$ -statistics are a little higher and the $R^{2}$ are somewhat higher as well. Focusing on the regressions with excess [[Assets|returns]] as dependent variable in Panel C,  a one standard deviation rise in experienced payout growth,  which is 0.33 percentage points,  is associated with next quarter excess [[Assets|returns]] being lower by $-5.967 \times 0.33=1.97$

Table 4.2: Predictive regressions of one-quarter-ahead [[Assets|returns]] on experienced [[Equity Commodity and Currency Math|dividend growth]],  1927-2021

|                         | a           | b          | $R^{2}$ |
| ----------------------- | ----------- | ---------- | ------- |
| Panel A: Log [[Assets|returns]]    |             |            |         |
| Estimates               | 0.066       | $-5.664$   | 0.028   |
| $t$-statistic           | $(4.900)$   | $(-3.474)$ |         |
| Panel B: Simple [[Assets|returns]] |             |            |         |
| Estimates               | -0.927      | $-5.755$   | 0.026   |
| $t$-statistic           | $(-64.692)$ | $(-3.337)$ |         |
| Panel C: Excess [[Assets|returns]] |             |            |         |
...
The majority of these funds' shares are held by retail investors,  including holdings through self-directed retirement accounts like 401k accounts and IRAs. Moreover,  most of these equity funds are ones where the fund manager may be able to pick which stocks to buy,  but does not have discretion to invest in other asset than equity (except for a small holding of cash). In summary,  retail investors control a substantial share of the [[Hedge Fund Strategies|stock market]] through these mutual funds and ETF holdings.

Figure 4.8 shows how flows into MF and ETF correlate with the [[Hedge Fund Strategies|stock market]]'s log $P / D$ ratio and recent [[Hedge Fund Strategies|stock market]] [[Assets|returns]]. I calculate flow as the monthly net dollar amount of money flowing into or out from equity MF and ETF combined. To make the numbers comparable across time,  I divide each monthly dollar flow by the aggregate [[Hedge Fund Strategies|stock market]] capitalization at the end of the previous month.

To relate flow to the $\log P / D$ ratio in Figure 4.8a,  I cumulate the monthly flow over one-year moving windows,  i.e.,  at each date on the chart,  the blue line shows the sum of flow during the 12 months leading up to this date. The numbers are expressed in percent,  so,  for example,  in the early 2000s,  the cumulated inflow over the previous 12 months amounted to about 2 percent of the [[Hedge Fund Strategies|stock market]]'s [[Price-to-Sales Ratios in Stock Valuation|market capitalization]].

As the figure shows the one-year cumulated flow matches well the low-frequency movements in the $\log P / D$ ratio. For example,  the [[Chapter 16 - Black–Scholes Model|stock price]] boom in the 1990s was accompanied by a large cumulative inflow into equity funds. [[The Fall of Bear Stearns Lost Opportunities Haunt Final Days of Bear Stearns; Executives Bickeredover Raising Cash Cutting Mortgages|The fall]] in the $\log P / D$ ratio in the [[Squam Lake Group Letter|financial crisis]] 2008/09 also coincided with very low equity fund flows. According to this measure,  retail [[Lecture 4- [[Lecture 4- Investor Sentiment|Investor Sentiment]]|[[Lecture 4- Investor Sentiment|investor sentiment]]]] for [[Hedge Fund Strategies|stock market]] investing is pro-cyclical: eager to invest in equities in booms,  pulling out of the [[Hedge Fund Strategies|stock market]] in downturns.

Figure 4.8 b shows that at a higher frequency,  monthly flows (not cumulated) correlate positively with [[Assets|returns]] on the [[Hedge Fund Strategies|stock market]] index over the previous 12 months. There seems to be an extrapolative tendency of retail investors: when recent market [[Assets|returns]] are high,  they seem to be more optimistic about the prospects of [[Hedge Fund Strategies|stock market]] investing. This ties in well with the evidence on individual investor excess return [[FORWARD RATES AND TERM STRUCTURE|expectations]] in 4.1: Recall that we found that individual investors excess return [[FORWARD RATES AND TERM STRUCTURE|expectations]] are positively related to lagged 12 -month [[Assets|returns]].

The strong positive connection between fund flows and lagged 12-month [[Assets|returns]] is a hint that retail investor fund flows are not driven by superior information. In historical data,  there is no evidence that lagged 12-month predict future [[Hedge Fund Strategies|stock market]] excess
...
Figure 4.8: Equity mutual fund and ETF flows (% of total [[Hedge Fund Strategies|stock market]] capitalization)

[[Assets|returns]]. ${ }^{8}$ In addition,  the positive association of fund flows and $\log P / D$ points to market-timing in the wrong direction. Recall that $\log P / D$ is negatively associated with future excess [[Assets|returns]]. MF and ETF therefore receive inflows at times when future [[Hedge Fund Strategies|stock market]] excess [[Assets|returns]] are low.

Table 4.3: Relation of equity mutual fund and ETF flows to [[Lecture 4- Investor Sentiment|price-dividend ratio]] and past [[Assets|returns]]
...
Table 4.3 presents some statistical tests of the relationship between flows,  $\log P / D$,  and lagged 12-month [[Assets|returns]]. The table shows the results of a regression of monthly flows (in percent) on the $\log P / D$ at the end of the previous month and [[Hedge Fund Strategies|stock market]] [[Assets|returns]] during the previous 12 months. Since flows are strongly autocorrelated,  I adjust the $t$-statistics for autocorrelation. ${ }^{9}$.

The results confirm the impression from the figures. Both the $\log P / D$ ratio and lagged [[Assets|returns]] are positively related to equity MF and ETF flows. For example,  the second regression with both $\log P / D$ ratio and lagged [[Assets|returns]] as explanatory variables shows that a 10 percentage point higher past return over the past 12 months (less than one standard deviation) is associated with about $10 \times 0.14=1.4$ percentage points (of aggregate [[Hedge Fund Strategies|stock market]] cap) higher equity fund inflow in the next month (which is a bit more than one standard deviations of the monthly flows). The $R^{2}$ of ${} 29 \\%$ shows that log $P / D$ and lagged past [[Assets|returns]] together explain a substantial portion of monthly flows.

Broadly,  these facts are consistent with (although not proof of) the view that retail [[Lecture 4- [[Lecture 4- Investor Sentiment|Investor Sentiment]]|[[Lecture 4- Investor Sentiment|investor sentiment]]]] plays a role in driving the cycles in valuation levels that we see in valuation ratios like the $P / D$ ratio.

Now,  if equity MF and ETF flows are a good retail [[Lecture 4- [[Lecture 4- Investor Sentiment|Investor Sentiment]]|[[Lecture 4- Investor Sentiment|investor sentiment]]]] indicator,  and if this sentiment has price impact,  one should be able to use the flows to predict [[Assets|returns]]. More precisely,  if the effects of sentiment on stock prices accumulate,  then measures of

[^15]cumulative flows over longer periods of time should predict [[Hedge Fund Strategies|stock market]] excess [[Assets|returns]]. Unfortunately,  the data series of flows is rather short.

If we don't have enough data in the time series to get reliable statistical results,  we can try to look for cross-sectional differences between different assets to get more statistical confidence that flows really predict [[Assets|returns]] negatively. If funds invest in different assets and get different flows,  do the assets held by these funds perform differently afterwards?

Active MF are not a good set of funds to conduct such an exercise because in active MF the fund manager has discretion which assets to buy if flows come in. Flows do not get mechanically invested in a pre-defined set of assets. Even if the manager is restricted to invest within a specific asset class,  the manager of an active fund may still be able to find assets that are fairly valued or undervalued within an asset class and avoid overvalued assets. Conversely,  if [[Assets|returns]] are low following inflows into an active fund,  this could just be the consequence of the [[An Asset Allocation Primer|portfolio]] manager having made poor [[An Asset Allocation Primer|investment]] decisions.
...
Flows differ substantially across funds. One reason why flows differ across funds is that flows are sensitive to recent fund performance. This is the cross-sectional equivalent of the time-series relationship between recent [[Hedge Fund Strategies|stock market]] [[Assets|returns]] and aggregate fund flows that we discussed above.
...
The positive relationship is particularly strong for ETF (blue line in the chart). One one hand,  this makes sense. ETFs are designed for investors who want to be able to enter and exit a fund without incurring a lot of transaction costs. On the other hand,  unlike for active MF,  it's clear that this positive relationship between lagged performance and flows cannot be explained by investors seeking to allocate to the most skilled [[An Asset Allocation Primer|portfolio]] managers. These ETFs follow passive indexing strategies or mechanical rebalancing rules. There is no role for skilled,  discretionary active management in these ETFs. So it must be that recently high [[Assets|returns]] induce investors to believe that assets mechanically chosen by the ETF are attractive assets to invest in. In other words,
...
the positive performance-flow relationship we see in this figure captures a positive relationship between recent ETF [[Assets|returns]] and [[Lecture 4- [[Lecture 4- Investor Sentiment|Investor Sentiment]]|[[Lecture 4- Investor Sentiment|investor sentiment]]]] for the assets held by the ETF.

So how do the ETFs that receive high flows perform in the following months? Figure 4.10 shows that flows are negatively related to future performance in the cross-section of ETFs. In the study that this figure is taken from,  the authors sort all ETFs each month into 10 groups based on the prior month's flow. Then they calculate value-weighted [[Assets|returns]] (i.e.,  [[Assets|returns]] weighted by end of prior month total [[Price-to-Sales Ratios in Stock Valuation|market capitalization]] of each ETF) during the following 12 months. They then form a long-short [[An Asset Allocation Primer|portfolio]] that takes a [[Chapter 4 - Futures: Hedging and Speculation|long position]] in ETFs in the lowest-flow group and a short position in the ETFs in the highest-flow group. Figure 4.10 shows the cumulative return of this long-short [[An Asset Allocation Primer|portfolio]] in the 12 months following [[An Asset Allocation Primer|portfolio]] formation. Over the first five months after [[An Asset Allocation Primer|portfolio]] formation,  the [[An Asset Allocation Primer|portfolio]] accumulates positive [[Assets|returns]]. The error bars in the figure show two-standard-error [[Exotic Interest Rate Options|ranges]] and so these positive [[An Asset Allocation Primer|portfolio]] [[Assets|returns]] are different from zero at conventional levels of statistical significance. This means that ETFs with recent strong inflows perform poorly in the future while ETFs with recent strong outflows perform well in the future,  i.e.,  a negative relationship between flows and future performance.
...
Figure 4.10: [[Assets|Returns]] to a [[An Asset Allocation Primer|portfolio]] long in ETFs with low lagged flow and short in ETFs with high lagged flow
...
Figure 4.11: Prompting GPT-3.5 to generate economic [[FORWARD RATES AND TERM STRUCTURE|expectations]]
...
One idea is to use LLMs to approximate how humans' [[FORWARD RATES AND TERM STRUCTURE|expectations]] about the economy overall,  or the [[Hedge Fund Strategies|stock market]] specifically,  would respond to news. Take some news article. Would reading the article make a typical human more optimistic or more pessimistic? The idea is not that the LLM could become a super-human forecaster of the future. Instead,  the idea is that the LLM,  by being trained on a huge corpus of text written by humans,  may have learned to approximate how humans interpret news.

Figure 4.12 shows an example of how to prompt OpenAI's GPT-3.5 to generate economic [[FORWARD RATES AND TERM STRUCTURE|expectations]] based on news article headlines. The first $\mathrm{~s}$ is a placeholder for the news headline that is provided to the GPT. To implement the prompt,  one would replace it with the text of an actual news article headline. The second %s below is a place holder for the specific type of economic expectation that the GPT is supposed to generate. For example,  this could be "GDP growth."

After prompting the GPT with a large number of archived article headlines from various months in the past,  one can then summarize the overall sentiment each month by taking the proportion of articles to which GPT responds with "increase" of GDP growth minus the proportion of articles to which GPT responds with "decrease" of GDP growth. One can do the same thing for other macroeconomic indicators such as industrial production growth,  employment,  [[Hedge Fund Strategies|stock market]] index [[Assets|returns]],  etc.

Figure 4.12 shows an aggregate measure of economic sentiment that averages over the economic [[FORWARD RATES AND TERM STRUCTURE|expectations]] measures for individual macroeconomic indicators every month (blue line). It also shows the cyclically-adjusted price-to-earnings ratio that we looked at in the last lecture. There is clearly a strong positive correlation between the two series. This is quite remarkable since the construction of the economic sentiment measure did not use any direct information about the price level of the [[Hedge Fund Strategies|stock market]]. Even so,  the sentiment measure matches quite well the depressed value of the [[Hedge Fund Strategies|stock market]] relative to earnings in the late 1970s,  the boom in the late 1990s,  and the drop during the [[Squam Lake Group Letter|financial crisis]] in 2007/08,  for example.
...
Iterating forward on this equation,  imposing the transversality condition $\lim _{T \rightarrow \infty} \rho^{T+1} v_{T+1}=$ 0 and taking time- $t$ conditional [[FORWARD RATES AND TERM STRUCTURE|expectations]] gave us the present-value relation (4.1). Assuming additionally that investors price the asset to earn,  in expectation,  a constant required rate of return $\theta,        (4.1)$ becomes
$$
...
where time-variation in the log [[Lecture 4- Investor Sentiment|price-dividend ratio]] $v_{t}$ is linked to time-varying [[FORWARD RATES AND TERM STRUCTURE|expectations]] of future [[Equity Commodity and Currency Math|dividend growth]].

There are two points that we should revisit now. First,  by iterating forward on (4.9) and then taking [[FORWARD RATES AND TERM STRUCTURE|expectations]],  we assumed that current (i.e.,  time-t) investors' [[FORWARD RATES AND TERM STRUCTURE|expectations]] of [[Assets|returns]] and cash flows at all horizons,  all the way to infinity,  pin down the value of the asset. This effectively assumes that time- $t$ investors value the asset as if they are planning to hold the asset forever. It's not necessarily consistent with current investors having the view that they will resell the asset at some point in the future to different investors-unless one is willing to assume that these different investors that they will eventually resell to have the same beliefs about stuff in the future that the current investors have. Second,  we should have another look at the assumption of imposing the transversality condition.

### 4.4.1 Speculation on short-term capital gains

On the first issue,  let's explore a different approach now where we first take [[FORWARD RATES AND TERM STRUCTURE|expectations]],  then iterate. So take [[FORWARD RATES AND TERM STRUCTURE|expectations]] of (4.9):
$$
...
I labeled these [[FORWARD RATES AND TERM STRUCTURE|expectations]] with superscript $A$ to denote that they reflect the [[FORWARD RATES AND TERM STRUCTURE|expectations]] of investor group $A$ who are [[Arbitrage Pricing of Derivatives|pricing]] the asset at time $t$. And $\theta$ is the expected

return that investors in group $A$ require for holding the asset for one period. At time $t+1$ there may be a (partly) different group of investors [[Arbitrage Pricing of Derivatives|pricing]] the assets. For example,  some new investors may have entered the market. Let's label the investors that are setting the price at $t+1$ with $B$. For simplicity,  let's assume that $A$ and $B$ investors,  and all investors periods farther in the future always demand the same [[Lecture 1- Probability Distributions of Returns|expected return]] $\theta$. The same valuation equation as (4.11) but at time $t+1$ then gives
$$
...
If groups $A$ and $B$ were the same,  i.e.,  if it was always just group $A$ [[Arbitrage Pricing of Derivatives|pricing]] the asset in all periods (and if investors are not delusional about the properties of their own [[FORWARD RATES AND TERM STRUCTURE|expectations]] in the future),  the [[General Risk-Adjusted Probability Measures|law of iterated expectations]] ${ }^{10}$ would imply
$$
...
This would bring us back,  after iterating forward,  to our earlier valuation model (4.10) where everything boils down to [[Preview of the Book|cash flow]] [[FORWARD RATES AND TERM STRUCTURE|expectations]] of the investors [[Arbitrage Pricing of Derivatives|pricing]] the asset at time $t$. But if the groups of investors [[Arbitrage Pricing of Derivatives|pricing]] the asset at different times are not the same,  and their [[FORWARD RATES AND TERM STRUCTURE|expectations]] are not the same,  the [[General Risk-Adjusted Probability Measures|law of iterated expectations]] does not hold.

Example: Suppose investors in group $A$ are pessimistic about $\Delta d_{t+2}$,  i.e.,  $\mathbb{E}_{t}^{A}\left[\Delta d_{t+2}\right]$ is low,  but,  at the same time,  they believe that investor group $B$ that sets prices next period will be optimistic. Then $\mathbb{E}_{t}^{A} \mathbb{E}_{t+1}^{B}\left[\Delta d_{t+2}\right]$ will be high. Therefore,  group $A$ investors may still be willing to pay a high price,  or a high-price dividend ratio $v_{t}$ for the asset at $t$,  despite their own pessimism about future [[Equity Commodity and Currency Math|dividend growth]].

This means that the price today depends on higher-order beliefs: It depends on what group $A$ at $t$ expects group $B$ to expect at $t+1$ about [[Equity Commodity and Currency Math|dividend growth]] at $t+2$. If we

[^16]do one further round of iteration on (4.13),  we will get [[FORWARD RATES AND TERM STRUCTURE|expectations]] of group $A$ about the [[FORWARD RATES AND TERM STRUCTURE|expectations]] of group $B$ about the [[FORWARD RATES AND TERM STRUCTURE|expectations]] of group $C$ at $t+2$,  and so on. [[FORWARD RATES AND TERM STRUCTURE|Expectations]] of [[FORWARD RATES AND TERM STRUCTURE|expectations]] of [[FORWARD RATES AND TERM STRUCTURE|expectations]] …

This analysis points to potential limitations of fundamental valuation approaches. If investors currently holding an asset base their [[An Asset Allocation Primer|investment]] case on belief that future investors will be optimists (about cash flows,  or about the beliefs of investors further in the future,  etc.),  and that they will be able to resell the assets profitably to these optimists,  then current prices could be unanchored from [[Week 2 Fundamentals Of Forecasting|fundamentals]]. This is also known as the "Greater Fool Theory" of investing: Buying an overvalued asset in the hope of reselling it to a "greater fool" at an even higher price in the future.

The value that $A$ investors would be willing to pay at $t$ if they knew that investors next period,  and in all following periods,  shared their own beliefs,  is what we could define as fundamental value of the asset in this case. The difference between the actual [[A Preview of Alternative Formulations|asset price]],  which is based on [[FORWARD RATES AND TERM STRUCTURE|expectations]] about the price of resale to future optimists,  and this fundamental value is what we could call the bubble component of the [[A Preview of Alternative Formulations|asset price]].
...
during the [[Chapter 16 - Black–Scholes Model|stock price]] boom in 1928 and 1929 before the "Black Thursday" [[Hedge Fund Strategies|stock market]] crash of October 24,  1929. ${ }^{12}$
...
Presence of return extrapolators: If some investors become more optimistic about an asset's expected [[Assets|returns]] after seeing recently high [[Assets|returns]],  then high recent
...
Source: Hong,  H. and Stein,  J.C.,  2007. Disagreement and the [[Hedge Fund Strategies|stock market]]. Journal of Economic Perspectives,  21(2),  pp0.\1-128.

[[Assets|returns]] may forecast higher future asset demand of optimistic investors. In our analysis of retail investor return [[FORWARD RATES AND TERM STRUCTURE|expectations]] above,  we saw some evidence for such extrapolative tendencies.

Entry of new investors: If recent high [[Assets|returns]],  or media attention to an asset,  predictably draw in new investors - perhaps due to "fear of missing out" (FOMO)this may be a predictable source of higher asset demand in the future.

Short sellers throw in the towel: Price rises generate losses for short sellers betting against an asset's price rise,  which can in turn generate [[Class Note 10 Liquidity and Class Note 10 Liquidity and Liquidity Managementliquidity management|liquidity]] problems for these short sellers. These problems may force them to liquidate their short positions. Figure 4.16 shows that this happened in dramatic fashion in the case of GameStop. Before January 2021,  short interest (i.e.,  how many shares were shorted by short sellers) was very high,  close to $100 \%$ of shares outstanding. But when the price exploded in January 2021,  short interest collapsed as short sellers closed their positions by buying back shares. This further exacerbated the price rise,  because to close a short position,  they have to buy back the shares that they sold short earlier. ${ }^{13}$
...
These mechanisms can generate positive feedback dynamics: Normally when the price goes up with everything else ([[Week 6 Assignment Review|expected cash flows]]) unchanged,  the [[Lecture 1- Probability Distributions of Returns|expected return]] goes down. In contrast,  in bubbly situations,  due to such positive feedback dynamics,  investors may have reasons to believe a rise in price generates higher expected [[Assets|returns]].

### 4.4.2 Pure bubbles

So far we focused on a type of [[A Preview of Alternative Formulations|asset price]] bubble where [[FORWARD RATES AND TERM STRUCTURE|expectations]] of some investors may be biased,  but the [[FORWARD RATES AND TERM STRUCTURE|expectations]] are still about [[Week 2 Fundamentals Of Forecasting|fundamentals]]. If we iterate on (4.13),  everything boils down to [[FORWARD RATES AND TERM STRUCTURE|expectations]] about [[FORWARD RATES AND TERM STRUCTURE|expectations]] about …. [[Preview of the Book|cash flow]] growth.
...
there may be no prospect at all of any [[Preview of the Book|cash flow]] from the asset. Cryptocurrencies are one recent example. For example,  bitcoin does not pay any dividends and it will never pay any dividends. Yet people are willing to pay thousands of dollars for one bitcoin.

One possible explanation (but not the only one-we'll get to a second one soon) is that the asset is a pure bubble. To analyze assets with zero cash flows,  our earlier analysis based on the present-value identity for the [[Lecture 4- Investor Sentiment|price-dividend ratio]] obviously won't be suitable. But,  to illustrate the main idea,  we can work with a simpler framework. Suppose investors are willing to hold a pure bubble asset that never pays any dividends at an [[Lecture 1- Probability Distributions of Returns|expected return]] equal to a (constant) [[Black Scholes Derivation|risk-free rate]] $R_{f}$. For this to make any sense,  these investors must be expecting that the asset has a resale value at a later date. More precisely,  it should be the case that
$$
...
Hence,  as long as investors expect a non-zero price at $t+1$,  the asset will have a nonzero price at $t$. What about [[FORWARD RATES AND TERM STRUCTURE|expectations]] where $\mathbb{E}_{t}\left[P_{t+1}\right] / P_{t}>1+R_{f}$ ? In this case,  investors at $t$ would regard the asset as attractive. The asset's [[Lecture 1- Probability Distributions of Returns|expected return]] then exceeds the return they require to hold the asset. As a consequence,  they would bid up the price of the asset at $t$ up to the point where price growth is equal to $R_{f}$. Conversely,  if $\mathbb{E}_{t}\left[P_{t+1}\right] / P_{t}<1+R_{f}$ the price at $t$ would have to fall the point where price growth is equal to $R_{f}$,  consistent with (4.14).

Iterating forward on (4.14) under the assumption that the [[General Risk-Adjusted Probability Measures|law of iterated expectations]] holds,  we get
$$
...
Now consider the limit as $T \rightarrow \infty$. For the asset to have a non-zero value at $t$,  and hence for there to be a non-zero pure [[A Preview of Alternative Formulations|asset price]] bubble,  investors must expect that the price in the future keeps growing each period forever at a rate equal to the [[Black Scholes Derivation|risk-free rate]]. If expected price growth is smaller than $R_{f}$,  then we would have
$$
...
Along the same lines as for the [[Preview of the Book|cash flow]] [[FORWARD RATES AND TERM STRUCTURE|expectations]] we discussed above,  these [[FORWARD RATES AND TERM STRUCTURE|expectations]] about future price growth could also involve [[FORWARD RATES AND TERM STRUCTURE|expectations]] of future [[FORWARD RATES AND TERM STRUCTURE|expectations]] of other investors of future [[FORWARD RATES AND TERM STRUCTURE|expectations]] … of price growth. This is then the pure bubble version of the greater fool theory.
...
We can apply our [[Lecture 4- Investor Sentiment|price-dividend ratio]] based valuation approach in (4.1) straightforwardly here with just minor modifications:
$$
...
I won't do this explicitly here,  but one could again think of the present-value relations here in terms of [[FORWARD RATES AND TERM STRUCTURE|expectations]] of future investors [[FORWARD RATES AND TERM STRUCTURE|expectations]] … etc. This introduces a speculative motive: Holding an asset today may be attractive if there is reason to believe that future investors will come in with optimistic beliefs about the asset's future convenience benefits.

Getting a handle on investor [[FORWARD RATES AND TERM STRUCTURE|expectations]] about future convenience benefits of gold or cryptocurrencies is difficult. It's not even clear how to measure these benefits. But even so,  we can use the present-value relation above to figure out some factors that should affect the valuation of these assets.

Since we think of the convenience benefits $d_{t+j}$ in (4.17) as real benefits,  the expected [[Assets|returns]] $\mathbb{E}_{t}\left[r_{t+j}\right]$ represent expected real [[Assets|returns]]. What (4.17) tells us then is that when investors' required real [[Assets|returns]] go up,  prices of assets like gold and cryptocurrencies should fall,  unless it happens to be the case that [[FORWARD RATES AND TERM STRUCTURE|expectations]] of future real convenience benefits go up at the same time.

Figure 4.17 presents some evidence that this mechanism for valuation changes seems highly relevant. The figure shows an index of real gold prices. I took an import price index of gold prices and converted it to real prices by dividing by the [[Pricing an Inflation Swap|Consumer Price Index]] (CPI). In addition,  the chart shows a series of [[Real Interest Rates and Aggregate Production|real interest rates]]. The [[Real Interest Rates and Aggregate Production|real interest rates]] are extracted from the prices of Treasury [[War Economies and Hyperinflation|Inflation]]-Protected Securities (TIPS). They represent long-term [[Real Interest Rates and Aggregate Production|real interest rates]] over a 10-year horizon. We will talk in much more detail about how TIPS work in a few weeks. For now,  just note that one can extract long-term [[Real Interest Rates and Aggregate Production|real interest rates]] (or real "yields") from prices of these securities. According to the logic of the present-value relation in (4.17),  [[Real Interest Rates and Aggregate Production|real interest rates]] should be inversely related to the value of gold: higher [[Real Interest Rates and Aggregate Production|real interest rates]] should coincide with lower gold prices. For this reason,  to facilitate a graphical comparison,  I convert the real yield series as $1 /(1+$ real yield $)$.
...
As the figure shows,  there is indeed a strong relationship. When [[Real Interest Rates and Aggregate Production|real interest rates]] went down,  such as from 2009 to 2012 or 2019 to 2021,  the gold price rose. Conversely,  rises in [[Real Interest Rates and Aggregate Production|real interest rates]] are associated with falling gold prices. This is consistent with the logic of our present-value model above: higher real rates mean that investors are discounting future convenience benefits at a higher rate,  which leads to lower valuation today.

An equivalent way of thinking about this: higher [[Real Interest Rates and Aggregate Production|real interest rates]] make interestpaying assets more attractive relative to gold. Hence the gold price has to fall,  so that it has a greater chance of appreciating in the future,  in order to still attract demand.

Figure 4.18 shows similar dynamics at work in the price of bitcoin in recent years. The price of bitcoin in recent years also moved inversely with [[Real Interest Rates and Aggregate Production|real interest rates]]. For bitcoin and other cryptocurrencies,  the effects of real [[How Countries Go Broke-Chapter 12 to Chapter 14|interest rate changes]] may be particularly dramatic because a lot of the promised convenience benefits have not yet materialized but are expected to kick in at some point in the still somewhat distant future. The more the bulk of expected convenience benefits is tilted toward the distant future,  the stronger (due to compounding) the effect of real [[How Countries Go Broke-Chapter 12 to Chapter 14|interest rate changes]].
...
economic forces. This helps evaluate how adding gold or crypto assets to a [[An Asset Allocation Primer|portfolio]] influences overall [[2. Forwards, Swaps, Futures, and Options|portfolio volatility]]. For example,  we should expect substantial positive correlation of gold and crypto [[Some Stylized Empirical Facts About Asset Retur|asset returns]] with the [[Assets|returns]] of bonds,  especially [[War Economies and Hyperinflation|inflation]] protected bonds like TIPS.
