...
- Applications of Lecture 2- Asset Allocation with Multiple Risky Assets
...
- 'Case study: Lecture 2- Asset Allocation with Multiple Risky Assets'
...
- Lecture 2- Asset Allocation with Multiple Risky Assets and financial analysis
- Lecture 2- Asset Allocation with Multiple Risky Assets in modern finance
...
This may seem like an extremely unsophisticated Asset Allocation with Multiple Risky Assets | asset allocation]] strategy. And in some sense it is. But look at Figure 2.10! The Figure shows the out-of-sample Sharpe ratios of four strategies: (i) no shrinkage at all - this is the portfolio of the 10-year line
