...
In more extreme situations, however, there is a risk in the background that the central bank may be drawn away from the job of stabilizing the economy towards supporting a fiscally challenged government. A condition for the central bank to be able to carry out [[Lecture 7-[[Lecture 7-Risk and Return of Bonds|Risk and Return]] of Bonds#7.6 [[A Preview of Alternative Formulations|Asset price]] reactions to [[The Economist Regime Change|monetary policy]] surprises|[[The Economist Regime Change|monetary policy]]]] that stabilizes the economy and [inflation](War Economies and Hyperinflation.md) is that the government pursues a sound [[The Economist Regime Change|fiscal policy]]. If the government gets into a budget crisis, or even if investors just anticipate that it might, the central bank may be forced into supporting government finances.
...
Let's first consider the case of [[An Analytical Decomposition of Forward Rates|risk-neutral investors]]. [[An Analytical Decomposition of Forward Rates|Risk-neutral investors]] would price this bond subject to [default risk](Default Risk and Credit Derivatives 183.md) at the expected payoff discounted at the defaultfree yield,
  $$
\begin{equation*}
...
This makes clear that for bonds with substantial risk of default one should not interpret the promised yield as an [[Lecture 1- Probability Distributions of Returns|expected return]]. If [default risk](Default Risk and Credit Derivatives 183.md) is substantial, the [[Lecture 1- Probability Distributions of Returns|expected return]] can be far lower than the promised yield.
  
Is sovereign [default risk](Default Risk and Credit Derivatives 183.md) compensated with higher expected excess [returns](Assets.md)? Evidence from two centuries of data in Figure 8.17 suggests so. The plots show [[Lecture 7-Risk and Return of Bonds|risk and return]] of countries' external debt issued in U.S. dollars or British pounds, using real [returns](Assets.md) calculated by deflating with the U.S. or U.K. [inflation](War Economies and Hyperinflation.md) rate, respectively.
  
Figure 8.17a shows return standard deviations of sovereign debt of different countries on the x-axis and average real [returns](Assets.md) on the y-axis. Countries marked in red are countries that are serial defaulters; they had multiple default events during the past 200 years, and their [returns](Assets.md) are generally riskier. But as the plot shows, investors also earned a higher [[Theoretical Factors|expected excess return]].
...
From a [[Lecture 5- Dynamic [[An Asset Allocation Primer|Portfolio]] Choice|[portfolio](An Asset Allocation Primer.md) choice]] viewpoint, the above illustrates that the risk of sovereign debt is clearly systematic. Concerns about defaults that lead to declines in prices of risky sovereign debt seem to be concentrated in periods when developed [[An Introduction to Equity Markets|equity markets]] are also doing poorly.
...
[^8]:    ${ }^{1}$ Log [returns](Assets.md) are also called [[The Expectation Hypothesis|continuously compounded returns]].
...
[^13]:    ${ }^{5}$ The geometric sequence of weights I have chosen here guarantees that the weights always sum to one for any value of $k$${ }^{6}$ For more details, see Nagel, S. and Xu, Z., 2022. [[Fixed Income Asset Pricing|Asset pricing]] with fading memory. Review of Financial Studies, 35(5), pp.2190-2245 and Malmendier, U. and Nagel, S., 2016. Learning from [inflation](War Economies and Hyperinflation.md) experiences. Quarterly Journal of Economics, 131(1), pp.53-87.
...
[^34]:   ${ }^{6}$ Note that for this channel to be operative, the [[Lecture 7-[[Lecture 7-Risk and Return of Bonds|Risk and Return]] of Bonds#7.4 [[The Expectation Hypothesis|Expectations hypothesis]]|[[The Expectation Hypothesis|expectations hypothesis]]]] does not have to hold exactly. All that is required is that [expectations](FORWARD RATES AND TERM STRUCTURE.md) of future short-term [[Interest Rate Quotations|interest rates]] are one driver of long-term
