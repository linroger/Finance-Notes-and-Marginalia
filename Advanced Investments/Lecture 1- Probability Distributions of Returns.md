...
- Applications of Lecture 1- Probability Distributions of Returns
...
- 'Case study: Lecture 1- Probability Distributions of Returns'
...
- Lecture 1- Probability Distributions of Returns and financial analysis
- Lecture 1- Probability Distributions of Returns in modern finance
...
Let's now consider a simple Portfolio Choice | portfolio choice]] problem using CRRA preferences. Suppose the investor wants to choose among two assets: A risk-free asset that offers return $R_{f}$ and a risky asset that offers IID returns $R$. If the investor starts with $W_{0}$ at the beginning of a period and invests a proportion $\omega$ into the risky asset,  then the return on their wealth portfolio is$$
...
So to explain the average investor's Asset Allocation with Multiple Risky Assets | asset allocation]] at the end of 2022 with our formula (1.26),  we need it to yield$$
