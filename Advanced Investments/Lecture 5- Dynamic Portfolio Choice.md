...
As in Table 3.1 in Lecture 3,  I generate 1,  000 simulated series of [returns](Assets.md) and sentiment,  each with length 400 quarters. I repeat this for different values of $\phi$. For each
...
The geometric mean of the [portfolio](An Asset Allocation Primer.md) return $R_{p,    t}$ over the next $h$ periods is
$$
...
Table 5.5: Simulations of [portfolio](An Asset Allocation Primer.md) [risk and return](Lecture 7-Risk and Return of Bonds.md) over 40-year horizon
...
<<<<<<< HEAD
Which of these [portfolio](An Asset Allocation Primer.md) allocation policies,  and the [Probability Distributions](Lecture%201-%20[[Exercises) of [Returns](../Financial%20Markets/Financial%20Asset%20Pricing%20Theory%20Overview/Chapter%203%20-%20%20Assets,%20Portfolios,%20and%20Arbitrage/Assets.md)|probability distribution]] of wealth
=======
...
<<<<<<< HEAD
Figure 5.2: Simulated distribution of wealth after 40 years for portfolios of different [riskiness](../Financial%20Instruments/Financial%20Derivatives%20and%20Quantitative%20Methods/Risk%20Preferences.md). Growth-optimal [portfolio](An Asset Allocation Primer.md) has $\gamma=1$.

they generate,  are more attractive to an investor depends on the investors risk preferences. The growth-optimal [portfolio](An Asset Allocation Primer.md) is not a universally preferable [portfolio](An Asset Allocation Primer.md). Whether an investor prefers the growth-optimal [portfolio](An Asset Allocation Primer.md),  or a more conservative [portfolio](An Asset Allocation Primer.md) with lower risky asset exposure,  or a riskier [portfolio](An Asset Allocation Primer.md),  depends on risk preferences. An expected utility maximizing investor would choose it only if they have [relative risk aversion](../Financial%20Markets/Financial%20Asset%20Pricing%20Theory%20Overview/Chapter%208%20-%20Consumption-Based%20Asset%20Pricing/CCAPM%20with%20Alternative%20Preferences.md) equal to 1 . If they have higher risk aversion,  they prefer a less risky,  lower [expected return](Lecture 1- Probability Distributions of Returns.md) strategy. If they have lower risk aversion,  they prefer a strategy with higher risk and higher [expected return](Lecture 1- Probability Distributions of Returns.md) than the growth-optimal strategy.
=======
Figure 5.2: Simulated distribution of wealth after 40 years for portfolios of different [[Risk Preferences|riskiness]]. Growth-optimal [portfolio](An Asset Allocation Primer.md) has $\gamma=1$.

they generate,  are more attractive to an investor depends on the investors risk preferences. The growth-optimal [portfolio](An Asset Allocation Primer.md) is not a universally preferable [portfolio](An Asset Allocation Primer.md). Whether an investor prefers the growth-optimal [portfolio](An Asset Allocation Primer.md),  or a more conservative [portfolio](An Asset Allocation Primer.md) with lower risky asset exposure,  or a riskier [portfolio](An Asset Allocation Primer.md),  depends on risk preferences. An expected utility maximizing investor would choose it only if they have [[CCAPM with Alternative Preferences|relative risk aversion]] equal to 1 . If they have higher risk aversion,  they prefer a less risky,  lower [expected return](Lecture 1- Probability Distributions of Returns.md) strategy. If they have lower risk aversion,  they prefer a strategy with higher risk and higher [expected return](Lecture 1- Probability Distributions of Returns.md) than the growth-optimal strategy.
>>>>>>> d83d5c06204d625fbecfdb77e4d3f37c9c80e27b
...
Wealth at the end of the [investment](An Asset Allocation Primer.md) horizon,  $W_{t+h}$,  is then log-normally distributed as well. In this case it is convenient to maximize the log of expected utility (which produces the same result as maximizing expected utility),  which is
$$
...
For this long-term [portfolio](An Asset Allocation Primer.md) log return variance it matters whether [returns](Assets.md) are IID or not. If prices are mean-reverting and hence [returns](Assets.md) negatively serially correlated,  as the evidence suggests that we reviewed in Section 5.1.2,  then,  for $h>1$,
$$
...
| LLER $^{3}$                     | $ 7.8                    | 1.6\%                  |                          |                      |                    |
| Other                           | $ 0.2                    | 0.0\%                  |                          |                      |                    |
| Financing & [Liquidity](../Financial%20Markets%20and%20Institutions/III.%20Liquidity%20of%20Assets/Class%205-%20Private%20Information,%20Liquidity,%20and%20Securitization/Class%20Note%2010%20Liquidity%20and%20Class%20Note%2010%20Liquidity%20and%20Liquidity%20Managementliquidity%20management.md)           | $ (7.0)                  | (1.5%)                 |                          |                      |                    |
...
On one hand,  if our views about future [risk and return](Lecture 7-Risk and Return of Bonds.md) have not changed and our risk aversion has not changed,  so the previous [portfolio](An Asset Allocation Primer.md) weights of $60 / 40$ are still optimal,  then we should rebalance back to the previous [portfolio](An Asset Allocation Primer.md) weights of $60 / 40$. But the fact the average investors' weights have drifted away from the previous weights to 65/35,  and the average investor is apparently fine with this means that other investors must have changed their views and future risk and [returns](Assets.md),  or their risk aversion must have changed,  so that they are willing to hold the asset classes at $65 / 35$. If price changes have made the aggregate [market capitalization](../Advanced%20Financial%20Analysis%20and%20Valuation/Financial%20Ratios/Price-to-Sales%20Ratios%20in%20Stock%20Valuation.md) of the [stock market](Hedge Fund Strategies.md) bigger relative to the value of all bonds this must mean either that

the average investor perceives stocks as less risky or less averse to its risk than before. In this case,  the [returns](Assets.md) of stocks expected by the average investor would fall to some degree (as price goes up with unchanged future [cash flow](../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%201%20-%20Purpose%20and%20Structure%20of%20Financial%20Markets/Preview%20of%20the%20Book.md) [expectations](../Fixed%20Income%20Asset%20Pricing/Fixed%20Income%20Lecture%20Notes/FORWARD%20RATES%20AND%20TERM%20STRUCTURE.md)),  but the investor is happy to hold a higher share of stocks in their [portfolio](An Asset Allocation Primer.md) due to the lower [riskiness](../Financial%20Instruments/Financial%20Derivatives%20and%20Quantitative%20Methods/Risk%20Preferences.md) or lower aversion to this risk.

that the average investor became more optimistic about the [future cash flows](../Financial%20Engineering/Advanced%20Derivatives%20Pricing%20Methodology.md) of stocks. In this case,  the price rise would be dampened a bit by the fact that investors require a higher expected rate of return from stocks if they are to command a bigger share of their [portfolio](An Asset Allocation Primer.md). As a consequence,  the price rise would coincide with a higher [expected return](Lecture 1- Probability Distributions of Returns.md) expected by the average investor.
=======
...
On one hand,  if our views about future [risk and return](Lecture 7-Risk and Return of Bonds.md) have not changed and our risk aversion has not changed,  so the previous [portfolio](An Asset Allocation Primer.md) weights of $60 / 40$ are still optimal,  then we should rebalance back to the previous [portfolio](An Asset Allocation Primer.md) weights of $60 / 40$. But the fact the average investors' weights have drifted away from the previous weights to 65/35,  and the average investor is apparently fine with this means that other investors must have changed their views and future risk and [returns](Assets.md),  or their risk aversion must have changed,  so that they are willing to hold the asset classes at $65 / 35$. If price changes have made the aggregate [[Price-to-Sales Ratios in Stock Valuation|market capitalization]] of the [stock market](Hedge Fund Strategies.md) bigger relative to the value of all bonds this must mean either that

the average investor perceives stocks as less risky or less averse to its risk than before. In this case,  the [returns](Assets.md) of stocks expected by the average investor would fall to some degree (as price goes up with unchanged future [[Preview of the Book|cash flow]] [[FORWARD RATES AND TERM STRUCTURE|expectations]]),  but the investor is happy to hold a higher share of stocks in their [portfolio](An Asset Allocation Primer.md) due to the lower [[Risk Preferences|riskiness]] or lower aversion to this risk.
...
If we are rebalancing back to 60/40,  we are implicitly expressing the view that we are somehow taking a different view about [risk and return](Lecture 7-Risk and Return of Bonds.md),  or have different changes in preferences about [risk and return](Lecture 7-Risk and Return of Bonds.md),  than the average investor. Is this what we want? Perhaps our views about future [risk and return](Lecture 7-Risk and Return of Bonds.md) should have changed. If the market changed its valuation of stocks and bonds in aggregate,  perhaps there is a good reason for it? Perhaps we should just follow what the market does?

So the questions we need to ask ourselves then is how we compare relative to the average investor.

<<<<<<< HEAD
If the average investors aversion to [stock market](Hedge Fund Strategies.md) risk has gone down,  or their perception of [riskiness](../Financial%20Instruments/Financial%20Derivatives%20and%20Quantitative%20Methods/Risk%20Preferences.md) of stocks has gone down,  do we think we are similar to the average investor,  or can trust that the average investor makes a good assessment here and we can just follow along? If yes,  we should not rebalance in response to price changes.
=======
If the average investors aversion to [stock market](Hedge Fund Strategies.md) risk has gone down,  or their perception of [[Risk Preferences|riskiness]] of stocks has gone down,  do we think we are similar to the average investor,  or can trust that the average investor makes a good assessment here and we can just follow along? If yes,  we should not rebalance in response to price changes.
>>>>>>> d83d5c06204d625fbecfdb77e4d3f37c9c80e27b

If the average investors optimism about [future cash flows](../Financial%20Engineering/Advanced%20Derivatives%20Pricing%20Methodology.md) of stocks has gone up,  should we go along with this because the average investor probably knows better than we do? If yes,  we should not rebalance in response to price changes.

<<<<<<< HEAD
In other words,  if we believe that [financial markets](../Financial%20Markets%20and%20Institutions/Financial%20Markets%20and%20Institutions%20Lecture%20Notes.md) are efficient and that we are similar to the average investor in terms of how our risk aversion changes (or does not change) over time,  then we should not rebalance in response to price changes. By rebalancing frequently back to the weights recommended by a fixed-weight strategy,  we would implicitly express the view that we are different from the average investor. In some sense,  therefore,  a fixed-weight strategy is actually a form of market-timing (and a contrarian one,  as we already discussed) where we are hoping to do better than the average investor by disagreeing with the average investor's [investment](An Asset Allocation Primer.md) decisions. If we don't think we are different from the average investor,  and we would therefore like to follow a passive approach that does not involve implicit market-timing through rebalancing,  then we should let our [portfolio](An Asset Allocation Primer.md) weights drift with market prices.
=======
...
So far we have ignored that there may be reasons other than rebalancing in response to price changes that may require trading: stocks earn dividends that must be reinvested,  bonds pay coupons and they mature and the obtained funds must be reinvested,  initial public offerings bring new assets to the market,  etc. The rule of letting [portfolio](An Asset Allocation Primer.md) weights drift with prices doesn't exactly tell us what to do when these complications are present.

But there is a relatively simple solution: If we want to follow the principle of avoiding deviations from what the average in investor is doing,  let's try to hold a [portfolio](An Asset Allocation Primer.md) whose weights move in lockstep with changes in the relative aggregate market values of the

asset classes in our [portfolio](An Asset Allocation Primer.md). This [portfolio](An Asset Allocation Primer.md) will be close to what we get by just letting [portfolio](An Asset Allocation Primer.md) weights drift with price changes,  but not exactly. The amount of trading required to achieve these [portfolio](An Asset Allocation Primer.md) weights is minimal. And it will give us guidance how to reinvest dividends,  proceeds from redemptions when firms go private,  etc.

In our stocks/bonds case,  we would start out with an allocation that reflects our assessment of [risk and return](Lecture 7-Risk and Return of Bonds.md) at that time and our risk preferences,  which leads us,  say,  to a $60 / 40$ [portfolio](An Asset Allocation Primer.md),  so our initial equity share at time $t=0$ is
$$
...
If the only reason why the values $V_{e}$ and $V_{b}$ changed were price changes,  then $\omega_{t}$ in (5.55) would be exactly the weight we would get if we just let [portfolio](An Asset Allocation Primer.md) weights drift with price changes. But in practice $V_{e}$ and $V_{b}$ will also change because new firms come to market,  bonds get redeemed,  and so on.

The same logic applies analogously with more than two asset classes. For example,  if we hold a [portfolio](An Asset Allocation Primer.md) of several global asset classes,  we need estimates of the total market value of all assets globally in these classes.

<<<<<<< HEAD
Nobel laureate Bill Sharpe has called this approach to (mostly avoid) [portfolio](An Asset Allocation Primer.md) rebalancing an adaptive [Asset Allocation](Lecture%202-%20[[Lecture%202-%20Asset%20Allocation%20with%20Multiple%20Risky%20Assets) with [Multiple Risky Assets](Lecture%202-%20Asset%20Allocation%20with%20Multiple%20Risky%20Assets.md)|[asset allocation](Lecture%202-%20Asset%20Allocation%20with%20Multiple%20Risky%20Assets.md)]] policy. ${ }^{5}$
=======
...
I use the data on aggregate stock and debt holdings of U.S. investors that we looked at earlier in Figure 1.12 to calculate $V_{e,    t}$ and $V_{b,    t}$ at the end of every quarter from December 1951 to December 2022. And then,  starting with an initial [portfolio](An Asset Allocation Primer.md) of $60 / 40$ at the end of 1951,  I use these to calculate the adaptive allocation to equity following (5.55) every quarter. Figure 5.4 shows the result.
...
<<<<<<< HEAD
COVID pandemic in 2020,  and below-average allocations following [stock market](Hedge Fund Strategies.md) downturns such as during the depth of the [financial crisis](../Financial%20Markets%20and%20Institutions/III.%20Liquidity%20of%20Assets/Class%209-%20Bailouts%20and%20Bank%20Failures/Squam%20Lake%20Group%20Letter.md) in 2008-09.

Is this a good thing? The potential advantage of this adaptive approach kicks in if [financial markets](../Financial%20Markets%20and%20Institutions/Financial%20Markets%20and%20Institutions%20Lecture%20Notes.md) are efficient. Expected [returns](Assets.md) and risks could change from quarter to quarter,  but by letting our [portfolio](An Asset Allocation Primer.md) track the average investors' [portfolio](An Asset Allocation Primer.md) allocation,  we are avoiding taking a bet against the average investor. Instead,  we rely on the "wisdom of the average investor" : say,  if the average investors' allocation to equity has gone up,  there must be a good reason for it,  and so it makes sense to follow what the average investor does.
=======
COVID pandemic in 2020,  and below-average allocations following [stock market](Hedge Fund Strategies.md) downturns such as during the depth of the [[Squam Lake Group Letter|financial crisis]] in 2008-09.

Is this a good thing? The potential advantage of this adaptive approach kicks in if [[Financial Markets and Institutions Lecture Notes|financial markets]] are efficient. Expected [returns](Assets.md) and risks could change from quarter to quarter,  but by letting our [portfolio](An Asset Allocation Primer.md) track the average investors' [portfolio](An Asset Allocation Primer.md) allocation,  we are avoiding taking a bet against the average investor. Instead,  we rely on the "wisdom of the average investor" : say,  if the average investors' allocation to equity has gone up,  there must be a good reason for it,  and so it makes sense to follow what the average investor does.
>>>>>>> d83d5c06204d625fbecfdb77e4d3f37c9c80e27b

But if markets are to some degree inefficient,  following what the average investor does could become a disadvantage. What if the average investor sometimes gets it wrong? For example,  if [stock market](Hedge Fund Strategies.md) booms are times when stocks are overvalued because the average investor gets too optimistic about future growth in stocks' cash flows,  then it may not be a good idea to let our weight on equities increase along with the rise in stock prices because we would raise our stock allocation exactly when future [stock market](Hedge Fund Strategies.md) [returns](Assets.md) are likely to be poor. Given the evidence on stock return predictability we discussed in the previous lectures,  regularly rebalancing to a fixed [portfolio](An Asset Allocation Primer.md) share,  say
$60 / 40$,  may be a better approach.

Table 5.7: [Risk and return](Lecture%207-Risk%20and%20Return%20of%20Bonds.md) of different rebalancing strategies

|   | Fixed 60/40 | Adaptive | Fixed at mean(adapt.weight) |

| --- | --- | --- | --- |

| Panel A: Quarterly [returns](Assets.md),  annualized stats |   |   |   |
...
| Panel B: 10-year [returns](Assets.md),  annualized stats |   |   |   |
...
Let's do a simple empirical calculation of the [returns](Assets.md) that we would have earned in past decades with an adaptive allocation approach and a fixed 60/40 [portfolio](An Asset Allocation Primer.md) that is rebalanced at the end of every quarter. Table 5.7 presents the results. It shows the performance of portfolios that mix U.S. stocks (CRSP value-weighted index) and a [portfolio](An Asset Allocation Primer.md) of U.S. Treasury bonds from 1952 to 2022. We treat the bond [portfolio](An Asset Allocation Primer.md) as a long-term riskless asset and look at the excess return of the combined stock-bond [portfolio](An Asset Allocation Primer.md) relative to the long-term [returns](Assets.md) of this bond [portfolio](An Asset Allocation Primer.md).
...
<<<<<<< HEAD
Panel A looks at mean,  standard deviation,  and Sharpe ratio of quarterly [returns](Assets.md) of the three strategies,  with all statistics annualized. In this short-term [returns analysis](../Financial%20Instruments/Financial%20Derivatives%20and%20Quantitative%20Methods/Asset%20Price%20Dynamics.md),  I use T-bill [returns](Assets.md) as the [risk-free asset](2. Forwards, Swaps, Futures, and Options.md) return proxy. As the table shows,  the differences between the three strategies' outcomes are not big. But the adaptive strategy does a little worse in terms of Sharpe ratio [returns](Assets.md) than the third strategy that has the same

average exposure to stocks. If [returns](Assets.md) were IID,  as we have assumed in our theoretical analyses so far,  this should not be the case. Part of this worse performance is due to a somewhat lower average excess return. This is consistent with the evidence we discussed that high [stock market](Hedge Fund Strategies.md) valuation levels have historically been followed by relatively poor [returns](Assets.md) on stocks. The contrarian market-timing of the fixed-weight strategy provides a little performance boost relative to the passive adaptive [Asset Allocation](Lecture%202-%20[[Lecture%202-%20Asset%20Allocation%20with%20Multiple%20Risky%20Assets) with [Multiple Risky Assets](Lecture%202-%20Asset%20Allocation%20with%20Multiple%20Risky%20Assets.md)|[asset allocation](Lecture%202-%20Asset%20Allocation%20with%20Multiple%20Risky%20Assets.md)]] strategy.

Panel B takes the perspective of a long-term investor and evaluates outcomes of the three strategies at a 10-year [investment](An Asset Allocation Primer.md) horizon ( $h=40$ quarters). With long-term [returns](Assets.md),  we should not simply take means and standard deviations of simple long-term [returns](Assets.md) to calculate a Sharpe ratio. For the Sharpe ratio to be a good summary of the risk-return profile of an asset or [portfolio](An Asset Allocation Primer.md),  the distribution of the [returns](Assets.md) should not be too far from normal. However,  long-term simple [returns](Assets.md) are strongly positively skewed (since they have downside bounded at $-100 \%$,  but unlimited upside) and hence variance of long-term simple [returns](Assets.md) is not a good [risk measure](../Financial%20Instruments/Leverage%20as%20a%20Measure%20of%20Risk.md). But an examination of the optimal fixed-weight formula (5.48) gives us a hint how we could address the issue. Under the log-normal distribution,  the numerator in that formula is the log expected simple long-run excess return and the formula relates it to the variance of the long-run log return in the denominator. In the same way,  we can construct a long-run Sharpe ratio with good properties for log-normally distributed [returns](Assets.md) as follows:
=======
Panel A looks at mean,  standard deviation,  and Sharpe ratio of quarterly [returns](Assets.md) of the three strategies,  with all statistics annualized. In this short-term [[Asset Price Dynamics|returns analysis]],  I use T-bill [returns](Assets.md) as the [risk-free asset](2. Forwards, Swaps, Futures, and Options.md) return proxy. As the table shows,  the differences between the three strategies' outcomes are not big. But the adaptive strategy does a little worse in terms of Sharpe ratio [returns](Assets.md) than the third strategy that has the same

average exposure to stocks. If [returns](Assets.md) were IID,  as we have assumed in our theoretical analyses so far,  this should not be the case. Part of this worse performance is due to a somewhat lower average excess return. This is consistent with the evidence we discussed that high [stock market](Hedge Fund Strategies.md) valuation levels have historically been followed by relatively poor [returns](Assets.md) on stocks. The contrarian market-timing of the fixed-weight strategy provides a little performance boost relative to the passive adaptive [[Lecture 2- [[Lecture 2- Asset Allocation with Multiple Risky Assets|Asset Allocation]] with [[Lecture 2- Asset Allocation with Multiple Risky Assets|Multiple Risky Assets]]|[[Lecture 2- Asset Allocation with Multiple Risky Assets|asset allocation]]]] strategy.

Panel B takes the perspective of a long-term investor and evaluates outcomes of the three strategies at a 10-year [investment](An Asset Allocation Primer.md) horizon ( $h=40$ quarters). With long-term [returns](Assets.md),  we should not simply take means and standard deviations of simple long-term [returns](Assets.md) to calculate a Sharpe ratio. For the Sharpe ratio to be a good summary of the risk-return profile of an asset or [portfolio](An Asset Allocation Primer.md),  the distribution of the [returns](Assets.md) should not be too far from normal. However,  long-term simple [returns](Assets.md) are strongly positively skewed (since they have downside bounded at $-100 \%$,  but unlimited upside) and hence variance of long-term simple [returns](Assets.md) is not a good [[Leverage as a Measure of Risk|risk measure]]. But an examination of the optimal fixed-weight formula (5.48) gives us a hint how we could address the issue. Under the log-normal distribution,  the numerator in that formula is the log expected simple long-run excess return and the formula relates it to the variance of the long-run log return in the denominator. In the same way,  we can construct a long-run Sharpe ratio with good properties for log-normally distributed [returns](Assets.md) as follows:
>>>>>>> d83d5c06204d625fbecfdb77e4d3f37c9c80e27b
$$
...
where $r_{f,    t: t+h}$ is an appropriate proxy for the rate of return on a long-term risk-free [investment](An Asset Allocation Primer.md) over the horizon $h$.

If [returns](Assets.md) are IID $\log$-normal,  then $\log \left(1+\mathbb{E}\left[R_{p,    t: t+h}\right]\right)$ and $\operatorname{var}\left(r_{p,    t: t+h}\right)$ grow proportionally with $h$ and hence $L R S R$ does not change with horizon-which is a sensible result for an IID environment.

<<<<<<< HEAD
Panel B shows that the long-run Sharpe ratios are all lower than the Sharpe ratios in Panel A for the fixed-weight strategies. This is a consequence of using the bond [portfolio](An Asset Allocation Primer.md) [returns](Assets.md) as [risk-free asset](2. Forwards, Swaps, Futures, and Options.md) return proxies. Long-term bonds had higher [returns](Assets.md) than T-bills during the sample period analyzed in this table,  so we are subtracting higher numbers when we construct excess [returns](Assets.md). (If one uses T-bill [returns](Assets.md) instead,  the long-run Sharpe ratios are slightly higher than the short-run Sharpe ratios in Panel A,  consistent with a variance-reducing effect of [mean reversion](The Ornstein-Uhlenbeck (OU) Process.md) in stock prices). In terms of relative performance between the three strategies,  the message from the longterm Sharpe ratios in Panel B is the same as in Panel A: the adaptive [Asset Allocation](Lecture%202-%20[[Lecture%202-%20Asset%20Allocation%20with%20Multiple%20Risky%20Assets) with [Multiple Risky Assets](Lecture%202-%20Asset%20Allocation%20with%20Multiple%20Risky%20Assets.md)|[asset allocation](Lecture%202-%20Asset%20Allocation%20with%20Multiple%20Risky%20Assets.md)]] strategy underperforms.

So unless we are convinced that valuation cycles in the [stock market](Hedge Fund Strategies.md) reflect timevarying risk aversion or time-varying risk and that we (or our clients) share this timevariation in risk aversion or these time-varying risk perceptions,  it's not clear that an adaptive [Asset Allocation](Lecture%202-%20[[Lecture%202-%20Asset%20Allocation%20with%20Multiple%20Risky%20Assets) with [Multiple Risky Assets](Lecture%202-%20Asset%20Allocation%20with%20Multiple%20Risky%20Assets.md)|[asset allocation](Lecture%202-%20Asset%20Allocation%20with%20Multiple%20Risky%20Assets.md)]] strategy is preferable. The contrarian trading implied by a fixed-weight strategy may actually be preferable and worth the small transaction cost of rebalancing. It's a simple,  relatively robust way of exploiting the tendency of [stock market](Hedge Fund Strategies.md) [returns](Assets.md) to mean-revert without having to estimate a statistical return-prediction model.

### 5.6 Myopic market-timing

A practically feasible method that goes some way of taking advantage of the opportunities offered by [time-varying expected returns](Lecture%203-%20Dynamics%20of%20Returns.md) and risk is to solve the [Portfolio](Lecture%205-%20Dynamic%20[[An%20Asset%20Allocation%20Primer) Choice|[portfolio](An Asset Allocation Primer.md) choice]] problem every period as if [returns](Assets.md) were IID. This means we use the solution we derived earlier in (5.49),  but now with conditional expected log short-horizon [returns](Assets.md),  $\mathbb{E}_{t}\left[r_{t+1}\right]$. So far in this lecture,  we did not allow for a time-varying conditional variance,  $\sigma_{t}^{2}=\operatorname{var}_{t}\left(r_{t+1}\right)$,  but we can now allow for this,  too,  and easily incorporate a time-varying conditional variance in the [portfolio](An Asset Allocation Primer.md) formula. With this strategy,  we can also allow for a time-varying short-term [risk-free rate](Black Scholes Derivation.md):
=======
Panel B shows that the long-run Sharpe ratios are all lower than the Sharpe ratios in Panel A for the fixed-weight strategies. This is a consequence of using the bond [portfolio](An Asset Allocation Primer.md) [returns](Assets.md) as [risk-free asset](2. Forwards, Swaps, Futures, and Options.md) return proxies. Long-term bonds had higher [returns](Assets.md) than T-bills during the sample period analyzed in this table,  so we are subtracting higher numbers when we construct excess [returns](Assets.md). (If one uses T-bill [returns](Assets.md) instead,  the long-run Sharpe ratios are slightly higher than the short-run Sharpe ratios in Panel A,  consistent with a variance-reducing effect of [mean reversion](The Ornstein-Uhlenbeck (OU) Process.md) in stock prices). In terms of relative performance between the three strategies,  the message from the longterm Sharpe ratios in Panel B is the same as in Panel A: the adaptive [[Lecture 2- [[Lecture 2- Asset Allocation with Multiple Risky Assets|Asset Allocation]] with [[Lecture 2- Asset Allocation with Multiple Risky Assets|Multiple Risky Assets]]|[[Lecture 2- Asset Allocation with Multiple Risky Assets|asset allocation]]]] strategy underperforms.
...
A practically feasible method that goes some way of taking advantage of the opportunities offered by [[Lecture 3- Dynamics of Returns|time-varying expected returns]] and risk is to solve the [[Lecture 5- Dynamic [[An Asset Allocation Primer|Portfolio]] Choice|[portfolio](An Asset Allocation Primer.md) choice]] problem every period as if [returns](Assets.md) were IID. This means we use the solution we derived earlier in (5.49),  but now with conditional expected log short-horizon [returns](Assets.md),  $\mathbb{E}_{t}\left[r_{t+1}\right]$. So far in this lecture,  we did not allow for a time-varying conditional variance,  $\sigma_{t}^{2}=\operatorname{var}_{t}\left(r_{t+1}\right)$,  but we can now allow for this,  too,  and easily incorporate a time-varying conditional variance in the [portfolio](An Asset Allocation Primer.md) formula. With this strategy,  we can also allow for a time-varying short-term [risk-free rate](Black Scholes Derivation.md):
>>>>>>> d83d5c06204d625fbecfdb77e4d3f37c9c80e27b
$$
...
With this method,  we choose a [portfolio](An Asset Allocation Primer.md) every period as if future [returns](Assets.md) were generated IID. But when the next period arrives,  we recompute the solution now based on $\mathbb{E}_{t+1}\left[r_{t+2}\right],    \sigma_{t+1}^{2}=\operatorname{var}_{t+1}\left(r_{t+2}\right)$,  and $r_{f,    t+1}$ (which would not have changed if [returns](Assets.md) were truly IID). We reshuffle our [portfolio](An Asset Allocation Primer.md) accordingly.

<<<<<<< HEAD
This approach clearly takes advantage of the opportunities that arise from having information about time varying expected [returns](Assets.md) or volatilities. This can potentially be a substantial improvement over a policy that simply ignores these opportunities and sticks to a fixed [portfolio](An Asset Allocation Primer.md). But we are not taking into account the effects that work through the long-run [portfolio return variance](Lecture%202-%20Asset%20Allocation%20with%20Multiple%20Risky%20Assets.md) that we discussed above. For example,  if mean-reversion makes stocks less risky in the long-run and hence a more attractive asset,  the formula in (5.57) does not take this into account because it uses only the short-run variance. So the myopic market-timing strategy is not necessarily utility-improving for a long-term investor.
=======
This approach clearly takes advantage of the opportunities that arise from having information about time varying expected [returns](Assets.md) or volatilities. This can potentially be a substantial improvement over a policy that simply ignores these opportunities and sticks to a fixed [portfolio](An Asset Allocation Primer.md). But we are not taking into account the effects that work through the long-run [[Lecture 2- Asset Allocation with Multiple Risky Assets|portfolio return variance]] that we discussed above. For example,  if mean-reversion makes stocks less risky in the long-run and hence a more attractive asset,  the formula in (5.57) does not take this into account because it uses only the short-run variance. So the myopic market-timing strategy is not necessarily utility-improving for a long-term investor.
>>>>>>> d83d5c06204d625fbecfdb77e4d3f37c9c80e27b
...
<<<<<<< HEAD
Figure 5.5 illustrates how the weights of these strategies look like with a cut of 100 quarters from one simulation run with $\phi=0.95$. With $\gamma=5$,  the myopic market-timing strategy invests on average about $56 \%$ of the [portfolio](An Asset Allocation Primer.md) in the [stock market](Hedge Fund Strategies.md). This is the fixed weight for the third strategy in the list above. The myopic market-timing strategy has weights that vary around this level from around zero to occasionally above one. Periods when the weight is low are periods when the conditional [expected excess return](../Financial%20Markets/Financial%20Asset%20Pricing%20Theory%20Overview/Chapter%209%20-%20Factor%20Models/Theoretical%20Factors.md) on the [stock market](Hedge Fund Strategies.md) is low; periods when the weight is high are periods when the conditional [expected excess return](../Financial%20Markets/Financial%20Asset%20Pricing%20Theory%20Overview/Chapter%209%20-%20Factor%20Models/Theoretical%20Factors.md) is high. When the weight is below zero,  this means
=======
Figure 5.5 illustrates how the weights of these strategies look like with a cut of 100 quarters from one simulation run with $\phi=0.95$. With $\gamma=5$,  the myopic market-timing strategy invests on average about $56 \%$ of the [portfolio](An Asset Allocation Primer.md) in the [stock market](Hedge Fund Strategies.md). This is the fixed weight for the third strategy in the list above. The myopic market-timing strategy has weights that vary around this level from around zero to occasionally above one. Periods when the weight is low are periods when the conditional [[Theoretical Factors|expected excess return]] on the [stock market](Hedge Fund Strategies.md) is low; periods when the weight is high are periods when the conditional [[Theoretical Factors|expected excess return]] is high. When the weight is below zero,  this means
>>>>>>> d83d5c06204d625fbecfdb77e4d3f37c9c80e27b

that the strategy takes a short position in the [stock market](Hedge Fund Strategies.md); when it's above one,  the strategy takes a leveraged position in the [stock market](Hedge Fund Strategies.md) financed by borrowing at the [risk-free rate](Black Scholes Derivation.md).

The optimal fixed-weight strategy has a risky asset weight of around $68 \%$,  which is substantially higher than the average weight of the myopic market-timing strategy. This reflects the fact that the optimal fixed-weight strategy takes into account the long-term variance-reducing effect of mean-reversion. This makes a [stock market](Hedge Fund Strategies.md) [investment](An Asset Allocation Primer.md) look more attractive,  hence the higher weight.
...
<<<<<<< HEAD
As the table shows,  the market-timing strategy is generally outperforming the other two in terms of expected utility. Thus,  a [risk-averse investor](../Financial%20Engineering/2.%20Forwards,%20Swaps,%20Futures,%20and%20Options.md) with $\gamma=5$ would clearly prefer the market-timing strategy over the two fixed-weights strategies. This makes sense. After all,  the market-timing strategy exploits time-variation in expected [returns](Assets.md) while the fixed-weights strategies ignores it. But it is not automatically true under all parameter constellations for the simulations that generate the data. The reason is that the myopic market-timing strategy looks only one period ahead in the optimization. For this reason,  it does not take into account the long-term variance-reducing effect of mean-reversion. At least in theory,  there could therefore be parameter constellations that
=======
As the table shows,  the market-timing strategy is generally outperforming the other two in terms of expected utility. Thus,  a [[2. Forwards, Swaps, Futures, and Options|risk-averse investor]] with $\gamma=5$ would clearly prefer the market-timing strategy over the two fixed-weights strategies. This makes sense. After all,  the market-timing strategy exploits time-variation in expected [returns](Assets.md) while the fixed-weights strategies ignores it. But it is not automatically true under all parameter constellations for the simulations that generate the data. The reason is that the myopic market-timing strategy looks only one period ahead in the optimization. For this reason,  it does not take into account the long-term variance-reducing effect of mean-reversion. At least in theory,  there could therefore be parameter constellations that
>>>>>>> d83d5c06204d625fbecfdb77e4d3f37c9c80e27b
...
As we discussed,  the myopic market-timing strategy is not fully optimal for the longterm investor because it allocates each period as if [returns](Assets.md) were IID going forwardwhich they are not. Since the problem is intractable,  we can't figure out exactly how much more we would need to allocate to stocks to optimally exploit the fact that stocks are less riskier in the long-run (than it may seem from a short-horizon analysis) due to mean-reversion. But we can try a heuristic approach that may go some of the way towards the fully optimal solution: Use the myopic market-timing formula (5.57),  but instead of the short-run variance $\sigma^{2}$ (which is constant in the sentiment model that we are simulating here) plug in the long-run variance $\operatorname{var}\left(r_{p,    t: t+h}\right) / h$ from the optimal fixed weight strategy formula (5.49). This produces only a slight improvement: in the $\phi=0.95$ case,  the long-term investor gets expected utility of 0.198 instead of 0.194 . This confirms that the myopic market-timing strategy is not fully optimal,  but it seems difficult to improve it in a substantial way.

<<<<<<< HEAD
The [bottom line](../Advanced%20Financial%20Analysis%20and%20Valuation/Financial%20Ratios/Operating%20Income%20vs.%20Net%20Income%20What's%20the%20Difference.md) is that the myopic market-timing strategy seems like a reasonable approach,  even though it's not fully optimal. One caveat,  though,  is that in these simulations we knew exactly the value of conditional expected [stock market](Hedge Fund Strategies.md) [returns](Assets.md) at every point in time. In practice,  we would have to estimate this with the predictive regression techniques we discussed in earlier lectures. This introduces estimation noise into the [portfolio](An Asset Allocation Primer.md) weights which will lead to some degree of performance deterioration. As a consequence,  in practice,  the optimal fixed-weight strategy may be quite competitive relative to the myopic market-timing strategy. It takes into account the effects of meanreversion on the long-run variance,  but does not try to exploit predictability of excess [returns](Assets.md) for market timing.
=======
