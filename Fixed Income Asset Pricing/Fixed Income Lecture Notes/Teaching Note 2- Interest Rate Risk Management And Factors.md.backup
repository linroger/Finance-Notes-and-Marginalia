...
- [Interest rates](../../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%202/Interest%20Rate%20Quotations.md) vary quite dramatically over time.
...
- The *[duration](../../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%205/Key%20Rates%20O1s%20Durations%20and%20Hedging.md) - of a security is defined as the sensitivity of the security's price to
small,  uniform changes in the yield curve.
- Traditionally,  the [duration](../../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%205/Key%20Rates%20O1s%20Durations%20and%20Hedging.md) is defined with respect to changes in yield-to-maturity. - However,  it is convenient to introduce it using the continuously compounded yield$r(t,            T)$,  as formulas are easier and the interpretation is also easier.
...
- Hence,  we define the [duration](../../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%205/Key%20Rates%20O1s%20Durations%20and%20Hedging.md) of a security with price P by$$D_{P}=-\frac{1}{P}\frac{d\ P}{d\ r}$$
- This definition is all you need to remember,  as everything follows from here.
## EXAMPLE: DURATION OF A ZERO COUPON BOND
- Consider a zero coupon bond - with [time to maturity](../../Financial%20Instruments/Lecture%20Notes-%20Financial%20Instruments/Teaching%20Note%201-%20Forward%20Rates%20Agreement/Hedging%20Strategies%20with%20Forwards.md) T and price$Z(t,            T)$. By
...
- We now show that the [duration](../../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%205/Key%20Rates%20O1s%20Durations%20and%20Hedging.md) of a [portfolio](../../Advanced%20Investments/An%20Asset%20Allocation%20Primer.md) of securities is just the weighted
...
- Let Π be the value of the [portfolio](../../Advanced%20Investments/An%20Asset%20Allocation%20Primer.md)$$\Pi=N_{1}P_{1}+N_{2}P_{2}$$
- We can then compute:$$D_{\Pi}\;=\;-\frac{1}{\Pi}\frac{d\;\Pi}{d\;r}$$$$\;=\;\frac{1}{\Pi}\left(-N_{1}\times\frac{d P_{1}}{d r}-N_{2}\times\frac{d P_{2}}{d r}\right)$$$$\;=\;\frac{1}{\Pi}\left(N_{1}P_{1}\times(-1)\frac{1}{P_{1}}\frac{d P_{1}}{d r}+N_{2}P_{2}\times(-1)\frac{1}{P_{2}}\frac{d P_{2}}{d r}\right)$$
## DURATION OF A PORTFOLIO OF SECURITIES
- Obtaining$$D_\text{П }=\left.w_1D_1+w_2D_2\right.\tag{1}$$
- where$$w_i=\frac{N_iP_i}\Pi \tag{2}$$
- Clearly,  the same derivation can be applied for any number of assets.
## EXAMPLE: DURATION OF A COUPON BOND
- We know a bond is equivalent to a [portfolio](../../Advanced%20Investments/An%20Asset%20Allocation%20Primer.md) of zero-coupon bonds$$P(0,           T)=\sum_{i=1}^{n}c(T_{i})Z(0,           T_{i})$$
...
- From (3),  we can compute the percentage change in the bond due to a small parallel shift in the yield function$r(t,            τ)$as$$\frac{dP}{P}\approx-D\times dr$$
  - Hence,  if we hold a [portfolio](../../Advanced%20Investments/An%20Asset%20Allocation%20Primer.md) of 10-year at-par coupon bonds with [duration](../../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%205/Key%20Rates%20O1s%20Durations%20and%20Hedging.md) equal to 5,  we know that a one-basis point increase in the yield function ($dr=\%$) is going to change the value of the bond approximately by$-5\times/100\times\$100$million (par amount)$=-\$50,  000$.
![|800](Z.%20Clippings/Lecture%20Note%202-%20Interest%20Rate%20Risk%20Management%20And%20Factors-20240407053754286.png)
## DURATION DEFINITIONS
- We defined the [duration](../../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%205/Key%20Rates%20O1s%20Durations%20and%20Hedging.md) as$$D=-\frac{1}{P}\frac{dP}{dr}$$
...
- The [Macaulay duration](.md) is defined as$$D^{M c}=-\frac{(1+y/2)}{P}\frac{d P}{d y}$$
- Some algebra shows$$D^{M c}=\frac{1}{2}\sum_{j=1}^{n}w_{j}\times j$$
...
- It is easy to see that$$M D=\frac{D^{M c}}{\left(1+\frac{y}{2}\right)}$$
...
| Security      | Bid       | Ask      | Yield   | [Accrued Interest](../../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%202%20-%20Spot%20Markets/Intra-Year%20Compounding%20and%20Day-Count.md) | PVBP      |
|---------------|-----------|----------|---------|------------------|-----------|
...
- How can the trader devise a trading strategy to bet on their view,  without taking on [interest rate risk](../Analysis%20of%20Fixed%20Income%20Securities.md)?
...
- Hence,  to profit from the movement,  we need a short position in the long-term bond and a [long position](../../Financial%20Engineering/Derivatives/Part%20I%20-%20Forwards%20and%20Futures/Chapter%204%20-%20Futures:%20Hedging%20and%20Speculation.md) in the short-term bond.
> [!NOTE]
...
>
> Here's how the trader could devise a trading strategy to capitalize on this view without taking on [interest rate risk](../Analysis%20of%20Fixed%20Income%20Securities.md):
>
...
>
> 1. **Long the 2-year T-Note**: Simultaneously,  the trader should take a [long position](../../Financial%20Engineering/Derivatives/Part%20I%20-%20Forwards%20and%20Futures/Chapter%204%20-%20Futures:%20Hedging%20and%20Speculation.md) in the 2-year T-Note. By buying the 2-year T-Note,  the trader stands to profit if its price doesn't fall as much as the 30-year T-Bond or if it rises. This is because a smaller increase in yield (or a decrease) for the 2-year note means its price remains stable or increases relative to the 30-year bond.
>
> This strategy is known as a **[duration](../../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%205/Key%20Rates%20O1s%20Durations%20and%20Hedging.md)-neutral spread trade**. It aims to have equal [dollar duration](../../Financial%20Engineering/A%20Guide%20to%20Duration%20DV01%20and%20Yield%20Curve.md) in both the long and the short positions,  thereby neutralizing the [interest rate risk](../Analysis%20of%20Fixed%20Income%20Securities.md). The [dollar duration](../../Financial%20Engineering/A%20Guide%20to%20Duration%20DV01%20and%20Yield%20Curve.md) is a measure of how much the value of a security will change in response to a change in [interest rates](../../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%202/Interest%20Rate%20Quotations.md). By balancing the [dollar duration](../../Financial%20Engineering/A%20Guide%20to%20Duration%20DV01%20and%20Yield%20Curve.md) of the [long and short positions](../../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%2013/Market%20Size%20and%20Participants.md),  the trader is insulated from overall movements in [interest rates](../../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%202/Interest%20Rate%20Quotations.md) and is specifically betting on the change in the yield spread.
>
...
> - If the yield on the 30-year T-Bond increases significantly while the yield on the 2-year T-Note increases marginally (or not at all),  the short position in the 30-year T-Bond will be profitable,  and the [long position](../../Financial%20Engineering/Derivatives/Part%20I%20-%20Forwards%20and%20Futures/Chapter%204%20-%20Futures:%20Hedging%20and%20Speculation.md) in the 2-year T-Note will either be profitable or will lose less than the 30-year T-Bond.
> - This trading strategy allows the trader to profit from the expected change in the yield curve shape without taking a directional bet on [interest rates](../../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%202/Interest%20Rate%20Quotations.md).
>
> To ensure that the [interest rate risk](../Analysis%20of%20Fixed%20Income%20Securities.md) is hedged properly,  the trader will have to adjust the sizes of the short and long positions so that the [duration](../../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%205/Key%20Rates%20O1s%20Durations%20and%20Hedging.md) of the positions offsets one another. This involves calculating the [dollar duration](../../Financial%20Engineering/A%20Guide%20to%20Duration%20DV01%20and%20Yield%20Curve.md) of each position and ensuring that the [dollar duration](../../Financial%20Engineering/A%20Guide%20to%20Duration%20DV01%20and%20Yield%20Curve.md) weighted position in the 30-year T-Bond is equal and opposite to that of the 2-year T-Note.
- Let$n_2$and$n_{30}$be the units of 2-year notes and 30 year bonds involved in the trading strategy.
- Then,  the trader can hedge the [interest rate risk](../Analysis%20of%20Fixed%20Income%20Securities.md) by setting$$n_{2}\times P V B P_{2}=n_{30}\times P V B P_{30}$$
...
- How is this done in practice?
	...
	- Spread between [repos](../../Financial%20Markets%20and%20Institutions/III.%20Liquidity%20of%20Assets/Class%207-%20CP,%20Repo,%20and%20the%20Crisis/Class%20Note%2012%20Part%202%20Repos.md) is the profit for the Repo Dealer,  who borrows money at 4.9% and lends it at 5%.
...
- The trader lost money,  even if the spread did increase.
- The reason,  of course,  are the transaction costs,  such as [Bid and Ask](Class%20Note%209%20[[Class%20Note%209%20Bid%20and%20Ask%20Prices%20With%20Private%20Information) Prices With Private Information|[bid-ask](../../Financial%20Markets%20and%20Institutions/III.%20Liquidity%20of%20Assets/Class%205-%20Private%20Information,%20Liquidity,%20and%20Securitization/Bid-Ask%20Prices%20with%20Adverse%20SelectionPrivate%20Information.md) spreads]] in the Treasury market and in the Repo market.
- The trader lost money,  even if the spread did increase. - The reason,  of course,  are the transaction costs,  such as [Bid and Ask](Class%20Note%209%20[[Class%20Note%209%20Bid%20and%20Ask%20Prices%20With%20Private%20Information) Prices With Private Information|[bid-ask](../../Financial%20Markets%20and%20Institutions/III.%20Liquidity%20of%20Assets/Class%205-%20Private%20Information,%20Liquidity,%20and%20Securitization/Bid-Ask%20Prices%20with%20Adverse%20SelectionPrivate%20Information.md) spreads]] in the
Treasury market and in the Repo market.
## INTEREST RATE RISK MANAGEMENT: CONVEXITY
- [Convexity](../Problem%20Sets/PSET%20II%20Fixed%20Income%20Asset%20Pricing%201.md) measures the curvature of a security with respect to [interest rates](../../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%202/Interest%20Rate%20Quotations.md)$$C=\frac{1}{P}\frac{d^{2}\ P}{d\ r^{2}}$$
...
- Predicting variation in [interest rates](../../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%202/Interest%20Rate%20Quotations.md) over a short period (daily) is very hard. So,  $E[dr]=0$is a good approximation. However,  note that$E[dr^{2}]=Var(dr)>0$.
...
## POSITIVE CONVEXITY: GOOD NEWS FOR AVERAGE RETURNS
  ...
  - Although this number seems extremely small,  it is a daily [expected return](../../Advanced%20Investments/Lecture%201-%20Probability%20Distributions%20of%20Returns.md).
	  - Annualized [expected return](../../Advanced%20Investments/Lecture%201-%20Probability%20Distributions%20of%20Returns.md) from [convexity](../Problem%20Sets/PSET%20II%20Fixed%20Income%20Asset%20Pricing%201.md) = 1.11 × 10−04 × 252 = 2.79%
...
- A [pension fund](../../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%2013/Uses%20of%20Interest%20Rate%20Swaps.md) buys$100 million (par value) of a 10-year,  5% coupon bond.
...
- The approximate losses from an increase in$r$of 1% are$$\frac{dP}{P}\approx-D\times0.01=-0.0803=-8\%\tag{8}$$$$\frac{dP}{P}\approx-D\times0.01+\frac{1}{2}\times C\times(0.01)^{2}=-0.07662=-7.66\%\tag{9}$$
  ...
  - Using the [pricing](../../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%207/Arbitrage%20Pricing%20of%20Derivatives.md) formula with$r=4.5\%$and$r=5.5\%$,  we obtain that price declines to$95.63from$103.58:$$$\frac{dP}{P}=\frac{\$95.63-\$103.58}{\$103.58}=-7.67\%$$
...
- Let $k_1$ and $k_2$ be the positions in the bonds. The value of the hedged [portfolio](../../Advanced%20Investments/An%20Asset%20Allocation%20Primer.md) is$$V=P_{c}+k_{1}\ P_{1}+k_{2}\ P_{2}\Longrightarrow d\ V=d\ P_{c}+k_{1}\ d\ P_{1}+k_{2}\ d\ P_{2}$$
...
## HEDGING EQUATIONS
- Setting $dV = 0$ yields two equations for [hedging](../../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%205/Key%20Rates%20O1s%20Durations%20and%20Hedging.md):
        - **[Delta Hedging](../../Financial%20Instruments/Financial%20Instruments.md)** $k_1 D_1 P_1 + k_2 D_2 P_2 = -D P_c$
        - **[Convexity](../Problem%20Sets/PSET%20II%20Fixed%20Income%20Asset%20Pricing%201.md) [Hedging](../../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%205/Key%20Rates%20O1s%20Durations%20and%20Hedging.md)** $k_1 C_1 P_1 + k_2 C_2 P_2 = -C P_c$
- The solution to this [system of equations](../../Financial%20Engineering/Fixed%20Income%20Derivatives/A%20Primer%20on%20Probability%20Theory%20and%20Stochastic%20%20Modelling.md) is:
...
- Given $P_c$,            $D_1$,            $D_2$,            $C_1$,            and $C_2$,            the [hedge ratio](../../Financial%20Engineering/Derivatives/Part%20VI%20-%20The%20Greeks/Chapter%2027%20-%20Delta%20Hedging.md) $k_1$ and $k_2$ are calculated as $k_1 = -0.4562$ and $k_2 = -1.1737$.
## SPOT CURVE SHIFT AND HEDGING OUTCOME
- Panel B: [Duration and Convexity](../../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%208/An%20Analytical%20Decomposition%20of%20Forward%20Rates.md) [Hedging](../../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%205/Key%20Rates%20O1s%20Durations%20and%20Hedging.md)
        - **[Spot Curve](Teaching%20Note%204%20Interest%20Rate%20Derivatives.md) Shift**
        ...
        - **Position and [Portfolio](../../Advanced%20Investments/An%20Asset%20Allocation%20Primer.md) Value**
          - The position $k_1$ remains constant at -0.4562.
          - The position $k_2$ remains constant at -1.1737.
          - Change in [Portfolio](../../Advanced%20Investments/An%20Asset%20Allocation%20Primer.md) Value varies with the [spot curve](Teaching%20Note%204%20Interest%20Rate%20Derivatives.md) shift,            from 0.0000 to -0.0027.
## CONCLUSION
...
- If we go long bonds with high [convexity](../Problem%20Sets/PSET%20II%20Fixed%20Income%20Asset%20Pricing%201.md),            such as long-term bonds,            and [duration](../../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%205/Key%20Rates%20O1s%20Durations%20and%20Hedging.md)
hedge the [interest rate risk](../Analysis%20of%20Fixed%20Income%20Securities.md) using bonds with low [convexity](../Problem%20Sets/PSET%20II%20Fixed%20Income%20Asset%20Pricing%201.md),            such as short-term bonds,            we gain positive [returns](../../Financial%20Markets/Financial%20Asset%20Pricing%20Theory%20Overview/Chapter%203%20-%20%20Assets,%20Portfolios,%20and%20Arbitrage/Assets.md) from [convexity](../Problem%20Sets/PSET%20II%20Fixed%20Income%20Asset%20Pricing%201.md).
- That is,            in equation$$d V\approx-\left(D\ P_{c}+k\ D_{z}\ Z\right)\ d r+\frac{1}{2}\ \left(P_{c}\ C+k\ Z\ C_{z}\right)\ d r^{2}$$
the first parenthesis is always zero,            because of [hedging](../../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%205/Key%20Rates%20O1s%20Durations%20and%20Hedging.md),            while the second parenthesis is always positive,            entailing a positive flow of money.
...
- Suppose that on April 1,            2004 a [fixed income](../Lecture%20Notes%20Bonds,%20%20Preferred%20Stock,%20%20and%20Structured%20Products.md) fund has$100 million (par amount)
invested in a 3.875 coupon bond expiring on February 15,            2013. The price of
the bond on that day is$101.50 (per$100 of face value),            and its [duration](../../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%205/Key%20Rates%20O1s%20Durations%20and%20Hedging.md) is
D = 7.491
- Let's [duration](../../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%205/Key%20Rates%20O1s%20Durations%20and%20Hedging.md) hedges with the zero with T =Feb 15,            2005 ([duration](../../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%205/Key%20Rates%20O1s%20Durations%20and%20Hedging.md) DS = 0.87):$$k_{S}=-{\frac{D\times P}{D_{S}\times P_{S}}}={\frac{7.491\times101.5}{0.87\times99.0019}}=-8.83$$
- Between April 1,            2004 and April 15,            2004,            the yield curve shifted up by 0.5%,            on
average.
- An effective [duration](../../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%205/Key%20Rates%20O1s%20Durations%20and%20Hedging.md) hedge should have largely hedged the losses due to the shift
in [interest rates](../../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%202/Interest%20Rate%20Quotations.md).
- If we add 0.50% to each of the yield on April 1 and recompute the value of the
hedged [portfolio](../../Advanced%20Investments/An%20Asset%20Allocation%20Primer.md),            we find its value would only change from$101.50 to$101.57,           
implying 0.07% increase in value.
## AN ISSUE WITH DURATION HEDGING
- In sharp contrast,            the new yield curve implies the value of the hedged [portfolio](../../Advanced%20Investments/An%20Asset%20Allocation%20Primer.md) is$$V_{4/15/2004}=\$98.20,           \text{ a decline of 3.30%}$$$$
...
- **Determining Positions**:
		  - Using Equation (18),  the positions$k_S$and$k_L$in the short-term and long-term zero coupon bonds are calculated as:
			 -$k_S = -0.5266$
			 -$k_L = -1.1259$
- **[Portfolio](../../Advanced%20Investments/An%20Asset%20Allocation%20Primer.md) Value Post-Hedge**:
		  - As of April 15,  2007,  the value of the hedged [portfolio](../../Advanced%20Investments/An%20Asset%20Allocation%20Primer.md) is represented as:
