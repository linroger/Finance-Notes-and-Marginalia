...
- Understanding The Yield Curve- Part 1 and financial analysis
- Understanding The Yield Curve- Part 1 in modern finance
- Applications of Understanding The Yield Curve- Part 1
- 'Case study: Understanding The Yield Curve- Part 1'
...
A key assumption in the pure Risk and Return of Bonds#7.4 Expectations hypothesis | expectations hypothesis]] is that all government bonds,  regardless of maturity,  have the same expected return.
...
That is,  it is possible to identify in advance periods when the near-term bond risk premia are abnormally high or low. These premia tend to be high after poor economic conditions.md) and low after strong economic conditions.md).
...
- Real Yield: Difference between a long-term bond yield and a proxy for expected inflation/War%20Economies%20and%20Hyperinflation.md); our proxy is the recently published year-on-year consumer price inflation/War%20Economies%20and%20Hyperinflation.md) rate.
...
- Convexity (Cx): Measure of the nonlinearity in a bond’s P/y -relation; $Cx = (\mathrm{d}[^2]P/\mathrm{d}y[^2]) * (1/P)$.
