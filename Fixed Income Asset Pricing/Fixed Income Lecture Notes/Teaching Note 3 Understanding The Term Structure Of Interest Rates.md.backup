...
# [Teaching Note 3 Understanding The Term Structure Of Interest Rates](Understanding%20the%20Term%20Structure%20of%20Interest%20Rates.md)
## Introduction
...
2. What is the risk involved in investing in [Treasury securities](../../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Front%20Matter/US%20Markets.md)? 3. Can we predict medium-to-long term yields? What about [returns](../../Financial%20Markets/Financial%20Asset%20Pricing%20Theory%20Overview/Chapter%203%20-%20%20Assets,%20Portfolios,%20and%20Arbitrage/Assets.md)?
...
- Because under these assumptions, $Z_{t+1}(1)$ is known today, its value today is the discounted value using the current l-year yield:$$Z_t(2)=Z_t(1)\times Z_{t+1}(1)=e^{-(y_t(1)+y_{t+1}(1))}$$
 - Because the two-year yield also satisfies $Z_t(2)=e^{-y_t(2)\times2}$ , we obtain that under perfect foresight$$\begin{aligned}y_t(2)=\frac{1}{2}(y_t(1)+y_{t+1}(1))\end{aligned}$$
## The Expectations Hypothesis (cntd.)
- Extending this reasoning to $n$ future one-year yields, then under perfect foresight the yield of a zero-coupon bond with $n+1$ years to maturity is:$$)=\text{Average}[y_t(1),y_{t+1}(1),...,y_{t+n}(1)]=\frac{1}{n+1}\sum_{i=0}^{n}$$
- The [Risk and Return](Lecture%207-[[Lecture%207-Risk%20and%20Return%20of%20Bonds) of Bonds#7.4 [Expectations hypothesis](../../Financial%20Markets/Financial%20Asset%20Pricing%20Theory%20Overview/Chapter%2010%20-%20The%20Economics%20of%20the%20Term%20Structure%20of%20Interest%20Rates/The%20Expectation%20Hypothesis.md)|[expectations hypothesis](../../Financial%20Markets/Financial%20Asset%20Pricing%20Theory%20Overview/Chapter%2010%20-%20The%20Economics%20of%20the%20Term%20Structure%20of%20Interest%20Rates/The%20Expectation%20Hypothesis.md)]] substitutes the perfect foresight with forecasts:
Erates The long$$\begin{aligned}&term\:yield\:=\:forecasted\:average\:path\:of\:f\\&y_{t}(n+1)\:=\:E_{t}\left[\frac{1}{n+1}\sum_{i=0}^{n}y_{t+i}(1)\right]\end{aligned}$$
- Subtracting the curent l-year yield, we can also write$$y_t(n+1)-y_t(1)\:=\:E_t\left[\frac{1}{n+1}\sum\limits_{i=0}^ny_{t+i}(1)\right]-y_t(1)$$
...
- We saw in Teaching Notes 1 that a [forward rate](../../Clippings/Forward%20Points%20in%20Currency.md) at $t$ for an [investment](../../Advanced%20Investments/An%20Asset%20Allocation%20Primer.md) between $\tau_{1}$ and $\tau_{2}$ can be written as$$\tau_{2})=\frac{1}{\tau_{2}-\tau_{1}}\operatorname{ln}\left(\frac{Z_{t}(\tau_{1})}{Z_{t}(\tau_{2})}\right)=\frac{1}{\tau_{2}-\tau_{1}}\left(y_{t}(\tau_{2})\tau_{2}-y_{t}(\tau_{2})\right)$$
...
- The expectation hypothesis then implies that for every $i$ the [forward rate](../../Clippings/Forward%20Points%20in%20Currency.md) is equal to the expected future short-term rate:2$$f_t(\tau_i,\tau_i+\Delta t)=E_t[y_{t+\tau_i}(\Delta t)]\:.$$
 ![500](Attachments/500-92.png)
- Again, expected future rates are mostly lower than forward rates.
### Time Varying Risk Premia
- The violation of the [Risk and Return](Lecture%207-[[Lecture%207-Risk%20and%20Return%20of%20Bonds) of Bonds#7.4 [Expectations hypothesis](../../Financial%20Markets/Financial%20Asset%20Pricing%20Theory%20Overview/Chapter%2010%20-%20The%20Economics%20of%20the%20Term%20Structure%20of%20Interest%20Rates/The%20Expectation%20Hypothesis.md)|[expectations hypothesis](../../Financial%20Markets/Financial%20Asset%20Pricing%20Theory%20Overview/Chapter%2010%20-%20The%20Economics%20of%20the%20Term%20Structure%20of%20Interest%20Rates/The%20Expectation%20Hypothesis.md)]] (and the time variation in spread) suggests the existence of an additional term in Equation (1):$$y_t(n+1)\:=\:E_t\left[\frac{1}{n+1}\sum\limits_{i=0}^ny_{t+i}(1)\right]+RP_t$$
·where $RP_{t}$ reflects a risk premium from holding the bond from $t$ to $t+1$
- The time variation in $RP_{t}$ invalidates the [Risk and Return](Lecture%207-[[Lecture%207-Risk%20and%20Return%20of%20Bonds) of Bonds#7.4 [Expectations hypothesis](../../Financial%20Markets/Financial%20Asset%20Pricing%20Theory%20Overview/Chapter%2010%20-%20The%20Economics%20of%20the%20Term%20Structure%20of%20Interest%20Rates/The%20Expectation%20Hypothesis.md)|[expectations hypothesis](../../Financial%20Markets/Financial%20Asset%20Pricing%20Theory%20Overview/Chapter%2010%20-%20The%20Economics%20of%20the%20Term%20Structure%20of%20Interest%20Rates/The%20Expectation%20Hypothesis.md)]].
- Even if the expectation of future [interest rates](../../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%202/Interest%20Rate%20Quotations.md) does not change, the yield curve may change because $RP_{t}$ changes. - Therefore, movements in the yield curve do not only correspond to variations in expected future short-term yields.
### Term Structure Decomposition
·Let $y_{t}(n+1)=$ yield at $t$ of a bond with [time to maturity](../../Financial%20Instruments/Lecture%20Notes-%20Financial%20Instruments/Teaching%20Note%201-%20Forward%20Rates%20Agreement/Hedging%20Strategies%20with%20Forwards.md) $(n+1)$ years from $t$$$Z_t(n+1)=e^{-y_t(n+1)(n+1)}$$
...
&-\frac{n^2}{2(n+1)}V_t
\end{aligned}$$
(Expected future yield) (Risk premium) ([Convexity](../Problem%20Sets/PSET%20II%20Fixed%20Income%20Asset%20Pricing%201.md))
...
3. A [convexity](../Problem%20Sets/PSET%20II%20Fixed%20Income%20Asset%20Pricing%201.md) term due to the nonlinear relation that exists between the yield $y_{t+1}(n)$ and the price $Z_{t+1}(n)=e^{-y_{t+1}(n)\times n}$
...
- Subtract $y_{t}\left(n+1\right)\times\left(n\right)/\left(n+1\right)$ on both sides, to get$$E_t\left[y_{t+1}\left(n\right)\right]-y_t\left(n+1\right)\:=\quad\frac{1}{n}[y_t\left(n+1\right)-y_t$$
 ![500](Attachments/500-85.png)
- A steep [term structure](../../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%209/The%20Vasicek%20Model.md) (on the RHS) signals the market expects an increase in the yield $y_{t}\left(n+1\right)$ between $t$ and $t+1$ (on the LHS)$$E_t\left[y_{t+1}\left(n\right)\right]>y_t\left(n+1\right)$$$-\Longrightarrow$ market expects a low or negative return on $(n+1)$ maturity bond.
### Long-Term Yield Increase
 ![500](Attachments/500-90.png)
...
·This implies a loss on [investment](../../Advanced%20Investments/An%20Asset%20Allocation%20Primer.md):$$R_{t,t+1}=\frac{Z_{t+1}(29)}{Z_t(30)}-1=\frac{10.3893}{12.7048}-1=-18\%$$
...
### Long-Term Yield Decrease
 ![500](Attachments/500-86.png)
·Example: On $t=1/30/2004$ yield curve was increasing and the spread was $4.1\%$
 - In the data, high spread forecast a decline of long-term yield $y_{t}(30)=5.347\%$ - And indeed, it did: $t+1=1/31/2005$ wehave $y_{t+1}(29)=4.655\%$ This implies a gain on [investment](../../Advanced%20Investments/An%20Asset%20Allocation%20Primer.md):$$R_{t,t+1}=\frac{Z_{t+1}(29)}{Z_t(30)}-1=\frac{25.9279}{20.1046}-1=+29\%$$
### Time Varying Risk Premia
 - This result implies that the slope of the [term structure](../../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%209/The%20Vasicek%20Model.md) predicts$$LRP_t=RP_t-\frac{n^2}{2}V_t,$$
...
- High slope $\not\Rightarrow$ market expects higher future rates. -High slope $\Rightarrow$ high risk premium $\Rightarrow$ high [expected return](../../Advanced%20Investments/Lecture%201-%20Probability%20Distributions%20of%20Returns.md) of long-term bonds $\Rightarrow$ strong price increase $\Rightarrow$ low future yield.
## The Predictability of Bond Returns
- The Log Risk Premium $LRP_{t}$ can also be rewritten as:4$$LRP_t=E_t\left[\log\left (\frac{Z_{t+1}\left (n\right)}{Z_t\left (n+1\right)}\right)-\log\left (\frac{1}{Z_t\left (1\right)}\right)\right]$$
...
- Let now be $t_2$ and let our income be the same. Because of [inflation](../../International%20Finance/Bridgewater/Principles%20For%20Navigating%20Big%20Debt%20Cycles/Part%20II%20Detailed%20Case%20Studies/German%20Debt%20Crisis%20andHyperinflation%20(1918–1924)/War%20Economies%20and%20Hyperinflation.md), now CPI $(t_2)=$ 20.
...
[BID ASK](../../Financial%20Markets%20and%20Institutions/III.%20Liquidity%20of%20Assets/Class%205-%20Private%20Information,%20Liquidity,%20and%20Securitization/Bid%20Ask%20and%20Transaction%20Prices%20in%20a%20Specialist%20Market%20With%20Heterogeneously%20Informed%20Traders.md) CouponMaturity
...
- A real [discount factor](../../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%201/Discount%20Factors.md) $Z^{real}(t; T)$ defines the ecchange rate between consumption goods at $t$ versus consumption goods at a later date $T$
...
- The real [term structure of interest rates](../../Financial%20Engineering/6.%20A%20Brief%20Introduction%20to%20Stochastic%20Calculus.md) is $r_{real}(t; T)$ for maturities $T$
...
- To compute the present value we need more assumptions.$\bullet$ Let $\pi$ be the annualized [inflation](../../International%20Finance/Bridgewater/Principles%20For%20Navigating%20Big%20Debt%20Cycles/Part%20II%20Detailed%20Case%20Studies/German%20Debt%20Crisis%20andHyperinflation%20(1918–1924)/War%20Economies%20and%20Hyperinflation.md) rate between O and $T$$$\pi=\frac{1}{T}\ln\left (\frac{\mathsf{CPI}(T)}{\mathsf{CPI}(0)}\right)$$
...
## Inflation Risk Premium
 - Assume now [inflation](../../International%20Finance/Bridgewater/Principles%20For%20Navigating%20Big%20Debt%20Cycles/Part%20II%20Detailed%20Case%20Studies/German%20Debt%20Crisis%20andHyperinflation%20(1918–1924)/War%20Economies%20and%20Hyperinflation.md) rate is not known and assume it is log-normal 5$$\log\left (\frac{\mathsf{CPI}(T)}{\mathsf{CPI}(0)}\right)=x\sim\mathcal{N}(\overline{\pi}\: T,\sigma\pi^2\:T)$$
...
2. Save the 100 dollars, and buy $\frac{\$100}{Z (0, T)}$ zero coupon bonds with maturity $T$ .At that time, the investor can buy $\frac{\$100}{Z (0, T)}\frac 1{\mathbf{CPI}(T)}$ of the cosumptiongod, for an additional amount of utility$$\frac{\$100}{Z\left (0, T\right)}\frac 1{\mathsf{CPI}(T)}U'\left (C (T), T\right)$$
## Equilibrium
...
- In aggregate, real consumption $C (t)$ depends on real GDP $Y (t)$
 - Assume that [inflation](../../International%20Finance/Bridgewater/Principles%20For%20Navigating%20Big%20Debt%20Cycles/Part%20II%20Detailed%20Case%20Studies/German%20Debt%20Crisis%20andHyperinflation%20(1918–1924)/War%20Economies%20and%20Hyperinflation.md) and real GDP growth have the joint log-normal distribution$$\begin{pmatrix}{\log\left (\frac{\mathsf{CPI}(T)}{\mathsf{CPI}(0)}\right)}\\{\log\left (\frac{Y (T)}{Y (0)}\right)}\end{pmatrix}=\begin{pmatrix}x\\y\end{pmatrix}\thicksim\mathcal{N}\left (\left (\begin{array}{c}\overline{\pi}T\\\overline{g}T\end{array}\right.\right),\left (\begin{array}{c}\sigma\pi^2 T\\\sigma\pi\sigma_g\rho_{g,\pi}T\end{array},\begin{array}{c}\sigma\pi\sigma_g\rho_{g,\pi}T\\\sigma_g^2 T\end{array}\right)$$
## Equilibrium Prices
- Substitute the [CRRA utility](../../Financial%20Markets/Financial%20Asset%20Pricing%20Theory%20Overview/Chapter%208%20-%20Consumption-Based%20Asset%20Pricing/The%20Simple%20Multi-Period%20Ccapm.md) function$$U' (C, t)=e^{-\rho t}C (t)^{-\gamma}$$
...
## Inflation Risk Premium
- We found
[Inflation](../../International%20Finance/Bridgewater/Principles%20For%20Navigating%20Big%20Debt%20Cycles/Part%20II%20Detailed%20Case%20Studies/German%20Debt%20Crisis%20andHyperinflation%20(1918–1924)/War%20Economies%20and%20Hyperinflation.md) risk premium $=-\gamma\sigma\pi\sigma_{g}\rho_{g,\pi}$
- Where$\rho_{g,π}$ = Correlation ([Inflation](../../International%20Finance/Bridgewater/Principles%20For%20Navigating%20Big%20Debt%20Cycles/Part%20II%20Detailed%20Case%20Studies/German%20Debt%20Crisis%20andHyperinflation%20(1918–1924)/War%20Economies%20and%20Hyperinflation.md), real GDP growth)
 - Intuitively:
-If $\rho_{g,\pi}<0\Longrightarrow$ high [inflation](../../International%20Finance/Bridgewater/Principles%20For%20Navigating%20Big%20Debt%20Cycles/Part%20II%20Detailed%20Case%20Studies/German%20Debt%20Crisis%20andHyperinflation%20(1918–1924)/War%20Economies%20and%20Hyperinflation.md) occurs when real GDP is low $\Longrightarrow$ nominal bond is devalued in recessions, when people most need the money! $\Longrightarrow$ very risky security $\Longrightarrow$ high risk premium $\Longrightarrow$ high long-term yield
...
* Late 1970 s/ early 1980 s: Fear of stagflation (high [inflation](../../International%20Finance/Bridgewater/Principles%20For%20Navigating%20Big%20Debt%20Cycles/Part%20II%20Detailed%20Case%20Studies/German%20Debt%20Crisis%20andHyperinflation%20(1918–1924)/War%20Economies%20and%20Hyperinflation.md) and low growth) $\Longrightarrow$ high [inflation](../../International%20Finance/Bridgewater/Principles%20For%20Navigating%20Big%20Debt%20Cycles/Part%20II%20Detailed%20Case%20Studies/German%20Debt%20Crisis%20andHyperinflation%20(1918–1924)/War%20Economies%20and%20Hyperinflation.md) shocks are bad news for the economy $\Longrightarrow$ both nominal bonds and stock drop * Mid 2000 s: Fear of deflation (low [inflation](../../International%20Finance/Bridgewater/Principles%20For%20Navigating%20Big%20Debt%20Cycles/Part%20II%20Detailed%20Case%20Studies/German%20Debt%20Crisis%20andHyperinflation%20(1918–1924)/War%20Economies%20and%20Hyperinflation.md) and low growth) $\Longrightarrow$ high [inflation](../../International%20Finance/Bridgewater/Principles%20For%20Navigating%20Big%20Debt%20Cycles/Part%20II%20Detailed%20Case%20Studies/German%20Debt%20Crisis%20andHyperinflation%20(1918–1924)/War%20Economies%20and%20Hyperinflation.md) shocks are good news for the economy $\Longrightarrow$ nominal bonds drop but stock rise
## The Covariance between Stocks and Bonds, and the CAPM Bond Beta
 ![500](Attachments/500-89.png)
...
- They can be generalized by assuming that expected [inflation](../../International%20Finance/Bridgewater/Principles%20For%20Navigating%20Big%20Debt%20Cycles/Part%20II%20Detailed%20Case%20Studies/German%20Debt%20Crisis%20andHyperinflation%20(1918–1924)/War%20Economies%20and%20Hyperinflation.md) $\overline{\pi}_t$ and expected GDP growth $\overline{g}_t$ are time varying.
- Using the continuous time methodology, for instance, we may assume$$d\overline{\pi}_{t}\:=\: (\alpha\pi-\beta\pi\overline{\pi}_{t}) dt+\sigma_{\overline{\pi}}\: dW_{\overline{\pi}}\\d\overline{g}_{t}\:=\: (\alpha_{g}-\beta_{g}\overline{g}_{t}) dt+\sigma_{\overline{g}}\: dW_{\overline{g}}$$
 - [Inflation](../../International%20Finance/Bridgewater/Principles%20For%20Navigating%20Big%20Debt%20Cycles/Part%20II%20Detailed%20Case%20Studies/German%20Debt%20Crisis%20andHyperinflation%20(1918–1924)/War%20Economies%20and%20Hyperinflation.md) and real GDP growth themselves are$$\begin{array}{rcl}d\log (\mathsf{CPI}_t)&=&\pi_tdt+\sigma_\pi&dW_\pi\\d\log (Y_t)&=&\overline{g}_tdt+\sigma_g&dW_g\end{array}$$
...
·where$$(t, T)=\frac{1-e^{-\beta\pi (T-t)}}{\beta\pi};\quad C (t, T)=\frac{1-e^{-\beta_{g}(T-t)}}{\beta_{g}}$$
...
2. Expected [inflation](../../International%20Finance/Bridgewater/Principles%20For%20Navigating%20Big%20Debt%20Cycles/Part%20II%20Detailed%20Case%20Studies/German%20Debt%20Crisis%20andHyperinflation%20(1918–1924)/War%20Economies%20and%20Hyperinflation.md) risk premium: $\gamma\sigma_{g}\sigma_{\overline{\pi}}\rho_{g\overline{\pi}}$ If $\rho_{g,\overline{\pi}}<0\Longrightarrow r (t, T)$ ↑ 3. Expected growth risk premium: $\gamma\sigma_{g}\sigma_{\overline{g}}\rho_{g\overline{g}}$ If $\rho_{g,\overline{g}}<0\Longrightarrow r (t, T)$ ↑ - and many [convexity](../Problem%20Sets/PSET%20II%20Fixed%20Income%20Asset%20Pricing%201.md) effects.
...
- The result above can be casted in terms of [monetary policy](../../Financial%20Markets%20and%20Institutions/III.%20Liquidity%20of%20Assets/Class%209-%20Bailouts%20and%20Bank%20Failures/Articles/The%20Economist%20Regime%20Change.md) actions:$$
...
- From previous results and using Ito's formula, the real rate follows a [Vasicek model](Vasicek%20Short%20Rate%20Model.md)$$dr_{real, t}=\beta_g\left (\overline{r}_{real}-r_{real, t}\right) dt+\sigma_{real}dW_{\overline{g}}$$
...
- The real zero-coupon bond [pricing](../../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%207/Arbitrage%20Pricing%20of%20Derivatives.md) formula is then$$Z_{real}(t, T)=e^{\overline{A}(t, T)-C (t, T) r_{real, t}}$$
·where$$T)=\left (\overline{r}_{real}^{*}-\frac{1}{2}\frac{\sigma_{real}^{2}}{\beta_{g}^{2}}\right)[C (t, T)-(T-t)]-\frac{C (t, T)}{4}$$$\bullet$ where $\overline{r}_{real}^{*}=\overline{r}_{real}-\gamma\sigma_{g}\sigma_{real}\rho_{\rho, real}$
 - The [risk neutral](../../Financial%20Instruments/Lecture%20Notes-%20Financial%20Instruments/Teaching%20Note%207-Exotic%20Options%20And%20Derivative%20Pricing%20By%20Monte%20Carlo%20Simulation.md) process of the real rate is$$dr_{real, t}=\beta_g\left (\overline{r}_{real}^*-r_{real, t}\right) dt+\sigma_{real}dW_{\overline{g}}^*$$
## Fitting Real Vasicek to TIPS
- We can use TIPS again to extract the real zero coupon bond prices
- The procedure is the same for nominal [Vasicek](../../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%209/The%20Vasicek%20Model.md) (see TN 7), except with the additional dificulty that we may not know what the short-term real rate $r_{real, t}$ actually is.
...
- The above setting with expected [inflation](../../International%20Finance/Bridgewater/Principles%20For%20Navigating%20Big%20Debt%20Cycles/Part%20II%20Detailed%20Case%20Studies/German%20Debt%20Crisis%20andHyperinflation%20(1918–1924)/War%20Economies%20and%20Hyperinflation.md) and expected GDP growth can be generalized to any factors Φ1, t $\phi_{1, t}$ $\phi _{1, t}$, $\phi _{2, t\ldots }$
...
From the [pricing equation](../../Financial%20Markets/Financial%20Asset%20Pricing%20Theory%20Overview/Chapter%204%20-%20State%20Prices/Definitions%20and%20Immediate%20Consequences.md) we have.$$Z\left (t, T\right)=E\left[e^{-\rho (T-t)-(q (T)-q (t))-\gamma (y (T)-y (t))}\right]$$
