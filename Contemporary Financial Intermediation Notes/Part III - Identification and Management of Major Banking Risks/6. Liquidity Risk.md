...
Thus, legal reserve requirements and LLR pricing and availability shift $\$a_t$$ least a portion of the liquidity management problem back to the banks. Other banks, without access to an LLR facility, own the liquidity problem outright.
