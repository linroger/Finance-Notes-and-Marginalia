...
For example, if futures prices tend to rise when interest rates are rising, a futures contract will be worth more than a forward contract, and thus the futures price must exceed the forward price. The mechanism is as follows: when futures prices are rising, interest rates are rising as well, so the profits from a long futures contract can be invested at higher-than-average interest rates; but when futures prices are falling, interest rates are also falling, so that the losses can be financed at lower-than-average interest rates. Thus, when futures prices move in the same direction as interest rates, futures prices are higher than forward prices.  
...
The option will specify a quantity of foreign exchange to be bought or sold. For example, a call listed on the Philadelphia Stock Exchange would allow the holder to buy 6.25 million yen. But options need not be bought at exchanges. They can also be bought over the counter as long as the purchaser can find someone willing to sell an option.  
