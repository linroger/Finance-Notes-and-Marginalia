...
Now, the [[A Primer on Probability Theory and Stochastic  Modelling|transition probabilities]] for a [[A Primer on Probability Theory and Stochastic  Modelling|Markov Chain model]] of this process is given by:  
...
Now that we worked out an expression for [[A Primer on Probability Theory and Stochastic  Modelling|transition probabilities]], we can write a system of  equations that must be satisfied by the [[A Primer on Probability Theory and Stochastic  Modelling|stationary distribution]] of this model.  
$$
