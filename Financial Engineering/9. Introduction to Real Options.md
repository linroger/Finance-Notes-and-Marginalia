...
- 9. Introduction to Real Options and financial analysis
- 9. Introduction to Real Options in modern finance
- Applications of 9. Introduction to Real Options
- 'Case study: 9. Introduction to Real Options'
tags:
- stochastic
- discount
- options
