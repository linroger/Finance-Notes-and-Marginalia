...
Therefore $\$a_t$$ $\alpha = 0$ this curve must be tangent to the capital market line. Therefore the slope of the curve $$a_t$$ $\alpha = 0$ must equal the slope of the capital market line. Using (7) and (8) we see the former slope is given by
