...
n this chapter, we take a look at American put options. It is well known that irrespective of any dividends or cash payouts on the underlying, it could be optimal to exercise an American put option early. Dividends, in fact, reduce the likelihood of [[Bond Futures Options|early exercise]], but they do not eliminate it.  

# 20.1 THE NATURE OF THE PROBLEM OF PRICING AN AMERICAN PUT  

Based on [[Black Scholes Derivation|geometric Brownian motion]], the price of an American put follows the partial differential equation,  
$$
...
The critical [[A Preview of Alternative Formulations|asset price]] that triggers [[Bond Futures Options|early exercise]] is defined as $S_{t}^{*}$ in the equation  
$$
X-S_{t}^{*}=P_{t}.
$$  

This condition means that at $t$ , there is an [[A Preview of Alternative Formulations|asset price]], $S_{t}^{*}$ , that produces a put price, $\boldsymbol{P}_{t}$ . When that put price is equal to the exercise value, any [[A Preview of Alternative Formulations|asset price]] below $S_{t}^{*}$ will trigger [[Bond Futures Options|early exercise]]. The time point $t$ is clearly any time point up to the expiration, $T$ .  

At the first instant, there is no probability of prior exercise. So we integrate the exercise payoff, which is the [[Options|exercise price]] minus the [[A Preview of Alternative Formulations|asset price]], over all possible asset prices less than the critical [[A Preview of Alternative Formulations|asset price]]. Then we discount this value back one instant. This produces two terms, one of which is the discounted [[Options|exercise price]] multiplied by the probability that the [[A Preview of Alternative Formulations|asset price]] will be below the critical [[A Preview of Alternative Formulations|asset price]]. At the next instant we must also discount the expected payoff, but we must consider the joint probability of exercise at that instant conditional on not having exercised at the previous instant. We follow this procedure for the remaining instants over the life of the option.  
...
1 Derive the partial differential equation for an American put option based on [[Black Scholes Derivation|geometric Brownian motion]] when we assume that dividends are paid in the form of a continuously compounded dividend yield.  
