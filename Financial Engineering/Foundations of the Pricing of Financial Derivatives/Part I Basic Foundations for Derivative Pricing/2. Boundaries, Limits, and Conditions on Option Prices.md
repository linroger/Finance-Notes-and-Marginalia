...
Before exploring boundaries, limits, and other conditions, we introduce selected terminology. More detailed explanations will be given later. We now present moneyness terminology that is independent of whether you buy or sell the option. Let $S_t$ be the price of the underlying at time $t$ and $X$ be the exercise price of the call option, then, when $S_t > X$, we say that the call is in-the-money and when $S_t < X$, we say that the call is out-of-the-money. When $S_t = X$, the call is said to be at-the-money. Now suppose $X$ is the exercise price of the put option, then, when $S_t < X$, we say that the put is in-the-money and when $S_t > X$, we say that the put is out-of-the-money. When $S_t = X$, the put is said to be at-the-money.  
