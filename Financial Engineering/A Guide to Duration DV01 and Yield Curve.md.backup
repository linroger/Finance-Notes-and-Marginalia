...
=======
[Duration](../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%205/Key%20Rates%20O1s%20Durations%20and%20Hedging.md) and Dv01 ([dollar duration](.md)) measure [price sensitivity](../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%204/Duration.md) and provide the basic [risk measure](../Financial%20Instruments/Leverage%20as%20a%20Measure%20of%20Risk.md) for bonds, swaps, and other [fixed income instruments](../Course%20Notes/Python/QuantLib-Python/Valuing%20Callable%20Bonds%20Using%20QuantLib%20Python.md). When valuing. instruments off a yield curve, [duration](../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%205/Key%20Rates%20O1s%20Durations%20and%20Hedging.md) and Dv01 naturally extend to a vector of partial. DV01s or durations ([key rate durations](.md)) and these are widely used in the finance. industry. But partial Dv01s or durations can be measured with respect to different. rates: [forwards](../Financial%20Markets/Financial%20Asset%20Pricing%20Theory%20Overview/Chapter%2012%20-%20Derivatives/Forwards%20and%20Futures.md), par rates, zero yields, or others. This paper reviews the concepts of partial Dv01 and [duration](../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%205/Key%20Rates%20O1s%20Durations%20and%20Hedging.md) and then discusses a simple method for transforming partial DVO1s between different rate bases and provides examples. The benefit of this transformation method is that it only requires calculating the risk of a small set of. alternate instrument and does not require re-calculating the original [portfolio](../Advanced%20Investments/An%20Asset%20Allocation%20Primer.md) risk.. (This paper is also available in an interactive version with enhanced digital content - see. references.)  

Keywords: Dvo1, [Duration](../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%205/Key%20Rates%20O1s%20Durations%20and%20Hedging.md), [Key Rate](../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%205/Key%20Rates%20O1s%20Durations%20and%20Hedging.md) [Duration](../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%205/Key%20Rates%20O1s%20Durations%20and%20Hedging.md), [Interest Rate Risk](../Fixed%20Income%20Asset%20Pricing/Analysis%20of%20Fixed%20Income%20Securities.md), Yield Curve Risk,   
[Dollar Duration](.md), [Modified Duration](.md), Partial DV01   
...
=======
[Duration](../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%205/Key%20Rates%20O1s%20Durations%20and%20Hedging.md) and Dv01 provide the basic measures for evaluating the risk or sensitivity of [fixed income instruments](../Course%20Notes/Python/QuantLib-Python/Valuing%20Callable%20Bonds%20Using%20QuantLib%20Python.md) and are both used throughout the financial industry. The Dv01 (dollar value of an 01) is just the derivative of price with respect to yield:.  
$$
P r i c e=P V(\mathrm{y})D V O I=-\frac{d P V}{d\mathrm{y}}
$$  

Modified or adjusted [duration](../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%205/Key%20Rates%20O1s%20Durations%20and%20Hedging.md), the derivative in percentage instead of dollar terms, is just the Dv01 expressed in different units:  
$$
{\mathrm{Modified~or~}}{\mathrm{Adjusted~Duration}}=-{\frac{1}{P V}}{\frac{d{\cal P}V}{d~y}}=100\cdot{\frac{D V O I}{{\cal P}V}} 
$$  

One can use either Dv01 or [modified duration](.md) and the choice between them is largely a matter of convenience, taste, and custom. Dv01, also called [dollar duration](.md), PV01 (present value of an O1), or BPV (basis point value), measures the derivative in price terms: the dollar price change per change in yield. [Modified duration](.md) measures the derivative in percent terms: the. percent price change per change in yield. I will work mostly with Dv01 throughout this paper but the ideas can be applied. equally well to [modified duration](.md).  

In many practical applications a bond or other fixed-income security will be valued off a yield curve, and we can then extend the Dv01 or [duration](../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%205/Key%20Rates%20O1s%20Durations%20and%20Hedging.md) to partial Dv01s or durations - the partial [derivatives](../Financial%20Markets/Financial%20Trading%20and%20Markets/Chapter%209%20Arbitrage%20and%20Hedging%20With%20Options.md) with respect to yields for different parts of the cur ve:  
$$
...
<<<<<<< HEAD
$$\text{Partial DV01s} = \left(\frac{\partial PV}{\partial y_1} \quad \cdots \quad \frac{\partial PV}{\partial y_k}\right)$$  

Calculating and using partial DV01s based on a curve is a natural extension of the basic yield DV01, just as partial derivatives are a natural extension of the univariate derivative. Partial DV01s of one form or another are used throughout the financial industry (see Ho 1992 and Reitano 1991 for early discussions). Unlike for the basic DV01, however, when working with a full yield curve there is no single unique yield. Partial DV01s can be calculated with respect to any of a large set of possible yields. The values for the partial DV01s will depend on the set of rates used. Partial DV01s w.r.t. alternate yields all measure the same thing - risk to parts of the curve - but do so from different perspectives. As a result, we often need to transform between partial DV01s w.r.t. alternate yields.  
=======
(measured here as the price change for a $\$100$ notional bond per 100bp or 1 percentage point change in yield). The modifie. [duration](../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%205/Key%20Rates%20O1s%20Durations%20and%20Hedging.md) will be  
$$
M o d D=100\cdot{\frac{6.903}{70.26}}=9.83
$$  

(measured as the percent change per 1 percentage point change in yield). For the bond there is a single yield-to-maturity, so little choice in defining the Dv01 or [duration](../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%205/Key%20Rates%20O1s%20Durations%20and%20Hedging.md)..  
>>>>>>> 2e346c030bacda517086e02b86e48ba98c22a543

Let us turn to an example. Say we have a 10 year zero bond trading at \$70.26 or 3.561% semi-bond yield. The DV01 will be:

$$\text{DV01}_{\text{sab}} = -\frac{dPV}{dy_{\text{sab}}} = 6.903$$  
...
<<<<<<< HEAD
$$\text{ModD} = 100 \cdot \frac{6.903}{70.26} = 9.83$$  
=======
Zero yields are a common choice for partial Dv01 yields but might not be suitable for all circumstances and are by no means the only choice. We could instead calculate partial Dv01s w.r.t. [forwards](../Financial%20Markets/Financial%20Asset%20Pricing%20Theory%20Overview/Chapter%2012%20-%20Derivatives/Forwards%20and%20Futures.md) - using our curve this would be forward rates between 0, 1, 2, 5, and 10 years. For our zero bond the [forward rate](../Clippings/Forward%20Points%20in%20Currency.md) partial Dv01s would be:  
>>>>>>> 2e346c030bacda517086e02b86e48ba98c22a543
...
| | 10-year Zero Bond Forward Rate Partial DV01 |
|---|---|
| 0-1yr Fwd | 0.702 |
| 1-2yr Fwd | 0.702 |
| 2-5yr Fwd | 2.109 |
...
=======
We are not limited to zeros or [forwards](../Financial%20Markets/Financial%20Asset%20Pricing%20Theory%20Overview/Chapter%2012%20-%20Derivatives/Forwards%20and%20Futures.md). We could equally well calculate the risk w.r.t. yields on par bonds:  
>>>>>>> 2e346c030bacda517086e02b86e48ba98c22a543
...
1. Start with partial DV01s for the original security or portfolio calculated in one representation, usually based on the risk system used and particular functional form used to build the curve.
2. Pick a set of instruments that represent the alternate yields or rates desired for the partial DV01s. For example if we wish to transform to zero-coupon yields, choose a set of zero-coupon bonds.
3. Perform an auxiliary risk calculation for this set of alternate instruments to obtain partial derivatives, reported on the same basis as the original risk.
4. Use this matrix of partial derivatives to create a transformation matrix, and transform from the original partial DV01s to the new partial DV01s by a simple matrix multiplication.  
...
=======
Usually we start with risk in one representation or in one basis, dependent on the particular risk system we are using, but often we want to examine the partial Dv01s w.r.t. another set of yields. We might be given the partials w.r.t. [forwards](../Financial%20Markets/Financial%20Asset%20Pricing%20Theory%20Overview/Chapter%2012%20-%20Derivatives/Forwards%20and%20Futures.md) but wish to see the partial Dv01s w.r.t. par yields. We would need to transform from the forward basis to the par basis. This. paper describes a simple methodology for transforming between alternate sets of rates or instruments. The essence of the approach is:  

Start with partial Dvo1s for the original security or [portfolio](../Advanced%20Investments/An%20Asset%20Allocation%20Primer.md) calculated in one representation, usually based on the risk system used and particular functional form used to build the curve.   
...
Perform an auxiliary risk calculation for this set of alternate instruments to obtain partial [derivatives](../Financial%20Markets/Financial%20Trading%20and%20Markets/Chapter%209%20Arbitrage%20and%20Hedging%20With%20Options.md), reported on the same basis as the original risk.   
Use this matrix of partial [derivatives](../Financial%20Markets/Financial%20Trading%20and%20Markets/Chapter%209%20Arbitrage%20and%20Hedging%20With%20Options.md) to create a transformation matrix, and transform from the original partial Dv01s to the new partial DV01s by a simple matrix multiplication.  

The matrix provides a quick, computationally efficient way to transform from the original risk to the new risk, essentially a basis or coordinate transformation. The benefit of this transformation approach is that it does not require re-calculating the original [portfolio](../Advanced%20Investments/An%20Asset%20Allocation%20Primer.md) risk. The auxiliary risk calculation for the set of alternate instruments will generally be quick, involving valuation of a handful of plain-vanilla instruments.  

We can even take the idea one step further. The process above assumes the same number of new rates as old, but we may wish to view the partial Dv01s with respect to a reduced set of rates. In our example we might wish to remove the 2 year swap and measure risk w.r.t. the 1, 5, and 10 year [par swap](Fixed%20Income%20Derivatives/Determining%20the%20Expression%20for%20the%20Fair%20Value%20of%20the%20Swap%20Spread.md) yields:.  
>>>>>>> 2e346c030bacda517086e02b86e48ba98c22a543

| | 10-year Zero Bond Partial DV01 |
|---|---|
| 1yr Swap | -0.065 |
| 5yr Swap | -0.606 |
| 10yr Swap | 7.597 |
...
$$\text{Modified or Adjusted Duration} = -\frac{1}{V}\frac{dV}{dy} = -\frac{d\ln V}{dy}$$  
...
$$\text{Macaulay Duration} = \sum_{i=1}^{n} t_i \frac{PV_i}{V}$$  
=======
To do this requires building a new curve with a reduced set of market instruments, and then two auxiliary risk calculations - a set of instruments using the old curve and the same set of instruments using the new curve. Once again, this is computationally inexpensive since the original [portfolio](../Advanced%20Investments/An%20Asset%20Allocation%20Primer.md) does not need to be revalued using the new curve.  

# Review of Duration and DV01  

[Duration](../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%205/Key%20Rates%20O1s%20Durations%20and%20Hedging.md) and Dv01 are the foundation for virtually all [fixed income](../Fixed%20Income%20Asset%20Pricing/Lecture%20Notes%20Bonds,%20%20Preferred%20Stock,%20%20and%20Structured%20Products.md) [risk analysis](../Advanced%20Financial%20Analysis%20and%20Valuation/Lecture%20Notes%20Advanced%20Financial%20Analysis%20and%20Valuation/Week%203/Week%203%20Financial%20Risk%20Analysis.md). The ideas are well-known but it will prove useful to review the basic concepts. The [duration](../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%205/Key%20Rates%20O1s%20Durations%20and%20Hedging.md) we are concerned with is [modified duration](.md), the semi-elasticity, percentage [price sensitivity](../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%204/Duration.md) or logarithmic derivative of price with respect to yield:  
$$
{\mathrm{Modified~or~Adjusted~Duration}}=-{\frac{1}{V}}{\frac{d V}{d y}}=-{\frac{d{l n}V}{d y}}
$$  

he name [duration](../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%205/Key%20Rates%20O1s%20Durations%20and%20Hedging.md) originated with Frederick Macaulay (1938) and his definition of [duration](../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%205/Key%20Rates%20O1s%20Durations%20and%20Hedging.md) as the weighted average maturity f cash flows, using the present value of cash flows as weights:  
$$
\mathrm{{Macaulay~Duration}}=\sum_{i=1}^{n}t_{i}{\frac{P V_{i}}{V}}
$$  

[Macaulay duration](../Fixed%20Income%20Asset%20Pricing/Fixed%20Income%20Lecture%20Notes/Teaching%20Note%202-%20Interest%20Rate%20Risk%20Management%20And%20Factors.md) applies to instruments with [fixed cash flows](../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%202/Interest%20Rate%20Quotations.md) (. $t_{i}$ is the maturity of [cash flow](../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%201%20-%20Purpose%20and%20Structure%20of%20Financial%20Markets/Preview%20of%20the%20Book.md) i,. $P V_{i}$ is the present value of. [cash flow](../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%201%20-%20Purpose%20and%20Structure%20of%20Financial%20Markets/Preview%20of%20the%20Book.md) $i$ , and $V$ is the sum of all. $P V\mathrm{s}$ ). [Macaulay duration](../Fixed%20Income%20Asset%20Pricing/Fixed%20Income%20Lecture%20Notes/Teaching%20Note%202-%20Interest%20Rate%20Risk%20Management%20And%20Factors.md) is a measure of time or maturity (hence the name "[duration](../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%205/Key%20Rates%20O1s%20Durations%20and%20Hedging.md)"),. and is measured in years. This is in contrast to [modified duration](.md), which is a rate of change of price w.r.t. yield and is measured as percent per unit change in yield.  

The shared use of the term "[duration](../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%205/Key%20Rates%20O1s%20Durations%20and%20Hedging.md)" for both a maturity measure and a [price sensitivity](../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%204/Duration.md) measure causes endless confusion. but is deeply embedded in the finance profession. The shared use of the term arises because [Macaulay duration](../Fixed%20Income%20Asset%20Pricing/Fixed%20Income%20Lecture%20Notes/Teaching%20Note%202-%20Interest%20Rate%20Risk%20Management%20And%20Factors.md) and modi-. fied [duration](../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%205/Key%20Rates%20O1s%20Durations%20and%20Hedging.md) have the same numerical value when yield-to-maturity is expressed continuously-compounded. For a flat yieldto-maturity and continuously-compounded rates the sum of present values is:.  
$$
...
=======
But note that the term $\frac{C F_{i}\cdot e^{\mathrm{~-~}t i\cdot y}}{\l_{V}}$ is just - $\frac{P V_{i}}{\mathrm{~}_{V}}$ so that this is also the formula for [Macaulay duration](../Fixed%20Income%20Asset%20Pricing/Fixed%20Income%20Lecture%20Notes/Teaching%20Note%202-%20Interest%20Rate%20Risk%20Management%20And%20Factors.md), and so [modified duration](.md) and [Macaulay duration](../Fixed%20Income%20Asset%20Pricing/Fixed%20Income%20Lecture%20Notes/Teaching%20Note%202-%20Interest%20Rate%20Risk%20Management%20And%20Factors.md) have the same numerical value.  
>>>>>>> 2e346c030bacda517086e02b86e48ba98c22a543

$$V = \sum_{i=1}^{n} PV_i = \sum_{i=1}^{n} CF_i \cdot e^{-t_i \cdot y}$$  

<<<<<<< HEAD
Taking the logarithmic derivative w.r.t. $y$ gives:
=======
where $k$ is the [compounding frequency](../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%202/Interest%20Rate%20Quotations.md) (e.g. 1 for annual, 2 for semi-annual). Taking the logarithmic derivative in this case gives:  
$$
M o d D=-\frac{1}{V}\frac{d V}{d y}=\sum_{i=1}^{n}t_{i}\frac{1}{V}\frac{C F_{i}}{\left(1+y/k\right)^{k\cdot t i}}\frac{1}{\left(1+y/k\right)}
$$  
>>>>>>> 2e346c030bacda517086e02b86e48ba98c22a543

$$\text{ModD} = -\frac{1}{V}\frac{dV}{dy} = \sum_{i=1}^{n} t_i \frac{CF_i \cdot e^{-t_i \cdot y}}{V}$$  

But note that the term $\frac{CF_i \cdot e^{-t_i \cdot y}}{V}$ is just $\frac{PV_i}{V}$ so that this is also the formula for Macaulay duration, and so modified duration and Macaulay duration have the same numerical value.  

<<<<<<< HEAD
In the more common situation where rates are quoted periodically-compounded, then the sum of present values will be:
=======
It is vitally important to remember, however, that this expresses a relationship between the values of modified and Macaulay. [duration](../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%205/Key%20Rates%20O1s%20Durations%20and%20Hedging.md) (for fixed [cash flow](../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%201%20-%20Purpose%20and%20Structure%20of%20Financial%20Markets/Preview%20of%20the%20Book.md) instruments such as bonds) but that the two measures are conceptually distinct in spite of. sharing the name. [Macaulay duration](../Fixed%20Income%20Asset%20Pricing/Fixed%20Income%20Lecture%20Notes/Teaching%20Note%202-%20Interest%20Rate%20Risk%20Management%20And%20Factors.md) is a measure of time, denoted in years. [Modified duration](.md) is a rate of change, percentage change in price per unit change in yield. [Macaulay duration](../Fixed%20Income%20Asset%20Pricing/Fixed%20Income%20Lecture%20Notes/Teaching%20Note%202-%20Interest%20Rate%20Risk%20Management%20And%20Factors.md) is limited in application to instruments with [fixed cash flows](../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%202/Interest%20Rate%20Quotations.md) (such as standard bonds) while [modified duration](.md) can be applied to more general [fixed-income instruments](../Advanced%20Investments/Lecture%207-Risk%20and%20Return%20of%20Bonds.md) such as options..  
>>>>>>> 2e346c030bacda517086e02b86e48ba98c22a543

$$V = \sum_{i=1}^{n} PV_i = \sum_{i=1}^{n} \frac{CF_i}{(1 + y/k)^{k \cdot t_i}}$$  
...
$$\text{ModD} = -\frac{1}{V}\frac{dV}{dy} = \sum_{i=1}^{n} t_i \frac{1}{V} \frac{CF_i}{(1+y/k)^{k \cdot t_i}} \frac{1}{(1+y/k)}$$  

This can be written as:
=======
DV01 is also called [dollar duration](.md), BPV (basis point value), or PV01 (present value of an 01, although PV01 more accurately refers to the value of a one dollar or one basis point annuity). The relation between Dv01 and [modified duration](.md) is:  
$$
M o d D=100\cdot\frac{D V O I}{\textsl{V}}\quad\qquadD V O I=\frac{M o d D\cdot V}{100}
$$  

The concepts of [duration](../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%205/Key%20Rates%20O1s%20Durations%20and%20Hedging.md) and Dv01 become more concrete if we focus on specific examples. Consider a two year and a ten year bond, together with two and ten year annuities and zero bonds. Table 1 shows these bonds, together with assumed prices and yields.  

Table 1 - Dv01 and Durations For Selected Swaps, Annuities, and Zero-Coupon Bonds 'V01 is the dollar change for a $\$100$ notional instrument per 100bp change in yield. [Modified duration](.md) is the percent change per 100bp hange in yield. [Macaulay duration](../Fixed%20Income%20Asset%20Pricing/Fixed%20Income%20Lecture%20Notes/Teaching%20Note%202-%20Interest%20Rate%20Risk%20Management%20And%20Factors.md) is the weighted average [time to maturity](../Financial%20Instruments/Lecture%20Notes-%20Financial%20Instruments/Teaching%20Note%201-%20Forward%20Rates%20Agreement/Hedging%20Strategies%20with%20Forwards.md), in years.  
>>>>>>> 2e346c030bacda517086e02b86e48ba98c22a543

$$\text{ModD} = \sum_{i=1}^{n} t_i \frac{PV_i}{V} \frac{1}{(1 + y/k)}$$  

which gives the oft-quoted relation:

<<<<<<< HEAD
$$\text{ModD} = \frac{\text{MacD}}{(1+y/k)}$$  
...
$$\text{ModD} = 100 \cdot \frac{\text{DV01}}{V} \quad\quad \text{DV01} = \frac{\text{ModD} \cdot V}{100}$$  
...
|-----------|------------|-------|-----------|------|---------|----------|
| 2yr Bond | 2.5 | 100.0 | 2.5 | 1.94 | 1.94 | 1.96 |
| 10yr Bond | 3.5 | 100.0 | 3.5 | 8.38 | 8.38 | 8.52 |
| 2yr Ann | 2.5 | 4.86 | 2.3 | 0.06 | 1.23 | 1.24 |
| 10yr Ann | 3.5 | 29.72 | 3.22 | 1.46 | 4.91 | 4.98 |
| 2yr Zero | 0.0 | 95.14 | 2.51 | 1.88 | 1.97 | 2.00 |
| 10yr Zero | 0.0 | 70.28 | 3.56 | 6.90 | 9.82 | 10.00 |  
...
$$\text{DV01}_{10\text{yr bond}} = \frac{100.8417 - 99.1664}{3.6 - 3.4} = 8.38$$  
...
=======
The [modified duration](.md) can be calculated from the Dv01 using the relation in (5). The [Macaulay duration](../Fixed%20Income%20Asset%20Pricing/Fixed%20Income%20Lecture%20Notes/Teaching%20Note%202-%20Interest%20Rate%20Risk%20Management%20And%20Factors.md) can then be calculated using the relation (3) or the original definition (2). For the table above, and in most practical applications, it proves. easier to calculate a numerical derivative approximations to either Dv01 or [modified duration](.md) (1 or 4) and then use the. relations (3) and (5) to derive the other measures..  

Table 1 shows the [Macaulay duration](../Fixed%20Income%20Asset%20Pricing/Fixed%20Income%20Lecture%20Notes/Teaching%20Note%202-%20Interest%20Rate%20Risk%20Management%20And%20Factors.md) of the zero bonds are equal to maturity, as should be. The modified durations are slightly lower (dividing by one plus yield as per above), and the Dvo1s lower still (multiplying by the zero prices, which are below 100). For the coupon bonds the [Macaulay duration](../Fixed%20Income%20Asset%20Pricing/Fixed%20Income%20Lecture%20Notes/Teaching%20Note%202-%20Interest%20Rate%20Risk%20Management%20And%20Factors.md) is less than maturity, reflecting the coupons that are paid prior to. m aturity.  

A good way to visualize the [Macaulay duration](../Fixed%20Income%20Asset%20Pricing/Fixed%20Income%20Lecture%20Notes/Teaching%20Note%202-%20Interest%20Rate%20Risk%20Management%20And%20Factors.md) is to imagine PVs of cash flows as weights placed on a balance-beam. Figure 1 shows the [Macaulay duration](../Fixed%20Income%20Asset%20Pricing/Fixed%20Income%20Lecture%20Notes/Teaching%20Note%202-%20Interest%20Rate%20Risk%20Management%20And%20Factors.md) for the two year annuity. The cash flows are. $\$1.25$ each half- year, and the circles represent the PVs, which gradually decline further out. The fulcrum of the balance beam is just slightly less than the mid-point (1.24 years). If we drew the diagram for the two year bond there would be a much large cash flow (the. $\$100$ principal) at year 2 and this is what pushes the [Macaulay duration](../Fixed%20Income%20Asset%20Pricing/Fixed%20Income%20Lecture%20Notes/Teaching%20Note%202-%20Interest%20Rate%20Risk%20Management%20And%20Factors.md) (the fulcrum on the balance beam) out to 1.96 years for the two year coupon bond..  

![](1814cb9a3ff36af6d901ced72027f0cf0be48f37951e9abd3da6a9e13985d0dd.jpg)  
Figure 1 - [Macaulay Duration](../Fixed%20Income%20Asset%20Pricing/Fixed%20Income%20Lecture%20Notes/Teaching%20Note%202-%20Interest%20Rate%20Risk%20Management%20And%20Factors.md) for Two Year Annuity   
This shows the [Macaulay duration](../Fixed%20Income%20Asset%20Pricing/Fixed%20Income%20Lecture%20Notes/Teaching%20Note%202-%20Interest%20Rate%20Risk%20Management%20And%20Factors.md) as the fulcrum or balance point on a balance beam, with weights representing the present value ofcash flows. "PV' is the present value ofthe [cash flow](../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%201%20-%20Purpose%20and%20Structure%20of%20Financial%20Markets/Preview%20of%20the%20Book.md). Time" is the maturity ofthe [cash flow](../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%201%20-%20Purpose%20and%20Structure%20of%20Financial%20Markets/Preview%20of%20the%20Book.md). The [Macaulay Duration](../Fixed%20Income%20Asset%20Pricing/Fixed%20Income%20Lecture%20Notes/Teaching%20Note%202-%20Interest%20Rate%20Risk%20Management%20And%20Factors.md) is shown at the fulcrum.  

The equality (or near-equality) in the values of modified and [Macaulay duration](../Fixed%20Income%20Asset%20Pricing/Fixed%20Income%20Lecture%20Notes/Teaching%20Note%202-%20Interest%20Rate%20Risk%20Management%20And%20Factors.md) can be a valuable aid to intuition. [Macaulay duration](../Fixed%20Income%20Asset%20Pricing/Fixed%20Income%20Lecture%20Notes/Teaching%20Note%202-%20Interest%20Rate%20Risk%20Management%20And%20Factors.md) will always be less than the maximum maturity (equal only for a single [cash flow](../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%201%20-%20Purpose%20and%20Structure%20of%20Financial%20Markets/Preview%20of%20the%20Book.md), i.e. a zero-coupon bond, as seen in table 1 and the definition in equation 2). This means we can often make a rough guess at the [Macaulay duration](../Fixed%20Income%20Asset%20Pricing/Fixed%20Income%20Lecture%20Notes/Teaching%20Note%202-%20Interest%20Rate%20Risk%20Management%20And%20Factors.md) and from that infer a rough value for the [modified duration](.md). For example a ten year bond will have [Macaulay duration](../Fixed%20Income%20Asset%20Pricing/Fixed%20Income%20Lecture%20Notes/Teaching%20Note%202-%20Interest%20Rate%20Risk%20Management%20And%20Factors.md) somewhat but not dramatically less than 10 years, and so the [modified duration](.md) will be somewhat less than $10\%$ . In table 1 we can see that the ten year bond has a [Macaulay duration](../Fixed%20Income%20Asset%20Pricing/Fixed%20Income%20Lecture%20Notes/Teaching%20Note%202-%20Interest%20Rate%20Risk%20Management%20And%20Factors.md) of 8.5 years and a [modified duration](.md) of $8.4\%$  

[Macaulay duration](../Fixed%20Income%20Asset%20Pricing/Fixed%20Income%20Lecture%20Notes/Teaching%20Note%202-%20Interest%20Rate%20Risk%20Management%20And%20Factors.md) is useful as an aide for intuition but in measuring [price sensitivity](../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%204/Duration.md) we must use either [modified duration](.md) or DV01. In many cases one can use either, converting between them using equation (5) depending on the needs of the problem. Generally, managers of real-money long-only portfolios use [modified duration](.md) while managers of trading and [derivatives](../Financial%20Markets/Financial%20Trading%20and%20Markets/Chapter%209%20Arbitrage%20and%20Hedging%20With%20Options.md) portfolios tend to use Dvo1. [Modified duration](.md) is well-suited for long-only portfolios, where [risk and return](../Advanced%20Investments/Lecture%207-Risk%20and%20Return%20of%20Bonds.md) can be. measured as a percent of [portfolio](../Advanced%20Investments/An%20Asset%20Allocation%20Primer.md) value, while Dv01 is more suited to portfolios where the present value of the [portfolio](../Advanced%20Investments/An%20Asset%20Allocation%20Primer.md) may be zero and measuring risk in dollar or absolute terms is more convenient..  

In using [duration](../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%205/Key%20Rates%20O1s%20Durations%20and%20Hedging.md) we must be careful with a few points. First, we must keep straight the distinction between [Macaulay duration](../Fixed%20Income%20Asset%20Pricing/Fixed%20Income%20Lecture%20Notes/Teaching%20Note%202-%20Interest%20Rate%20Risk%20Management%20And%20Factors.md) (a measure of maturity) and [modified duration](.md) (a measure of [price sensitivity](../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%204/Duration.md)). Second, we must remember that (modified) [duration](../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%205/Key%20Rates%20O1s%20Durations%20and%20Hedging.md) tells us the [price sensitivity](../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%204/Duration.md) to a change in rates, but does not tell us what rates we are sensitive to, in spite of the term "[duration](../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%205/Key%20Rates%20O1s%20Durations%20and%20Hedging.md)"'. Consider the ten year annuity, which has a Macaulay and [modified duration](.md) of roughly 5. The [duration](../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%205/Key%20Rates%20O1s%20Durations%20and%20Hedging.md) of 5 does not mean the annuity reacts in the same way as a five year bond. Think back to the fulcrum view from figure 1 - for the annuity the fulcrum is in the middle but the cash flows at the far end depend on longer-dated rates. For the ten year annuity the fulcrum sits at roughly 5 years but there are cash flows extending out to ten years.  

As a personal matter I usually use Dv01 rather than [duration](../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%205/Key%20Rates%20O1s%20Durations%20and%20Hedging.md). I prefer to sidestep the confusion between the different. meanings of the term "[duration](../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%205/Key%20Rates%20O1s%20Durations%20and%20Hedging.md)" and find the concept of Dv01 cleaner and simpler. Having stated my [preference](../Financial%20Markets/Financial%20Asset%20Pricing%20Theory%20Overview/Chapter%205%20-%20Modeling%20the%20Preferences%20of%20Individuals/Utility%20Indices.md), however,. it is a personal [preference](../Financial%20Markets/Financial%20Asset%20Pricing%20Theory%20Overview/Chapter%205%20-%20Modeling%20the%20Preferences%20of%20Individuals/Utility%20Indices.md) and Dv01 or [modified duration](.md) can usually be used interchangeably. Throughout the rest of this paper, however, I will use Dv01 rather than [duration](../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%205/Key%20Rates%20O1s%20Durations%20and%20Hedging.md)..  

# Yield and Forward Curves  

The discussion above treated Dv01 as a function of yield-to-maturity, essentially treating each bond or instrument on its own, having its own yield. In many situations we will in contrast consider a set of bonds or instruments together, all valued off a common market-based yield curve. For example a collection of swaps will be valued off a yield curve derived for a. small set of on-the-run or active instruments (swaps, [futures](../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md), libor deposits). The value of the swaps is the discounted value. of [future cash flows](Advanced%20Derivatives%20Pricing%20Methodology.md), discounting off the yield curve. Discounting cash flows off a yield curve or forward curve forms the. foundation for all trading of [fixed income instruments](../Course%20Notes/Python/QuantLib-Python/Valuing%20Callable%20Bonds%20Using%20QuantLib%20Python.md).  

When a collection of bonds or other [fixed-income instruments](../Advanced%20Investments/Lecture%207-Risk%20and%20Return%20of%20Bonds.md) is valued off a common yield curve, the idea of Dv01 or. [duration](../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%205/Key%20Rates%20O1s%20Durations%20and%20Hedging.md) extends naturally to partial Dv01s or [key rate durations](.md). Such partial Dv01s are widely used on trading desks and. [risk management](Financial%20Mathematics%20Course.md) groups. Before turning to partial Dv01s, however, it is useful to briefly review the idea of yield or forward curves. (Coleman 1998 discusses forward curves in more detail.)  
>>>>>>> 2e346c030bacda517086e02b86e48ba98c22a543

# Forward, Zero, and Discount Curves  

<<<<<<< HEAD
The most constructive way to think of a yield curve is as a function that provides the discount factor for any day - for our bonds discussed above we would want the discount factor for any date from today out to 10 years in the future. It is particularly convenient to work with the forward curve $f(t)$, where $t$ is the maturity measured in years from today and $f(.)$ is the instantaneous forward rate. Alternatively we could work with the zero-coupon yield curve $z(t)$, or discount curve $d(t)$, but the three are related and so the choice becomes one of convenience. When we express rates continuously-compounded, the relations between the forward, zero, and discount curve are:
=======
The most constructive way to think of a yield curve is as a function that provides the [discount factor](../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%201/Discount%20Factors.md) for any day - for our the bonds discussed above we would want the [discount factor](../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%201/Discount%20Factors.md) for any date from today out to 10 years in the future. It is particularly convenient to work with the forward curve $f(t)$ , where $t$ is the maturity measured in years from today and $f(.)$ is the instantaneous [forward rate](../Clippings/Forward%20Points%20in%20Currency.md). Alternatively we could work the zero-coupon yield curve $z(t)$ , or [discount curve](../Credit%20Markets/Credit%20Market%20PSETS/Advanced%20Usage%20of%20QuantLib%20analytics%20library.md) $d(t)$ , but the three are related and so the choice becomes one of convenience. When we express rates continuously-compounded, the relations between the forward, zero, and [discount curve](../Credit%20Markets/Credit%20Market%20PSETS/Advanced%20Usage%20of%20QuantLib%20analytics%20library.md) are:  
$$
...
$$z(t) = \frac{\int_0^t f(u) du}{t}$$

<<<<<<< HEAD
$$d(t) = \exp[-z(t) \cdot t] = \exp\left[-\int_0^t f(u) du\right]$$  
...
<<<<<<< HEAD
As an example of a functional form we can assume that instantaneous forward rates are constant between instrument maturity points (break points or knot points) and that the forward rates jump at maturity points. In this case the variables $(\nu_1 \cdots \nu_k)$ are the forward rates between knot points. (This is, in fact, a practical and useful forward curve often used by market practitioners, but it is only one among many.) Functionally, this is a piece-wise constant function:
=======
In other words these are the current-market [par swap](Fixed%20Income%20Derivatives/Determining%20the%20Expression%20for%20the%20Fair%20Value%20of%20the%20Swap%20Spread.md) rates. We can now build a forward or yield curve that is consistent with these [par swap](Fixed%20Income%20Derivatives/Determining%20the%20Expression%20for%20the%20Fair%20Value%20of%20the%20Swap%20Spread.md) rates.  
>>>>>>> 2e346c030bacda517086e02b86e48ba98c22a543
...
=======
In practice swap curves are usually built with a variety of different instruments, including libor deposits, libor [futures](../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md), and par swaps. For expository purposes it will be useful to consider a curve built with both spot and forward instruments, and. thus we will build our curve with the following instruments:.  
>>>>>>> 2e346c030bacda517086e02b86e48ba98c22a543

Table 3 - Market Instrument Used for Building Sample Curve  

| Instrument | Forward Start | Underlier (yrs) | Coupon Rate (%) | Fwd Rate (cc) |
|-----------|---------------|-----------------|-----------------|---------------|
| 1yr Swap | 0 | 1 | 2.0 | 0.0199 |
| 1y2y Fwd | 1 | 1 | 3.014 | 0.0299 |
| 5yr Swap | 0 | 5 | 3.0 | 0.0333 |
...
|-----------|---------------|-----------------|-----------------|-------|
| 1yr Swap | 0 | 1 | 2.0 | 0.0 |
| 1y2y Fwd | 1 | 1 | 3.014 | 0.0 |
| 5yr Swap | 0 | 5 | 3.0 | 0.0 |
| 10yr Swap | 0 | 10 | 3.5 | 0.0 |
| 2yr Swap | 0 | 2 | 2.5 | 0.0 |
| 3yr Swap | 0 | 3 | 2.8 | 0.06 |
| 2yr Ann | 0 | 2 | 2.5 | 4.86 |
| 10yr Ann | 0 | 10 | 3.5 | 29.72 |
| 2yr Zero | 0 | 2 | 0.0 | 95.14 |
| 10yr Zero | 0 | 10 | 0.0 | 70.28 |  
...
=======
Partial Dv01s, partial durations, or [key rate durations](.md) are used throughout the finance industry and have a long history. Ho. (1992) introduced the term [key rate](../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%205/Key%20Rates%20O1s%20Durations%20and%20Hedging.md) [duration](../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%205/Key%20Rates%20O1s%20Durations%20and%20Hedging.md). Reitano covered multifactor yield curve models as early as 1991 (Reitano 1991) and has revisited the topic in a recent review (Reitano 2008)..  

When we use a yield curve to value a set of [fixed income instruments](../Course%20Notes/Python/QuantLib-Python/Valuing%20Callable%20Bonds%20Using%20QuantLib%20Python.md) rather than a single yield-to-maturity for each bond, it is natural to extend the concept of Dv01 from a univariate derivative to a set of partial [derivatives](../Financial%20Markets/Financial%20Trading%20and%20Markets/Chapter%209%20Arbitrage%20and%20Hedging%20With%20Options.md). We now turn to these partial DV01s.  

# Risk w.r.t. Curve Variables  

Once we have a forward curve as a function of the variables $\left(\begin{array}{l l l}{\nu_{1}}&{\cdots}&{\nu_{k}}\end{array}\right)$ it is straight-forward to calculate the partial [derivatives](../Financial%20Markets/Financial%20Trading%20and%20Markets/Chapter%209%20Arbitrage%20and%20Hedging%20With%20Options.md) (delta risk or Dvo1) with respect to these curve variables or parameters. As a practical matter we might do this by simply bumping the variables up and down and taking a numerical derivative, as we did above for the Dv01 with a single yield-to-maturity. Say we have a [portfolio](../Advanced%20Investments/An%20Asset%20Allocation%20Primer.md) consisting of $n$ instruments or positions. The prices or PVs of these instruments will be functions of the curve variables $\left(\begin{array}{l l l}{\nu_{1}}&{\cdots}&{\nu_{k}}\end{array}\right)$ represented by the vector  
$$
{\mathrm{Prices}}={\left(\begin{array}{l}{P_{1}}\ {\vdots}\ {P_{n}}\end{array}\right)}={\left(\begin{array}{l l l}{P_{1}(\nu_{1}\cdots\nu_{k})}\ &{\vdots}\ {P_{n}(\nu_{1}\cdots\nu_{k})}\end{array}\right)}
$$  

and the matrix of partial [derivatives](../Financial%20Markets/Financial%20Trading%20and%20Markets/Chapter%209%20Arbitrage%20and%20Hedging%20With%20Options.md) will be:  
$$
...
For the piece-wise forward curve we are using, the curve variables are forward rates and the partial Dv01s will be with respect to forward rates. For the sample market yield curve shown in table 3 the [forward rate](../Clippings/Forward%20Points%20in%20Currency.md) partial Dv01s for selected instruments will be:  
>>>>>>> 2e346c030bacda517086e02b86e48ba98c22a543

$$\text{Derivatives} = \left(\begin{array}{ccc}
\frac{\partial P_1}{\partial \nu_1} & \cdots & \frac{\partial P_1}{\partial \nu_k} \\
\vdots & \ddots & \vdots \\
\frac{\partial P_n}{\partial \nu_1} & \cdots & \frac{\partial P_n}{\partial \nu_k}
\end{array}\right)$$  
...
| 10yr Swap | 0.99 | 0.96 | 2.68 | 3.87 | 8.50 |
| 2yr Swap | 0.99 | 0.97 | 0 | 0 | 1.96 |
| 3yr Swap | 0.99 | 0.97 | 0.94 | 0 | 2.90 |
| 2yr Ann | 0.04 | 0.02 | 0 | 0 | 0.06 |
| 10yr Ann | 0.29 | 0.25 | 0.57 | 0.36 | 1.47 |
| 2yr Zero | 0.95 | 0.95 | 0 | 0 | 1.90 |
| 10yr Zero | 0.70 | 0.70 | 2.11 | 3.51 | 7.03 |  
...
$$\text{DpDr} = \text{Derivative of prices w.r.t. curve input rates} = \left(\begin{array}{ccc}
\frac{\partial P_1}{\partial r_1} & \cdots & \frac{\partial P_1}{\partial r_k} \\
\vdots & \ddots & \vdots \\
\frac{\partial P_n}{\partial r_1} & \cdots & \frac{\partial P_n}{\partial r_k}
\end{array}\right)$$  
=======
urning to the bumping of curve input, if the $k$ curve input rates are. $(\mathrm{~}r_{1}\mathrm{~~}\cdots\mathrm{~~}r_{k}\mathrm{~~})$ then the matrix of partial [derivatives](../Financial%20Markets/Financial%20Trading%20and%20Markets/Chapter%209%20Arbitrage%20and%20Hedging%20With%20Options.md) is:.  
$$
...
For our hypothetical market yield curve and the instruments shown in table 3, the risk will be w.r.t. the 1 year [par rate](../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%202/Pricing%20Interest%20Rate%20Swaps.md), the 1-2 year forward [par rate](../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%202/Pricing%20Interest%20Rate%20Swaps.md), the 5 year and 10 year par rates. This is shown in table 4.  
>>>>>>> 2e346c030bacda517086e02b86e48ba98c22a543

For our hypothetical market yield curve and the instruments shown in table 3, the risk will be w.r.t. the 1 year par rate, the 1-2 year forward par rate, the 5 year and 10 year par rates. This is shown in table 6.  
...
| 3yr Swap | 0.64 | 0.62 | 1.60 | 0 | 2.87 |
| 2yr Ann | 0.04 | 0.02 | 0 | 0 | 0.06 |
| 10yr Ann | 0.08 | 0.05 | 0.54 | 0.79 | 1.46 |
| 2yr Zero | 0.94 | 0.94 | 0 | 0 | 1.88 |
| 10yr Zero | -0.08 | -0.05 | -0.54 | 7.70 | 7.03 |  

<<<<<<< HEAD
DV01s are reported as dollar change for a \$100 notional instrument per 100bp change in yields or rates. Instruments used in fitting the curve are highlighted.  
=======
The partial Dv01s w.r.t. curve inputs shown in table 6 is simply a transformation of the original risk w.r.t. curve variables shown in table 5. The underlying forward curve changes in exactly the same manner, we just measure the Dv01s w.r.t. the curve inputs rather than the curve parameters. Nor are we restricted to the curve inputs we originally used. We could use alternate instruments that would be appropriate for building the curve. For example we could substitute the 2 year swap for the 1-2 year forward and then we would have the risk w.r.t. the [par swap](Fixed%20Income%20Derivatives/Determining%20the%20Expression%20for%20the%20Fair%20Value%20of%20the%20Swap%20Spread.md) instead of the [forward swap](Derivatives/Part%20IX%20-%20Fixed%20Income%20Derivatives/Chapter%2039%20-%20Swaptions,%20Forward%20Swaps,%20and%20MBS.md)..  
>>>>>>> 2e346c030bacda517086e02b86e48ba98c22a543
...
=======
Bumping curve inputs is very useful but requires re-building the yield curve multiple times and re-calculating the risk for the. whole [portfolio](../Advanced%20Investments/An%20Asset%20Allocation%20Primer.md). In many risk systems it is easy to calculate the [derivatives](../Financial%20Markets/Financial%20Trading%20and%20Markets/Chapter%209%20Arbitrage%20and%20Hedging%20With%20Options.md) w.r.t. curve parameters but difficult (requiring re-. programming) to calculate [derivatives](../Financial%20Markets/Financial%20Trading%20and%20Markets/Chapter%209%20Arbitrage%20and%20Hedging%20With%20Options.md) w.r.t. curve inputs. We now turn to an approach that accomplishes the same - risk as if we re-built and bumped curve inputs - but without the burden of actually re-building the curve and re-valuing the whole. [portfolio](../Advanced%20Investments/An%20Asset%20Allocation%20Primer.md). The trick is that we can choose a set of alternate curve inputs and use the multivariate inverse function theorem to. calculate the inverse Jacobian to obtain the transformation that converts the original partial Dvo1s into partials w.r.t. the alternate curve inputs.  
>>>>>>> 2e346c030bacda517086e02b86e48ba98c22a543
...
=======
We now describe a straight-forward method to calculate [derivatives](../Financial%20Markets/Financial%20Trading%20and%20Markets/Chapter%209%20Arbitrage%20and%20Hedging%20With%20Options.md) w.r.t. alternate variables (subject to certain technical restrictions). The result will be to calculate the risk as if we went through the process of re-building the curve and bumping. w.r.t. inputs as in the previous section, but without the burden of actually re-building the curve multiple times..  
>>>>>>> 2e346c030bacda517086e02b86e48ba98c22a543
...
<<<<<<< HEAD
Consider $k$ alternate variables $(x_1 \cdots x_k)$. Assume for now that these alternate variables are themselves the yields or rates we want to use for calculating partial DV01s and that we can calculate these as a function of the forward curve:
=======
If we have the same number of variables $(\mathrm{~\boldmath~{~\pi~}~}_{1}\mathrm{~\boldmath~{~\cdot~}~}\mathrm{~\boldmath~{~\pi~}~}_{\stackrel{{\scriptstyle}{{x_{k}}}}{\cal{~)}}}$ as curve variables $(\mathrm{~\boldmath~\nu~}_{1}\mathrm{~\boldmath~\cdots~}\mathrm{~\boldmath~\nu~}_{k})$ then we can calculate the [derivatives](../Financial%20Markets/Financial%20Trading%20and%20Markets/Chapter%209%20Arbitrage%20and%20Hedging%20With%20Options.md) of these alternate variables w.r.t. the curve variables and this will be the Jacobian matrix for the function (8):  
$$
...
$$\text{Alternate variables} = \left(\begin{array}{c}
x_1 \\
\vdots \\
x_k
\end{array}\right) = \left(\begin{array}{c}
...
If we have the same number of alternate variables $(x_1 \cdots x_k)$ as curve variables $(\nu_1 \cdots \nu_k)$ then we can calculate the derivatives of these alternate variables w.r.t. the curve variables and this will be the Jacobian matrix for the function (8):

$$\text{DxDv} = \text{Jacobian for Curve} \to \text{Alternate Variables} = \left(\begin{array}{ccc}
\frac{\partial x_1}{\partial \nu_1} & \cdots & \frac{\partial x_1}{\partial \nu_k} \\
\vdots & \ddots & \vdots \\
\frac{\partial x_k}{\partial \nu_1} & \cdots & \frac{\partial x_k}{\partial \nu_k}
\end{array}\right)$$  
...
$$\text{Inverse Jacobian} = \text{DvDx} = \left(\begin{array}{ccc}
\frac{\partial \nu_1}{\partial x_1} & \cdots & \frac{\partial \nu_1}{\partial x_k} \\
\vdots & \ddots & \vdots \\
\frac{\partial \nu_k}{\partial x_1} & \cdots & \frac{\partial \nu_k}{\partial x_k}
...
Jsing the Jacobian of the inverse function we can transform the [derivatives](../Financial%20Markets/Financial%20Trading%20and%20Markets/Chapter%209%20Arbitrage%20and%20Hedging%20With%20Options.md) w.r.t. curve variables to [derivatives](../Financial%20Markets/Financial%20Trading%20and%20Markets/Chapter%209%20Arbitrage%20and%20Hedging%20With%20Options.md) w.r.t. the new ariables. Consider the first row of equation 6:  
...
The calculation in step (2) requires evaluating the risk of a small set of traded instruments, and this (and the additional calculations) will usually be quick and cheap relative to evaluating the risk of the whole [portfolio](../Advanced%20Investments/An%20Asset%20Allocation%20Primer.md). The transformation matrix (13) (or 11) can then be applied to the original [portfolio](../Advanced%20Investments/An%20Asset%20Allocation%20Primer.md) risk, transforming the partial Dv01s from curve variables $\left(\begin{array}{l l l}{\nu_{1}}&{\cdots}&{\nu_{k}}\end{array}\right)$ to alternate yields $\left(\begin{array}{l l l}{{y_{1}}}&{{\cdots}}&{{y_{k}}}\end{array}\right)$ . Naturally, the same process applies if the original risk is reported w.r.t. curve input rates $(\mathrm{~}r_{1}\mathrm{~~}\cdots\mathrm{~~}r_{k}\mathrm{~~})$  
...
Further, let us say that our risk system can easily calculate the [derivatives](../Financial%20Markets/Financial%20Trading%20and%20Markets/Chapter%209%20Arbitrage%20and%20Hedging%20With%20Options.md) of these rates w.r.t. the curve variables. In this case we can apply equation (11) directly. This is an exercise only, since we should end up with the same risk as bumping the curve inputs, shown in table 6. In this case the Jacobian for the alternate variables $(\mathrm{~\boldmath~{~\boldsymbol~{~x~}~}~}_{1}\mathrm{~\boldmath~{~\cdot~}~}\mathrm{~\boldmath~{~\boldsymbol~{~\cdot~}~}~}\mathrm{~\boldmath~{~\boldsymbol~{~\it~{~~\varepsilon~}~}~}~})$ is  
...
Applying the transformation shown in equation (11) to the [derivatives](../Financial%20Markets/Financial%20Trading%20and%20Markets/Chapter%209%20Arbitrage%20and%20Hedging%20With%20Options.md) (Dv01s) w.r.t. curve variables shown in table 5 gives.   
...
Now let us turn to a more substantive example, where we wish to measure Dv01s w.r.t. [par swap](Fixed%20Income%20Derivatives/Determining%20the%20Expression%20for%20the%20Fair%20Value%20of%20the%20Swap%20Spread.md) rates instead of the mix of spot and forward swaps shown in tables 5 and 6. In other words we take the variables (. $\left(\begin{array}{l l l}{x_{1}}&{\cdots}&{x_{k}}\end{array}\right)$ in equation (8) to be the [par swap](Fixed%20Income%20Derivatives/Determining%20the%20Expression%20for%20the%20Fair%20Value%20of%20the%20Swap%20Spread.md) rates on 1, 2, 5, and 10 year swaps:  
...
Again, let use assume that our risk system can easily calculate the [derivatives](../Financial%20Markets/Financial%20Trading%20and%20Markets/Chapter%209%20Arbitrage%20and%20Hedging%20With%20Options.md) of the rates themselves w.r.t. the curve variable: so that we can apply equation (11) directly. The Jacobian for these rates is:.  

Table 9 - Jacobian for [Par Swap](Fixed%20Income%20Derivatives/Determining%20the%20Expression%20for%20the%20Fair%20Value%20of%20the%20Swap%20Spread.md) Rates (Equation 9)  
...
Applying the transformation shown in equation (11) to the [derivatives](../Financial%20Markets/Financial%20Trading%20and%20Markets/Chapter%209%20Arbitrage%20and%20Hedging%20With%20Options.md) (Dv01s) w.r.t. curve variables shown in table 5 gives the risk shown in table 9. Risk expressed in this form may be more intuitive than that shown in table 6. Here a 2 year swap is sensitive to only the 2 year swap, while a 3 year swap is sensitive to both the 2 year [swap rate](../Fixed%20Income%20Asset%20Pricing/Fixed%20Income%20Lecture%20Notes/Teaching%20Note%204%20Interest%20Rate%20Derivatives.md) and the 5 year [swap rate](../Fixed%20Income%20Asset%20Pricing/Fixed%20Income%20Lecture%20Notes/Teaching%20Note%204%20Interest%20Rate%20Derivatives.md)..  

Table 10 - Dv01 w.r.t. [Par Swap](Fixed%20Income%20Derivatives/Determining%20the%20Expression%20for%20the%20Fair%20Value%20of%20the%20Swap%20Spread.md) Rates for Selected Instruments, Transformed via Equation 11  
...
with the PVs calculated from the forward curve. The par coupon or [par rate](../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%202/Pricing%20Interest%20Rate%20Swaps.md) is the coupon that makes the price equal to pa1 (100):  
$$
...
(ignoring for now complications related to partial periods, [compounding frequency](../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%202/Interest%20Rate%20Quotations.md), etc.). The yield on a par bond (Price=100) will equal the par coupon.  

In building a [swap curve](Fixed%20Income%20Derivatives/Determining%20the%20Expression%20for%20the%20Fair%20Value%20of%20the%20Swap%20Spread.md) we will use par swaps and we will often measure risk w.r.t. the [par swap](Fixed%20Income%20Derivatives/Determining%20the%20Expression%20for%20the%20Fair%20Value%20of%20the%20Swap%20Spread.md) rates. That is what we did in tables 7 and 9 above. But we can also think of the "yield" of a swap - more precisely the yield of a bond with the same fixed coupons and a final repayment of principal. The par yield will be the same as the par coupon (by definition) but the risk w.r.t. the par yield will not be quite the same as the risk w.r.t. the par coupon. The reason is that the derivative of the coupon and yield w.r.t. curve variables are different:  
$$
...
We can see the differences for our sample curve by comparing the Jacobians (9) for the par rates and par yields. Table 9,. repeated here, shows the [derivatives](../Financial%20Markets/Financial%20Trading%20and%20Markets/Chapter%209%20Arbitrage%20and%20Hedging%20With%20Options.md) of [par swap](Fixed%20Income%20Derivatives/Determining%20the%20Expression%20for%20the%20Fair%20Value%20of%20the%20Swap%20Spread.md) rates w.r.t. curve parameters. Table 11 shows the [derivatives](../Financial%20Markets/Financial%20Trading%20and%20Markets/Chapter%209%20Arbitrage%20and%20Hedging%20With%20Options.md) of yields. For the 1 year swap the derivative of the [par rate](../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%202/Pricing%20Interest%20Rate%20Swaps.md) and the par yield are the same since the curve is flat between O and 1 years. The [derivatives](../Financial%20Markets/Financial%20Trading%20and%20Markets/Chapter%209%20Arbitrage%20and%20Hedging%20With%20Options.md) differ for the lon ger m aturity swaps.  

Table 9 (repeated) - Jacobian for [Par Swap](Fixed%20Income%20Derivatives/Determining%20the%20Expression%20for%20the%20Fair%20Value%20of%20the%20Swap%20Spread.md) Rates (Equation 9)  

Table 11 - Jacobian for [Par Swap](Fixed%20Income%20Derivatives/Determining%20the%20Expression%20for%20the%20Fair%20Value%20of%20the%20Swap%20Spread.md) Yields   
...
This difference in [derivatives](../Financial%20Markets/Financial%20Trading%20and%20Markets/Chapter%209%20Arbitrage%20and%20Hedging%20With%20Options.md) gives a slight difference in transformed risk. The following table shows the original risk transformed to risk w.r.t. yields, and we can see that there are slight differences from the risk reported in table 10.  

Table 12 - Dv01 w.r.t. [Par Swap](Fixed%20Income%20Derivatives/Determining%20the%20Expression%20for%20the%20Fair%20Value%20of%20the%20Swap%20Spread.md) Yields for Selected Instruments, Transformed via Equation 14  
...
If we wish to calculate the risk w.r.t. par rates rather than yields we can employ equation (15) to get the derivative of the par coupon from price [derivatives](../Financial%20Markets/Financial%20Trading%20and%20Markets/Chapter%209%20Arbitrage%20and%20Hedging%20With%20Options.md) of instruments:.  
$$
...
Our risk system, however, can only calculate the [derivatives](../Financial%20Markets/Financial%20Trading%20and%20Markets/Chapter%209%20Arbitrage%20and%20Hedging%20With%20Options.md) of bond prices w.r.t. curve variables. The following table shows the derivative of prices w.r.t. curve variables (continuously-compounded forward rates):.  
...
The partial Dv01s can be summed to give a total Dv01, and this is displayed in the tables above. This total Dv01 is the sensitivity to a "parallel shift' in all the underlying rates. Examination of the tables shows, however, that the total Dv01 differs for different sets of rates. For example, the total Dv01 for the 10 year zero bond in table 15 (shift in all zero yields) is 6.91 while in table 12 (shift in all par yields) it is 6.93. For example, the total Dv01 for the 10 year [par swap](Fixed%20Income%20Derivatives/Determining%20the%20Expression%20for%20the%20Fair%20Value%20of%20the%20Swap%20Spread.md) in table 5 (shift in cc [forwards](../Financial%20Markets/Financial%20Asset%20Pricing%20Theory%20Overview/Chapter%2012%20-%20Derivatives/Forwards%20and%20Futures.md)) is 8.49 while in table 12 (shift in all par yields) it is 8.38.  

The fact is that a parallel shift in one set of rates is not always parallel in another set of rates. It will be the same when the yield curve is flat and all rates use the same compounding, or if we work with zero and forward rates in the same compounding basis. When we work with a sloped curve and par rates or yields (i.e. instruments with intermediate coupons) a parallel shift in one set of rates will not be parallel in another. This is easiest to see using a simple example with forward rates and. yields on par bonds. Say the 0-5 year [forward rate](../Clippings/Forward%20Points%20in%20Currency.md) is flat at. $10.00\%\mathrm{sab}$ or $9.7580\%\mathrm{cc}$ . If rates are not in the same basis then a 1bp change in the continuously-compounded forward transats into a 1.05bp change in the sab [par rate](../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%202/Pricing%20Interest%20Rate%20Swaps.md) (sice d =e e/ 2), not a 1bp change in the [par rate](../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%202/Pricing%20Interest%20Rate%20Swaps.md). When the [forward rate](../Clippings/Forward%20Points%20in%20Currency.md) is quoted semi-annual bond (rate of. $2\%$ ) then a 1bp sab change in. the forward does translate into a 1bp sab change in the par. But this will not carry out to longer maturities unless the curve is flat. If the 5- 10 year forward is $20\%$ sab (the 10 year par $13.2819\%\mathrm{sab}$ ) then a 1bp sab change in the [forwards](../Financial%20Markets/Financial%20Asset%20Pricing%20Theory%20Overview/Chapter%2012%20-%20Derivatives/Forwards%20and%20Futures.md) ( $10\%$ and $20\%$ to $10.01\%$ and $20.01\%$ translate into a 0.95bp change in the 10 year par yield (from $13.2819\%$ to $13.2914\%$ . In other words, a 1bp "parallel" shift in sab [forwards](../Financial%20Markets/Financial%20Asset%20Pricing%20Theory%20Overview/Chapter%2012%20-%20Derivatives/Forwards%20and%20Futures.md) translates into a non-parallel shift in sab pars:  
$$
...
The top panel shows that a "paralll shift"' of 1bp in all [forwards](../Financial%20Markets/Financial%20Asset%20Pricing%20Theory%20Overview/Chapter%2012%20-%20Derivatives/Forwards%20and%20Futures.md) (continuously-compounded) implies a greater-than-1bp shift in par yields, with larger shifts at the longer end. These data also show that, because a "parallel shift' in one set of rates is not parallel in another, unless we restrict ourselves to zeros and [forwards](../Financial%20Markets/Financial%20Asset%20Pricing%20Theory%20Overview/Chapter%2012%20-%20Derivatives/Forwards%20and%20Futures.md) in the same compounding basis, there is no simple way to transform the "total Dv01' from one set of rates to another - we must use the transformation of equation (11) 0r (14).  

# Choice of AppropriateAlternate Variables  

The transformation technique is quite powerful, but we have to careful in choosing the alternate instruments and rates used in the transformation. There are some obvious restrictions on choosing alternative instruments, restrictions required to ensure the transformation works mathematically. Even when these conditions are satisfied, however, choosing rates that do not match the original curve can give odd results. We have to remember that the transformation approach tells us what the risk would be if we re-built and bumped our original curve with our alternate instruments. If we choose instruments that are not appropriate to our original curve we will get what appear to be odd results for the risk. The transformation approach. does not involve building a new curve - it is only a transformation of the original partial [derivatives](../Financial%20Markets/Financial%20Trading%20and%20Markets/Chapter%209%20Arbitrage%20and%20Hedging%20With%20Options.md) w.r.t. the original variables.  
...
The transformation tells us what the risk of the original curve would be if we built the original curve with a 3 year swap, but it cannot tell us what the risk would be for a different curve - to do that we need to build a new curve. Our original curve was built using market instruments with maturities of 1, 2, 5, and 10 years. As a result, transforming using combinations of [forwards](../Financial%20Markets/Financial%20Asset%20Pricing%20Theory%20Overview/Chapter%2012%20-%20Derivatives/Forwards%20and%20Futures.md), pars, zeros will work fine as long as they have maturities of 1, 2, 5, and 10 years. But trying to transform with a 3 year rate causes problems because the original curve is not set up for a 3 year instrument.  
...
Rather than re-build a new curve and revalue the complete [portfolio](../Advanced%20Investments/An%20Asset%20Allocation%20Primer.md) using this new curve, there are some simplifying. transformations we can apply. The transformations (6) or (9) will not work because the Jacobian (9) will not be full rank - it will not be square since $j<k$  
...
The transformation matrix (16) cannot be obtained from the original curve. Instead we need to build a new curve, using a. reduced set of curve variables. We do not, however, need to revalue the whole [portfolio](../Advanced%20Investments/An%20Asset%20Allocation%20Primer.md) using this new curve. All we need is the matrix of [derivatives](../Financial%20Markets/Financial%20Trading%20and%20Markets/Chapter%209%20Arbitrage%20and%20Hedging%20With%20Options.md) in equation (16), relating the old and new curve variables. Generally, however, we cannot conveniently calculate (16) directly so we will use a set of "intermediate instruments" that we can value using both the old and new cur ve.  
...
The matrix DvDx is (the inverse of) the price Jacobian (14) for the "intermediate instruments' from the original curve and will be the risk of a small [portfolio](../Advanced%20Investments/An%20Asset%20Allocation%20Primer.md) of traded instruments.   
...
Table 18 - Compressed Dv01 w.r.t. [Par Swap](Fixed%20Income%20Derivatives/Determining%20the%20Expression%20for%20the%20Fair%20Value%20of%20the%20Swap%20Spread.md) Yields for Selected Instruments  
...
e can calculate the [derivatives](../Financial%20Markets/Financial%20Trading%20and%20Markets/Chapter%209%20Arbitrage%20and%20Hedging%20With%20Options.md) of instruments w.r.t. the curve parameters, just as we did in table 5 above. In this case the risk is w.r.t. continuously-compounded zero rates. The following table shows the risk w.r.t. the curve variables, on other words w.r.t. zero rates.  
...
Next, we can transform to risk w.r.t. [par swap](Fixed%20Income%20Derivatives/Determining%20the%20Expression%20for%20the%20Fair%20Value%20of%20the%20Swap%20Spread.md) yields by calculating the Jacobian and inverse Jacobians (equation 13). The following table shows the Jacobian, the [derivatives](../Financial%20Markets/Financial%20Trading%20and%20Markets/Chapter%209%20Arbitrage%20and%20Hedging%20With%20Options.md) of [par swap](Fixed%20Income%20Derivatives/Determining%20the%20Expression%20for%20the%20Fair%20Value%20of%20the%20Swap%20Spread.md) yields w.r.t. zero curve variables. This should be compared with table 11 which shows the Jacobian for the same [par swap](Fixed%20Income%20Derivatives/Determining%20the%20Expression%20for%20the%20Fair%20Value%20of%20the%20Swap%20Spread.md) yields but w.r.t. forward curve variables. Applying the transfor-. mation gives the data in the table below..  

Table 20 - Jacobian for [Par Swap](Fixed%20Income%20Derivatives/Determining%20the%20Expression%20for%20the%20Fair%20Value%20of%20the%20Swap%20Spread.md) Yields (Equation 9) for Transformation from Zero Curve Risk  

Table 21 - Dv01 w.r.t. [Par Swap](Fixed%20Income%20Derivatives/Determining%20the%20Expression%20for%20the%20Fair%20Value%20of%20the%20Swap%20Spread.md) Yields for Selected Instruments   
...
In the .cdf/ .nbp version the reader can choose the instruments for reporting the partial Dv01s in the table below and then the transformed risk (together with the Jacobian and inverse Jacobian) will be re-calculated and displayed. There is a "[portfolio](../Advanced%20Investments/An%20Asset%20Allocation%20Primer.md)" of twenty securities, including swaps, annuities, zeros bonds, and [forwards](../Financial%20Markets/Financial%20Asset%20Pricing%20Theory%20Overview/Chapter%2012%20-%20Derivatives/Forwards%20and%20Futures.md):  
...
The partial Dv01s for all the instruments, calculated from the piece-wise constant forward curve, is shown in the following :able. The Dv01s are [derivatives](../Financial%20Markets/Financial%20Trading%20and%20Markets/Chapter%209%20Arbitrage%20and%20Hedging%20With%20Options.md) w.r.t. continuously-compounded forward rates (the parameters of the curve above).  
...
Table A4 shows the Dvo1, [modified duration](.md), and [Macaulay duration](../Fixed%20Income%20Asset%20Pricing/Fixed%20Income%20Lecture%20Notes/Teaching%20Note%202-%20Interest%20Rate%20Risk%20Management%20And%20Factors.md) for a sub-set of the securities above. These are calculated based on each security's yield-to-maturity separately, rather than based on the yield curve presented above. Below the table is a figure illustrating the [Macaulay duration](../Fixed%20Income%20Asset%20Pricing/Fixed%20Income%20Lecture%20Notes/Teaching%20Note%202-%20Interest%20Rate%20Risk%20Management%20And%20Factors.md) for the first security in the table. The reader can use the menus to select which securities are displayed in the table.  
...
[Macaulay Duration](../Fixed%20Income%20Asset%20Pricing/Fixed%20Income%20Lecture%20Notes/Teaching%20Note%202-%20Interest%20Rate%20Risk%20Management%20And%20Factors.md) for first security in table above  

![](1f0dc4994f6c4a4602f97b72885010b369ada3b16f466779636c02cd4ff9c74f.jpg)  
DV01 is the dollar change for a $\$100$ notional instrument per 100bp change in yield. [Modified duration](.md) is the percent change per 100bp change in yield. [Macaulay duration](../Fixed%20Income%20Asset%20Pricing/Fixed%20Income%20Lecture%20Notes/Teaching%20Note%202-%20Interest%20Rate%20Risk%20Management%20And%20Factors.md) is the weighted average [time to maturity](../Financial%20Instruments/Lecture%20Notes-%20Financial%20Instruments/Teaching%20Note%201-%20Forward%20Rates%20Agreement/Hedging%20Strategies%20with%20Forwards.md), in years. [Duration](../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%205/Key%20Rates%20O1s%20Durations%20and%20Hedging.md) for forward swaps are not calculated (anc are reported as -100).  

# Transformed Partial Dv01s  

The table below is initialized to report risk w.r.t. 1, 2, 5, and 10 year [par swap](Fixed%20Income%20Derivatives/Determining%20the%20Expression%20for%20the%20Fair%20Value%20of%20the%20Swap%20Spread.md) yields. If you are reading the .cdf version you may choose alternate instruments from the four drop-down lists and the risk will re-calculate. You can choose sets of instruments that are not appropriate (for example using the 3 year swap instead of the 2 year swap) but the transformation will still be calculated. If you choose a set of instruments for which the Jacobian is singular, the risk will not display.  
...
Ho, Thomas S.Y. (1992), "[Key Rate Durations](.md): Measures of Interest Rate Risks," The Journal of [Fixed Income](../Fixed%20Income%20Asset%20Pricing/Lecture%20Notes%20Bonds,%20%20Preferred%20Stock,%20%20and%20Structured%20Products.md), September 1992 Vol. 2, No. 2, pp. 29-44   
Macaulay, Frederick (1938), Some Theoretical Problem s Suggested by the Movements of [Interest Rates](../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%202/Interest%20Rate%20Quotations.md), Bond Yields, and Stock Prices in the United States since 1856. New York: Columbia University Press.   
Reitano, Robert R., (2008), "Yield Curve [Risk Management](Financial%20Mathematics%20Course.md),' in Handbook of Finance, Frank J. Fabozzi, ed., vol. 3, p. 215 Hoboken, NJ: John Wiley and Sons..   
Reitano, Robert R., (1991), "Multivariate [Duration](../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%205/Key%20Rates%20O1s%20Durations%20and%20Hedging.md) Analysis," Transactions of the Society of Actuaries XLIlI: 335-391, availabl on-line at http:/ / www.soa.org/ library/ research/ transactions-of-society-ofactuaries/ 1990-95/ 1991/ january/ tsa91v4311.pdf   
This paper, (Coleman 2011, "A Guide to [Duration](../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%205/Key%20Rates%20O1s%20Durations%20and%20Hedging.md), Dv01, and Yield Curve Risk Transformations") is also available in .cdf/ .nbp format (Wolfram computable document format or notebook player) with dynamic interactivity enabled - see www.closemountain.com/publications.htm1  