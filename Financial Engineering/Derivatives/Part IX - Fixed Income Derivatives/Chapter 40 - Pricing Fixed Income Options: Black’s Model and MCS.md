...
$V_{T}=$ cash value (price) of the ‘underlying asset’ at $T$   $F_{0}=$ forward price at $t=0$ of the underlying asset, for delivery at $T$ $T=$ time to maturity of the option   $r=$ interest rate continuously compounded for maturity, $T$ $K=$ strike price   $\sigma=$ volatility of the forward price.  
