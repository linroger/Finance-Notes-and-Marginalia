...
Once a constant vega [portfolio](../../Advanced%20Investments/An%20Asset%20Allocation%20Primer.md) is found, the payoff of this [portfolio](../../Advanced%20Investments/An%20Asset%20Allocation%20Primer.md) can be expressed as an approximately linear function of $\sigma^{2}$  
$$
...
This operation has isolated the instantaneous percentage local volatility on the right-hand side. But, what we need for the [variance swap](../Variance%20Swaps.md) is the integral of this term. Integrating both sides we get  
$$
...
The integral, therefore, represents the trading gains or losses of a dynamically maintained [portfolio](../../Advanced%20Investments/An%20Asset%20Allocation%20Primer.md).12  
...
Pure volatility instruments, such as volatility swaps and variance swaps, make sense for [institutional investors](../../Financial%20Markets/Financial%20Trading%20and%20Markets/Chapter%204%20Institutional%20Trading.md), because volatility is both a diversifier on the downside and a global hedge on an equity [portfolio](../../Advanced%20Investments/An%20Asset%20Allocation%20Primer.md). [Institutional investors](../../Financial%20Markets/Financial%20Trading%20and%20Markets/Chapter%204%20Institutional%20Trading.md) such as pension funds and insurance companies clearly need to diversify. While they are moving to other asset classes, such as [hedge funds](../Basis%20Trade%20Explainer.md), they also do not want to reduce their exposure to [equity markets](../An%20Introduction%20to%20Equity%20Markets.md), particularly if there is a good chance of [equity markets](../An%20Introduction%20to%20Equity%20Markets.md) performing well. With this in mind, they are increasingly turning to long-term volatility strangles.  

The main external driver of the current ongoing rise in volatility is M & A activity.  

Requests for forward [volatility strategies](../Derivatives/Part%20IV%20-%20Options/Chapter%2017%20-%20Option%20Strategies.md) to hedge [structured products](../../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%201%20-%20Purpose%20and%20Structure%20of%20Financial%20Markets/Preview%20of%20the%20Book.md) are also on the rise, particularly among private banks. These strategies fit their needs, as dealers sold a lot of forward volatility certificates and warrants to them last year.  

(Thomson Reuters IFR, 2004)  

# 15.7.4 POST-GFC REGULATION, STANDARDIZATION AND EXCHANGE TRADED VOLATILITY PRODUCTS  

In addition to supply and demand the market for volatility is also influenced by regulation. OTC [derivatives](../../Financial%20Markets/Financial%20Trading%20and%20Markets/Chapter%209%20Arbitrage%20and%20Hedging%20With%20Options.md) regulation in Europe and the United States is pushing markets toward standardization and exchange trading.  

# 15.7.4.1 Variance futures  

The properties of the CBOE Volatility Index, or VIX, are now relatively well understood.13 The Vix has a negative correlation with the S&P500 and this correlation tends to increase in crisis times. Thus the VIX can be used as a hedge or a “tail risk” hedge against extreme negative events. Unfortunately, the VIX is just a mathematical formula and not an investable index. It is not tradable and cannot be purchased. Fortunately there are several ways to benefit from a rise in the VIX by using exchange traded instruments: VIX [futures](../../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md), variance [futures](../../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md), VIX options, S&P options and volatility-related exchange traded funds (ETFs) and exchange traded notes (ETNs). There is also a myriad of over-the-counter products linked to the VIX.  

On December 10, 2012, the CBOE listed the S&P 500 Variance [futures](../../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md).  

The contract is not a [variance swap](../Variance%20Swaps.md) since it depends on the realized variance of the S&P500, but it does allow investors to speculate on the realized S&P500 volatility. Figure 15.11 shows the open interest and volume of the S&P500 variance [futures](../../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md) from 2012 until 2013.  

Below is a term sheet for the S&P500 Variance [Futures](../../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md)  

<html><body><table><tr><td>Description:</td><td>S&P 5Oo Variance [futures](../../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md) are exchange-traded [futures contracts](../Mathematics%20of%20the%20Financial%20Markets.md) based on the realized variance of the S&P 500 Composite [Stock Price](../Derivatives/Part%20IV%20-%20Options/Chapter%2016%20-%20Black–Scholes%20Model.md) Index (S&P 5O0). The final settlement value for the contract will be determined based on a standardized formula for calculating the realized variance of the S&P 5O0 measured from the time of initial listing until</td></tr><tr><td>Contract size:</td><td>expiration of the contract. The standard formula inputs for [discount factor](../../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%201/Discount%20Factors.md) and daily interest rate are determined by the Exchange. The contract multiplier for the S&P 50o Variance [futures](../../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md) contract is $1 per variance unit. One contract equals one variance unit.</td></tr><tr><td>Trading hours:</td><td>8:30 a.m.-3:15 p.m. (Chicago time). All Orders, quotes, cancellations and Order modifications for S&P 5o Variance [futures](../../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md) </td></tr><tr><td></td><td>during trading hours must be received by the Exchange by no later than 3:14:59 p.m. Chicago time and will be automatically rejected if received by the Exchange during trading hours after 3:14:59 p.m. Chicago time.</td></tr><tr><td>Contract months:</td><td>The Exchange may list contract months on S&P 50o Variance [futures](../../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md) that correspond to the listed contract months for S&P 500 Index options listed on Chicago Board Options Exchange, Incorporated (CBOE).</td></tr></table></body></html>  

![](aba7185781c2033b2c254edad751987b472021183fc07ef82a66cbeb03ce5a97.jpg)  
S&P500 VARIANCE [FUTURES](../../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md)   
Source: CBOE  

# FIGURE 15.11  

Open interest and volume of the S&P500 variance [futures](../../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md).  

In addition to the S&P500 VIX and Variance [futures](../../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md), the CBOE offers [futures](../../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md) on several other US equity indices such as  

VSW CBOE Short-Term Volatility Index [Futures](../../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md) (VSW) VX CBOE S&P 500 Volatility Index (VIX) [Futures](../../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md)  

# 538 CHAPTER 15 TOOLS FOR VOLATILITY ENGINEERING, VOLATILITY SWAPS  

VU CBOE Russell 2000 Volatility Index (RVX) [Futures](../../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md)   
VN CBOE Nasdaq-100 Volatility Index (VXN) [Futures](../../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md) emerging markets indices,   
VXEM CBOE Emerging Markets ETF Volatility Index (VXEEM) Security [Futures](../../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md) VXEW CBOE Brazil ETF Volatility Index (VXEWZ) Security [Futures](../../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md) and [commodities](../../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md)   
CBOE Gold ETF Volatility Index (GVZ) Security [Futures](../../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md)   
CBOE Crude Oil ETF Volatility Index (OVX) Security [Futures](../../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md).  

This shows the widespread acceptance of volatility as an asset class. It also highlights the fact that market participants are become more discerning regarding different types of [volatility exposure](../../Financial%20Instruments/Financial%20Derivatives%20and%20Quantitative%20Methods/JP%20Morgan-Variance%20Swaps.md) depending on country and asset class.  
...
“Plans to move over-the-counter variance swaps on to exchanges are in full swing in Europe as the Eurex [derivatives](../../Financial%20Markets/Financial%20Trading%20and%20Markets/Chapter%209%20Arbitrage%20and%20Hedging%20With%20Options.md) exchange prepares to list [futures](../../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md)-style contracts tracking EuroStoxx 50 variance in mid-2014.  

The exchange is not the first to attempt a listed alternative that produces the same pay-off as the widely traded OTC product. The CBOE launched S&P 500 variance [futures](../../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md) a year ago (see “Replicating variance”), but the contract has struggled to gain traction. Since the launch last October, open interest has built up to about 32,000 contracts and volume remains lumpy with relatively few days of active trading.  

Despite the inauspicious start for the US version, some traders remain optimistic there could be support for a listed version in Europe, where many asset managers looking to trade volatility do not have OTC approval, while the VStoxx [futures](../../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md) have just a fraction of the [liquidity](../../Financial%20Markets%20and%20Institutions/III.%20Liquidity%20of%20Assets/Class%205-%20Private%20Information,%20Liquidity,%20and%20Securitization/Class%20Note%2010%20Liquidity%20and%20Class%20Note%2010%20Liquidity%20and%20Liquidity%20Managementliquidity%20management.md) seen in VIX contracts.  

“The demand is there,” said Rory Hill, EMEA co-head of equity [derivatives](../../Financial%20Markets/Financial%20Trading%20and%20Markets/Chapter%209%20Arbitrage%20and%20Hedging%20With%20Options.md) at Citigroup. “After the crisis, closing down and novating OTC risk became an issue. Now, anything that’s OTC, institutions and funds want to try to get listed. Client flows are now pushing volumes on to exchanges and even banks themselves don’t want OTC exposure any more.”  

Sluggish demand for the CBOE product has been attributed to a variety of factors—not least the ample [liquidity](../../Financial%20Markets%20and%20Institutions/III.%20Liquidity%20of%20Assets/Class%205-%20Private%20Information,%20Liquidity,%20and%20Securitization/Class%20Note%2010%20Liquidity%20and%20Class%20Note%2010%20Liquidity%20and%20Liquidity%20Managementliquidity%20management.md) available in the US OTC variance swaps, where 10-year contracts can trade tighter than six-month maturities in Europe.  
...
already fulfilled,” said Mark Chen, head of equity [derivatives](../../Financial%20Markets/Financial%20Trading%20and%20Markets/Chapter%209%20Arbitrage%20and%20Hedging%20With%20Options.md) index trading at Citigroup in New York. [. . .]  

A number of dealers and [hedge funds](../Basis%20Trade%20Explainer.md) have already expressed interest in supporting the new product, subject to the right fee structure and incentives. But the real driver is likely to come from regulatory pressure as swaps are pushed into central clearing on a product-by-product basis.  
...
[Variance swap](../Variance%20Swaps.md) activity stalled to a near standstill in the wake of the crisis—Citi’s Hill estimates that volume plummeted to around $20\%$ of its 2006 07 peak, but has since returned to as much as $50\%$ , though that is concentrated in index trades. “There’s still some single-stock vol swap exposure but single-stock variance swaps died a death. Most of the [variance swap](../Variance%20Swaps.md) flow is concentrated”  

(Thomson Reuters IFR 2011, November 23, 2013)  

Regulation restricts the ability of certain investors to buy OTC products. The costs of [hedging](../../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%205/Key%20Rates%20O1s%20Durations%20and%20Hedging.md) and funding complex products has also increased in banks, thus explaining the increased attraction of exchange traded assets.  

# 15.7.5 THE HEDGE  

In Section 15.5, we discussed the potential uses and users of variance swaps. But who were the counterparties in variance swaps in the run up to the GFC? It turns out that variance swaps were not just attractive to investors but also for dealers in [investment](../../Advanced%20Investments/An%20Asset%20Allocation%20Primer.md) banks with large [structured products](../../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%201%20-%20Purpose%20and%20Structure%20of%20Financial%20Markets/Preview%20of%20the%20Book.md) businesses.  

# EXAMPLE  

Variance swaps became a very critical part of the risk recycling process for dealers that were running [structured products](../../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%201%20-%20Purpose%20and%20Structure%20of%20Financial%20Markets/Preview%20of%20the%20Book.md) books and had a short correlation exposure to offset. That was a big driver of the growth of the market in the early part of the last decade.  

([Structured Products](../../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%201%20-%20Purpose%20and%20Structure%20of%20Financial%20Markets/Preview%20of%20the%20Book.md), April 1, 2010, www.risk.net/1595196)  

The above example refers to dealers in large [investment](../../Advanced%20Investments/An%20Asset%20Allocation%20Primer.md) banks who had sold [structured products](../../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%201%20-%20Purpose%20and%20Structure%20of%20Financial%20Markets/Preview%20of%20the%20Book.md) to their clients. Equity [structured products](../../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%201%20-%20Purpose%20and%20Structure%20of%20Financial%20Markets/Preview%20of%20the%20Book.md), for example, often involved a [downside protection](../Fixed%20Income%20Derivatives/Equity%20Linked%20Note.md) to the client. The product would thus pay when markets fell. When markets fall, correlations tend to rise sharply. This would leave the seller of such products short correlation. Thus one way of [hedging](../../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%205/Key%20Rates%20O1s%20Durations%20and%20Hedging.md) such structured product exposure was to go long correlation by means of variance swaps. This is akin to buying protection on unexpected increases in correlations. Who would sell such protection? Before the [financial crisis](../../Financial%20Markets%20and%20Institutions/III.%20Liquidity%20of%20Assets/Class%209-%20Bailouts%20and%20Bank%20Failures/Squam%20Lake%20Group%20Letter.md) many [hedge funds](../Basis%20Trade%20Explainer.md) went short correlation. Thus, a hedge fund would go short a [variance swap](../Variance%20Swaps.md) on an index and go long a [variance swap](../Variance%20Swaps.md) on the constituent stock. This created a short position for the hedge fund and a [long position](../Derivatives/Part%20I%20-%20Forwards%20and%20Futures/Chapter%204%20-%20Futures:%20Hedging%20and%20Speculation.md) for the dealer. We discuss correlation trading and correlation swaps in more detail in the next chapter.  
...
When market professionals use the term “volatility,” chances are they refer to Black Schole’s [implied volatility](../../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%205%20Options%20on%20Prices%20and%20Hedge-Based%20Valuation/A%20Real-Life%20Option%20Pricing%20Exercise.md). Otherwise, they will use terms such as realized or historical volatility. Local volatility and [variance swap](../Variance%20Swaps.md) volatility are also part of the jargon. Finally, cap-floor volatility and [swaption volatility](../../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%2016/Swaption%20Skew.md) are standard terms in [financial markets](../../Financial%20Markets%20and%20Institutions/Financial%20Markets%20and%20Institutions%20Lecture%20Notes.md).  

As explained in Chapter 9, [implied volatility](../../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%205%20Options%20on%20Prices%20and%20Hedge-Based%20Valuation/A%20Real-Life%20Option%20Pricing%20Exercise.md) is simply the value of $\sigma$ that one would plug into the [Black Scholes formula](../../Financial%20Instruments/Lecture%20Notes-%20Financial%20Instruments/Lecture%20Note%205-%20Black%20Scholes%20Formula.md) to obtain the fair market value of a plain vanilla option as observed in the markets. For this reason, it is more correct to call it [Black Scholes](../../Credit%20Markets/Black-Scholes%20Model.md) implied vol or Black volatility in the case of interest rate [derivatives](../../Financial%20Markets/Financial%20Trading%20and%20Markets/Chapter%209%20Arbitrage%20and%20Hedging%20With%20Options.md). It is quite conceivable for a professional to use a different formula to price options, and the volatility implied by this formula would naturally be different. The term [implied volatility](../../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%205%20Options%20on%20Prices%20and%20Hedge-Based%20Valuation/A%20Real-Life%20Option%20Pricing%20Exercise.md) is, thus, a formula-dependent variable.  

We can attach the following definitions to the term “volatility.”  

First, there is the class of realized volatilities. This is closest to what is contained in statistics courses. In this case, there is an observed or to-be-observed data set, a “sample,” $\{x_{1},...x_{n}\}$ , which can be regarded as a realization of a possibly vector-[stochastic process](../../The%20Ornstein-Uhlenbeck%20(OU)%20Process.md), $x_{t},$ defined under some real-world probability $P$ . The process $x_{t}$ has a second moment  
$$
...
Such volatilities measure the actual real-world fluctuations in asset prices or [risk factors](../../Financial%20Instruments/Assignments/PSET%206-%20Financial%20Instruments.md). One example of the use of this volatility concept was shown in this chapter. The $\sigma_{t}^{2}$ defined earlier represented the [floating leg](../../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%202/Pricing%20Interest%20Rate%20Swaps.md) of the [variance swap](../Variance%20Swaps.md) discussed here.  

The next class is [implied volatility](../../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%205%20Options%20on%20Prices%20and%20Hedge-Based%20Valuation/A%20Real-Life%20Option%20Pricing%20Exercise.md).14 There is an observed market price. The market practitioner has a [pricing](../../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%207/Arbitrage%20Pricing%20of%20Derivatives.md) formula (e.g., [Black Scholes](../../Credit%20Markets/Black-Scholes%20Model.md)) or procedure (e.g., implied trees) for this price. Then, [implied volatility](../../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%205%20Options%20on%20Prices%20and%20Hedge-Based%20Valuation/A%20Real-Life%20Option%20Pricing%20Exercise.md) is that “volatility” number, or series of numbers, which must be plugged into the formula in order to recover the fair market price. Thus, let $F(S_{t},t,r,\sigma_{t},T)$ be the [Black Scholes price](../../Financial%20Instruments/Assignments/PSET%205%20Financial%20Instruments.md) for a European option written on the underlying $S_{t},$ with [interest rates](../../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%202/Interest%20Rate%20Quotations.md) $r$ and expiration $T.$ . At time $t$ , $\sigma_{t}$ represents the [implied volatility](../../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%205%20Options%20on%20Prices%20and%20Hedge-Based%20Valuation/A%20Real-Life%20Option%20Pricing%20Exercise.md) if we solve the following equation (nonlinearly) for $\sigma_{t}$ :  
$$
F(S_{t},t,r,\sigma_{t},T)=\mathrm{observedprice}
$$  

This [implied volatility](../../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%205%20Options%20on%20Prices%20and%20Hedge-Based%20Valuation/A%20Real-Life%20Option%20Pricing%20Exercise.md) may differ from the realized volatility significantly, since it incorporates any adjustments that the trader feels he or she should make to expected realized volatility. [Implied volatility](../../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%205%20Options%20on%20Prices%20and%20Hedge-Based%20Valuation/A%20Real-Life%20Option%20Pricing%20Exercise.md) may be systematically different than realized volatility if volatility is stochastic and if a risk premium needs to be added to volatility quotes. Violations of [Black Scholes](../../Credit%20Markets/Black-Scholes%20Model.md) assumptions may also cause such a divergence.  

Local volatility is used to represent the function $\sigma(.)$ in a [stochastic differential equation](../Fixed%20Income%20Derivatives/Implementing%20Heath,%20Jarrow%20&%20Merton%20(HJM)%20Model.md):  
$$
\mathrm{d}S(t)=\mu(S,t)\mathrm{d}t+\sigma(S,t)S_{t}\mathrm{d}W_{t}\quad t\in[0,\infty)
$$  

However, local volatility has a more specific meaning. Suppose options on $S_{t}$ trade in all strikes, $K$ , and expirations $T_{\mathbf{\delta}}$ , and that the associated [arbitrage](../../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%207/Arbitrage%20Pricing%20of%20Derivatives.md)-free prices, $\{C(S_{t},t,K,T)\}$ , are observed for all $K,T.$ . Then the function $\sigma(S_{t},t)$ is the local volatility, if the corresponding SDE successfully replicates all these observed prices either through a [Monte Carlo](../../Financial%20Instruments/Lecture%20Notes-%20Financial%20Instruments/Teaching%20Note%207-Exotic%20Options%20And%20Derivative%20Pricing%20By%20Monte%20Carlo%20Simulation.md) or PDE [pricing](../../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%207/Arbitrage%20Pricing%20of%20Derivatives.md) method.  

In other words, local volatility is a concept associated with [calibration](../../Credit%20Markets/Credit%20Markets%20Session%204.md) [exercises](../../Financial%20Markets/Financial%20Asset%20Pricing%20Theory%20Overview/Chapter%2012%20-%20Derivatives/Exercises.md). It can be regarded as a generalization of [Black Scholes](../../Credit%20Markets/Black-Scholes%20Model.md) [implied volatility](../../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%205%20Options%20on%20Prices%20and%20Hedge-Based%20Valuation/A%20Real-Life%20Option%20Pricing%20Exercise.md). The [implied volatility](../../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%205%20Options%20on%20Prices%20and%20Hedge-Based%20Valuation/A%20Real-Life%20Option%20Pricing%20Exercise.md) replicates a single observed price through the [Black Scholes formula](../../Financial%20Instruments/Lecture%20Notes-%20Financial%20Instruments/Lecture%20Note%205-%20Black%20Scholes%20Formula.md). The local volatility, on the other hand, replicates an entire surface of options indexed by $K$ and $T$ , through a [pricing](../../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%207/Arbitrage%20Pricing%20of%20Derivatives.md) method. As a result, we get a [volatility surface](../7.%20Black%20Scholes%20Model.md) indexed by $K$ and $T$ , instead of a single number as in the case of [Black Scholes](../../Credit%20Markets/Black-Scholes%20Model.md) [implied volatility](../../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%205%20Options%20on%20Prices%20and%20Hedge-Based%20Valuation/A%20Real-Life%20Option%20Pricing%20Exercise.md). Finally, in this chapter we encountered the [variance swap](../Variance%20Swaps.md) volatility. This referred to the expectation of the average future squared deviations. But, because the expectation used the [risk-neutral measure](../Verifying%20Martingale%20Property%20with%20Q.md), it is different from real-world volatility.  

Discussions of the volatility smile relate to these volatility notions. The [implied volatility](../../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%205%20Options%20on%20Prices%20and%20Hedge-Based%20Valuation/A%20Real-Life%20Option%20Pricing%20Exercise.md) is obviously of interest to most traders but it cannot exist independently of realized volatility. It is natural to expect a close relationship between the two concepts.15 Also, as volatility trading develops, more and more instruments are written that use the realized volatility as some kind of underlying risk factor for creating new products. The [variance swap](../Variance%20Swaps.md) was only one example.  

# 15.9 CONCLUSIONS  

This chapter provided a brief [introduction](../../Financial%20Markets%20and%20Institutions/III.%20Liquidity%20of%20Assets/Class%209-%20Bailouts%20and%20Bank%20Failures/Squam%20Lake%20Group%20Introduction.md) to a sector that may, in the future, play an even more significant role in financial market strategies. Our purpose was to show how we can isolate the volatility of a risk factor from other related risks, and then construct instruments that can be used to trade it. An important point should be emphasized here. The introductory discussion contained in this chapter deals with the case where the volatility parameter is a function of time and the underlying price only. These methods have to be modified for more complex volatility specifications.  

# SUGGESTED READING  

Rebonato (2000) and (2002) are good places to start getting acquainted with the various notions of volatility. Bossu et al. (2005) provide a good [introduction](../../Financial%20Markets%20and%20Institutions/III.%20Liquidity%20of%20Assets/Class%209-%20Bailouts%20and%20Bank%20Failures/Squam%20Lake%20Group%20Introduction.md) to variance swaps. Some of the material in this chapter comes directly from Demeterfi et al. (1999), where the reader will find proper references to the literature as well. The important paper by Dupire (1992) and the literature it generated can be consulted for local volatility.  
...
a. How would you price this position? What does [pricing](../../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%207/Arbitrage%20Pricing%20of%20Derivatives.md) mean in this context anyway Which price are we trying to determine and write in the contract?   
...
Two-year [implied volatility](../../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%205%20Options%20on%20Prices%20and%20Hedge-Based%20Valuation/A%20Real-Life%20Option%20Pricing%20Exercise.md) on the Nasdaq 100 was last week near all-time highs, at around $45.7\%$ , but the tumult in tech stocks over the last several years is largely played out, said [a] global head of equity [derivatives](../../Financial%20Markets/Financial%20Trading%20and%20Markets/Chapter%209%20Arbitrage%20and%20Hedging%20With%20Options.md) strategy in New York. The tech stock boom appears to be over, as does the most eye-popping part of the downturn, he added. While there will be selling pressure on tech companies over the next several quarters, a dramatic sell-off similar to what the market has seen over the last six months is unlikely.  

The bank recommends entering a [volatility swap](../Variance%20Swaps.md) on the differential between the Nasdaq and the S&P, where the investor receives a payout if the realized volatility in two years is less than about $21\%$ , the approximate differential last week between the at-the-money forward two-year implied volatilities on the indices. The investor profits here if, in two years, the realized two-year volatility for the Nasdaq has fallen relative to the equivalent volatility on the S&P.  
...
[The trader] noted that there are other means of putting on this trade, such as selling two-year at-the-money forward straddles on Nasdaq volatility and buying two-year at-themoney forward straddles on S&P vol. ([Derivatives](../../Financial%20Markets/Financial%20Trading%20and%20Markets/Chapter%209%20Arbitrage%20and%20Hedging%20With%20Options.md) Week (now part of GlobalCapital), October 30, 2000)  
