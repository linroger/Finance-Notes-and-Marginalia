...
Let us place ourselves in a Black Scholes-type environment, with constant interest rates $r$ and constant volatility $\sigma$ . Further, the $S_{t}$ follows the Wiener process%20Process.md)-driven SDE,  
$$
...
This is a geometric stochastic differential equation%20Model.md) whose solution is given by  
$$
