...
First, if at constant inflation/War%20Economies%20and%20Hyperinflation.md) and hence at constant long rates, the short end interest rates decline. A loosening of monetary policy by the Central Bank due to moderately weakening real economy may be one example. Second, short rates and Central Bank monetary policy may stay the same, but due either to inflationary pressures or strengthening economic activity the long rates may go up. These two cases represent two possible views and the spread note will provide one way to take an exposure toward such an event.  
