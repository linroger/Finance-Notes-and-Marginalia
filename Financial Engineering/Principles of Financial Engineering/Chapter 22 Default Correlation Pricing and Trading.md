...
be a sequence of latent variables. Their role is to generate statistically dependent zero-one variables.3 There is no model of a random variable that can generate dependent zero-one random variables with a closed-form density or [distribution function](../Verification%20of%20Central%20Limit%20Theorem.md). $\{\boldsymbol{S}^{j}\}$ are used in a [Monte Carlo](../../Financial%20Instruments/Lecture%20Notes-%20Financial%20Instruments/Teaching%20Note%207-Exotic%20Options%20And%20Derivative%20Pricing%20By%20Monte%20Carlo%20Simulation.md) approach to do this.  
...
As a matter of fact, the joint probability of default is more than 10 times greater than the simple-minded (and in this case, wrong) calculation by simple multiplication of individual [default probabilities](../../Credit%20Markets/Credit%20Markets%20Session%203.md).  
...
1. Explain the difference between a [cash CDO](../../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20II%20CASH%20FLOW%20ENGINEERING/Chapter%2010%20-%20Collateralized%20Debt%20Obligations%20and%20Basket%20Credit%20Derivatives/Collateralized%20Debt%20Obligations%20and%20Basket%20Cred.md) and a [synthetic CDO](../../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20II%20CASH%20FLOW%20ENGINEERING/Chapter%2010%20-%20Collateralized%20Debt%20Obligations%20and%20Basket%20Credit%20Derivatives/Collateralized%20Debt%20Obligations%20and%20Basket%20Cred.md)?   
2. What is the difference between compound correlation and base correlation?   
3. We consider a reference [portfolio](../../Advanced%20Investments/An%20Asset%20Allocation%20Primer.md) of three [investment](../../Advanced%20Investments/An%20Asset%20Allocation%20Primer.md) grade names with the following 1-year CDS rates: $c(1)=116$ $c(2)=193$ $c(3)=140$ The [recovery rate](../../Credit%20Markets/Credit%20Markets%20Session%203.md) is the same for all names at $R=40$ . The notional amount invested in every CDO tranche is $\$1.50$ . Consider the questions: a. What are the corresponding default probabilities? b. How would you use this information in predicting actual defaults? c. Suppose the defaults are uncorrelated. What is the distribution of the number of defaults during 1 year? d. How much would a $0\mathrm{-}66\%$ tranche lose under these conditions? e. Suppose there are two tranches: $0\mathrm{-}50\%$ and $50{\mathrm{-}}100\%$ . How much would each tranche pay over a year if you sell protection? f. Suppose all CDS rates are now equal and that we have $c(1)=c(2)=c(3)=100$ . Also, all defaults are correlated with a correlation of one. What is the loss distribution? What is the spread of the $0\mathrm{-}50\%$ tranche?  

4. We consider a reference [portfolio](../../Advanced%20Investments/An%20Asset%20Allocation%20Primer.md) of four [investment](../../Advanced%20Investments/An%20Asset%20Allocation%20Primer.md) grade names with the following 1-year CDS rates:  
$\begin{array}{l}{c(1)=14}\\ {c(2)=7}\\ {\operatorname{c}(3)=895}\\ {c(4)=33}\end{array}$   
The [recovery rate](../../Credit%20Markets/Credit%20Markets%20Session%203.md) is the same for all names at $R=30\%$ .   
The notional amount invested in every CDO tranche is $\$1.00$ . Consider the questions:  

a. What are the corresponding annual [default probabilities](../../Credit%20Markets/Credit%20Markets%20Session%203.md)?  
...
d. Suppose the [default correlation](../../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20II%20CASH%20FLOW%20ENGINEERING/Chapter%2010%20-%20Collateralized%20Debt%20Obligations%20and%20Basket%20Credit%20Derivatives/Copulas%20and%20the%20Modeling%20of%20Default%20Correlatio.md) becomes 1, and all CDS rates are equal at $60~\mathrm{bp}$ , answer questions (a)(c) again. e. How do you hedge the risk that the probability of default will go up in the equity tranche?  

5. We consider a reference [portfolio](../../Advanced%20Investments/An%20Asset%20Allocation%20Primer.md) of three [investment](../../Advanced%20Investments/An%20Asset%20Allocation%20Primer.md) grade names with the following 1-year CDS rates: $c(1)=15$ $c(2)=11$ $c(3)=330$ The [recovery rate](../../Credit%20Markets/Credit%20Markets%20Session%203.md) is the same for all names at $R=40$ . The notional amount invested in every CDO tranche is $\$1.50$ . Consider the questions: a. What are the corresponding default probabilities? b. How would you use this information in predicting actual defaults? c. Suppose the defaults are uncorrelated. What is the distribution of the number of defaults during 1 year? d. How much would a $0\mathrm{-}66\%$ tranche lose under these conditions? e. Suppose there are two tranches: $0\mathrm{-}50\%$ and $50-100\%$ . How much would each tranche pay over a year if you sell protection? f. Suppose all CDS rates are now equal and that we have $c(1)=c(2)=c(3)=100$ . Also, all defaults are correlated with a correlation of one. What is the loss distribution? What is th spread of the $0\mathrm{-}50\%$ tranche?  

6. Explain the following position using appropriate graphs. In particular, make sure that you define a barbell in credit sector. Finally, in what sense is this a [convexity](../../Fixed%20Income%20Asset%20Pricing/Problem%20Sets/PSET%20II%20Fixed%20Income%20Asset%20Pricing%201.md) position?  
...
8. (Default Loss Distribution) Building on the tranche valuation model outlined in the text, write a MATLAB program to model the sensitivity of the default loss distribution of a [portfolio](../../Advanced%20Investments/An%20Asset%20Allocation%20Primer.md) consisting of 100 names/underlyings to changes in [default correlation](../../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20II%20CASH%20FLOW%20ENGINEERING/Chapter%2010%20-%20Collateralized%20Debt%20Obligations%20and%20Basket%20Credit%20Derivatives/Copulas%20and%20the%20Modeling%20of%20Default%20Correlatio.md) (ρ). Assume that the default probability (p) of each of the [portfolio](../../Advanced%20Investments/An%20Asset%20Allocation%20Primer.md) constituents is the same and equal to $5\%$ . Take 100 numbers of latent variables to carry out the simulations and interpret the results.   
9. (Correlation swaps and equity option implied correlation) In this chapter, we drew an analogy between tranche implied default correlations and implied volatilities and implied correlations in equity option markets. Equity correlation trading was discussed in Chapter 16. One approach to trading correlations is by means of a correlation swap. a. Explain how a synthetic equity correlation swap on the S&P500 or S&P100, for example, can be created. What are the similarities and differences between trading [default correlation](../../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20II%20CASH%20FLOW%20ENGINEERING/Chapter%2010%20-%20Collateralized%20Debt%20Obligations%20and%20Basket%20Credit%20Derivatives/Copulas%20and%20the%20Modeling%20of%20Default%20Correlatio.md) and equity option implied correlation? b. Download stock return and option data and calculate the implied and realized correlation for the index over the 2004 2013 period. c. Comment on the evolution of the so-called correlation risk premium, that is the difference between the implied and realized correlation. d. Are correlation swaps an attractive [investment](../../Advanced%20Investments/An%20Asset%20Allocation%20Primer.md)? What are the caveats?  