...
Agencies buy mortgages in at least two ways. First, they pay “cash” for mortgages and hold them on their books.1 Second, they issue mortgage-backed securities.md) (MBSs) in exchange for pools of mortgages that they receive from lenders. The lenders can in turn either hold these MBSs on their books, or sell them to investors. To the extent that mortgages are converted into MBSs, the purchased mortgage loans are securitized.2 Agencies guarantee the payment of the principal and interest. Hence, the “credit risk” is borne by the issuing institution.3 We now discuss the engineering of a mortgage deal and the resulting positions. As usual, we use a highly simplified setting.  
...
$$
\mathrm{d}F(t,t_{1})=\sigma F(t,t_{1})\mathrm{d}W_{t}\quad t\in0,\infty)
$$  
