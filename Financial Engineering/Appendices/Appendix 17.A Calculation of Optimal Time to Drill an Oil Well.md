...
We choose $S_*$ to maximize this expression, taking $S^*$ as determined by equation (17.15). Finally, prior to the original investment decision, which occurs $\$a_t$$ $\bar{S} > S$, the value of the well is:
...
While operating, prior to the shutdown $\$a_t$$ $S > S_*$, we have:
