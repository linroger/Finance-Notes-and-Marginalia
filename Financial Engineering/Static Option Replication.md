...
In this section we will present some mathematical concepts regard-. ing the static replication of options. We assume that there is a single source of uncertainty driving the stock price process represented by. the Wiener process%20Process.md) $Z(t)$ in terms of which the stock evolution is. given by  
$$
