...
- Ability to issue "common stock" $\$a_t$$ will ("printing press" in local currency)
...
- Defaulted bonds trade $\$a_t$$ distressed levels, based on likelihood of recovering the funds sometime in the future
...
## Investing $\$a_t$$ Risk-Free Reference Rates (FedFunds, SOFR, LIBOR)
!500

## Risky Bond Cash-Flows Indexed to Reference Rate
!500

### Floating Rate Bond Financed $\$a_t$$ Reference Index Rate
!500
