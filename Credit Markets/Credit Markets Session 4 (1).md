...
<<<<<<< HEAD
Observation: ~380 US cash treasury instruments (bills, notes and bonds) actively traded in the market, quoted $\$a_t$$ different prices/yields, based on coupon, maturity and liquidity profile (~380 dimensional problem)

Question: can we compute model prices for all US Treasuries using one sparse parametric model (dimensionality reduction)?
=======
Observation: ~380 US cash treasury instruments (bills, notes and bonds) actively traded in the market, quoted $\$a_t$$ different prices/yields, based on coupon, maturity and Class Note 10 Liquidity and Class Note 10 Liquidity and Liquidity Managementliquidity management | liquidity]] profile (~380 dimensional problem)
...
- ... quoted $\$a_t$$ different prices/yields/spreads, based on coupon, maturity and liquidity profile
...
- ... quoted $\$a_t$$ different prices/yields/spreads, based on coupon, maturity and Class Note 10 Liquidity and Class Note 10 Liquidity and Liquidity Managementliquidity management | liquidity]] profile
...
- For a given issuer and seniority rank, collect market prices for all bonds and CDS $\$a_t$$ time $t$.
...
- Can we think of the calibrated model prices as "fair prices" for the given instruments, $\$a_t$$ least on a relative basis?
=======
...
- Differences between model and market prices are called "model edges"
- "Model edges" can be converted from price into yield or spread space, by using DV01/sensitivities
- Can we think of the calibrated Credit Markets Session 4 | model prices]] as "fair prices" for the given instruments, $\$a_t$$ least on a relative basis?
>>>>>>> d83d5c06204d625fbecfdb77e4d3f37c9c80e27b
...
- Intuitive way to visualize the dynamics of curve shapes through time
	...
	- issued $\$a_t$$ "par price": bond coupon = bond yield
...
>>>>>>> d83d5c06204d625fbecfdb77e4d3f37c9c80e27b
- Little human interaction "$\$a_t$$ run-time"
### Methods
...
- Joint securities dynamics decomposed into
	...
	- Idiosyncratic risks
<<<<<<< HEAD
- Portfolio factor risks aggregated $\$a_t$$ portfolio level via "betas"/factor loadings
...
=======
- An Asset Allocation Primer | Portfolio]] factor risks aggregated $\$a_t$$ An Asset Allocation Primer | portfolio]] level via "betas"/factor loadings
