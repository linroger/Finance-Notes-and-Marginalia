...
More often than not, short-term volatilities are higher than long-term volatilities - this is true in bond, caps, or swaption volatilities that are often in equities and currencies. There are many potential explanations, such as mean reversion%20Process.md), with the trade being on the relative point on the volatility curve. Implied volatilities tend to be higher than subsequently realized volatilities. This could be. an artifact of the demand for the liquidity or convenience of risk insurance, rather than self-insurance. The trade is to go long volatility and to delta hedge the exposure.  
