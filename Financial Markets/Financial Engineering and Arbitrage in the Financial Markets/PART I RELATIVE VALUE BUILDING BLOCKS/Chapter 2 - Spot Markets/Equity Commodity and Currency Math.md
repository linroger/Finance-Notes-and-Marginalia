...
Stocks, like bonds, are financial assets offering a promise of [[Advanced Derivatives Pricing Methodology|future cash flows]]: dividends and capital gains. These cash flows are, however, much less certain. While coupon interest must be paid at the scheduled dates, cash dividends are only paid if declared by the company. Also, bond price fluctuations are constrained by the magnitude of [[How Countries Go Broke-Chapter 12 to Chapter 14|interest rate changes]] and their. impact on discounting; capital gains and losses on stocks can be very large, as both the cash flows (the numerator) and the [[PSET 7- Kohler|discount rate]] (the denominator) affect the present value of the future, very uncertain, cash flows. Stock valuation is not an exact science and depends critically on the easy-to-disagree-on assumption of the rate of change (growth) in [[Advanced Derivatives Pricing Methodology|future cash flows]]. While we review the details of dividend and [[Free Cash Flow Valuation of Companies|free cash flow]] discounting in a later chapter, we offer the basics here.  

[[Futures Not Subject to Cash-And-Carry|Commodities]] are physical assets of uniform enough quality to trade in bulk. They are. purchased not for the benefit of [[Advanced Derivatives Pricing Methodology|future cash flows]], but for use in production, or for a promise of price appreciation. The major groups of [[Futures Not Subject to Cash-And-Carry|commodities]] are agricultural, metals, energy and financials. Each commodity's quality is defined very strictly in physical terms -- size and quality. or chemical composition -- to ensure near perfect substitutability. West Texas Intermediate oil is a commodity; Brent crude is a separate commodity as it is not as light or as sweet as WTI.. The price of a commodity is typically defined in [[Forwards and Futures Notes|currency]] per appropriate physical quantity:. oil in dollars per barrel, corn in cents per bushel, equity index in dollars per index point..  

Currencies are special [[Futures Not Subject to Cash-And-Carry|commodities]] in that their prices are defined in [[Forwards and Futures Notes|currency]] per unit of another [[Forwards and Futures Notes|currency]], and therefore can be inverted and are naturally traded in a triangular way, i.e. one [[Forwards and Futures Notes|currency]] traded for another, then for another, and then for another or the same.  

# 2.5.1 Equities  

Fundamentally, the price of a stock is equal to the discounted value of all the dividends/cash flows received over the expected holding horizon plus the discounted value of the final price received for the stock at the end of the holding horizon. Since, rationally, the final price that the next buyer will pay must reflect the discounted value of all the future dividends from then on, today's [[Chapter 16 - Black–Scholes Model|stock price]] can be viewed as the discounted value of all the dividends/cash flows received during the holding horizon and beyond. Thus, if Jack buys the stock today and. expects to hold it for $n$ years, he would value the stock as the PV of all the dividends and the. PV of the sale price  
$$
...
This sequence of dividends can follow several canonical patterns. If the dividends are expected to grow at a constant percentage rate $g$ per year (which is less than the [[PSET 7- Kohler|discount rate]]), then we can use the formula for the sum of an infinite geometric series to get the price of the stock today  
$$
P_{0}=\frac{D_{1}}{r-g}
$$  
...
In stock valuation, even a minute news release changing the forecast of the growth rate of. earnings, or [[Preview of the Book|cash flow]] can lead to significant price revisions. Chapter 11 contains a thorough review of the fundamental equity valuation using discounted [[Free Cash Flow Valuation of Companies|free cash flow]].  

# 2.5.2Currencies  

Currencies are [[Futures Not Subject to Cash-And-Carry|commodities]]. They trade in bulk and are of uniform quality: a 20-euro note can be replaced by 20 1-euro coins without loss of value. Normally, the price of a commodity is quoted in [[Forwards and Futures Notes|currency]] per physical unit of commodity like a bushel, a barrel or a metric tonne. Currencies, also called foreign exchange (FX), are special since the priced physical unit of the commodity is also a [[Forwards and Futures Notes|currency]]. One pound sterling (the priced commodity) may cost 1.5 US dollars ([[Arbitrage Pricing of Derivatives|pricing]] [[Forwards and Futures Notes|currency]]), or 1 US dollar (priced commodity) may cost O.6667 pounds sterling ([[Arbitrage Pricing of Derivatives|pricing]] [[Forwards and Futures Notes|currency]]). The price in pounds per dollar is equivalent to the reciprocal of the price in dollars per pound. Exchanging dollars for pounds can be described either as selling dollars or buying pounds.  

The other feature distinguishing currencies from other [[Futures Not Subject to Cash-And-Carry|commodities]] is that we often want to know and transact at the cross ratio. We rarely exchange 300 barrels of oil for bushels of wheat. However, when returning to London from Mexico, we may want to exchange the leftover 600 pesos for pounds without first selling pesos for dollars and then dollars for pounds..  

Let us review quote conventions and some potential issues. In what follows, we use the easily recognizable three-letter [[Forwards and Futures Notes|currency]] codes as adopted by the transaction messaging system SWIFT. Most currencies around the world are quoted with respect to a vehicle [[Forwards and Futures Notes|currency]] which is one of the major hard currencies, e.g. USD, GBP, or EUR. A [[Forwards and Futures Notes|currency]] can be quoted in European terms, i.e. in [[Forwards and Futures Notes|currency]] per dollar, or American terms in dollars per [[Forwards and Futures Notes|currency]]. Most British Commonwealth currencies (AUD, NZD, etc.) and the euro (EUR) follow the American convention (US dollars per euro or pound). Most others (e.g. CHF, PLZ, JPY) follow the European convention (Swiss francs or Danish krone per US dollar). Remembering all this is important when observing quotes or percentage appreciation rates that are not labeled. This text follows the standard in which a [[Arbitrage Opportunity Accounting|spot exchange rate]] is denoted by. $X$ with the terms in square brackets or as a superscript. For example 1.5 dollars per pound sterling is:.  
$$
X^{U S D/G B P}=X\left[\frac{U S D}{G B P}\right]=1.50
$$  

For any two currencies, the FX rate in [[Forwards and Futures Notes|currency]] 1 per unit of [[Forwards and Futures Notes|currency]] 2 uniquely determines the FX rate in [[Forwards and Futures Notes|currency]] 2 per unit of [[Forwards and Futures Notes|currency]] 1, i.e. $X[C u r r1/C u r r2]=1/X[C u r r2/C u r r1]$ In our example:  
$$
...
Table 2.4 [[Forwards and Futures Notes|Currency]] changes against the USD as of .... ./2009   
...
The main law governing spot [[Forward Points in Currency|currency trading]] is that of no triangular [[Arbitrage Pricing of Derivatives|arbitrage]]. In the inter-dealer market, all spot FX rates have to be 'in line' with each other in such a way that buying one [[Forwards and Futures Notes|currency]] through a vehicle is neither cheaper nor more expensive than buying it directly. The rule, of course, does not apply to retail markets. Let us illustrate.  

![](3e6fc1944f0da999299ac6bf2525b33cbed6a5d358bf1e0d06e8a9da7f65a083.jpg)  
Figure 2.18 Triangular [[Arbitrage Pricing of Derivatives|arbitrage]]  
...
You would not be alone in pursuing this triangle [[Arbitrage Pricing of Derivatives|arbitrage]] opportunity. Dealers in New York. would sell dollars for yen, convert the yen into HK dollars in Tokyo and, with HK dollars, buy. back US dollars in New York (it does not matter where you start on the triangle). Every dealer. around the globe would be going in the same direction. The USD-into-JPY trade would drive up the yen, the JPY-into-HKD trade would drive up HKD relative to JPY, and the HKD-intoUSD trade would drive the USD up against the HKD. Likely, all three quotes would change. until the yen price of HK dollars was the same in New York and Tokyo..  

In the above, we ignore the transaction costs in the form of a [[Bid Ask and Transaction Prices in a Specialist Market With Heterogeneously Informed Traders|bid-ask spread]]. In reality, we need to modify the computed amounts by considering that we would sell at the bid and buy at the ask. Instead of simply one FX cross rate, we need to compute its [[Class Note 9 Bid and Ask Prices With Private Information|bid and ask]]. The principle remains the same.  

The triangular [[Arbitrage Pricing of Derivatives|arbitrage]] principle binds hundreds of possible [[Forwards and Futures Notes|currency]] combinations. As soon as one FX quote changes in the market, many others must follow..  