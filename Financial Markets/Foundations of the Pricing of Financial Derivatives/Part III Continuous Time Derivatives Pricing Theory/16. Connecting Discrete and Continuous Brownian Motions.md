...
- 16. Connecting Discrete and Continuous Brownian Motions and financial analysis
- 16. Connecting Discrete and Continuous Brownian Motions in modern finance
- Applications of 16. Connecting Discrete and Continuous Brownian Motions
- 'Case study: 16. Connecting Discrete and Continuous Brownian Motions'
...
Now we must index our ratio of probabilities by time, that is, $\gamma_{t}^{s}$ . First note that the process starts at $\gamma_{0}=1.0$ .11 The stochastic process%20Process.md) of $\gamma_{t}^{s}$ can be derived as follows. First consider $\gamma_{t}^{+}$ , which as we know is $q/\phi$ . The value $q/\phi$ can be expressed as a weighted average of the next two values of the process as shown here:  
...
[^2]: Now there would be three outcomes at time step 2: $+2$ with probability $\textstyle1_{I_{4},\mathrm{~0~}}$ with probability $[^1]h$ , and $^{-2}$ with probability $1/_{4}$ . The expected value is still zero, but the variance is now $(1/4)(2-0)^{2}+(1/2)(0-0)^{2}+(1/4)(-2-0)^{2}=2$ .
