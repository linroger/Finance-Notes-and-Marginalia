...
EXERCISE 5.2 (Adapted from Problem 3.3 in Kreps (1990).) Consider the following two [probability distributions](.md) of consumption. $\pi_{1}$ gives 5, 15, and 30 (dollars) with probabilities $1/3$ $5/9$ , and $1/9$ , respectively. $\pi_{2}$ gives 10 and 20 with probabilities $2/3$ and $1/3$ , respectively.  
