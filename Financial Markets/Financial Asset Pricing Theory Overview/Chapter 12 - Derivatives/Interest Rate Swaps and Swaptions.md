...
which is identical to the value of the floating rate payment.md) of the swap. Therefore, the value of this floating rate payment.md) at any time $t\leq T_{i}-\delta$ must be  
$$
