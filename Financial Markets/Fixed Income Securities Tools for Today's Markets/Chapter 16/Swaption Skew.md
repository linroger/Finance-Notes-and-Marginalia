...
Proposition: [Pricing](../Chapter%207/Arbitrage%20Pricing%20of%20Derivatives.md) a bond according to either of the following methods gives the same price:  
...
where (A3.11) simply multiplies both sides of (A3.10) by $(1+f(1))\cdots\cdot\cdot(1+$ $f(n))$ ; (A3.12) recognizes that the second and third lines of (A3.11) are $P_{n}$ the price of the bond after $_n$ years, with discounting under the assumption of realized [forwards](../../Financial%20Asset%20Pricing%20Theory%20Overview/Chapter%2012%20-%20Derivatives/Forwards%20and%20Futures.md); and (A3.13) simplifies terms.  
...
Equation (A4.5) multiplies each term in the summation by one, in the form of $\overset{}{P^{i}}/\overset{}{P^{i}}$ . Equation (A4.6) follows from the definition of [duration](../Chapter%205/Key%20Rates%20O1s%20Durations%20and%20Hedging.md) in the text,.   
...
Begin with [least-squares estimation](../Chapter%206/Level%20Versus%20Change%20Regressions.md), which finds the parameters $\hat{\alpha}$ and $\hat{\beta}$ to minimize,  
$$
...
To minimize this variance by choosing the Dv01 in the [hedging](../Chapter%205/Key%20Rates%20O1s%20Durations%20and%20Hedging.md) bonds, differentiate (A6.15) with respect to $\overline{{D V01}}^{30}$ , set the result to zero, and solve. for $\overline{{D V01}}^{30}$  
$$
...
Let $P$ be the [full price](../Chapter%201/Accrued%20Interest.md) of some security that depends on $r$ and time. Then, by [Ito's lemma](../../../Financial%20Engineering/Determining%20the%20Stochastic%20Process%20for%20a%20Forward%20Contract%20from%20Ito’s%20Lemma.md),  
$$
...
[Solving Equations](../../../Financial%20Engineering/Inverse%20Matrices%20Solve%20Linear%20Systems.md) (A9.3) and (A9.4) simultaneously shows that $p=$ .4917 and $r_{u u}=4.1949\%$ . These values are given in Figure A9.2 along with solutions to the analogous equations for $q$ and $r_{d d}$  
...
Expression (A9.15) can be interpreted as follows: The time $t$ [forward rate](../../../Clippings/Forward%20Points%20in%20Currency.md) with maturity $\tau$ and tenor $\tau^{\prime}$ can be decomposed into a component that. represents the [risk-neutral expectation](../../Financial%20Asset%20Pricing%20Theory%20Overview/Chapter%2011%20-%20Risk-adjusted%20probabilities/Risk-Neutral%20Probabilities.md) of the $\tau^{\prime}$ maturity yield prevailing at.  
...
The term multiplying dt on the right-hand side of (A9.25) has a clear. interpretation: the [expected return](../../../Advanced%20Investments/Lecture%201-%20Probability%20Distributions%20of%20Returns.md) at time. $t$ of holding $\tau$ maturity zero coupon bond from time $t$ to time $t+d t$ is equal to the riskless rate prevailing at time $t$ , plus a risk-premium term that is equal to the [duration](../Chapter%205/Key%20Rates%20O1s%20Durations%20and%20Hedging.md) of the zero coupon bond (its maturity) times the loading of the yield of a zero coupon bond with maturity $\tau-t$ , times the volatility of the long rate, times the. price of risk prevailing at time t, namely,. $\lambda_{t}$ . We will assume that the price of risk does change over time. We will not specify its dynamics, but we will assume that $\lambda_{t}$ is a very persistent process, so that $E_{t}(\lambda_{t+\Delta t})\approx\lambda_{t}$ for $\Delta t=1$ i.e. one price of risk next-year is expected to be equal to this year's. If we changed measure to the [risk-neutral measure](../../../Financial%20Engineering/Verifying%20Martingale%20Property%20with%20Q.md), this term would disappear from the right-hand side of (A9.25), that is, the expected instantaneous return of our zero coupon bond would equal the riskless rate.  

Recall as well the definition of the [forward rate](../../../Clippings/Forward%20Points%20in%20Currency.md) at time $t$ with maturity $\tau$ and tenor $\Delta\tau:f_{t}(\tau)=(p(t,\tau)-p(t,\tau+\Delta\tau))/\Delta\tau-\mathrm{we}$ will omit the tenor as. an explicitly argument of $f_{t}()$ . Now, consider the following strategy: At time $t$ , buy one zero coupon bond with maturity $\tau+\Delta\tau$ , and simultaneously sell. one zero coupon bond with maturity $\tau$ . First, we claim that the return of this strategy is equal to the [forward rate](../../../Clippings/Forward%20Points%20in%20Currency.md) with tenor $\Delta\tau$ prevailing at time $t$ minus the $\Delta\tau$ maturity yield prevailing at time $\tau$ . To see this, denote by. $R_{t}^{\tau}$ the cumulative [realized return](../Chapter%203/Realized%20Returns.md) between time $t$ and time $\tau$ . We then have,  
$$
...
where $f_{\tau}(\tau)$ is equal to the zero coupon yield with maturity $\Delta\tau$ prevailing at time $\tau$ which, for a sufficiently small $\Delta\tau$ , approximately equals the [spot rate](../../../International%20Finance/The%20Foreign%20Exchange%20Market%20Annotations.md) prevailing at time $\tau$ . Hence, the [expected return](../../../Advanced%20Investments/Lecture%201-%20Probability%20Distributions%20of%20Returns.md) (under the true measure) of this strategy at time $t$ is equal to the [forward rate](../../../Clippings/Forward%20Points%20in%20Currency.md) at time $t$ , minus the. expected [short rate](../../../Fixed%20Income%20Asset%20Pricing/Fixed%20Income%20Lecture%20Notes/An%20Overview%20of%20the%20Vasicek%20Short%20Rate%20Model.md) at time $\tau$ . Let's keep this result aside for a moment.  

We will now compute the [expected return](../../../Advanced%20Investments/Lecture%201-%20Probability%20Distributions%20of%20Returns.md) of this strategy (again, under the true measure). Note that the [expected return](../../../Advanced%20Investments/Lecture%201-%20Probability%20Distributions%20of%20Returns.md) of the long and short side cancel out for entire the holding period except for the segment $(t,t+\Delta\tau)$ and $(\tau-\Delta\tau,\tau)$ , because in the model the risk premia depends on [time to maturity](../../../Financial%20Instruments/Lecture%20Notes-%20Financial%20Instruments/Teaching%20Note%201-%20Forward%20Rates%20Agreement/Hedging%20Strategies%20with%20Forwards.md) only. Applying [Ito's lemma](../../../Financial%20Engineering/Determining%20the%20Stochastic%20Process%20for%20a%20Forward%20Contract%20from%20Ito’s%20Lemma.md) to (A9.25), canceling the [short rate](../../../Fixed%20Income%20Asset%20Pricing/Fixed%20Income%20Lecture%20Notes/An%20Overview%20of%20the%20Vasicek%20Short%20Rate%20Model.md), integrating and taking [expectations](../../../Fixed%20Income%20Asset%20Pricing/Fixed%20Income%20Lecture%20Notes/FORWARD%20RATES%20AND%20TERM%20STRUCTURE.md), and dismissing the contribution of the segments $(\tau-\Delta\tau,\tau)$ because only the long factor is priced, we get,.  
$$
...
Note that the expected risk premium (A9.27) is the product of the yet. unknown $\lambda_{t}$ and an amount of risk term. $R P(t,\tau,\Delta\tau)$ that can be easily computed. As we mention in the text, in order to imply $\lambda_{t}$ from the observed forward rates and the parameters of the model, we will assume that there is a maturity $\tau$ such that the (true) expectation of what the [short rate](../../../Fixed%20Income%20Asset%20Pricing/Fixed%20Income%20Lecture%20Notes/An%20Overview%20of%20the%20Vasicek%20Short%20Rate%20Model.md) will be. at maturity $\tau$ is equal to the (true) expectation of the [short rate](../../../Fixed%20Income%20Asset%20Pricing/Fixed%20Income%20Lecture%20Notes/An%20Overview%20of%20the%20Vasicek%20Short%20Rate%20Model.md) will be at. any maturity $\tau^{\prime}>\tau$ . With this assumption, we can specialize this reasoning. to two long maturities $\tau^{\prime}>\tau$ , subtract the resulting equations and solve for. the price of risk $\lambda_{t}$ as follows,  
$$
\lambda_{t}=\frac{f_{t}(\tau^{\prime})-f_{t}(\tau)}{R P(t,\tau^{\prime},\Delta\tau)/\Delta\tau-R P(t,\tau,\Delta\tau)/\Delta\tau}
$$  

Armed with an estimate for. $\lambda_{t}$ , we can then take [expectations](../../../Fixed%20Income%20Asset%20Pricing/Fixed%20Income%20Lecture%20Notes/FORWARD%20RATES%20AND%20TERM%20STRUCTURE.md) on both. sides of the equation (A9.26) at maturity $\tau-\Delta\tau$ and use (A9.27) to solve for the expected rate for a long enough maturity $\tau-\Delta\tau$ . We finally get,.  
$$
E_{t}(r_{\tau})=f_{t}(\tau)-\lambda_{t}R P(t,\tau,\Delta\tau)
$$  

To get an intuition for (A9.29), say that the price of risk $\lambda_{t}$ that we solved before is 0.09. The loading of the 10-year zero coupon bond yield on the long factor is 0.7, and the volatility of the long factor is about 100 basis points, then the 10-year risk premium would be approximately $0.09\times0.01\times10\times$ $0.7=63\mathrm{bps}$ . The [convexity](../../../Fixed%20Income%20Asset%20Pricing/Problem%20Sets/PSET%20II%20Fixed%20Income%20Asset%20Pricing%201.md) advantage term for the 10-year rate is about 24bps. These numbers are very close to the ones obtained by evaluating the model at estimated parameters, and 0.09 is the average price of risk in the sample.5 If we assume that the 10-year [forward rate](../../../Clippings/Forward%20Points%20in%20Currency.md) is $3\%$ , the implied expected one-year rate, nine years rate under the true measure would then be $0.03+0.0024-0.0063=2.61\%$  

We computed the price of risk in the manner described already for using the 14- and 15-year [forwards](../../Financial%20Asset%20Pricing%20Theory%20Overview/Chapter%2012%20-%20Derivatives/Forwards%20and%20Futures.md) to extract $\uplambda$ for every day in our sample, and then using this estimate to imply the expectation of the 10-year rate using the 10-year [forward rate](../../../Clippings/Forward%20Points%20in%20Currency.md). Results are not sensitive to using other, longer maturities.  

The implied 10-year rate expectation computed in this manner is plotted in the text against an estimate of the long run expected [short rate](../../../Fixed%20Income%20Asset%20Pricing/Fixed%20Income%20Lecture%20Notes/An%20Overview%20of%20the%20Vasicek%20Short%20Rate%20Model.md) obtained. outside the model, just by just adding the real rate forecast produced by the Cleveland Fed, to a measure of long run [inflation](../../../International%20Finance/Bridgewater/Principles%20For%20Navigating%20Big%20Debt%20Cycles/Part%20II%20Detailed%20Case%20Studies/German%20Debt%20Crisis%20andHyperinflation%20(1918–1924)/War%20Economies%20and%20Hyperinflation.md), which we took as the average of the 10-year [inflation](../../../International%20Finance/Bridgewater/Principles%20For%20Navigating%20Big%20Debt%20Cycles/Part%20II%20Detailed%20Case%20Studies/German%20Debt%20Crisis%20andHyperinflation%20(1918–1924)/War%20Economies%20and%20Hyperinflation.md) rate forecast produced by the Cleveland Fed, the 10-year forecast produced by the ATsIX model of the Philadelphia Fed,. and an estimate of trend [inflation](../../../International%20Finance/Bridgewater/Principles%20For%20Navigating%20Big%20Debt%20Cycles/Part%20II%20Detailed%20Case%20Studies/German%20Debt%20Crisis%20andHyperinflation%20(1918–1924)/War%20Economies%20and%20Hyperinflation.md) obtained with a simple exponential moving. average rule with a decay parameter of 0.987, a value used elsewhere in the. literature.6 Other procedures to assess long rate [expectations](../../../Fixed%20Income%20Asset%20Pricing/Fixed%20Income%20Lecture%20Notes/FORWARD%20RATES%20AND%20TERM%20STRUCTURE.md) are possible. (for example, the Survey of Market Participants conducted by the New York Fed several times a year, or the long-standing Bluechip Financial Forecast survey).  

# A11.1 FORWARD DROP APPROXIMATELY EQUALS CASH CARRY  

Define the following notation, all for 100 face amount of a bond:  
$p_{0}$ : [flat price](../Chapter%201/Accrued%20Interest.md) for spot settlement : $c$ : annual coupon payment : $d_{1}$ : number of days from spot settlement to the coupon payment date $d_{2}$ : number of days from the coupon payment date to [forward settlement](../Chapter%2011/Forward%20Bond%20Yield.md). $d=d_{1}+d_{2}$ : number of days from spot to [forward settlement](../Chapter%2011/Forward%20Bond%20Yield.md). $A I_{0},A I_{d}$ : [accrued interest](../../Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%202%20-%20Spot%20Markets/Intra-Year%20Compounding%20and%20Day-Count.md) as of spot and forward settlements,. respectively : $r{:}$ repo rate from spot to [forward settlement](../Chapter%2011/Forward%20Bond%20Yield.md). : $p_{0}(d)$ : [flat price](../Chapter%201/Accrued%20Interest.md) for [forward settlement](../Chapter%2011/Forward%20Bond%20Yield.md)  

With this notation, the [forward price](../Chapter%2011/Forward%20Contracts%20and%20Forward%20Prices.md) of the bond, based on the discussion in the text, can be written as,.  
$$
...
This section highlights the differences between [pricing](../Chapter%207/Arbitrage%20Pricing%20of%20Derivatives.md) forward and [futures contracts](../../../Financial%20Engineering/Mathematics%20of%20the%20Financial%20Markets.md) in a [term structure](../Chapter%209/The%20Vasicek%20Model.md) model. To focus on this difference, it is assumed here that the [futures](../../Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md) contract has one delivery date and one deliverable bond and that its conversion factor is one. Section A11.4 discusses the [pricing](../Chapter%207/Arbitrage%20Pricing%20of%20Derivatives.md) of. delivery options in a [term structure](../Chapter%209/The%20Vasicek%20Model.md) model. Also, for simplicity, it is assumed. here that there are no intermediate coupon dates between the spot and [forward settlement](../Chapter%2011/Forward%20Bond%20Yield.md) dates.  

Using the methodology of Chapter 7, begin with a recombining, bi-. nomial tree with three dates, labeled 0, 1, and 2, where the forward and [futures contracts](../../../Financial%20Engineering/Mathematics%20of%20the%20Financial%20Markets.md) expire on date 2. Set the following notation:.  
$r_{0},r_{1}^{u}$ , and $r_{1}^{d}$ : the initial one-period rate, and the one-period rates on date 1, in the up and down states, respectively.   $\textbf{\em P}_{0},P_{2}^{u u},P_{2}^{u d}$ and $P_{2}^{d d}$ : the initial [full price](../Chapter%201/Accrued%20Interest.md) of the underlying bond, and the date-2 full prices in the "up-up," "up-down," and "down-down" states, respectively..   $\mathbf{\Phi}^{\overline{{\mathbf{\alpha}}}}\mu_{0},p_{2}^{u u},p_{2}^{u d}$ and $\dot{p}_{2}^{d d}$ : fat pries at the indicated dates and states..   
: $P_{0}(2)$ : the initial full [forward price](../Chapter%2011/Forward%20Contracts%20and%20Forward%20Prices.md)..   
: $p_{0}(2)$ : the initial flat [forward price](../Chapter%2011/Forward%20Contracts%20and%20Forward%20Prices.md).. $F_{0},F_{1}^{u}, $ $F_{1}^{d}$ : the initial [futures price](../Chapter%2011/Futures%20Price%20and%20the%20Quality%20Option%20Before%20E.md), and the date-1 [futures](../../Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md) prices in the up and down states, respectively..   $\equiv q,1-q$ : the risk-neutral [transition probabilities](../../../Financial%20Engineering/Fixed%20Income%20Derivatives/A%20Primer%20on%20Probability%20Theory%20and%20Stochastic%20%20Modelling.md) on all dates to move up and down from the current state, respectively.  
...
Each term of Equation (A11.4) is the probability of a particular path through the tree times the discounted value of the bond price at the end of that path, where discounting is done using the [short-term rates](../Chapter%208/Volatility%20and%20Convexity.md) along. the path. Taking all terms together, therefore, $P_{0}$ is the expected discounted bond price. More generally, then, letting $_n$ be the number of periods, $P_{n}$ the random [full price](../Chapter%201/Accrued%20Interest.md) of the bond at period $_n$ , and $r_{i}$ the random short-term rate over period $i$ to $i+1$  
$$
P_{0}=E\left[\frac{P_{n}}{\prod_{i=0}^{n-1}(1+r_{i})}\right]
$$  

The [discount factor](../Chapter%201/Discount%20Factors.md) to period. $n,d(n)$ , is just a special case of (A11.5) when the terminal price equals one in all states. Hence,  
$$
d(n)=E\left[\frac{1}{\prod_{i=0}^{n-1}(1+r_{i})}\right]
$$  

Following the discussion in the text, the forward [full price](../Chapter%201/Accrued%20Interest.md) of the bond is just the future value, to the forward delivery date, of the full spot price of the bond. Therefore, using Equations (A11.5) and (A11.6),  
$$
P_{0}^{f w d}=\frac{P_{0}}{d(n)}
$$  

Turning to the [futures price](../Chapter%2011/Futures%20Price%20and%20the%20Quality%20Option%20Before%20E.md), start again with the recombining, risk-. neutral [binomial tree](../Chapter%207/Rate%20and%20Price%20Trees.md). At expiration on date 2, the [futures price](../Chapter%2011/Futures%20Price%20and%20the%20Quality%20Option%20Before%20E.md) equals the flat bond price. (At contract expiration, the bond is delivered at the [futures](../../Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md). price plus [accrued interest](../../Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%202%20-%20Spot%20Markets/Intra-Year%20Compounding%20and%20Day-Count.md).) In the up state of date 1, the [futures price](../Chapter%2011/Futures%20Price%20and%20the%20Quality%20Option%20Before%20E.md) is $F_{1}^{u}$ , which means that the [daily settlement](../Chapter%2011/Pricing%20and%20Hedging%20Implications%20of%20Daily%20Sett.md) payment for a [long position](../../../Financial%20Engineering/Derivatives/Part%20I%20-%20Forwards%20and%20Futures/Chapter%204%20-%20Futures:%20Hedging%20and%20Speculation.md) of one contract on date 2 is ${p}_{2}^{u u}-F_{1}^{u}$ in the up-up state and $p_{2}^{u d}-F_{1}^{u}$ in the up-down state. But because the value of a [futures](../../Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md) contract initiated at any. date is zero, the expected discounted value of the [daily settlement](../Chapter%2011/Pricing%20and%20Hedging%20Implications%20of%20Daily%20Sett.md) payments. from the date 1 up state must be zero. Hence,  
$$
\frac{q(p_{2}^{u u}-F_{1}^{u})+(1-q)(p_{2}^{u d}-F_{1}^{u})}{1+r_{1}^{u}}=0
$$  

And, solving for the [futures price](../Chapter%2011/Futures%20Price%20and%20the%20Quality%20Option%20Before%20E.md),  
$$
F_{1}^{u}=q{p}_{2}^{u u}+(1-q)p_{2}^{u d}
$$  

Analogously, the [futures price](../Chapter%2011/Futures%20Price%20and%20the%20Quality%20Option%20Before%20E.md) in the date 1 down state is,  
$$
F_{1}^{d}=q{p}_{2}^{u d}+(1-q)p_{2}^{d d}
$$  

On date 0, the [futures price](../Chapter%2011/Futures%20Price%20and%20the%20Quality%20Option%20Before%20E.md) is $F_{0}$ , and the expected discounted value of. the date 1 settlement payment must be zero. Hence,  
$$
...
Hence, in a risk-neutral tree, the [futures price](../Chapter%2011/Futures%20Price%20and%20the%20Quality%20Option%20Before%20E.md) is the expected value of the bond price on the contract [expiration date](../../../Financial%20Instruments/Financial%20Derivatives%20and%20Quantitative%20Methods/Risk%20Neutral%20Pricing%20of%20Options.md). More generally,.  
$$
F_{0}=E[\phi_{n}]
$$  
...
Let $A I_{n}$ be the [accrued interest](../../Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%202%20-%20Spot%20Markets/Intra-Year%20Compounding%20and%20Day-Count.md) on the bond as of date $_n$ . Because [accrued interest](../../Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%202%20-%20Spot%20Markets/Intra-Year%20Compounding%20and%20Day-Count.md) is not a random variable, $E[P_{n}]=E[\Tilde{P}_{n}]+A I_{n}$ . Next, substitute the definitions of. $P_{0},d(n)$ , and $F_{0}$ from Equations (A11.5), (A11.6), and. (A11.14) into Equation (A11.16) to see that,.  
$$
\mathrm{Co}\nu\left(P_{n},\frac{1}{\prod_{i=0}^{n-1}(1+r_{i})}\right)=P_{0}-(F_{0}+A I_{n})d(n)
$$  

Rearranging terms, substituting in the [forward price](../Chapter%2011/Forward%20Contracts%20and%20Forward%20Prices.md) from Equation (A11.7), and recognizing that phwd $P_{0}^{f w d}=\bar{p}_{0}^{\bar{f}w d}+A I_{n}$  
$$
...
Finally, because bond prices are negatively correlated with [interest rates](../Chapter%202/Interest%20Rate%20Quotations.md), the covariance term in Equation (A11.18) is negative and, therefore,  
$$
F_{0}<p_{0}^{f w d}
$$  

The [futures price](../Chapter%2011/Futures%20Price%20and%20the%20Quality%20Option%20Before%20E.md) is less than the [forward price](../Chapter%2011/Forward%20Contracts%20and%20Forward%20Prices.md).  

# A11.4  FUTURES DELIVERY OPTIONS IN A TERM STRUCTURE MODEL  

Having set up a [term structure](../Chapter%209/The%20Vasicek%20Model.md) model in the form of a tree, the quality option. can be priced as follows. Start at the delivery date. At each node, compute the ratio of the price to conversion factor for each deliverable bond. Find the. bond with the minimum ratio and set the [futures price](../Chapter%2011/Futures%20Price%20and%20the%20Quality%20Option%20Before%20E.md) equal to that ratio.. Then, given these terminal values of the [futures price](../Chapter%2011/Futures%20Price%20and%20the%20Quality%20Option%20Before%20E.md), prices on earlier dates can be computed along the lines described in Section A11.2. In the case of the timing, end-of-month, and wild-card options, which are American-style options exercisable by the short, the [futures price](../Chapter%2011/Futures%20Price%20and%20the%20Quality%20Option%20Before%20E.md) at each node in the tree. is the minimum of the [futures price](../Chapter%2011/Futures%20Price%20and%20the%20Quality%20Option%20Before%20E.md) with the option exercised and with the. option not exercised.  
...
[Arbitrage-free pricing](../../../Financial%20Engineering/6.%20A%20Brief%20Introduction%20to%20Stochastic%20Calculus.md) models usually assume that some set of securities is fairly priced. In the case of [futures](../../Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md), the standard assumption is that the forward prices of all bonds in the [deliverable basket](../Chapter%2011/Mechanics%20of%20Us%20Treasury%20Note%20and%20Bond%20Futures.md) are fair. Technically, this [calibration](../../../Credit%20Markets/Credit%20Markets%20Session%204.md) can be accomplished by assigning a spread to each bond such that its [forward price](../Chapter%2011/Forward%20Contracts%20and%20Forward%20Prices.md) in the model matches the [forward price](../Chapter%2011/Forward%20Contracts%20and%20Forward%20Prices.md) in the market. The assumption that bond prices are fair is in the spirit of [pricing](../Chapter%207/Arbitrage%20Pricing%20of%20Derivatives.md) the [futures](../../Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md) relative to cash. Another approach can be used to decide whether the underlying bonds are fairly priced or not.  

[Term structure models](../../../Financial%20Engineering/Financial%20Mathematics%20Course.md) commonly used for [pricing](../Chapter%207/Arbitrage%20Pricing%20of%20Derivatives.md) [futures](../../Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md) fall into two. main categories. First are one- or two-factor short-rate models along the lines of those described in Chapters 7-9. These models are relatively easy to. implement and, for the most part, flexible enough to capture the yield curve dynamics driving [futures](../../Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md) prices. With only one or two factors, however, these. models cannot capture the idiosyncratic price movements of any deliverable bond relative to another.  

The second type of model allows for a richer set of relative price movements across bonds in the [deliverable basket](../Chapter%2011/Mechanics%20of%20Us%20Treasury%20Note%20and%20Bond%20Futures.md). These models essentially allow each bond to follow its own price or yield process. There are costs to this flexibility, however. First, ensuring that these models are [arbitrage](../Chapter%207/Arbitrage%20Pricing%20of%20Derivatives.md) free takes some effort. Second, the user must specify the parameters that describe the stochastic behavior of all bond prices in the basket, for example, a volatility for each of the bonds in the basket along with correlations between each pair of bonds.  

[Futures traders](../../../Financial%20Engineering/Derivatives/Part%20I%20-%20Forwards%20and%20Futures/Chapter%202%20-%20Futures%20Markets.md) often describe their models in terms of the beta of each bond in the basket relative to a benchmark bond in the basket. The beta. of a bond represents the expected change in yield of that bond given a one-basis-point change in the yield of the benchmark. A bond with a beta of 1.02, for example, implies that the bond's yield is assumed to change $2\%$ more than the yield of the benchmark bond. The beta of a particular bond. can be thought of as the coefficient from a regression of changes in its yield on changes in the benchmark's yield. Note that in a [one-factor model](../Chapter%207/Profit%20and%20Loss%20Attribution%20with%20an%20OAS.md) the. beta of a bond is simply the ratio of the volatility of that bond yield to the volatility of the benchmark's yield.  

# Short-Term Rates and Their Derivatives  

ing of forward and [futures](../../Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md) rates and the [futures-forward](../Chapter%2012/The%20Futures-Forward%20Difference.md) rate difference in [term structure models](../../../Financial%20Engineering/Financial%20Mathematics%20Course.md). All [expectations](../../../Fixed%20Income%20Asset%20Pricing/Fixed%20Income%20Lecture%20Notes/FORWARD%20RATES%20AND%20TERM%20STRUCTURE.md) here are also with respect to some risk-neutral or [pricing](../Chapter%207/Arbitrage%20Pricing%20of%20Derivatives.md) probabilities.  

The first step in this Appendix is to show that the [futures](../../Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md) rate with respect to a term rate, like a [Euribor futures](../Chapter%2012/EURIBOR%20Forward%20Rate%20Agreements%20and%20Futures.md) rate in the text, is greater than the corresponding forward term rate.  

The $\beta$ year rate, $t$ years forward,e $r_{t}^{f w d}$ , is the rate that equate the present value at time $t$ of receiving a unit of [currency](../../../Financial%20Instruments/Lecture%20Notes-%20Financial%20Instruments/Teaching%20Note%201-%20Forward%20Rates%20Agreement/Forwards%20and%20Futures%20Notes.md) at time $t+\beta$ with the price of -year zero coupon bond, -years forward, p. Usig continuously compounded rates,  
$$
...
where $F_{0}$ is the [futures price](../Chapter%2011/Futures%20Price%20and%20the%20Quality%20Option%20Before%20E.md) of that zero coupon bond.  
...
Because of [daily settlement](../Chapter%2011/Pricing%20and%20Hedging%20Implications%20of%20Daily%20Sett.md) payments of [futures contracts](../../../Financial%20Engineering/Mathematics%20of%20the%20Financial%20Markets.md), and following the same argument as in Appendix A11.2, which leads to Equation (A11.14),  
...
By [Jensen's inequality](../Chapter%208/Volatility%20and%20Convexity.md) and Equation (A12.5),  
$$
...
The next step in this appendix is to show that the [futures](../../Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md) rate with respect to an average rate, like a [one-month SOFR](../Chapter%2012/One-Month%20SOFR%20Futures.md) ([Secured Overnight Financing Rate](../Chapter%2010/SOFR.md)) [futures](../../Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md) rate or a [fed funds futures](../Chapter%2012/Fed%20Fund%20Futures.md) rate, is greater than the [futures](../../Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md) rate with respect to a term rate. This fact, combined with the result just proved, implies that [futures](../../Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md) rates with respect to average rates are also greater than the corresponding forward rates.  

Let $R(t,t+\beta)$ be the integral of the continuously compounded [overnight rates](../Chapter%2012/Short-Term%20Rates%20and%20the%20Transition%20from%20LIBOR.md) from $t$ to $t+\beta$ , so that the average rate is $R(t,t+\beta)/\beta$ . Once again, because of the [daily settlement](../Chapter%2011/Pricing%20and%20Hedging%20Implications%20of%20Daily%20Sett.md) of [futures contracts](../../../Financial%20Engineering/Mathematics%20of%20the%20Financial%20Markets.md), today's [futures](../../Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md) rate on the average rate, $A_{t}^{f u t}$ , is today' expectation of the average at time $t$  
$$
...
where $E_{t}[\cdot]$ gives the expectation as of time $t$ . Applying [Jensen's inequality](../Chapter%208/Volatility%20and%20Convexity.md). to (A12.10) and rearranging terms,  
$$
...
where the third equation takes [expectations](../../../Fixed%20Income%20Asset%20Pricing/Fixed%20Income%20Lecture%20Notes/FORWARD%20RATES%20AND%20TERM%20STRUCTURE.md) of the second as of today, and the last equality follows from Equation (A12.9). Equation (A12.11) says that the [futures](../../Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md) rate on the average is greater than the [futures](../../Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md) rate on the term rates, as was to be proved.  

The final step in this appendix is to show that the [futures](../../Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md) rate with. respect to a compounded rate, like a three-month [SOFR futures](../Chapter%2012/One-Month%20SOFR%20Futures.md) rate, is greater than the [futures](../../Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md) rate with respect to an average rate. Once again,. because of [daily settlement](../Chapter%2011/Pricing%20and%20Hedging%20Implications%20of%20Daily%20Sett.md), today's [futures](../../Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md) rate on a compounded rate, Cfut, is the expectation of that compounded rate in the future. Mathematically, in a continuously compounded version of Equation (12.10) in the text,.  
$$
C_{t}^{f u t}=\frac{1}{\beta}(E[e^{R(t,t+\beta)}]-1)
$$  

By [Jensen's inequality](../Chapter%208/Volatility%20and%20Convexity.md) and the properties of the exponential function,  
$$
E[e^{R(t,t+\beta)}]-1>e^{E[R(t,t+\beta)]}-1>E[R(t,t+\beta)]
$$  

Finally, combining Equations (A12.12), (A12.13), and the definition of the [futures](../../Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md) rate on the average in (A12.9),  
$$
\displaystyle{C_{t}^{f u t}=\frac{1}{\beta}(E[e^{R(t,t+\beta)}]-1)>\frac{1}{\beta}E[R(t,t+\beta)]=A_{t}^{f u t}}
$$  

Hence, as was to be proved, the [futures](../../Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md) rate on a compounded rate is greater than the [futures](../../Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md) on an average rate.  

To summarize, the financial insight is that, because of [daily settlement](../Chapter%2011/Pricing%20and%20Hedging%20Implications%20of%20Daily%20Sett.md), the [forward price](../Chapter%2011/Forward%20Contracts%20and%20Forward%20Prices.md) on a zero coupon bond is greater than the [futures price](../Chapter%2011/Futures%20Price%20and%20the%20Quality%20Option%20Before%20E.md) on. that bond. This result, from Chapter 11, plus a [convexity](../../../Fixed%20Income%20Asset%20Pricing/Problem%20Sets/PSET%20II%20Fixed%20Income%20Asset%20Pricing%201.md) effect in moving from price to rate, shows that the [futures](../../Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md) rate with respect to a term rate exceeds the corresponding forward term rate. Then, accounting for the [convexity](../../../Fixed%20Income%20Asset%20Pricing/Problem%20Sets/PSET%20II%20Fixed%20Income%20Asset%20Pricing%201.md) effects of moving to a [futures](../../Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md) rate with respect to an average rate or with respect to a compounded rate, these [futures](../../Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md) rates exceed the [futures](../../Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md) rate with respect to the term rate. The [bottom line](../../../Advanced%20Financial%20Analysis%20and%20Valuation/Financial%20Ratios/Operating%20Income%20vs.%20Net%20Income%20What's%20the%20Difference.md), then, is that all of the [futures](../../Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md) rates discussed in the chapter exceed the corresponding term [forward rate](../../../Clippings/Forward%20Points%20in%20Currency.md)..  

# Interest Rate Swaps  

# A13.1PRICING A EURIBOR SWAP AS OF FEBRUARY 24, 2022  

This section prices a two-year [fixed-for-floating swap](Swaptions.md), where the floating rate is three-month [Euribor](../Chapter%2012/EURIBOR%20Forward%20Rate%20Agreements%20and%20Futures.md). The inputs are the [term structure](../Chapter%209/The%20Vasicek%20Model.md) of STR OIS given in Table A13.1, the two-year [Euribor](../Chapter%2012/EURIBOR%20Forward%20Rate%20Agreements%20and%20Futures.md) [swap rate](../../../Fixed%20Income%20Asset%20Pricing/Fixed%20Income%20Lecture%20Notes/Teaching%20Note%204%20Interest%20Rate%20Derivatives.md) of. $0.078\%$ , and the two-year STR-[Euribor](../Chapter%2012/EURIBOR%20Forward%20Rate%20Agreements%20and%20Futures.md) [basis swap](../Chapter%2013/Basis%20Swaps.md) spread of. $0.138\%$ . All cash flows are. assumed to follow the actual/360 convention, and all of the relevant dates are assumed to be business days..  

The OIS rates in the fourth column of the table are observed in the market. The discount factors are calculated by setting the present value of the fixed payments on each OIS (including the fictional notional amount at maturity) equal to par, which is the value of the floating legs that pay compounded daily STR. Letting $d(t)$ denote the [discount factor](../Chapter%201/Discount%20Factors.md) for $t$ years, the equations determining the discount factors, along the same lines as for [SOFR swaps](../../../Credit%20Markets/Credit%20Market%20PSETS/Advanced%20Usage%20of%20QuantLib%20analytics%20library.md) explained in Chapter 2, are the following,.  

TABLE A13.1 STR OIS Rates as of February 24, 2022.   


<html><body><table><tr><td>Term (years)</td><td>Term (date)</td><td>Term (days)</td><td>Rate (%)</td><td>[Discount Factor](../Chapter%201/Discount%20Factors.md)</td><td>FwdRate (%)</td></tr><tr><td>0.25</td><td>05/24/2022</td><td>89</td><td>-0.5695</td><td>1.0014099</td><td>-0.1408</td></tr><tr><td>0.50</td><td>08/24/2022</td><td>181</td><td>-0.5580</td><td>1.0028134</td><td>-0.1400</td></tr><tr><td>0.75</td><td>11/24/2022</td><td>273</td><td>-0.5110</td><td>1.0038902</td><td>-0.1073</td></tr><tr><td>1.00</td><td>02/24/2023</td><td>365</td><td>-0.4380</td><td>1.0044606</td><td>-0.0568</td></tr><tr><td>1.25</td><td>05/24/2023</td><td>454</td><td>-0.3380</td><td>1.0042784</td><td>0.1081</td></tr><tr><td>1.50</td><td>08/24/2023</td><td>546</td><td>-0.2330</td><td>1.0035455</td><td>0.0730</td></tr><tr><td>1.75</td><td>11/24/2023</td><td>638</td><td>-0.1400</td><td>1.0024888</td><td>0.1054</td></tr><tr><td>2.00</td><td>02/24/2024</td><td>730</td><td>-0.0600</td><td>1.0012201</td><td>0.1267</td></tr></table></body></html>  
$$
...
Solving this set of equations gives the discount factors in Table A13.1. The resulting forward rates are shown in the table as well but are not. needed for the remaining calculations. In any case, with these discount factors, the two-year [Euribor](../Chapter%2012/EURIBOR%20Forward%20Rate%20Agreements%20and%20Futures.md) [swap rate](../../../Fixed%20Income%20Asset%20Pricing/Fixed%20Income%20Lecture%20Notes/Teaching%20Note%204%20Interest%20Rate%20Derivatives.md) of. $0.078\%$ and the two-year STR versus three-month [Euribor](../Chapter%2012/EURIBOR%20Forward%20Rate%20Agreements%20and%20Futures.md) [basis swap](../Chapter%2013/Basis%20Swaps.md) spread of. $0.138\%$ are related by equating the present value of the fixed side of the [Euribor](../Chapter%2012/EURIBOR%20Forward%20Rate%20Agreements%20and%20Futures.md) swap payments (including the fictional notional amount) to one (i.e., the value of floating STR, including the fictional notional amount) plus the present value of the [basis swap](../Chapter%2013/Basis%20Swaps.md) spread payments. Mathematically,  
$$
...
Note that Equation (A13.2) is the [pricing](../Chapter%207/Arbitrage%20Pricing%20of%20Derivatives.md) condition. Given the $0.078\%$ [swap rate](../../../Fixed%20Income%20Asset%20Pricing/Fixed%20Income%20Lecture%20Notes/Teaching%20Note%204%20Interest%20Rate%20Derivatives.md), it can be used to solve for the $0.138\%$ [basis swap](../Chapter%2013/Basis%20Swaps.md) spread. Or, conversely, given the $0.138\%$ [basis swap](../Chapter%2013/Basis%20Swaps.md) spread, it can be used to solve for the $0.078\%$ [swap rate](../../../Fixed%20Income%20Asset%20Pricing/Fixed%20Income%20Lecture%20Notes/Teaching%20Note%204%20Interest%20Rate%20Derivatives.md).  

# A13.2 TWO-CURVE PRICING  

For the purposes of this section, assume for simplicity that payments are annual at times $t=1,\ldots,T$ . For ease of exposition, say that the [risk-free rate](../../../Financial%20Instruments/Black%20Scholes%20Derivation.md) index is STR and that the non-[risk-free rate](../../../Financial%20Instruments/Black%20Scholes%20Derivation.md) index is [Euribor](../Chapter%2012/EURIBOR%20Forward%20Rate%20Agreements%20and%20Futures.md). Given a set of discount factors, $d(t)$ , derived from STR OIS; a set of [Euribor](../Chapter%2012/EURIBOR%20Forward%20Rate%20Agreements%20and%20Futures.md) swap rates, $c(t)$ ; and STR versus [Euribor](../Chapter%2012/EURIBOR%20Forward%20Rate%20Agreements%20and%20Futures.md) [basis swap](../Chapter%2013/Basis%20Swaps.md) spreads, $x(t)$ , the fair [pricing](../Chapter%207/Arbitrage%20Pricing%20of%20Derivatives.md) conditions for the [Euribor](../Chapter%2012/EURIBOR%20Forward%20Rate%20Agreements%20and%20Futures.md) swaps, discussed in the text and the previous section are, for every $t$  
$$
c(t)\sum_{s=1}^{t}d(s)+d(t)=1+x(t)\sum_{s=1}^{t}d(s)
$$  

Now define a set of adjusted [Euribor](../Chapter%2012/EURIBOR%20Forward%20Rate%20Agreements%20and%20Futures.md) forward rates, $L^{\prime}(t)$ , such that the present values of the floating legs of the [Euribor](../Chapter%2012/EURIBOR%20Forward%20Rate%20Agreements%20and%20Futures.md) swaps equal their correct values, which are given by the right-hand side of (A13.3),  
$$
\sum_{s=1}^{t}L^{\prime}(s)d(s)+(1+L^{\prime}(t))d(t)=1+x(t)\sum_{s=1}^{t}d(s)
$$  

Given the [basis swap](../Chapter%2013/Basis%20Swaps.md) spreads, Equation (A13.4) could be used to solve for all of the adjusted [Euribor](../Chapter%2012/EURIBOR%20Forward%20Rate%20Agreements%20and%20Futures.md) forward rates, one at a time, starting with $t=1$ and continuing through to. $t=T$ .These $L^{\prime}(t)$ could then be used to price. payments that depend on [Euribor](../Chapter%2012/EURIBOR%20Forward%20Rate%20Agreements%20and%20Futures.md). However, noticing that the right-hand sides of Equations (A13.3) and (A13.4) are the same, these two equations. can be combined,  
$$
c(t)\sum_{s=1}^{t}d(s)+d(t)=\sum_{s=1}^{t}L^{\prime}(s)d(s)+(1+L^{\prime}(t))d(t)
$$  

But given all of the swap rates,. $c(t)$ , Equation (A13.5) can be used iteratively to solve for the $L^{\prime}(t)$ . In other words, so long as the [Euribor](../Chapter%2012/EURIBOR%20Forward%20Rate%20Agreements%20and%20Futures.md) swaps are. priced fairly relative to STR OIS, there is no need to know the [basis swap](../Chapter%2013/Basis%20Swaps.md) spreads.  

In summary, then, the two-curve methodology for [pricing](../Chapter%207/Arbitrage%20Pricing%20of%20Derivatives.md) [Euribor](../Chapter%2012/EURIBOR%20Forward%20Rate%20Agreements%20and%20Futures.md) swaps is as follows. First, solve for the adjusted forward rates, $L^{\prime}(t)$ , as just described. Second, project those adjusted forward rates as future [Euribor](../Chapter%2012/EURIBOR%20Forward%20Rate%20Agreements%20and%20Futures.md) floating rates to set floating-leg payments. Third, discount both fixed- and floating-leg payments using the STR discount factors.  

# Corporate Debt and Credit Default Swaps  

# A14.1 CUMULATIVE DEFAULT AND SURVIVAL RATES  

Proposition: If the hazard rate is constant at $\uplambda$ , then the [cumulative survival probability](../../Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%207%20-%20Default%20Risk%20and%20Credit%20Derivatives/A%20Constant%20Default%20Probability%20Model.md) to time $t$ $C S(t)$ , is $e^{-\lambda t}$ , and the cumulative default probability, CD(t), is 1 - e-t.  
...
where Equation (A14.4) is the solution to Equation (A14.3). The cumulative default probability is just one minus the [cumulative survival probability](../../Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%207%20-%20Default%20Risk%20and%20Credit%20Derivatives/A%20Constant%20Default%20Probability%20Model.md),. which gives CD(t) = 1 - e-At .  

[Fixed Income Securities](../../../Clippings/Bond%20Equivalent%20Yield%20(BEY)%20-%20Definition,%20Formula,%20and%20Example.md): Tools for Today's Markets, Fourth Edition. Bruce Tuckman and Angel 505 Serrat $\copyright$ 2022 Bruce Tuckman and Angel Serrat. Published 2022 by John Wiley & Sons, Inc..  

# A14.2 UPFRONT AMOUNTS  

Continue with the notation of the previous section, and add the following:  
$s^{C D S}$ : [CDS spread](../Chapter%2014/Cds-Equivalent%20Bond%20Spread.md) cCDS: CDS coupon : $T$ : maturity of the CDS, in years. n: number of CDS premium payments per year $\overline{{\overline{{\mathbf{\alpha}}}}}t_{i}$ : time of CDS premium payment $\quad;i=1,\ldots,n T_{\cdot}$ with $t_{0}\equiv0$ : $d(t_{i})$ : [discount factor](../Chapter%201/Discount%20Factors.md) at time. $t_{i}$ , at risk-free or benchmark rates $\texttt{\textbf{n}}$ : [recovery rate](../../../Credit%20Markets/Credit%20Markets%20Session%203.md) UF: upfront amount  

Then, following the logic described in the text, with the detail that premium payments follow the actual/360 [day-count](../../Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%202%20-%20Spot%20Markets/Intra-Year%20Compounding%20and%20Day-Count.md) convention, the expected discounted value of the fee leg, $V^{f e e}$ , is,  
$$
...
The upfront amount, following the logic of the text, equals the expected. discount value of paying the CDS coupon as a premium payment rather than the [CDS spread](../Chapter%2014/Cds-Equivalent%20Bond%20Spread.md). Essentially, the upfront amount is computed like the fee leg, with $-(c^{\mathrm{{CDS}}}-s^{\mathrm{{CDS}}})$ or $(s^{\dot{C}\dot{D}S}-c^{\dot{C}D S})$ replacing $s^{C D S}$ . Hence,  
$$
...
can be computed along the lines of the contingent leg, except that the payment from the bond upon default is $R$ times the [principal amount](../../../Financial%20Instruments/Financial%20Derivatives%20and%20Quantitative%20Methods/HSBC-Auto%20callable%20Barrier%20Notes%20with%20Step-up%20Premium.md), while the payment due to the buyer of protection upon default is. $1-R$ times the [principal amount](../../../Financial%20Instruments/Financial%20Derivatives%20and%20Quantitative%20Methods/HSBC-Auto%20callable%20Barrier%20Notes%20with%20Step-up%20Premium.md). Therefore, using Equations (A14.5) and (A14.6) - simplified here to assume that [coupon payments](../Chapter%203/Realized%20Returns.md) are exactly one-half years apart - the. price of a bond,. $P$ , with a coupon rate,. $c$ given a hazard rate, is given by,.  
$$
...
Assuming that investors are [risk neutral](../../../Financial%20Instruments/Lecture%20Notes-%20Financial%20Instruments/Teaching%20Note%207-Exotic%20Options%20And%20Derivative%20Pricing%20By%20Monte%20Carlo%20Simulation.md) or that the hazard rate is a [risk-neutral pricing](../../../Financial%20Engineering/Financial%20Mathematics%20Course.md) rate, investors are indifferent between buying a corporate bond and buying a bond without [default risk](../../Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%207%20-%20Default%20Risk%20and%20Credit%20Derivatives/Default%20Risk%20and%20Credit%20Derivatives%20183.md) if the [expected return](../../../Advanced%20Investments/Lecture%201-%20Probability%20Distributions%20of%20Returns.md) of the former, given in Equation (A14.15), is equal to the [risk-free rate](../../../Financial%20Instruments/Black%20Scholes%20Derivation.md). Mathematically, then,  
$$
...
This section very briefly discusses three problems that arise in the context. of [pricing](../Chapter%207/Arbitrage%20Pricing%20of%20Derivatives.md) MBS in [term structure models](../../../Financial%20Engineering/Financial%20Mathematics%20Course.md): path dependence, proxies for the mortgage rate, and factors apart from [interest rates](../Chapter%202/Interest%20Rate%20Quotations.md)..  

As for path dependence, the burnout and media effects imply that the value of an MBs depends not only on the current [term structure of interest rates](../../../Financial%20Engineering/6.%20A%20Brief%20Introduction%20to%20Stochastic%20Calculus.md), but also on the history of the [term structure](../Chapter%209/The%20Vasicek%20Model.md). [Pricing](../Chapter%207/Arbitrage%20Pricing%20of%20Derivatives.md) by backward induction, however, described in earlier chapters of the book, does not naturally accommodate path dependence: at any node of a [binomial tree](../Chapter%207/Rate%20and%20Price%20Trees.md), for example, there is no memory of how the interest rate process moved from its current state to that particular node of the tree.  

A popular solution for [pricing](../Chapter%207/Arbitrage%20Pricing%20of%20Derivatives.md) path-dependent claims is [Monte Carlo simulation](../../../Financial%20Instruments/Pricing%20a%20Callable%20Leveraged%20Constant%20Maturity%20Swap%20Spread%20Note.md). To price a security in this framework, in a one-factor setting, proceed as follows. First, generate a large number of paths of [interest rates](../Chapter%202/Interest%20Rate%20Quotations.md) at the frequency and to the horizon desired. For this purpose, paths are generated using a particular [risk-neutral process](../Chapter%207/Profit%20and%20Loss%20Attribution%20with%20an%20OAS.md) for the short-term rate. Second, calculate the cash flows of the security along each path. In the mortgage context, this would include the security's scheduled payments along with its prepayments. Burnout and the media effect can be implemented in this framework, because each path is available in its entirety as cash flows are calculated. Third, starting at the end of each path, calculate the discounted value of the security's cash flows along each path using the [interest rates](../Chapter%202/Interest%20Rate%20Quotations.md) along that path. Fourth, compute the value of the security as the average of the discounted values across paths.  

To connect [Monte Carlo simulation](../../../Financial%20Instruments/Pricing%20a%20Callable%20Leveraged%20Constant%20Maturity%20Swap%20Spread%20Note.md) with the [pricing](../Chapter%207/Arbitrage%20Pricing%20of%20Derivatives.md) approach used elsewhere in the book, recall Equation (A11.5), reproduced here for convenience,  
$$
P_{0}=E\left[\frac{P_{n}}{\prod_{i=0}^{n-1}(1+r_{i})}\right]
$$  
...
In the [Monte Carlo](../../../Financial%20Instruments/Lecture%20Notes-%20Financial%20Instruments/Teaching%20Note%207-Exotic%20Options%20And%20Derivative%20Pricing%20By%20Monte%20Carlo%20Simulation.md) framework, measures of [interest rate sensitivity](../Chapter%2011/Forward%20Bond%20Yield.md) can be computed by shifting the initial [term structure](../Chapter%209/The%20Vasicek%20Model.md) in some manner, repeating the valuation process, and calculating the difference between the initial and shifted prices. As a numerical matter, paths should not be regenerated between the initial and shifted valuations, as that would introduce noise into the sensitivity calculations.  

A general drawback of [Monte Carlo simulation](../../../Financial%20Instruments/Pricing%20a%20Callable%20Leveraged%20Constant%20Maturity%20Swap%20Spread%20Note.md) is that is does not naturally accommodate the valuation of American- or Bermudan-style options,. because the value of holding an option at any state typically requires [pricing](../Chapter%207/Arbitrage%20Pricing%20of%20Derivatives.md) by backward induction. While methodological advances are now used to overcome this problem,1 the issue does not really arise when valuing the. prepayment option. As it is generally accepted that homeowner behavior is not well explained as the optimal exercise of a [fixed income](../../../Fixed%20Income%20Asset%20Pricing/Lecture%20Notes%20Bonds,%20%20Preferred%20Stock,%20%20and%20Structured%20Products.md) option, a path-dependent prepayment function, which is well-suited to [Monte Carlo simulation](../../../Financial%20Instruments/Pricing%20a%20Callable%20Leveraged%20Constant%20Maturity%20Swap%20Spread%20Note.md), is the preferred approach..  

The second problem addressed in this section relates to the mortgage. rate. Valuing an MBS along a path requires both the benchmark of discounting rates as well as the mortgage rate. Discounting can be done at benchmark rates plus a spread, but the incentive of a prepayment model depends on the current mortgage rate. The difficulty is that calculating the fair mortgage rate at a single date on a single path of a [Monte Carlo simulation](../../../Financial%20Instruments/Pricing%20a%20Callable%20Leveraged%20Constant%20Maturity%20Swap%20Spread%20Note.md) is a problem of the same order of magnitude as the original problem of [pricing](../Chapter%207/Arbitrage%20Pricing%20of%20Derivatives.md) a particular. MBS as of the current state! Common practice, therefore, is to build a simple model of the mortgage rate as a function of benchmark rates and, perhaps,. volatility, for example, an estimated regression model of the mortgage rate as a function of one or more benchmark rates and rate volatility. It may not be trivial to compute long-term benchmark rates along a path of [short-term rates](../Chapter%208/Volatility%20and%20Convexity.md), but this difficulty can usually be overcome with a closed-form solution for long-term rates or with a numerical approximation consistent with the short-term rate process.  

The third problem is that defaults and turnover depend on variables other than [interest rates](../Chapter%202/Interest%20Rate%20Quotations.md), like housing prices, which are not traditionally included in the [pricing](../Chapter%207/Arbitrage%20Pricing%20of%20Derivatives.md) of [fixed income securities](../../../Clippings/Bond%20Equivalent%20Yield%20(BEY)%20-%20Definition,%20Formula,%20and%20Example.md). Incorporating these variables, including their correlations with [interest rates](../Chapter%202/Interest%20Rate%20Quotations.md), is yet another challenge of [pricing](../Chapter%207/Arbitrage%20Pricing%20of%20Derivatives.md) MBS.  
...
1. Given the functional form of a probability distribution (e.g., normal, lognormal), there exist parameters of that distribution such that. $V_{0}$ , the [arbitrage-free price](../../../Financial%20Engineering/Determining%20the%20Stochastic%20Process%20for%20a%20Forward%20Contract%20from%20Ito’s%20Lemma.md) of any asset today, is given by,.  
$$
{\frac{V_{0}}{N_{0}}}=E_{0}\left[{\frac{V_{t}}{N_{t}}}\right]
$$  

where $N_{t}$ is the price at time $t$ of an asset chosen as the numeraire; $\mathbf{}V_{t}$ is value at time $t$ of an asset being priced today, including reinvested cash flows; and. $E_{t}[\cdot]$ gives [expectations](../../../Fixed%20Income%20Asset%20Pricing/Fixed%20Income%20Lecture%20Notes/FORWARD%20RATES%20AND%20TERM%20STRUCTURE.md) as of time $t$ under the appropriately parameterized probability distribution. Equation (A16.1) is known as the [martingale property](../../Financial%20Asset%20Pricing%20Theory%20Overview/Chapter%202%20-%20Uncertainty,%20Information,%20and%20Stochastic%20Processes/Continuous-Time%20Stochastic%20Processes.md) of asset prices. This claim is proved in a special case in Section A16.2 but used more generally here.  
...
Gains process. The gains process of an asset at any time equals the value of that asset at that time plus the value of all its cash flows reinvested to that time. For this purpose, all cash flows are reinvested and then rolled at prevailing short-term [interest rates](../Chapter%202/Interest%20Rate%20Quotations.md).  
...
These definitions allow for the statement of the main result of this section: in the [absence of arbitrage](../../Financial%20Asset%20Pricing%20Theory%20Overview/Chapter%2012%20-%20Derivatives/Exercises.md) opportunities, there exists a parameter-. ization of a given probability distribution, or a [pricing](../Chapter%207/Arbitrage%20Pricing%20of%20Derivatives.md) measure, such that the normalized gains of any asset today equals the expected value of that asset's normalized gains in the future. Technically, there exist probabilities such that the normalized gains process is a martingale. As the goal here is. intuition rather than mathematical generality, this result is proven in the context of a single-period, [binomial](../../Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%205%20Options%20on%20Prices%20and%20Hedge-Based%20Valuation/A%20Real-Life%20Option%20Pricing%20Exercise.md) process..  
...
Then, to rule out risk-free [arbitrage opportunities](../../../Financial%20Markets%20and%20Institutions/III.%20Liquidity%20of%20Assets/Class%208-%20Markets,%20Meltdowns,%20and%20Arbitrage/Class%20Note%2013%20The%20LTCM%20Meltdown.md), it must be the case that,  
$$
...
Equation (A16.23) just rearranges the terms of (A16.22); combining. (A16.23) with (A16.17) and (A16.18) gives (A16.24); and (A16.24) with (A16.16) gives (A16.25). Hence, as was to be shown, there is a [pricing](../Chapter%207/Arbitrage%20Pricing%20of%20Derivatives.md) measure, in this case the probability. $p$ , such that the normalized gains processes. of B and C are martingales. And, of course, since nothing distinguishes A from the other assets, a probability with the same properties could have. been found had B or C been chosen as the numeraire instead..  
...
Therefore, the [martingale property](../../Financial%20Asset%20Pricing%20Theory%20Overview/Chapter%202%20-%20Uncertainty,%20Information,%20and%20Stochastic%20Processes/Continuous-Time%20Stochastic%20Processes.md) for the bond says that,  
$$
...
So, applying the [martingale property](../../Financial%20Asset%20Pricing%20Theory%20Overview/Chapter%202%20-%20Uncertainty,%20Information,%20and%20Stochastic%20Processes/Continuous-Time%20Stochastic%20Processes.md) under the numeraire to a payment of $c(1+r_{2})$ on date 2 requires that,  
$$
...
With this result, the discussion [returns](../../Financial%20Asset%20Pricing%20Theory%20Overview/Chapter%203%20-%20%20Assets,%20Portfolios,%20and%20Arbitrage/Assets.md) to the [martingale property](../../Financial%20Asset%20Pricing%20Theory%20Overview/Chapter%202%20-%20Uncertainty,%20Information,%20and%20Stochastic%20Processes/Continuous-Time%20Stochastic%20Processes.md) of the bond in (A16.26). Substituting (A16.28) into (A16.26),  
$$
...
The left-hand side of the second line of (A16.29) is the date 0 [forward price](../Chapter%2011/Forward%20Contracts%20and%20Forward%20Prices.md) of the bond for delivery on date 2. The third line, then, simply denotes this [forward price](../Chapter%2011/Forward%20Contracts%20and%20Forward%20Prices.md) by $B_{0}(2)$ . Hence, taking the zero coupon bond of maturity. $T$ as a numeraire, the [forward price](../Chapter%2011/Forward%20Contracts%20and%20Forward%20Prices.md) of a bond for delivery on date $T$ is a martingale.  

Turning now to the price of an option on the bond, consider a call with payoff $(B_{T}-K)^{+}$ . Applying the [martingale property](../../Financial%20Asset%20Pricing%20Theory%20Overview/Chapter%202%20-%20Uncertainty,%20Information,%20and%20Stochastic%20Processes/Continuous-Time%20Stochastic%20Processes.md) to the option price and assuming that the forward bond price is lognormal with volatility parameter $\sigma$ , the call option is priced as,  
$$
...
The terminal payoff of a [Euribor futures](../Chapter%2012/EURIBOR%20Forward%20Rate%20Agreements%20and%20Futures.md) call option with strike $K$ and expiration time $T$ is, per unit notional,  
$$
[K-f_{T}(T,T+\tau)]^{+}
$$  

Given the [daily settlement](../Chapter%2011/Pricing%20and%20Hedging%20Implications%20of%20Daily%20Sett.md) feature of [Euribor futures](../Chapter%2012/EURIBOR%20Forward%20Rate%20Agreements%20and%20Futures.md) options, the numeraire of choice is the money market account, the value of one unit of [currency](../../../Financial%20Instruments/Lecture%20Notes-%20Financial%20Instruments/Teaching%20Note%201-%20Forward%20Rates%20Agreement/Forwards%20and%20Futures%20Notes.md) invested and then rolled every period, at the prevailing short-term rate. Denoting the money market account by $M(t)$ and the short-term rate from time t - 1 to t by rt,  
$$
M(0)=1
$$  
$$
...
The first point to make about the money market account is that it is the numeraire of the risk-neutral short-term rate process used in the [term structure models](../../../Financial%20Engineering/Financial%20Mathematics%20Course.md) presented earlier in the book. To see this, apply the [martingale property](../../Financial%20Asset%20Pricing%20Theory%20Overview/Chapter%202%20-%20Uncertainty,%20Information,%20and%20Stochastic%20Processes/Continuous-Time%20Stochastic%20Processes.md) with the numeraire to an arbitrary gains process. $V_{t}$ at time $t$  
$$
...
The second point to make about the money markets as numeraire is that [futures](../../Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md) prices are martingales under this numeraire. This is proved in Section A16.5.  

Turning now to [Euribor futures](../Chapter%2012/EURIBOR%20Forward%20Rate%20Agreements%20and%20Futures.md) options, because they are subject to [daily settlement](../Chapter%2011/Pricing%20and%20Hedging%20Implications%20of%20Daily%20Sett.md) and are [futures contracts](../../../Financial%20Engineering/Mathematics%20of%20the%20Financial%20Markets.md), their prices are also martingales with the money market account as numeraire. Furthermore, if $F_{t}$ is the underlying. [futures price](../Chapter%2011/Futures%20Price%20and%20the%20Quality%20Option%20Before%20E.md) at time. $t$ , then at the expiration of a put option on the [futures price](../Chapter%2011/Futures%20Price%20and%20the%20Quality%20Option%20Before%20E.md) (call on rates) at time $T$ , the option is worth. $(F_{T}-K)^{+}$ . Putting together the [martingale property](../../Financial%20Asset%20Pricing%20Theory%20Overview/Chapter%202%20-%20Uncertainty,%20Information,%20and%20Stochastic%20Processes/Continuous-Time%20Stochastic%20Processes.md) of the [futures](../../Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md), (A16.38), the [martingale property](../../Financial%20Asset%20Pricing%20Theory%20Overview/Chapter%202%20-%20Uncertainty,%20Information,%20and%20Stochastic%20Processes/Continuous-Time%20Stochastic%20Processes.md) of [futures](../../Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md) options, (A16.39), and the [final settlement price](EURIBOR%20Futures%20Options.md) of the [futures](../../Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md) options, (A16.40), results in the price of the [Euribor futures](../Chapter%2012/EURIBOR%20Forward%20Rate%20Agreements%20and%20Futures.md) put option at time t, denoted vEBPut,  
$$
...
Similarly, for the [Euribor futures](../Chapter%2012/EURIBOR%20Forward%20Rate%20Agreements%20and%20Futures.md) call option (put on rates),  
$$
...
As shown in Section A16.5, [futures](../../Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md) prices are a martingale in the [risk-neutral measure](../../../Financial%20Engineering/Verifying%20Martingale%20Property%20with%20Q.md), that is, when the numeraire is the money market account, $M(t)$ Hence, with $F_{t}$ the underlying bond [futures price](../Chapter%2011/Futures%20Price%20and%20the%20Quality%20Option%20Before%20E.md) at time. $t$  
$$
F_{0}=E[F_{T}]
$$  

By the [martingale property](../../Financial%20Asset%20Pricing%20Theory%20Overview/Chapter%202%20-%20Uncertainty,%20Information,%20and%20Stochastic%20Processes/Continuous-Time%20Stochastic%20Processes.md), the price of a put option on the [futures](../../Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md) is,  
$$
...
To continue, make the assumption - defended in the text -- that the [discount factor](../Chapter%201/Discount%20Factors.md) is uncorrelated with the [futures price](../Chapter%2011/Futures%20Price%20and%20the%20Quality%20Option%20Before%20E.md). Then, Equation (A16.45). becomes,  
$$
...
where (A16.47) follows from the [risk-neutral pricing](../../../Financial%20Engineering/Financial%20Mathematics%20Course.md) of a zero coupon bond. Finally, applying Section A16.5 to (A16.43), (A16.47) with the assumption that the bond [futures price](../Chapter%2011/Futures%20Price%20and%20the%20Quality%20Option%20Before%20E.md) has a lognormal distribution,.  
$$
...
Caplets that mature at time $T$ are written on a [forward rate](../../../Clippings/Forward%20Points%20in%20Currency.md) from time $T$ to $T+\tau$ , whose value, at time $t$ , is denoted by $f_{t}(T,T+\tau)$ . It is first shown that taking a $T+\tau$ -year zero coupon bond as the numeraire makes this [forward rate](../../../Clippings/Forward%20Points%20in%20Currency.md) a martingale. Let $d_{t}(T)$ be the time- $\cdot t$ price of a zero coupon bond maturing at time $T$ . By the definition of a [forward rate](../../../Clippings/Forward%20Points%20in%20Currency.md) of term $\tau$  
$$
...
Next, consider a [portfolio](../../../Advanced%20Investments/An%20Asset%20Allocation%20Primer.md) that is long a. $T$ -year zero and short a. $T+\tau$ -year zero. Taking the. $T+\tau$ -year zero as the numeraire, the normalized. gains process of this [portfolio](../../../Advanced%20Investments/An%20Asset%20Allocation%20Primer.md) is a martingale. Mathematically,  
$$
...
where the last line of (A16.51) just uses the definition of the [forward rate](../../../Clippings/Forward%20Points%20in%20Currency.md). Combining (A16.50) and (A16.51) shows that the [forward rate](../../../Clippings/Forward%20Points%20in%20Currency.md) is a martingale under the chosen numeraire,  
$$
f_{t}(T,T+\tau)=E_{t}[f_{T}(T,T+\tau)]
$$  

Turning to the valuation of the caplet, its normalized gains process is. a martingale as well. Hence, taking [expectations](../../../Fixed%20Income%20Asset%20Pricing/Fixed%20Income%20Lecture%20Notes/FORWARD%20RATES%20AND%20TERM%20STRUCTURE.md) of its normalized gain as of $T+\tau$  
$$
...
Finally, assuming that the [forward rate](../../../Clippings/Forward%20Points%20in%20Currency.md) $f_{T}(T,T+\tau)$ is normal with variance $\sigma^{2}T$ , and knowing from (A16.52) with $t=0$ that its mean is $f_{0}(T,T+\tau)$ , the results of Section A16.4 apply and,  
$$
...
The underlying of a $T$ -year into $\tau$ -year swaption is the forward [par swap](../../../Financial%20Engineering/Fixed%20Income%20Derivatives/Determining%20the%20Expression%20for%20the%20Fair%20Value%20of%20the%20Swap%20Spread.md) rate from $T$ to $T+\tau$ , which, at time $t$ , is denoted by $C_{t}(T,T+\tau)$ . It is first shown that taking an annuity from $T$ to $T+\tau$ as the numeraire makes this forward [par swap](../../../Financial%20Engineering/Fixed%20Income%20Derivatives/Determining%20the%20Expression%20for%20the%20Fair%20Value%20of%20the%20Swap%20Spread.md) rate a martingale. Denote the price of this annuity by $A_{t}(T,T+\tau)$  
...
Applying the [martingale property](../../Financial%20Asset%20Pricing%20Theory%20Overview/Chapter%202%20-%20Uncertainty,%20Information,%20and%20Stochastic%20Processes/Continuous-Time%20Stochastic%20Processes.md) with this annuity as numeraire,  
$$
...
Hence, as claimed, the forward [par swap](../../../Financial%20Engineering/Fixed%20Income%20Derivatives/Determining%20the%20Expression%20for%20the%20Fair%20Value%20of%20the%20Swap%20Spread.md) rate is a martingale under this numeraire.  
...
The last line of (A16.58) follows from (A16.57), the assumption that the forward [par swap](../../../Financial%20Engineering/Fixed%20Income%20Derivatives/Determining%20the%20Expression%20for%20the%20Fair%20Value%20of%20the%20Swap%20Spread.md) rate is normal with variance $\sigma^{2}T$ , and the appropriate result from Section A16.4.  
...
As the results in this section are part of the option [pricing](../Chapter%207/Arbitrage%20Pricing%20of%20Derivatives.md) literature, they are presented here for easy reference but without proof. Let $E^{N}[\cdot]$ and $E^{L N}[\cdot]$  

denote the [expectations](../../../Fixed%20Income%20Asset%20Pricing/Fixed%20Income%20Lecture%20Notes/FORWARD%20RATES%20AND%20TERM%20STRUCTURE.md) operators under the normal and lognormal distributions, respectively, and let $N(\cdot)$ denote the standard normal cumulative distribution.  
...
The initial value of a [futures](../../Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md) contract is zero; subsequent cash flows are from daily settlements; and at maturity, the [futures price](../Chapter%2011/Futures%20Price%20and%20the%20Quality%20Option%20Before%20E.md) is determined by some final settlement rule. Consider a two-period, three-date framework for simplicity, and let the [futures price](../Chapter%2011/Futures%20Price%20and%20the%20Quality%20Option%20Before%20E.md) on date. $t$ be $F_{t}$ . Then, the normalized. gains process is,  
$$
...
Since the value of a [futures](../../Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%203%20-%20Futures%20Markets/Futures%20Not%20Subject%20to%20Cash-And-Carry.md) contact on date O is zero, the [martingale property](../../Financial%20Asset%20Pricing%20Theory%20Overview/Chapter%202%20-%20Uncertainty,%20Information,%20and%20Stochastic%20Processes/Continuous-Time%20Stochastic%20Processes.md) implies that the expectation of the normalized gains at any future date is zero. In particular, for date 1,  
$$
...
As of date 2, the [martingale property](../../Financial%20Asset%20Pricing%20Theory%20Overview/Chapter%202%20-%20Uncertainty,%20Information,%20and%20Stochastic%20Processes/Continuous-Time%20Stochastic%20Processes.md) says that  
$$
0=E_{0}\left[\frac{(F_{1}-F_{0})(1+r_{2})+F_{2}-F_{1}}{(1+r_{1})(1+r_{2})}\right]
$$  

Using the [law of iterated expectations](../../Financial%20Asset%20Pricing%20Theory%20Overview/Chapter%2011%20-%20Risk-adjusted%20probabilities/General%20Risk-Adjusted%20Probability%20Measures.md), and the fact that $r_{1}$ is known as of date 0,  
$$
...
Together with (A16.68), (A16.72) shows that the [futures price](../Chapter%2011/Futures%20Price%20and%20the%20Quality%20Option%20Before%20E.md) is a martin-.   
gale under the [money-market account](../../../Financial%20Engineering/Appendices/Appendix%205.C%20Forward%20And%20Futures%20Prices%20When%20Interest%20Rates%20Are%20Random.md) or [risk-neutral measure](../../../Financial%20Engineering/Verifying%20Martingale%20Property%20with%20Q.md), as desired.  