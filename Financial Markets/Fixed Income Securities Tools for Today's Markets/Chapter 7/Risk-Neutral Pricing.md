...
[[Financial Mathematics Course|Risk-neutral pricing]] is a technique that modifies an assumed interest rate. process, like the one assumed at the start of this chapter, so that any contingent claim can be priced without having to construct and price its replicating. [[An Asset Allocation Primer|portfolio]]. Because the technique requires that the original interest rate pro-. cess be modified only once, and because this modification requires no more effort than [[Arbitrage Pricing of Derivatives|pricing]] a single contingent claim by [[Arbitrage Pricing of Derivatives|arbitrage]], risk-neutral pric-. ing is an extremely efficient way to price many contingent claims under the same assumed rate process.  

In the example of this chapter, the price of a one-year zero does not. equal its expected discounted value: its price is. $\$978.842$ , computed from the given one-year spot rate of. $2.15\%$ , while its expected discounted value is. $\$980.302$ , as derived in Equation (7.2). The probabilities of 0.5 for the up-. and down-states are the assumed true or [[Change of Probability Measure|real-world probabilities]]. But there are other probabilities, called [[Financial Instruments|risk-neutral probabilities]], which do cause the. expected discounted value to equal the market price. To find these probabilities, let the [[Financial Instruments|risk-neutral probabilities]] in the up- and down-states be. $\boldsymbol{p}$ and $(1-p)$ , respectively. Then, solve the following equation,  
$$
{\frac{{\frac{{\S987.654\phi+\S992.556(1-\phi)}{\left({\bf1}+{\frac{.02}{2}}\right)}}}={\S978.842}}{{\left({\bf1}+{\frac{.02}{2}}\right)}}}
$$  

to find that $p=.8009$ . Hence, under the [[Financial Instruments|risk-neutral probabilities]] of .8009 and .1991, the expected discounted value does equal the market price.  

[[Financial Instruments|Risk-neutral probabilities]] can also be described in terms of the [[Risk-Neutral Pricing|drift in interest rates]]. Under the true probabilities, there is a $50\%$ chance that the six-month rate rises from $2\%$ to $2.50\%$ , and a $50\%$ chance that it falls from $2\%$ to $1.50\%$ . Hence, the expected change in the six-month rate, or the drift of the six-month rate, is zero. Under the [[Financial Instruments|risk-neutral probabilities]], there is an $80.09\%$ chance of a 50-basis point increase and a $19.91\%$ chance of a 50-basis point decrease, for an expected change of 30.09 basis points. Hence, the drift of the six-month rate under these probabilities is 30.09 basis points.  

As pointed out in the previous section, the expected discounted value of the option payoff is $\$1.2653$ , while the arbitrage price is $\$0.504$ . But if expected discounted value were computed using the [[Financial Instruments|risk-neutral probabilities]], the resulting option value would equal its [[Arbitrage Pricing of Derivatives|arbitrage]] price,  
$$
\frac{.8009\times\S0+.1991\times\S2.555831}{\left(1+\frac{.02}{2}\right)}=\S0.504
$$  

The fact that the [[Arbitrage Pricing of Derivatives|arbitrage]] price of the option equals its expected. discounted value under the [[Financial Instruments|risk-neutral probabilities]] is not a coincidence. In general, to value contingent claims by [[Financial Mathematics Course|risk-neutral pricing]], proceed as follows. First, find the [[Financial Instruments|risk-neutral probabilities]] that equate the prices of the [[Rate and Price Trees|underlying securities]] to their expected discounted values. (In the simple. example here, the only risky, underlying security is the one-year zero.) Second, price the contingent claim by expected discounted value under these [[Financial Instruments|risk-neutral probabilities]]. The remainder of this section describes intuitively why [[Financial Mathematics Course|risk-neutral pricing]] works. Since the argument is a bit complex, it is broken up into four steps:.  

1. Given trees for the [[Rate and Price Trees|underlying securities]], the price of a security that is. priced by [[Arbitrage Pricing of Derivatives|arbitrage]] does not depend on investors' risk preferences. The reasoning is as follows..  

A security is priced by [[Arbitrage Pricing of Derivatives|arbitrage]] if its cash flows can be replicated by some [[An Asset Allocation Primer|portfolio]] of [[Rate and Price Trees|underlying securities]]. Under the assumed process for [[Interest Rate Quotations|interest rates]] in this chapter, the bond option is priced by [[Arbitrage Pricing of Derivatives|arbitrage]]. By contrast, it is unlikely that a specific common stock can be priced by [[Arbitrage Pricing of Derivatives|arbitrage]], because no [[An Asset Allocation Primer|portfolio]] of [[Rate and Price Trees|underlying securities]] can mimic the idiosyncratic fluctuations of a single common stock's market value.  

If a security is priced by [[Arbitrage Pricing of Derivatives|arbitrage]], and if everyone agrees on the price. evolution of the [[Rate and Price Trees|underlying securities]], then everyone agrees on the repli-. cating [[An Asset Allocation Primer|portfolio]]. In the option example, both an extremely risk-averse, retired investor and a professional gambler agree that a [[An Asset Allocation Primer|portfolio]] of $\$521.4375$ face of one-year zeros and -. $\$515.0000$ face of six-month zeros replicates the option. And because they agree both on the com-. position of the [[Pricing Forwards, Futures, Bonds, Swaps, Swaptions, Caps and Floors under No-Arbitrage and Risk-Neutral Pricing|replicating portfolio]] and on the prices of the underlying. securities, they must also agree on the price of the option..  

2. Imagine an economy that has the same current bond prices and possible future values of the six-month rate as the true economy. The imaginary economy is different, however, in that its investors are [[Teaching Note 7-Exotic Options And Derivative Pricing By Monte Carlo Simulation|risk neutral]]. Unlike investors in the true economy, then, investors in the imaginary economy do not penalize securities for risk: they price securities by expected discounted value. In particular, under the prob-. abilities in the imaginary economy, the expected discounted value of the one-year zero equals its market price. But, by Equation (7.7), the expected discounted value of the one-year zero does equal its market.  

price under the [[Financial Instruments|risk-neutral probabilities]] of .8009 and .1991. Hence, these [[Financial Instruments|risk-neutral probabilities]] are the probabilities in the imaginary economy.  
...
FIGURE 7.3 A Recombining [[A Real-Life Option Pricing Exercise|Binomial]] [[Rate and Price Trees|Rate Tree]].  

Continuing where the option example left off, having derived the. risk-neutral tree for [[Arbitrage Pricing of Derivatives|pricing]] a one-year zero, the goal is to extend the tree. to price a 1.5-year zero assuming that the 1.5-year [[The Foreign Exchange Market Annotations|spot rate]] is $2.25\%$ Ignoring the probabilities for a moment, several nodes of the 1.5-year zero [[Rate and Price Trees|price tree]] can be written down immediately, as shown in Figure 7.4. On date 3, the zero with an original term of 1.5 years matures and is worth its. face value of $\$1,000$ . On date 2, the value of the then six-month zero equals its face value discounted for six months at the then-prevailing spot rates of $3\%,2\%$ , and $1\%$ , in states 2, 1, and 0, respectively,  
$$
...
FIGURE 7.4 [[Rate and Price Trees|Price Tree]] for a 1.5-Year Zero Coupon Bond.  

Finally, on date 0, the 1.5-year zero equals its face value discounted at the given, 1.5-year [[The Foreign Exchange Market Annotations|spot rate]],  
$$
...
By definition, the expected discounted value under [[Financial Instruments|risk-neutral probabilities]] recovers market prices. With respect to the 1.5-year zero price on. date 0, this requires that,  
$$
...
FIGURE 7.5 [[Rate and Price Trees|Price Tree]] for a 1.5-Year Zero Coupon Bond, with Probabilities.  
...
The difference between the true and [[Financial Instruments|risk-neutral probabilities]] may once again be described in terms of drift. From dates 1 to 2, the drift under the true probabilities is zero. Under the [[Financial Instruments|risk-neutral probabilities]], the drift is computed from a $65.20\%$ chance of a 50-basis-point increase in the six-month. rate and a $34.80\%$ chance of a 50-basis-point decline in the rate. These numbers give a drift or expected change of 15.20 basis points..  

Substituting $q=0.6520$ back into Equations (7.14) and (7.15) completes the tree for the price of the 1.5-year zero, which is shown in Figure 7.7. It follows immediately from this tree that the one-year [[The Foreign Exchange Market Annotations|spot rate]] in six months may be either $2.5754\%$ or $1.5754\%$ , because,  
$$
...
The fact that the possible values of the one-year [[The Foreign Exchange Market Annotations|spot rate]] can be. extracted from the tree is at first surprising. The starting point of the example is the date 0 values of the. $0.5\cdot,1-$ , and 1.5-year spot rates, along. with assumptions about the evolution of the six-month rate over the next years. But because this information, in combination with [[Arbitrage Pricing of Derivatives|arbitrage]]. or risk-neutral arguments, is sufficient to determine the [[Rate and Price Trees|price tree]] of the 1.5-year zero, it is also sufficient to determine the possible values of the one-year [[The Foreign Exchange Market Annotations|spot rate]] in six months. Put another way, having specified initial.  

![](d8d12f91c9e74acdeaeef1ec78c2ee22cb94c63f7d11bb92360d396f0a287f48.jpg)  
FIGURE 7.6 [[Profit and Loss Attribution with an OAS|Risk-Neutral Process]] for the Six-Month Rate.  

![](c6ecc1837616414ffac4333e73344bc799583540762603f85041c4bd313847d0.jpg)  
FIGURE 7.7 Final [[Rate and Price Trees|Price Tree]] for a 1.5-Year Zero Coupon Bond, with Probabilities.  
...
The six-month rate process completely determines the one-year rate process here, because the model presented has only one factor. Writing down a tree for the evolution of the six-month rate alone implicitly assumes that prices of all [[Bond Equivalent Yield (BEY) - Definition, Formula, and Example|fixed income securities]] can be determined by the evolution of that rate. A multi-factor [[The Vasicek Model|term structure]] model is presented in Chapter 9.  

This section concludes with two additional observations about multi-period settings. First, extending the tree to any number of dates requires assumptions about the future possible values of the short-term rate and the calculation of [[Financial Instruments|risk-neutral probabilities]] that recover a given set of bond prices. Second, the composition of replicating portfolios depends on date and state. For example, the [[Pricing Forwards, Futures, Bonds, Swaps, Swaptions, Caps and Floors under No-Arbitrage and Risk-Neutral Pricing|replicating portfolio]] of a derivative as of date O is usually different from its [[Pricing Forwards, Futures, Bonds, Swaps, Swaptions, Caps and Floors under No-Arbitrage and Risk-Neutral Pricing|replicating portfolio]] on date 1, state 0,. and different again from its [[Pricing Forwards, Futures, Bonds, Swaps, Swaptions, Caps and Floors under No-Arbitrage and Risk-Neutral Pricing|replicating portfolio]] on date 1, state 1. From a trading perspective, this means that replicating portfolios must be adjusted as time passes and as [[Interest Rate Quotations|interest rates]] change. These adjustments are known as [[Lecture Note 5- Black Scholes Formula|dynamic replication]], in contrast to the [[Static Option Replication|static replication]] strategies of earlier chapters, like replicating a coupon bond with an unchanging [[An Asset Allocation Primer|portfolio]] of two other coupon bonds of the same maturity..  
...
Finally, the value of the swap on date O is the expected discounted value, under the [[Financial Instruments|risk-neutral probabilities]], of the date-1 payoffs, given by Equations (7.24) and (7.25),  
$$
...
FIGURE 7.8 [[Rate and Price Trees|Price Tree]] for a Stylized CMT Swap.  
