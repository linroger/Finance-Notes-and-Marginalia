...
This section argues that yield is not a reliable measure of relative value. In. fact, if two bonds have the same maturity but different yields, it is not nec-. essarily true that the bond with a higher yield is a superior [[An Asset Allocation Primer|investment]]. To explain this, the discussion turns to the [[Spreads|coupon effect]], starting with a simple numerical example and finishing with an empirical demonstration from the US Treasury bond market.  

Say that the one-year [[The Foreign Exchange Market Annotations|spot rate]] is $0\%$ and the two-year [[The Foreign Exchange Market Annotations|spot rate]] is $10\%$ Using the analytics of Chapter 2 and of this chapter, Table 3.1 gives the prices and yields of three two-year bonds with annual coupons of $0\%$ $5\%$ , and $9.5023\%$  
...
According to Table 3.1, the yield of the zero coupon bond is. $10\%$ Because this bond makes only one payment at maturity, its market price. can be found by discounting at either the two-year [[The Foreign Exchange Market Annotations|spot rate]] or at the bond's yield. Hence, those two must be equal at. $10\%$  
...
The yield of the $5\%$ bond, however, is $9.7203\%$ . Equations (3.11) and (3.12) show that the yield of. $9.7203\%$ has to summarize the [[The Vasicek Model|term structure]] of spot rates, or, in other words, that discounting at the yield has to have the same effect as discounting the first [[Preview of the Book|cash flow]] by. $0\%$ and the second by $10\%$ . The result of $9.7203\%$ is between the two spot rates, but a lot closer to. $10\%$ : most of the bond's [[Preview of the Book|cash flow]] comes from the second payment, which includes principal, and that second payment is discounted at $10\%$  

Table 3.1 also reports that the $9.5023\%$ bond, which sells for par, has a yield of $9.5023\%$ . This yield is also between the spot rates of. $0\%$ and $10\%$ and is also a lot closer to $10\%$ but not as close as for the $5\%$ bond. Because the $9.5023\%$ bond pays out relatively more of its value in the first [[Preview of the Book|cash flow]], its yield is closer to $0\%$ than is the yield of the $5\%$ bond.  

In general, the [[Spreads|coupon effect]] can be summarized as follows: when the [[The Vasicek Model|term structure]] of spot rates is upward sloping, bonds with higher coupons, which have more of their value discounted at shorter-term, lower spot rates, have lower yields to maturity. While not part of the discussion here, it is also true that when the [[The Vasicek Model|term structure]] of spot rates is downward sloping, bonds with higher coupons have higher yields.  

The [[Spreads|coupon effect]] makes it very clear that spot rates are meant to. describe [[Arbitrage Pricing of Derivatives|pricing]] in a bond market as a whole, while yields are meant to describe the [[Arbitrage Pricing of Derivatives|pricing]] of individual bonds. Furthermore, even though all of the bonds in the table are fairly priced relative to the [[The Vasicek Model|term structure]] of spot rates, each bond has a different yield. Put another way, the fact that the $0\%$ bond has the highest yield does not mean that it is the best [[An Asset Allocation Primer|investment]].. The fact that the par bond has the lowest yield does not mean that it is the worst [[An Asset Allocation Primer|investment]].  

Figures 3.2 and 3.3 show the [[Spreads|coupon effect]] at work in the US Treasury. market as of mid-May 2021. Figure 3.2 graphs the yields of all Treasury. coupon bonds against their maturity dates. Some bond yields are clearly off the curve. The four points above the curve with maturities from 2040 to. 2041 are relatively newly issued 20-year bonds. The Treasury stopped issu-. ing new 20-year bonds in 1986 but started to do so again in May 2020. These four bonds, therefore, have coupons that reflect the current, low-rate. environment. The other outstanding bonds with similar maturities were orig-. inally issued about 10 years ago as 30-year bonds, and, therefore, have. relatively high coupons, which reflect the interest rate environment at the. time they were issued.  

Table 3.2 shows the coupons and yields of these four newly issued. 20-year bonds, each paired with the coupons and yields of old 30-year bonds of the same maturity. As expected, because of the [[Spreads|coupon effect]] and the upward-sloping [[Expectations|term structure of rates]], the high-coupon, old 30-year bonds have lower yields than the low-coupon, newly issued 20-year bonds.. More analysis is needed, of course, to say that any one bond in this table is cheap or rich relative to another. But, because of the [[Spreads|coupon effect]], the fact that the new 20-year bonds have higher yields does not necessarily imply that they are better investments.  
