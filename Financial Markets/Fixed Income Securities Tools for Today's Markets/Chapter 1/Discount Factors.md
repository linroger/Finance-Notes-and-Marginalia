...
The [discount factor](.md) for a particular term gives the value today, or the present. value, of one unit of [currency](../../../Financial%20Instruments/Lecture%20Notes-%20Financial%20Instruments/Teaching%20Note%201-%20Forward%20Rates%20Agreement/Forwards%20and%20Futures%20Notes.md) to be received at the end of that term. Denote the [discount factor](.md) for $t$ years by $d(t)$ . Then, for example, if. $d(3.0)=0.99$ the present value of. $\$1$ to be received in three years is 99 cents.  

Because Treasury bonds promise [future cash flows](../../../Financial%20Engineering/Advanced%20Derivatives%20Pricing%20Methodology.md), discount factors can be extracted from Treasury bond prices. In fact, the rows of Table 1.2 can be. used to write equations that relate bond prices to discount factors. Starting. with the first row of the table, that is, with the bond maturing in six months,  
$$
101.4297=\left(100+{\frac{2.875}{2}}\right)d(0.5)
$$  

In words, the price of the 2.875s of 11/15/2021 equals the present value of its [future cash flows](../../../Financial%20Engineering/Advanced%20Derivatives%20Pricing%20Methodology.md), or, more precisely, the sum of its principal and  

coupon cash flows multiplied by the [discount factor](.md) for funds to be received in six months. Solving,. $d(.5)=0.999923.$ 2  
...
Figure 1.1 shows discount factors, in six-month intervals, from the. bonds listed in Table 1.2 and other bonds, not shown here, which have maturity dates on November 15 and May 15 out to 10 years. Discount factors can again be seen to decrease with term, with the value of. $\$1$ to be received in 10 years worth less than 85 cents as of the [pricing](../Chapter%207/Arbitrage%20Pricing%20of%20Derivatives.md) date..  
