...
$$
]=Ev-E[vx]=E\leftv-E[v\left[\frac{v}{\sqrt{\frac{\sum_{0}}{\sigma_{u}^{2}}}}-\frac{E[v]}{\sqrt{\frac{\sum_{0}}{\sigma_{u}^{2}}}}\right]\right]=\frac{\sum_{0}}{\sqrt{\frac{\sum_{0}}{\sigma_{u}^{2}}}}=\sqrt{\sum_{0}\sigma_{u}^{2}}=\sqrt{\sum_{0}\sigma_{u}^{2}}\mathrm{~,~}
$$  
