...
The shape of the yield curve has implications that are not always well understood.1. A curve whose slope rolls off' can imply a future [[Forward Curves Duration and Convexity|curve inversion]], even when such an inversion is very unlikely to take place. Since the 2008 crisis, curves have become lower and flatter, and their implied forecasts' start to look improbable. In this chapter, we report and update a study where we analysed the actual evolution of. curves long-term relative to their implied forecasts, and we show that in particular, forecasts of curve slope are likely to be biased. We investigate whether yield curve [[PSET II Fixed Income Asset Pricing 1|convexity]] is a driver of this effect..

# Are the Forwards a Useful Forecast?

Investors frequently take curve slope positions in liquid [[Forward Curves Duration and Convexity|fixed income products]]. For. example, if they have a view that the EUR yield curve is likely to steepen in the near. future, they might do a 2's-10's trade. If the curve does steepen beyond the slope. implied by the forward curve, the trade will deliver a profit. Investors can trade all parts of the curve from a few months tenor to 50 years, and more complex views. where the anticipated yield curve evolution could involve a change in curvature can also be expressed, often with 3 or 4 rather than 2 positions on the curve..

[[Week 2 Fundamentals Of Forecasting|Forecasting]] these changes is both a science and an art, but one factor that is. frequently taken into consideration is the [[Forward Curves Duration and Convexity|implied forward evolution]] of the yield curve. Each rate has a forward curve, and thus a combination of forward curves (or forward surface) will allow us to create a forward evolution path for the curve slope. Are forward curve slopes a useful indicator for the development of the curve?.

# Why are Forward Curves so 'Abnormal'?

Any prudent investor should always be circumspect about [[The Limits Of Arbitrage|market anomalies]] and ask whether or not there is a justification, which could point to hidden risks when trying to exploit this.

When it comes to forward yield curves, combined technical and fundamental factors explain the unusually flat curves, giving us confidence about a systematic flattening bias in [[Forwards and Futures|forwards]] that should not be realised on average.

Arithmetically, a forward curve is always flatter than the [[Teaching Note 4 Interest Rate Derivatives|spot curve]] if the [[Teaching Note 4 Interest Rate Derivatives|spot curve]] exhibits a concave shape - that is, if the shorter part of the curve is steeper than the longer part of the curve. All major yield curves persistently show this pattern because central bank [[Key Rates O1s Durations and Hedging|key rate]] [[FORWARD RATES AND TERM STRUCTURE|expectations]] dominate the shorter part of the curve out to 5y, the [[Forward Curves Duration and Convexity|term premium effect]] dominates intermediate maturities out to 10/15y maturities while [[PSET II Fixed Income Asset Pricing 1|convexity]] and supply/demand effects dominate the ultralong part of the curve.

Recall that [[PSET II Fixed Income Asset Pricing 1|convexity]] describes the change in [[Key Rates O1s Durations and Hedging|duration]] for a given change in the underlying yield. When yields fall, the [[Key Rates O1s Durations and Hedging|duration]] of a bond with [[Convexity|positive convexity]]. increases, and vice versa. For a long bond investor, [[PSET II Fixed Income Asset Pricing 1|convexity]] is therefore a positive. attribute. Your [[Key Rates O1s Durations and Hedging|duration]] increases when the market rallies, which means your bond. price increases become larger, and the converse is true in a bear market. This also explains why the larger the [[PSET II Fixed Income Asset Pricing 1|convexity]] value, the higher the expected yield volatility. Finally, the [[PSET II Fixed Income Asset Pricing 1|convexity]] of a non-callable bond rises significantly with [[Hedging Strategies with Forwards|time to maturity]], so that ultralong bonds have much higher [[PSET II Fixed Income Asset Pricing 1|convexity]]. For any given level of expected volatility, the [[PSET II Fixed Income Asset Pricing 1|convexity]] value of a longer-dated bond will therefore be higher, and the. yield of this bond will hence be lower..

Besides these technical aspects, supply/demand imbalances are also more relevant for longer maturities. Given the long liabilities of pension funds and life insurers and the persistent [[Duration Gap Management|duration gap]] of most of these ALM accounts, there is strong structural demand for ultralong [[Key Rates O1s Durations and Hedging|duration]]. At the same time, although prudent issuers should try to increase their [[Key Rates O1s Durations and Hedging|duration]] in order to reduce refinancing risk, most issuers have the bulk of their funding in shorter/intermediate maturities, because this generates interest rate savings in the longer run (given the 'normal' curve slope).

Everything considered, a 'normal' curve slope tends to be not only upwardsloping, but also concave - that is, the shorter part out to 10/15y is steeper than the ultralong part. In turn, this means that the forward curve is usually flatter than the [[Teaching Note 4 Interest Rate Derivatives|spot curve]].
...
However, recall that the forward forecast' is only ever purporting to forecast the mean of a distribution - there is always a range of values allowed around this, which would be indicated by the [[Swaption Skew|swaption volatility]]. While we do not examine this effect here, it could well be that a more complete treatment that includes the implied volatilities would resolve the difference between the implied and actual range of moves. More relevant, however, is the question of whether there is any systematic bias in the forecast.
...
(1) 2001-2007: All sections of the curve imply a flattening on average. Actual re sults, however, vary greatly by [[Forwards and Futures Notes|currency]] pair, with no consistent pattern. The range of actual moves is larger than the implied forward moves.
...
Figure 8.11: Average deviation of steepener trade vs [[Forwards and Futures|forwards]]. Source: Commerzbank, Bloomberg
...
Figure 8.12: Average deviation of 10-30y steepener vs [[Forwards and Futures|forwards]] (different periods). Source: Commerzbank, Bloomberg

It is important to realise that this is only an indication of profitability; we have neglected bid-offer costs and have also neglected the fact that when we unwind the trade, we will use 9-year and 29-year rates, not 10-year or 30-year rates. Addition-. ally, this result is valid for a trade held on the books for a year, which is not always. desirable. However, it does indicate that the persistent curve behaviour holds po-. tential and should be kept in mind when making [[An Asset Allocation Primer|investment]] decisions..

We can also create the chart in Figure 8.12 for the 5y forward case, as in Figure 8.13.. In this case, we only look at the full period case and compare it with the 1y for ward, as the data quality is less good for the sub-periods. Though not all investors. will wish to wait 5 years to see their [[Assets|returns]], for those who do, they are substantial. However, recall that these [[Assets|returns]] are over a 5y period and are approximately. linear with time, so it might be better to simply repeat the 1y strategy every year. for five years to generate similar results..

![](e5751c068645ab56decea2f73d12ea1eed99aabf71cb93b1cb093fb1d9f801eb.jpg)
1y and 5y forward steepener, in bp
Figure 8.13: Average deviation of 10-30y steepener vs [[Forwards and Futures|forwards]]. Source: Commerzbank, Bloomberg

# The Value of Convexity

It's natural to ask, 'Where on earth is this fairly consistent return coming from?' The natural first answer is probably something to do with [[PSET II Fixed Income Asset Pricing 1|convexity]]'. To understand. how this might be so, first we define [[PSET II Fixed Income Asset Pricing 1|convexity]] for a coupon bond, and then show. how it can take on a value along the yield curve. To do this, first we need to talk about the [[Key Rates O1s Durations and Hedging|duration]] of a bond as well..

# Defining Duration

The [[Key Rates O1s Durations and Hedging|duration]] of a bond is a quantity with a story. Initially, as one might deduce from the name, it was connected with the tenor of the bond. Specifically, it is the weighted average of the times until the cashflows of the bond are received, as shown in Figure 8.14. This is usually known as the [[Teaching Note 2- Interest Rate Risk Management And Factors|Macaulay Duration]]. There are two good ways to look at MacD - visually and algebraically. The first can lead to the second.

![](9760ef2b5400a3f379845072015895333281c3df89b240bec57b8da16743c4bc.jpg)
Figure 8.14: [[Teaching Note 2- Interest Rate Risk Management And Factors|Macaulay Duration]].
...
Now, let's use this to find the [[Key Rates O1s Durations and Hedging|duration]] MacD:
$$
...
However, these days, MacD is not used as often as its successor, the modified. [[Key Rates O1s Durations and Hedging|duration]]. Though similar in calculation method, the [[A Guide to Duration DV01 and Yield Curve|modified duration]] has a different and specific purpose. It is a [[Duration|price sensitivity]], specifically the percentage. derivative of price with respect to yield (or we could say the first order derivative of bond price with respect to yield). Perhaps it was realised that MacD possessed. this quality to an extent, and thus, [[A Guide to Duration DV01 and Yield Curve|modified duration]] was a better realisation of. sensitivity.

[[A Guide to Duration DV01 and Yield Curve|Modified duration]] is defined as follows:
$$
...
How do we use [[Key Rates O1s Durations and Hedging|duration]]? (Please note that for the rest of this paper, [[Key Rates O1s Durations and Hedging|duration]] will refer to ModD.) Let's take a look at the graph in Figure 8.15.

![](af374a4c608cf065869f68160bbd501068ca97e16ef4ef8eef472dc0e8cbb745.jpg)
Figure 8.15: Linear price-yield relationship. \*Note that although this graph is always drawn with bond price on the y-axis, it is strictly bond return, as [[Key Rates O1s Durations and Hedging|duration]] and later [[PSET II Fixed Income Asset Pricing 1|convexity]] are defined with respect to return Br rather than price. The graph would look just the same in form, but this distinction is important for later on.

If we can assume that the bond price and the bond yield have a linear relation-. ship, then the [[Key Rates O1s Durations and Hedging|duration]] is the ratio between them, or the slope of the line on the graph. Strictly, there needs to be a minus sign in the definition (2) as well, as the slope of the line is negative, though it is usually quoted as a positive number.

Though taking (1) and (2) together, the calculation of the [[Key Rates O1s Durations and Hedging|duration]] will be a sum over the number of years in the tenor, by some algebraic wizardry, we can express it in closed form. To see the full derivation of this formula, see Chua (1984).
$$
...
is critical, and it is this curvature which is represented by [[PSET II Fixed Income Asset Pricing 1|convexity]]. We can see that this curvature is very beneficial to the owner of the bond. Why? Because the price.
is always better than the linear approximation would indicate. Thus, the [[PSET II Fixed Income Asset Pricing 1|convexity]].

measures the change in [[Key Rates O1s Durations and Hedging|duration]] (or slope of the graph) with respect to yield, or we can say it is the second derivative of bond price with respect to yield.

How are we going to calculate this? There are a few ways. First, let's look at good old finite differences. We can derive a value for [[Key Rates O1s Durations and Hedging|duration]] this way as well. We. Set $\Delta\mathrm{r}$ to be $0.01\%$

Table 8.1: [[An Analytical Decomposition of Forward Rates|Duration and convexity]].
...
In Table 8.1, the central line is the same as the previous calculation for the [[Key Rates O1s Durations and Hedging|duration]];.
we are finding the present value of each cashflow of the bond and summing the val-.
ues to get the price. But given that we know that the [[Key Rates O1s Durations and Hedging|duration]] is the first derivative of the bond with respect to price, and the [[PSET II Fixed Income Asset Pricing 1|convexity]] is the second derivative, we can.
...
Another way of estimating the [[PSET II Fixed Income Asset Pricing 1|convexity]] of a bond is to say it is approximately equal to the square of the [[Key Rates O1s Durations and Hedging|duration]]; this is only strictly true for zero-coupon bonds, but is a somewhat useful estimate for other cases.

If we wanted to express [[PSET II Fixed Income Asset Pricing 1|convexity]] as a sum over the tenor of the bond, similar. to (1), then by taking the next derivative of price with respect to yield, we arrive at
$$
C o n v e x i t y=\frac{1}{P(1+y)^{2}}\sum_{i=1}^{n}P V_{i}\left(t_{i}^{2}+t_{i}\right)=27.982
$$

Now, while the expression for [[Key Rates O1s Durations and Hedging|duration]] as a closed form formula (3) is relatively well. known, a similar expression for [[PSET II Fixed Income Asset Pricing 1|convexity]] is not generally found in the literature.. There is an attempt to derive it in Miron and Swannell (1991), but it turns out to be

incorrect. Therefore, we took the time to produce a correct closed-form formula for [[PSET II Fixed Income Asset Pricing 1|convexity]], which makes it far easier to code into a spreadsheet and to look at depen. dencies. But it's a little longer than the formula for [[Key Rates O1s Durations and Hedging|duration]].
...
It is very pleasing to be able to write [[PSET II Fixed Income Asset Pricing 1|convexity]] in this way, as it can be seen that it depends only on coupon, yield and tenor. Once more, several terms can be added to account for semi-annual or quarterly coupons or stub periods (see Chua [1984], though there are errors in this reference)..

# Numerical Calculation of Convexity

Obviously, this tendency for the price-yield curvature to benefit the bondholder is. valuable. Also pretty obvious is that its value will be larger for larger bond volatilities. In other words, the more the price moves, the greater the [[PSET II Fixed Income Asset Pricing 1|convexity]] effect will. be. Let's see if we can put numbers onto the effect..
...
where $\mathrm{y_{0}}$ is the forward bond yield for a [[Forward Points in Currency|forward contract]] maturing at time. $t$ and $\mathrm{B_{r}}^{\prime}$ and $\mathrm{B_{r}}^{\prime\prime}$ are the first and second [[Chapter 9 Arbitrage and Hedging With Options|derivatives]] of bond return with respect to yield.

Of course, we know that $\mathrm{B_{r}}^{\prime}=\mathrm{\Omega}$ [[Key Rates O1s Durations and Hedging|duration]] (ModD), and $\mathrm{B_{r}}^{\prime\prime}{=}$ [[PSET II Fixed Income Asset Pricing 1|convexity]] (C)!

Now, we take [[FORWARD RATES AND TERM STRUCTURE|expectations]] of both sides of the equation.
$$
...
where $\upsigma_{\upgamma}$ is the relative yield volatility of the yield, i.e. the [[Swaption Skew|swaption volatility]] for the relevant time forward and tenor. For simplicity, we have used $\mathrm{t}{=}1$ year ahead for the following calculations.

This is gives us the first result. The value of the [[PSET II Fixed Income Asset Pricing 1|convexity]] for a bond is defined as follows:
$$
C o n v e x i t y~\nu a l u e=1/_{2}\sigma_{y}{}^{2}y_{0}{}^{2}t\times C
$$

This is the way you will see [[PSET II Fixed Income Asset Pricing 1|convexity]] value quoted in many texts, especially older ones. However, we need to be careful! These days, volatility in the [[Lecture Notes Bonds,  Preferred Stock,  and Structured Products|fixed income]] world is quoted as 'basis point volatility', not 'relative yield volatility', as it used to be. Basis point volatility is the volatility of yield changes $\Delta y$ , and today is something of the order of $1\%$ for most developed markets. If you see an [[Pricing a Callable Leveraged Constant Maturity Swap Spread Note|implied swaption volatility]] of $^{\bullet}40^{,}$ , it will mean 40 basis points, or $0.4\%$ . Some years ago, it was more usual to quote relative yield volatility - in which case, it might be something like $30\%$ , and it was the volatility of yield changes relative to yield, i.e. $\Delta y/y$ Thus, if we are using basis point volatilities, we have
$$
C o n v e x i t y~\nu a l u e=1/_{2}\sigma_{y}{^2}t\times C
$$

Now, we can just use this as a formula to calculate the value of [[PSET II Fixed Income Asset Pricing 1|convexity]] at a future time t. Note that $t$ is the time forward, not the tenor of the bond. The tenor of the. bond will enter via the formula for C. But what yield should we put into the [[PSET II Fixed Income Asset Pricing 1|convexity]] C? That should be the yield that we assume will hold in the future. This is where forecasts and views can enter and affect the value of [[PSET II Fixed Income Asset Pricing 1|convexity]] that we believe will pertain to the future time. Similarly, we can put the volatility into the formula that. we assume will exist at that time.
...
And inserting [[Key Rates O1s Durations and Hedging|Duration]] ModD and [[PSET II Fixed Income Asset Pricing 1|Convexity]] C, and using $\mathrm{E}_{\mathrm{t}}(\mathrm{y}_{0}){=}\mathrm{y}_{0}$ , we have
$$
...
Though the forward yield assumption is certainly one assumption that may be made, it is not the only one, and [[PSET II Fixed Income Asset Pricing 1|convexity]] values may be calculated using wider assump-. tions than this by using (8) for a wide range of future scenarios. A popular assump-. tion is that current bond [[Assets|returns]] (represented by current bond yields) will pertain in the future.

We can see that (7) and (8) are similar because a very rough approximation for the [[PSET II Fixed Income Asset Pricing 1|convexity]] calculation (only accurate for zero-coupon bonds) is that $\mathsf{C}=\mathbf{M}\mathsf{o d}\mathsf{D}^{2}$ If we also say that $\mathrm{ModD=T}$ ([[A Guide to Duration DV01 and Yield Curve|modified duration]] is somewhat similar to tenor, once. more only accurate for a zero-coupon bond), then they come out to be the same if time ahead $=$ tenor.
...
Figure 8.17: [[Chapter 10 - Bonds: Duration and Convexity|Convexity adjustment]] - bond [[Assets|returns]] constant. Source: Commerzbank, Bloomberg

![](505a0c3e28724b190bc2f9e9a4ac1b866537544cd35fb704ac2e834306464d7c.jpg)
Figure 8.18: [[Chapter 10 - Bonds: Duration and Convexity|Convexity adjustment]] - bond prices follow [[Forwards and Futures|forwards]]. Source: Commerzbank, Bloomberge
...
How have we created the [[Chapter 10 - Bonds: Duration and Convexity|convexity adjustment]]? We have used (7) to calculate. [[PSET II Fixed Income Asset Pricing 1|convexity]] value for Figure 8.17, and (8) for Figure 8.18, and then we added this amount to the bond yield. Figure 8.17 assumes that current bond [[Assets|returns]] (repre-. sented by yields) persist into the future, not that the bond prices will follow the [[Forward Contracts and Forward Prices|forward price]] curve.

It is important to note that though the calculation for the value of [[PSET II Fixed Income Asset Pricing 1|convexity]] is fairly well known, there are different ideas about how to integrate it into the current yield curve. If we assume that the entire market knows the value of [[PSET II Fixed Income Asset Pricing 1|convexity]] and. that this is priced into the curves, then the true' curve would be lower than the mar-. ket values. This is assumed in Ilmanen (1995), but it is by no means universal, and would indicate that the 'true' long-dated [[Assets|returns]] are close to zero. If, rather, we believe that [[PSET II Fixed Income Asset Pricing 1|convexity]] value adds to the current [[Assets|returns]], we would add the [[PSET II Fixed Income Asset Pricing 1|convexity]] value to the yield curve, as in Figures 8.17 and 8.19. It would certainly be possible to make a case that 'some part' of the [[PSET II Fixed Income Asset Pricing 1|convexity]] value is priced in, but that then involves another set of calculations and assumptions, all increasingly made with little data to rely upon. We have therefore used the simplest method and have added [[PSET II Fixed Income Asset Pricing 1|convexity]] value to the current curve, resulting in Figures 8.17 and 8.18.

Many previous papers have shown that generally, prices in FX and [[Interest Rate Quotations|interest rates]] don't necessarily follow the forward curve. Thus if we use the current curve to calculate [[PSET II Fixed Income Asset Pricing 1|convexity]] value (as for Figure 8.17), how much value is there in the curve at the long end? Right at the long end, at the 30y tenor, we see nearly 70 bp of value, whereas at the 10y point, we see about 10 bp of value. Thus, is there perhaps 40 bp (average of 10 and 70) to capture at the current time? Or is some already priced in?

If we say that our 10y-30y steepener trade was at least partly driven by convex-. ity, it regularly captured 15-20 bp of value. From our quick initial calculation, there is certainly enough [[PSET II Fixed Income Asset Pricing 1|convexity]] value in the curve to supply this, even if some is al-. ready priced in.

It is worth a quick note on bond [[Assets|returns]] vs bond yields. Strictly speaking, they. are not the same, but for example in Figure 8.18, following Ilmanen (1995), we have conflated them, which is a frequent assumption. Ilmanen (1995) also assumes that. the [[PSET II Fixed Income Asset Pricing 1|convexity]]-adjusted black curve in Figure 8.17 is analogous to a 1y forward curve and backs out a [[Teaching Note 4 Interest Rate Derivatives|spot curve]] from it. However, to our mind, it is not clear what this [[Teaching Note 4 Interest Rate Derivatives|spot curve]] would represent, as it is not necessarily a forecast or an adjustment..

# The Long End of the Curve

There is increasing interest in very long-dated instruments from investors, not least because they have desirable high [[PSET II Fixed Income Asset Pricing 1|convexity]]. Though there is little useful timeseries data for bonds with tenors greater than 30 years, the swap market is another matter. Spot and [[Chapter 39 - Swaptions, Forward Swaps, and MBS|forward swap]] data are available for the 50y tenor for some years. Though [[Swaption Skew|swaption volatility]] is not available, volatility curves tend to flatten at the long end. so the 30y vol may be used as a proxy for the 50y. In Figures 8.19 and 8.20, we show the swap yield with and without [[Chapter 10 - Bonds: Duration and Convexity|convexity adjustment]], and then in Figure 8.20, we show the 1y [[Chapter 39 - Swaptions, Forward Swaps, and MBS|forward swap]] rate with the same adjustment, which is another way of looking at the [[Lecture 1- Probability Distributions of Returns|expected return]] in a year's time. In fact, in the current environment, forward and spot curves are almost identical..

![](ac89f20007e71ada15d50f9b0b1cfef709410e87f35da71d96680052d97f4496.jpg)
Figure 8.19: [[Chapter 10 - Bonds: Duration and Convexity|Convexity adjustment]] - swap yield. Source: Commerzbank, Bloomberg

![](b4d8f37ffba6a417fe4a190ede8d5bfcee36d9fd41aa8d8536d47629d65eac68.jpg)
Figure 8.20: [[Chapter 10 - Bonds: Duration and Convexity|Convexity adjustment]] - 1y [[Chapter 39 - Swaptions, Forward Swaps, and MBS|forward swap]]. Source: Commerzbank, Bloomberge

As can be seen, the [[Chapter 10 - Bonds: Duration and Convexity|convexity adjustment]] means that longer-term instruments become much more desirable - which may go some way to explain investors' appetite for long-dated instruments.

# Value of Convexity through Time

To see how this [[Chapter 10 - Bonds: Duration and Convexity|convexity adjustment]] has varied in the past, we take historical 1y forward swaption volatilities and German government bond rates, and look at the [[PSET II Fixed Income Asset Pricing 1|convexity]] value of the 30-year point by using the coupon timeseries scaled as previously described. In Figure 8.21, it is about 60-70 bp at the current time. We see that this is in fact fairly modest and that [[PSET II Fixed Income Asset Pricing 1|convexity]] has had significant value in previous years. We then perform the same operation for the 50y swap rates to obtain Figure 8.22. As may be expected, they show similar patterns, but the adjustment is much larger for the longer tenor.

![](2838542b8e849e58d085c7ca93fb52b82f8e68d303cf4ffb22fc851b03ccf0f4.jpg)
Figure 8.21: [[Chapter 10 - Bonds: Duration and Convexity|Convexity adjustment]] - 30y German bonds. Source: Commerzbank, Bloomberg

![](bc81d89e2c071a3a191b11981af4b2d3ee3bdce68d7ac042b4dbd2fb515747d5.jpg)
Figure 8.22: [[Chapter 10 - Bonds: Duration and Convexity|Convexity adjustment]] - 50y EUR swaps. Source: Commerzbank, Bloomberg

The swaption data was patchy and had to be interpolated and extrapolated at. times, and we have also used an annual approximation for the calculation of [[PSET II Fixed Income Asset Pricing 1|convexity]] -- however, this seems to make little difference..

# Conclusion

Having identified a 10s-30s steepener trade in the long end of the yield curve which seems to deliver consistent [[Assets|returns]] over many currencies, delivering 15-20 bp of value annually, we find that the [[PSET II Fixed Income Asset Pricing 1|convexity]] value extant at those tenors is certainly enough to deliver that level of return, perhaps more. At the 30 year point, the current values of yield and [[PSET II Fixed Income Asset Pricing 1|convexity]] indicate that the [[PSET II Fixed Income Asset Pricing 1|convexity]] value is about 60-70 basis points, which is very significant in these low-yield times. However, in addition to delivering insight to the origin of the [[Assets|returns]] delivered by the trade, this substantial [[PSET II Fixed Income Asset Pricing 1|convexity]] value goes a long way to justifying the current flat curve and. inverted forward curve. We can say that the longer tenor investments are still offering value despite the flat curve environment, once [[PSET II Fixed Income Asset Pricing 1|convexity]] effects are taken into consideration.

It is clear from this analysis that the market systematically undervalues [[PSET II Fixed Income Asset Pricing 1|convexity]]. Current values would indicate that the long-dated bonds are cheap, but today's [[PSET II Fixed Income Asset Pricing 1|convexity]] values are moderate compared to some in the past, so clearly this misvaluation has been in place for some time. This agrees with the persistence of the 10s-30s steepener trade.
