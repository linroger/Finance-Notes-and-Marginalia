...
Then to this we can add the rolling hedge cost, which is the difference between the two swap rates, plus the [[Calculating Novel Cross-Currency Bases a|cross-currency basis]]:
$$
