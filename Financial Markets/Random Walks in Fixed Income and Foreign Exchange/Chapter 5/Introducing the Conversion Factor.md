...
Why does the conversion factor arise? One final way in which it might be useful to think of it is a consequence of the individual [[Advanced Usage of QuantLib analytics library|credit curve]] of a corporate vs the swap. curve. Forward FX rates, and indeed all FX hedge valuations, are calculated using. the swap curves in different currencies. But the [[Advanced Usage of QuantLib analytics library|credit curve]] of a corporate will (al-. most always) trade above the [[Determining the Expression for the Fair Value of the Swap Spread|swap curve]]. So the FX hedge cost does not take into account this differential, which is the [[Cds-Equivalent Bond Spread|credit spread]]. If it did, we would have no need to calculate [[Mechanics of Us Treasury Note and Bond Futures|conversion factors]]. But then different companies would have different forward rates and [[Class Note 10 Liquidity and Class Note 10 Liquidity and Liquidity Managementliquidity management|liquidity]] for any single [[Advanced Usage of QuantLib analytics library|credit curve]] would be very low. It is.
...
far better to calculate all hedges using the highly liquid [[Determining the Expression for the Fair Value of the Swap Spread|swap curve]] and then separately account for credit spreads using [[Mechanics of Us Treasury Note and Bond Futures|conversion factors]].

Still, we need to keep in mind that [[Mechanics of Us Treasury Note and Bond Futures|conversion factors]] calculated from swap. rates remain only an approximation, as the shape of the credit curves can vary as. well in the currencies under consideration. So theoretically, even if the swap rates. were the same in both currencies - that is, the calculated [[Mechanics of Us Treasury Note and Bond Futures|conversion factors]] were equal to 1 - the PVs of future cashflows in different currencies can vary..
...
[[Table of Contents|xccy basis]] could change sign, but that has never been the case except very briefly and to a tiny degree in 2014.
