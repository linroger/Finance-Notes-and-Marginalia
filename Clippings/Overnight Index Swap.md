...
### Key Takeaways
- The interest on the overnight rate portion of the swap is compounded and paid $\$a_t$$ reset dates, with the fixed leg being accounted for in the swap's value to each party.
...
In an overnight index swap, the overnight rate is exchanged for a fixed interest rate](https://www.investopedia.com/terms/f/fixedinterestrate.asp). An overnight index swap uses an overnight rate index such as the federal funds rate as the underlying rate for the floating leg, while the fixed leg would be set $\$a_t$$ a rate agreed upon by both parties.

The interest of the overnight rate portion of the swap is compounded and paid $\$a_t$$ reset dates, with the fixed leg being accounted for in the swap's value to each party.
