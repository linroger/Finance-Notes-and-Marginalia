...
Assume Paul prefers a fixed-rate loan and has loans available at a floating rate (SOFR + 0.5%) or at a fixed rate (10.75%). Mary prefers a floating rate loan and has loans available at a floating rate (SOFR + 0.25%) or at a fixed rate (10%).
