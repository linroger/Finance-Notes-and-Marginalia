...
Since it is variance (volatility squared) which arises naturally from delta-hedging options,  in terms of Leverage, Tail Risk, Volatility Products#6.7 Volatility products | volatility products]],  variance should be thought of as the true underlying. In this framework,  volatility swaps are naturally thought of as derivatives of variance – paying the square-root of the variance swap contract.
...
[^1]: Hedging Inflation/War%20Economies%20and%20Hyperinflation.md) with Real Assets,  John Normand,  July 2006
