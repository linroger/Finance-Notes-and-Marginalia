...
> 
> $$B_{d}=e^{-0.02}\times(5-0.54\times100)=-47.81$$
> 
...
> 
> Hedge: buy 6%/2 × 1 million = 30,000 Euros forward at the 6 month rate of 1.3 and buy 1,030,000 Euros forward at the 1 year rate of 1.29.
...
> and
> 
> $$F_{1/360, 1}=1.29\times e^{(0.025-0.031)\times359/360}=1.28$$
> 
> The value of the forward contracts from part(a)are now:
> 
> $$V_{1/360, 0.5}=e^{-0.02\times179/360}\times30,000\times(1.29-1.30)=-297.03$$
> 
> and
> 
> $$V_{1/360, 1} = e^{-0.025\times359/360} \times 1,030,000 \times (1.28 - 1.29) = -11,263.69$$
...
> 
> $$V_{Euro Bond} = 1.3 \times (e^{-0.02\times0.5} \times 30,000 + e^{-0.03} \times 1,030,000) = 1,338,038.51$$
> 
> The semiannual coupon from the offer is: $1,290,000 \times 0.03 = 38,700$
> 
> The present value of the offer is:
> 
> $$V_{Offer} = e^{-0.02\times0.5} \times 38,700 + e^{-0.025} \times [1,290,000 + 38,700] = 1,327,745.91$$
> 
