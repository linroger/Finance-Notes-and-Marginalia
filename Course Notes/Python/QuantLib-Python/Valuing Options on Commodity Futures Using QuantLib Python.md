...
The futures price $\$a_t$$ time $t$,  $F_{t}$ with a is modeled as:
$$
...
The value of an option $\$a_t$$ strike $K$,  maturing $$a_t$$ $T$,  risk free rate $r$ with volatility $\sigma$ of the underlying is given by the closed form expression:
$$
