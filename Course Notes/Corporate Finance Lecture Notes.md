...
- Investment Decision
  - Purchase decision regarding real or financial assets    o   D is investment or exit decision – sale of some all of an  investment
- Financing Decision
  - Sale of financial assets to fund an investment decision  §   Securities e.g., stocks or bonds  §   Loans
# Assets and Investment Decisions

- Capital Budget/Capital Expenditure
  - Amount to be spent for investment purposes in the year    o   Separate from Operating Budget/Operating Expenses
- Capital Structure
  - Set of liabilities which fund an investment     o   Usually used in reference to a corporation or trust
# Business Organizations
...
- Financial Managers
  - Budgeting, rule setting    o   Financing decisions – capital structure
# Financial Managers
 !500
...
- Friedman doctrine on business and social responsibility
  - Maximize the company’s value    o   Return money to investors (your employers)    o   “Well-functioning” financial markets    o   Investors act through taxation or philanthropy
...
- Agent – someone acting on behalf of others
  - Management  for shareholders and bond holders    o   Investment manager for clients
...
# •   When one reinvests their returns and continues to earn  interest, this is known as  compound interest
 !500
Growth of \$100 $$a_t$$ Different Interest Rates  $
# Present Value
...
# Present Value of \$100 $$a_t$$ Different Interest Rates  $
 !500
# Valuation
...
- Office building will be worth \$800,000 in one year for certain  $
  - PV = \$747,664 $$a_t$$ 7\%    o   Pay \$700,000 so net present value is +\$47,664
# Accounting for Risk

- Expected return:  mean return for project
  - Need to consider all potential outcomes    o   Difficulty in determining outcomes varies  o   Risk determines appropriate discount rate
...
- Opportunity cost must reflect the risk of the opportunity
  - Not necessarily (often unlikely) to equal the cost $\$a_t$$ which  the company investing in the opportunity may borrow    o   Should always be compared to a similarly risky opportunity
...
- Intuitively, consider difference between two perpetuities  starting a t=0 and one $\$a_t$$   $\tt t\mathrm{=}\tt t$  , where t  ≥1
$$
...
- Pension fund contributions:
  - Contribute \$5,000 per year; grow contribution $$a_t$$ 5\% p.a.    o   Expect fund to grow $$a_t$$ 6% p.a.
...
- Example: Initial investment \$1,000  $
  - Continuous interest rate: 5%    o   Number of periods:  3  o   Final value of investment:   \$1,000\% .\%5⋅&   = 1,161.83   o   Annual interest rate equivalent:  $
(\$1161.83/\$1000) !/&   −1 = 5.13%
#
...
- Face Value or Principal – amount to be repaid $\$a_t$$ maturity
# Bond Terminology

- Coupon – payments due $\$a_t$$ each coupon date   o   Cut off and redeemed (hence the term “coupon clippers”)  •   Interest typically paid semi-annually
...
- Coupon note or bond:
  - Trading “$\$a_t$$ par” – price equal to face value (e.g., 100)
  - Trading “below par” or “$\$a_t$$ a discount to par” below 100
§   Current yield is below YTM  §   Creates a capital gain $\$a_t$$ maturity
  - Trading “above par” or “$\$a_t$$ a premium”
...
- The Law of One Price:
  - Cash flows (of identical risk) delivered on a given date  must have the same spot rate    o   If untrue, there would be a risk-free arbitrage opportunity
 !500
Term Structure of Interest Rates
...
- Why does the term structure exist?
  - Liquidity preference    o   Expectations theory  o   Risk  o   Inflation/War%20Economies%20and%20Hyperinflation.md) (Deflation) risk
...
- Value of debt outstanding:  \$100 million (one year zero  coupon)  $
  - Risk free rate: 5% per annum    o   Expected return in one year  = (100 X 1.00 + 100 X .50 + 100 X .10)/3 = 160/3 = 53.33    o   Will pay less than:  53.33/1.05 = 50.79    o   Need more information on market risk profile to say more
# Bond Spreads
 !500
# Credit Ratings
#
...
- Many countries borrow in other currencies, however
  - “Take advantage” of lower rates available from  international investors    o   Part of a currency union  o   “Pegged” currency
# Sovereign Bond Yields
 !500
# Common Stock Trading

- Primary Share Offering
  - Usually an “Initial Public Offering” (IPO)
...
- Dividends
  ...
  - An equity investment may be thought of as a perpetuity
...
- When the market is well functioning
  - All investments with equivalent risk have the same  expected return,  )   Relationship between Stock Prices and Dividends
...
8\$7I\*)\$I \$7)+K+L \%N8#7+T ℎ7I 7[^7]K97_9\$ UN) K+^\$I&8\$+&
...
- But what if the investment requirements for utilities differ  from other businesses?
  - Will return to this $\$a_t$$ the beginning of next lecture
#
...
- Company is recovering from low earnings period
  - Earnings growing $\$a_t$$ only 4% annually    o   Return on equity is 4%
...
[^4]: ℎ9 903;5;CB 4- K3519 3045- 5B  $t o\;p r i c e\;r a t i o\;i s\;{\frac{E P S_{1}}{P_{0}}}=r\left(1-{\frac{P V G O}{P_{0}}}\right)$ U,
...
- Companies trade on a multiple of EBITDA (Earnings Before  Interest, Taxes, Depreciation and Amortization)
  - EBITDA is pre-tax Free Cash Flow (FCF)
...
- Discounted Cash Flows
  - First calculate the value in year 6 of the future cash flows
$$
...
- Many types of investment decisions
  - Mutual fund manager determining a portfolio choice    o   Private equity fund assessing a new investment  o   Information technology head deciding on a new  accounting system  o   Head of retail banking division determining where to open  a new branch
...
§   Now true in almost every country after years of  “financial repression”
  - NPV depends solely on forecasted cash flows and  opportunity cost of capital
...
- Assumptions underlying summing of project NPVs  o   Independence of project outcomes  o   Risk adjusted returns are similar
  - Based on Harry Markowitz’s modern portfolio theory  §    Will cover later in quarter     $N P V(A+B)=N P V(A)+N P V(B)$
...
- Accounting terms
  - Capital investment    o   Operating expenses
- Represents average rate of return across business  o   Need to look $\$a_t$$ marginal return of new activities
# Payback and Discounted Payback
...
- Limitations
  - Ignores cash flows after payback date    o   Equally weights all cash flows  §   Less of an issue in low/no inflation/War%20Economies%20and%20Hyperinflation.md) countries
# Payback Period
...
- Measure NPV of cashflows until end of payback period   o   Have never seen this used – would use NPV and IRR   o   Look $\$a_t$$ payback period to assess
...
- IRR contains built-in assumptions:
  - Interim cashflows are reinvested (or borrowed) $\$a_t$$ the IRR    o   Cash flows either all negative (positive) followed by all  positive (negative)
- If the cashflows cannot be reinvested (borrowed) $\$a_t$$ IRR,  return will be lower (borrowing cost higher)
...
- Common problem facing companies and investors
  ...
  - Examples:
§   New corporate accounting system  •   Buy  •   Build  •   Rent (Software as a Service)    §   Limited number of staff $\$a_t$$ an investment firm
...
- E – D shows incremental IRR and NPV from choosing E over D
  - Same return as D on first \$10,000 and 50\% return on  second \$10,000 – well above opportunity cost of capital
 !500
Machine Tool Example
...
- There is rarely a single interest rate that covers all relevant  time-periods
  - A “flat” yield curve
  - Unlikely to find the perfect discount rate or rates
- Focus on:
...
- Treat inflation/War%20Economies%20and%20Hyperinflation.md) consistently
- Separate investment and financing decisions
- Forecast and deduct taxes
# Cash Flows Not Profits

- Always working from Financial Statements
  - Not designed to represent cash flow    o   Represents business as a “going concern”
...
§   Increasing/decreasing sales  §   Changes in input prices (recently lumber, copper)
  - Omission of recovery of working capital  §   Positive cash flow $\$a_t$$ project’s end
# Discount Incremental Cash Flows
...
Opportunity Costs and Additional Revenue and Expense
  - Example:  unused but rentable office space to be used in  project should be charged $\$a_t$$ market rental rate
- Salvage value
...
- Many companies simply ignore
  - Assumes inflation/War%20Economies%20and%20Hyperinflation.md) low and affects all inputs and outputs  similarly    o   Most problematic when a specific input increases in cost  or output decreases in price relative to others
...
- Present theoretical basis for Separation Principle later
  - Investment’s discount rate based on its risk    o   Financing structure is an independent decision
...
- Investment cash flow has three components:
  - Capital Investment    o   Operating  o   Changes in working capital
- Capital Investment
  - Initial negative cash flow:  plant and equipment, R&D    o   Positive cash flow $\$a_t$$ end:  salvage value or reuse  International Mulch And Compost Company
- Operating Cash Flow
  - Revenues – Expenses – Taxes
  - Expense and tax reduction projects contribute to cash  flow
- Investment in Working Capital
  - Inventories + Accounts Receivable – Accounts Payable  (A/R – A/P is known as “trade credit”)    o   Negative cash flow (when sales are stable or increasing)
 !500
# IM&C Guano Project

- Cash Flow Forecasting
  - Capital Investment
§   Purchase \$12 mm P&E; salvage value \$1.949 mm  §   Difference between salvage value and depreciation is a  (taxable) capital gain $\$a_t$$ 21%
  - Operating Cash Flow
...
# •   Should harvest in year 4 to maximize NPV
  ...
  - Growth rate of cash flow falls below discount rate
...
- Previous example looked $\$a_t$$ life of machinery as fixed
...
- Among other things, value is determined by:  o   Time until expected returns are realized
  - Range of price changes over investment horizon  §   Volatility  §   Liquidity    o   Me a sur ability of potential price changes    o   Availability of mitigants
...
§   Last trade $\$a_t$$ \$39.8 million in 2014  §   Prior trade \$16.39 million in 2011  §   No sales since
...
- Nominal versus Real
  - Nominal – without accounting for inflation/War%20Economies%20and%20Hyperinflation.md)
$$
...
- Arithmetic returns
  - Simple average of annual returns – not weighted by value    o   What to expect for an “average” year based on history
...
Returns Over Time
 !500
- Need to look $\$a_t$$ the effect weighted by dollars $$a_t$$ risk
...
- The expectation for all the countries may have been identical
  - Actual results in the US may simply have been slightly  above average and investor expectations were lower
# Actual versus Expected Risk Premiums
 !500

# •   Stock prices have grown faster than dividends and earnings

  - Investors view stock market as a relatively safer
...
- Returns for many asset classes are assumed to be  approximately normally distributed
  - Not accurate for many    o   Traders and investors “kludge” as needed  o   Reason:  calculations of risk and return mathematically  simply with this assumption
...
- Harry Markowitz postulated as follows, if financial assets have  the following price distribution:
  - Returns of financial asset i, r i , are normally distributed    o   Each r i  has a standard deviation, σ i,  which is constant and   o   A covariance, σ ij , between all other financial assets, j, also  assumed constant
...
- A portfolio of such assets has the following properties:
  - Expected return, r p,  equals the sum of the proportion of  each asset’s return     o   Portfolio variance,   ${\upsigma}_{\uprho}{}^{2}.$  , a determined by the variance of  each asset’s return and that return’s with all other assets
- If all financial assets had these properties:
  - One could construct a minimum variance portfolio     o   At any desired risk level
...
- Market risk accounts for most of the risk of a well-diversified  portfolio
  - Average   $\\beta$   of stocks in the portfolio determine its riskiness
 !500
...
- Markowitz provided a model for risk and return, if:
  - Assets’ returns were normally distributed    o   Variance of asset returns were constant over time  o   There were no transaction or other trading costs
...
- The two-stock portfolio above can be extended to any  number of stocks (and other financial and real assets):
  - As long as the returns of new assets added to the  portfolio are not perfectly correlated with existing  ones, there will be a reduction in overall risk    o   The lower the correlation  among portfolio assets the  greater the risk reduction
# Efficient Portfolios
...
- Conversely, one can create a maximum return portfolio for  each level of risk (measured by standard deviation)
  - These are Efficient Portfolios    o   Relies on assumptions stated above
 !500
Efficient Portfolios
...
- Sharpe, Lintner and Treynor introduced the CAPM
  - Realized that if all investors priced assets as Markowitz  had proposed and     o   All investors could borrow and lend $\$a_t$$ the   risk-free rate:  §   The expected risk premium would be proportional to  !
- Not true for most individuals – good approximation for large  investors and financial intermediaries
# Borrowing and Lending $\$a_t$$ the Risk Free Rate
 !500
...
- Investor A borrows from Investor B
  - Additional  $3\\%$   return requires borrowing \$500,000 $$a_t$$ 2\%  and investing it $$a_t$$ 8% -- net additional
# Creating Leverage:  Example
...
- Archegos was a “family office” run by Bill Hwang
  - Tiger Asia Management found guilty of insider trading in  2012.  Founded by Hwang    o   One year later establishes Archegos Capital Management
- By 2020, 10 large banks had \$50 billion of credit exposure to  Archegos  $
  - Archegos assets believed to be approximately \$10 billion  $
# Archegos
...
- That is, there is a linear relationship between incremental  un divers if i able risk and return
  - A number studies of stock prices have shown this to be  approximately correct but with many anomalies  o   A company’s appropriate discount rate is its weighted  average cost of capital – not solely equity cost
 !500
 !500
 !500
...
- Potential Issues
  - Market mis-defined    o   Borrowing and lending restrictions  o   Equities:  positive and negative auto correlation of returns
 !500
Cumulative Returns
...
- Small versus large companies – CAPM states that only  !   matters
  - Il liquidity and idiosyncratic risks
...
§   If offered a higher return, investors would buy the  portfolio and borrow $\$a_t$$   $r_{f}$  , earning an arbitrage profit  §   If offered a lower return investors would sell the  portfolio and lend $$a_t$$  $r_{f}$  , earning an arbitrage profit
...
- Each asset is valued using its appropriate discount rate
  - “Sum-of-parts” analysis for large multi-line of business  companies    o   Discount each project (or asset) $\$a_t$$ rate $$a_t$$ which the  market would project it could be purchased independently
...
- Example:  Chase Capital Corporation (CCC)
  - Equity component of CCC’s liabilities based on relative  riskiness of investment:
...
- Apply weighted average by product
 !500
- “Franchise Value” versus Business Unit Value  o   Could not have raised outside money $\$a_t$$ these levels
...
[^4]: ℎ\*#\* # "9 5ℎ\* \*8I\*J5\*K #\*5)#L M7# ' N"O\*L 957JP
...
- Text notes CAPM is short-term, so   $r_{f}$   should represent shortterm rate
  - Use short-term interest rate or long-term rate less term  risk premium  §   Text chooses latter, using the long-term bond rate  minus the risk premium
...
- Projects are considered in terms of their own risk,  independent of how they are financed
  ...
  - Known as the asset beta – since represents the riskiness  of the corporate assets versus the market  o   Debt beta may be difficult to calculate, assumed .15
...
§   Comparable s  •   Internal projects  •   Stand-alone businesses
  ...
  - Don’t use fudge factors  §   Adjust cash-flows  §   Conduct break-even, sensitivity and scenario analysis
# Asset Betas
# •   Cyclical it y
...
- High fixed costs.md) relative to others – high asset beta
  - Steel
  - Automotive
...
- Other issues
  - Incorrect [discount rate  §   Project duration
...
- Everyone remembers:
  ...
  - Failure to complete the project on time (or $\$a_t$$ all)
- Text Example:
  - Project Z forecast to create \$1 mm of cash flow in one  year and discount rate is 10\%  $
# Allowing for Poor Outcomes
...
- Numerous implicit assumptions
  - No legal or regulatory issues (intellectual property)    o   Minimal liability issues  o   Additional investment requirements (charging stations)  o   Competitive threats  §   Margin compression – mitigate through supplier prices  §   Rate of unit or price declines  o   Market acceptance
...
- On an annual Accounting basis
  - Need to alter the variable of interest each year to achieve  zero pretax profit    o   Goal Seek works, but one year $\$a_t$$ a time
NPV Breakeven Changes
 !500
- Combined with prior product experience
  - Provides sense of riskiness of project turning NPV negative    o   Shows which categories have narrow window for error
# Operating Leverage and Break-even

- The Degree of Operating Leverage.md) (DOL) is defined as:
&'()'\*+,-' )ℎ,\*-' /\* &(01/+2 !"# =      &'()'\*+,-' )ℎ,\*-' /\* 3,4'2
...
- Calculate expected NPV and NPV $\$a_t$$ different probability  percentages
# Sample Distribution
 !500
...
- Financial and real option evaluation
  - Hedging strategies    o   Next steps regarding an existing project
# Real Options and Decision Trees

- Financial Options
  - Puts and Calls
  - Actively traded on stocks, currencies, commodities and  interest rates (bonds)
- Real Options
  - Ability to modify, delay, abandon or expand a project    o   Companies invest and find situation has changed
# Real Options and Decision Trees

- Financial Options are the right, but not the obligation, to buy  (Call) or sell (Put) a financial asset $\$a_t$$ a fixed price
- Investments in projects or companies may also be viewed as  options.  These are known as Real Options.
- UPS/Boeing
  - In late 2016, UPS and Boeing announced purchase of 14  Boeing 747-8 Freighters and the right to buy 14 additional  §   Pricing undisclosed  §   Most customers pay far below “list”  §   Options may or may not have been priced separately
...
# Decision to continue depends on probabilities and value of  outcomes $\$a_t$$ each stage
 !500
...
- Forecast biases
  - Managers tend to be optimistic:   §   Overestimate returns, underestimate risk
# Capital Budgets
...
- Housing the business in this building only makes sense if  cannot collect $\$a_t$$ least \$8 mm (net) in rent annually  $
# Business Analysis
...
- Assume you could rent out the building in perpetuity and  rents grow $\$a_t$$ the same rate as real estate values, then:   $P V={\frac{\S7\ m m}{.\,10-.3}}=\S100\ m m$
 !500
...
- A US company is considering modifying an existing plant to  produce Polyzone
  - Polyzone would prove very profitable $\$a_t$$ current prices  due to a global shortage
  - The company has no long-run technological or other  competitive advantage
  - Assumptions:
...
Polyzone Production
 !500
- Company looks $\$a_t$$ NPV breakeven pricing for a European  competitor – Polyzone’s inputs largely sourced from Europe  and many of the products users are there as well
Polyzone Production
 !500
...
- Market price $\$a_t$$ \$7 implies two different profit structures
...
- Value to Marvin
  ...
  - Annual net cash flow for 100 mm units:
...
- Why does NPV drop $\$a_t$$ new production above 200 mm?  o   Market size increases; price decreases
...
§   Marvin drives out all first generation competitors and  maintains a price $\$a_t$$ just under \$6.00  $
...
- Have already calculated value of the new plant $\$a_t$$ \$299 mm   $
...
- Shareholder rights without debt
  - Cash-flow Rights    o   Control Rights
...
- Financial Distress.md) and Bankruptcy
  - Owners may be forced to forego dividend payments  or put more money into company    o   Bankruptcy places company under “protection” of  court of law – creditors “estopped”
...
§   Real world less clear-cut  §   Large shareholders; activist investors  •   Own 5% or more of company  •   See this currently regarding ESG issues  §   Large shareholders allow small ones to be freeriders
  - Ability for large shareholders to profit $\$a_t$$ the expense  of small in some cases
# Voting Rights
...
- Public and private companies may issue preferred stock
  - Publicly issued preferred stock receives a preference in  receiving dividend payments
§   Fixed payment to investors – no voting rights  §   If preferred dividends unpaid, no common dividends  paid – typically “cumulative”   §   Limited voting rights may be granted to preferred  shareholders if dividend payments missed
  - Private companies issue preferred stock to give certain  investors, e.g. venture capital, preference in receipt of  proceeds ahead of founders
# Debt Instruments

- Major issues for CFO
  - Debt maturity    o   Fixed or floating rate  o   Currency choice  o   Covenants and collateral    o   Straight or convertible bonds    o   Lease versus buy  Debt Maturity and Fixed versus Floating Rates
...
- Fixed versus floating
  - Do the company’s earnings change with interest rate  levels?    o   Short-term rates generally below long-term
# Currency, Collateral and Covenants

- Try to match expenditures in country with borrowings
  - Eurozone plant selling into Europe financed in Euros    o   Risk of being unable to obtain the currency borrowed
...
- Bonds have the right, $\$a_t$$ the holder’s option, to be converted  into a fixed number of common shares $$a_t$$ a certain price
  - Coupon is below the coupon required on a straight bond  by the same company    o   Difference represents the implicit option premium paid for  the option to convert into stock  o   Example:  ABC Corporation can issue a 10 year fixed rate  note $\$a_t$$ yield of 6\% with \$1000 face value  §   Alternatively issue 10 year convertible $\$a_t$$ 2\% yield with  right to purchase 20 shares of ABC stock $$a_t$$ \$50/sh.
...
- Financial assets are traded on a financial market  o   Market makers provide liquidity
  - Financial intermediaries provide securities borrowing and  lending
...
- Companies that engage in financial asset purchases and sales  as a principal
  - Commercial Banks    o   Investment Banks  o   Insurance Companies  o   Securities and Futures Exchanges
...
- First Meriam Venture Partners buys 1 mm shares $\$a_t$$ \$1/sh.  $
 !500
...
- Other early stage investors include:
  ...
  - Private Equity firms; Corporations with strategic interest
...
- Internal Rate of Return
  - Likely overstates actual returns
# Initial Public Offering (IPO)

- Marvin goes public February 3, 2037
- Primary and Secondary Offerings
  - Primary – new shares for investment in business
...
§   Initial price level expected to be \$74-\$76/sh.  §   Priced $\$a_t$$ \$80/sh. after gauging investor interest  •   Compromise between risk of “successful” sale and  “leaving too much on the table”
# IPO Process
...
- US IPOs typically employ book building process
  - Institutional buyers indicate where they would buy IPO    o   Underwriters may give preference to certain potential  buyers
...
- 2017 – Deutsche below minimum capital threshold   o   Needs to raise €8 bn; current share price €18.00  o   Offers right to buy 1 sh. for every 2 shs. held $\$a_t$$ €11.65  o   Implies post offer price will be €15.88:
...
- May only be sold to Accredited Investors or Qualified  Institutional Buyers (QIBs) as defined in Regulation D under  the Securities Act of 1933
  ...
  - QIB – Certain institutional investors with unaffiliated  assets of \$100 mm; banks and thrifts \$25 mm; brokerdealers \$10 mm
# Private Placements

- Often specific types of debt or equity targeted $\$a_t$$ certain types  of buyers
...
- The Capital Structure of a company is its chosen mix of debt,  equity and other liabilities
  - Financial Leverage (gearing) refers to the relative amount  of debt to equity a company employs
  - If a firm’s value is based solely on the value of its assets  then capital structure should not matter – why are  investment bankers paid so much?
# Modigliani and Miller Debt Theorems
...
- Now look more closely $\$a_t$$ the MM propositions
# Capital Structure

- Commercial and investment banking revolve around:
  - Capital raising   o   Risk management  o   Mergers, acquisitions and divest it ure s
...
- Understanding which factors create:
  - Benefits to altering capital structure     o   Potentially unnecessary risks
- Critical to successful corporate financial management
- Critical choice CFO faces:
  - Amount of leverage (borrowing) to take on    §   Debt always appears less expensive than equity in the  short-term
# Wapshot Mining Company

- Issues 1000 shares $\$a_t$$ \$50 each   $
- Borrows \$25,000   $
...
- Buying 1% of the equity in U or 1% of the debt and equity in L  earn identical returns
  - By the Law of One Price, each investment must have the  same value:  1% of the company’s profits    o   Each must also have the same expected return
...
Financial manager points out that shareholders have ability to  create this outcome for themselves by buying two shares and  borrowing the funds to purchase one of the shares $\$a_t$$ 10%
...
# CSX Example After-tax WACC $\$a_t$$ Different D/E Ratios
 !500
...
- Major departures
  - Taxes    o   Transaction Costs  o   Financial Distress.md) and Bankruptcy  o   Conflicts between creditors and shareholders
# Taxes

- In the US and most other countries, interest paid by firms is a  deductible expense from taxable income
- Individuals and institutions that receive dividends and capital  gains are taxed (albeit $\$a_t$$ a lower rate than interest received)  and they are paid from after-tax corporate income
  - So-called “double taxation”
  - Some institutions, e.g., endowments and pension funds, are  tax exempt
# Taxes

- Limits were placed on the deduct i bil it y of interest $\$a_t$$ 30% of  income (defined as EBITDA) in 2017
  - This has been repealed as part of the CARES act legislation     o   With interest rates currently low, few companies would  have hit this constraint  §   Due to the Corona virus, poor earnings may have made  this constraint “bite” more quickly for some companies
- Assume that this constraint is not binding for our examples
 !500
# Tax Shield Valuation

- Firm U and L are identical except
  - L has \$1,000 of debt $$a_t$$ 8\% per annum    o   U is capitalized entirely with equity  $
...
- Above calculated value of L’s tax shield $\$a_t$$ \$210  $
  - Using this, L is worth \$10,210; U worth \$10,000  §   \$210 increase due solely to tax shield
  - Since L borrowed \$1,000, needs only 902 shares  outstanding $$a_t$$ a price of \$10.21 each
...
§   Formula does not apply $\$a_t$$ extremely high debt ratios  §   Debt may not be fixed and perpetually outstanding    §   Marginal tax rates vary  §   Variability of income limits value of tax shield  §   Limits on deduct i bil it y of interest expense
  - Most importantly
...
§   Often set $\$a_t$$ same rate  §   Capital gains tax only paid upon sale of asset
...
- To capture this we add costs of financial distress.md) to value  equation
...
- Financial distress.md) and bankruptcy are extremely costly
...
- Creditors often face additional costs as well:
  - Increased monitoring costs – asset valuations     o   Increased personnel costs $\$a_t$$ company – financial  consultants    o   More favorable loan terms – lower interest rate, deferral  of repayment of principal    o   Legal review – options if situation worsens, lender liability
# Bankruptcy Costs
...
- Court of equity – not of law
  - Vote on plan by “interested parties” – impaired creditors  §   At risk of losing money – not fully secured    o   Usually restructuring or turnaround specialists hired to  execute    o   If creditors agree, restructuring plan is put in place.  If not,  judge may impose a plan, known as a “cram down”
...
- Kept Chase Capital from selling $\$a_t$$ a distressed price – no  buyers
- Ultimately Age Refining Inc. sold to NuStar Energy LP in court  administered 363 sale
- Received all interest and principal, including penalty interest  Financial Distress.md) Costs and Firm Value
- Costs of financial distress.md) are an important departure from  perfect capital markets
...
- Loss of business value typically occurs prior to formal notice of  financial distress.md) or bankruptcy filing
...
- Shareholders in centi viz ed to “go for broke” or to ensure that  creditors do not benefit from capital contributions if company  in financial distress.md)
...
- This situation is known as Debt Overhang
  - Company has so much debt that new equity investment  cannot be obtained
...
- Bait and Switch
  - May lead to financial distress.md) as well as use in distress
  - Begin to add debt after long time policy of conservative  capital structure
...
# Type of Asset and Cost of Distress
  ...
  - “Essential” businesses allow for greater leverage
...
- Leverage based on
  - Degree and volatility of profits    o   Perceived liquidity of assets
...
- Cash, short-term investments and unutilized credit lines
  - Valuable when opportunities require quick action   o   Drag on financial returns since earning well-below WACC
...
# Should FTX have been placed into bankruptcy?
On November 6, Binance announces intention to sell its holdings  of FTT, estimated $\$a_t$$ 95.5 million FTT, worth approximately \$2.1  billion 5  $
  - Alameda proposes purchase of Binance’s holdings $\$a_t$$ \$22/FTT   §   Other FTT holders withdraw and sell \$5 billion of FTT
