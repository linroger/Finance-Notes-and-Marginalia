...
- Tarring all hedge funds with the brush that has been used for LTCM Meltdown | LTCM]] is wrong.
	- Hedge funds,  in general,  are surprisingly different from one another.
- Few hedge funds are as hugely leveraged as LTCM Meltdown | LTCM]].
...
- This has been partly responsible for the widening of Bid and Ask Prices With Private Information | bid-ask spreads]] (the difference between the price a trader is willing to pay for a security and the price at which he offers to sell it).
	- This,  in turn,  signals the drying up of liquidity in many financial markets.
- There is even a particular villain,  an exemplary specimen,  on which critics can focus: Long-Term Capital Management (LTCM Meltdown | LTCM]]).
...
- Although its rescue has staved off the worst consequences,  rumours that LTCM Meltdown | LTCM]] is busy unwinding its huge positions continue to spook the markets.
	- Other hedge funds are already paying a price for the fund's demise.
- Banks,  blamed for lending too generously to LTCM Meltdown | LTCM]] and its fellow hedge funds before,  are now being more miserly.
...
- Tarring all hedge funds with the brush that has been used for LTCM Meltdown | LTCM]] is wrong.
- The most striking thing about LTCM Meltdown | LTCM]] is not how similar it is to other hedge funds,  but how different.
...
- Still others,  such as LTCM Meltdown | LTCM]],  go in for "market-neutral" arbitrage.
...
- Few hedge funds are as hugely leveraged as LTCM Meltdown | LTCM]].
- By the time it was rescued,  LTCM Meltdown | LTCM]] had piled roughly $50 of borrowing on to every dollar of equity.
...
- LTCM Meltdown | LTCM]] was probably unique.
- **Why is leverage on LTCM Meltdown | LTCM]]'s scale so rare?**
...
- LTCM Meltdown | LTCM]] bet that their yields would converge by buying off-the-run Treasuries and selling their on-the-run counterparts short.
...
- LTCM Meltdown | LTCM]] sources say that such positions were leveraged some 30 to 40 times.
- In contrast,  LTCM Meltdown | LTCM]] had much lower leverage on its bet that yields on Danish mortgage-backed securities.md) would converge with those on American Treasuries-a far riskier speculation.
...
- According to Mr. Van,  other market-neutral hedge funds earned an average of 14% a year over the past five years,  compared with LTCM Meltdown | LTCM]]'s more stratospheric average of 40% a year in 1994-97.
- That is one reason to believe that other market-neutral funds will not find themselves in the same straits as LTCM Meltdown | LTCM]].
- **A hedge by any other name**
	...
	- Investment banks routinely have leverage in excess of 20 to 1.
- Like LTCM Meltdown | LTCM]],  they make much greater use of derivatives to leverage their bets than do most hedge funds.
- (They also make more extensive use of the sort of financial rocket-science for which two of LTCM Meltdown | LTCM]]'s founders won the Nobel prize.)
	- Mr. Ross reckons that banks punt the same amount of capital in this way as all hedge funds put together.
	- Banks' role in the present financial turmoil is crucial.
- After LTCM Meltdown | LTCM]] was rescued,  many investment banks were quick to reveal details of their exposure to LTCM Meltdown | LTCM]] in particular,  and in some cases to hedge funds in general.
...
- According to some reports,  whereas LTCM Meltdown | LTCM]] had an exposure of $80 billion to arbitrage between American Treasuries,   banks had $3 trillion tied up in similar bets.
- It was for this reason that the Fed felt it had no choice but to organise the rescue of LTCM Meltdown | LTCM]],  as Mr. Greenspan made clear in testimony to Congress.
...
- Unlike LTCM Meltdown | LTCM]],  banks have several sources of income,  from normal banking business in the case of commercial banks,  to corporate finance business or stockbroking for investment banks.
...
- The most favoured,  used by LTCM Meltdown | LTCM]] and most banks is the "value-at-risk" (VAR) model.
...
- The trouble spread to developed economies in April,  when investment banks' bond-trading desks started to lose money for the first time since 1994,  in this case in mortgage-backed securities.md).
...
- The news of LTCM Meltdown | LTCM]]'s troubles and its rescue was the last straw.
...
- Until the huge portfolios of LTCM Meltdown | LTCM]] and investment banks are seen as desirable,  rather than as a potential cause of further price declines,  many markets are likely to remain paralysed.
