...
[[Class Note 13 The [[Risk Management Lessons From Long Term Capital Management|LTCM Meltdown]]]]
...
1. **Consider two assets** that will be identical on date 3,  but it is not clear yet that they are identical.
   ...
   - If A is not selling for 100 times the price of B,  there is a [[Class Slides The LTCM Meltdown Liquidity and “Performance Based Arbitrage.”|long-term arbitrage]] opportunity.
   ...
   - This revision toward the proper price is referred to as a **“[[Class Slides The LTCM Meltdown Liquidity and “Performance Based Arbitrage.”|news trade]].”**
   - With probability $q$,  the mis-[[Arbitrage Pricing of Derivatives|pricing]] will get worse,  and the price will be $p_2 < p_1 < 100$.
...
1. Suppose that the price at date 1 is $p_1 = 80$,  and that on date 2:
   ...
   - With probability $1 - q$,  it will rise by 20 to $p_2 = 100$ (due to a [[Class Slides The LTCM Meltdown Liquidity and “Performance Based Arbitrage.”|news trade]]).
...
1. On date 2,  any arbs that see the opportunity will invest in it,  so long as $p_2 < 100$.
   ...
   - This prevents them from pushing the price all the way to 100,  despite being a [[Arbitrage Pure Versus Relative Value|pure arbitrage]].
...
1. The two-period [[Lecture 1- Probability Distributions of Returns|expected return]] of a PBA fund is:
...
1. The problem arose when [[Class Note 13 The [[Risk Management Lessons From Long Term Capital Management|LTCM Meltdown]]|LTCM]] lost so much money that they faced [[Class Note 13 The LTCM Meltdown|margin calls]].
   - For a large enough loss,  even [[Class Note 13 The [[Risk Management Lessons From Long Term Capital Management|LTCM Meltdown]]|LTCM]] had the equivalent of PBA,  leading to forced sales at the bottom.
   - [[Class Note 13 The [[Risk Management Lessons From Long Term Capital Management|LTCM Meltdown]]|LTCM]] faced a bank-run-style collective action problem.

1. If [[Class Note 13 The [[Risk Management Lessons From Long Term Capital Management|LTCM Meltdown]]|LTCM]] cannot attract enough capital to meet [[Class Note 13 The LTCM Meltdown|margin calls]],  they would be forced to liquidate at the bottom.
...
1. A meltdown causes an even larger price drop when arbs ([[Class Note 13 The [[Risk Management Lessons From Long Term Capital Management|LTCM Meltdown]]|LTCM]] in particular) liquidate.
...
1. Assume [[Class Note 13 The [[Risk Management Lessons From Long Term Capital Management|LTCM Meltdown]]|LTCM]] already established a position in the trade before date 1 and is long 20 units.
   - If [[Class Note 13 The [[Risk Management Lessons From Long Term Capital Management|LTCM Meltdown]]|LTCM]] were not long 20 units,  the price would be lower by 20.
...
1. Suppose the [[Class Note 13 The LTCM Meltdown|Russian default]] causes panic selling at date 1 by noise traders,  when [[Class Note 13 The [[Risk Management Lessons From Long Term Capital Management|LTCM Meltdown]]|LTCM]] already has a position of 20.
   - The noise trade at 1 is now -30.
   - If [[Class Note 13 The [[Risk Management Lessons From Long Term Capital Management|LTCM Meltdown]]|LTCM]] must liquidate immediately at date 1,  look at the meltdown in table 3:
...
1. The panic from the Russian crisis would make the price fall by 30 (from 80 to 50 on date 1) by itself.
   - By forcing [[Class Note 13 The [[Risk Management Lessons From Long Term Capital Management|LTCM Meltdown]]|LTCM]] to liquidate,  it makes the price fall by 50 (80 to 30).
   - The losses force a liquidation,  similar to a [[Bank Runs Deposit Insurance and Liquidity|bank run]].

## XVII. Delayed Liquidation and [[Class Note 13 The LTCM Meltdown|LTCM]]
1. In practice,  [[Class Note 13 The [[Risk Management Lessons From Long Term Capital Management|LTCM Meltdown]]|LTCM]] was careful to get advanced assurance from margin lenders not to force immediate [[Class Note 13 The LTCM Meltdown|margin calls]].
   - This allowed them some time to meet the calls.
   - If [[Class Note 13 The [[Risk Management Lessons From Long Term Capital Management|LTCM Meltdown]]|LTCM]] could delay liquidation until date 2,  they could still buy 5 at date 1.

1. **Table 4: A Delayed Meltdown if [[Class Note 13 The [[Risk Management Lessons From Long Term Capital Management|LTCM Meltdown]]|LTCM]] Can Wait to Liquidate**:
...
1. With probability $q$,  a noise trade forces the price down to 15 because [[Class Note 13 The [[Risk Management Lessons From Long Term Capital Management|LTCM Meltdown]]|LTCM]] is forced out.
1. With probability $1 - q$,  there is a [[Class Slides The LTCM Meltdown Liquidity and “Performance Based Arbitrage.”|news trade]] that pushes the price up to 75 (and then [[Class Note 13 The [[Risk Management Lessons From Long Term Capital Management|LTCM Meltdown]]|LTCM]] is not forced out).
1. The expected price change is:
   $$ q(15 - 55) + (1 - q)(75 - 55) = 20 - q(60). $$

1. For $q = 0.25$,  this is +5,  but for $q = 0.5$,  it is -10.
1. Assume $q = 0.5$ to learn about the front running problem faced by [[Class Note 13 The [[Risk Management Lessons From Long Term Capital Management|LTCM Meltdown]]|LTCM]].
