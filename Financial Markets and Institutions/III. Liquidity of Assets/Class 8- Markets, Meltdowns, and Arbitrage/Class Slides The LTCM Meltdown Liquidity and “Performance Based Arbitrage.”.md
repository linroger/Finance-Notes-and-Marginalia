...
[LTCM Meltdown](Class%20Note%2013%20The%20[[Risk%20Management%20Lessons%20From%20Long%20Term%20Capital%20Management)]]
...
1. **Consider two assets** that will be identical on date 3,  but it is not clear yet that they are identical.
   ...
   - If A is not selling for 100 times the price of B,  there is a [long-term arbitrage](.md) opportunity.
   ...
   - This revision toward the proper price is referred to as a **“[news trade](.md).”**
   - With probability $q$,  the mis-[pricing](../../../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%207/Arbitrage%20Pricing%20of%20Derivatives.md) will get worse,  and the price will be $p_2 < p_1 < 100$.
...
1. Suppose that the price at date 1 is $p_1 = 80$,  and that on date 2:
   ...
   - With probability $1 - q$,  it will rise by 20 to $p_2 = 100$ (due to a [news trade](.md)).
...
1. On date 2,  any arbs that see the opportunity will invest in it,  so long as $p_2 < 100$.
   ...
   - This prevents them from pushing the price all the way to 100,  despite being a [pure arbitrage](../../../Financial%20Markets/Financial%20Engineering%20and%20Arbitrage%20in%20the%20Financial%20Markets/PART%20I%20RELATIVE%20VALUE%20BUILDING%20BLOCKS/Chapter%201%20-%20Purpose%20and%20Structure%20of%20Financial%20Markets/Arbitrage%20Pure%20Versus%20Relative%20Value.md).
...
## X. [LTCM](Class%20Note%2013%20The%20LTCM%20Meltdown.md) as a Long-Term Arb
...
1. The two-period [expected return](../../../Advanced%20Investments/Lecture%201-%20Probability%20Distributions%20of%20Returns.md) of a PBA fund is:
...
1. The problem arose when [LTCM Meltdown](Class%20Note%2013%20The%20[[Risk%20Management%20Lessons%20From%20Long%20Term%20Capital%20Management)|LTCM]] lost so much money that they faced [margin calls](Class%20Note%2013%20The%20LTCM%20Meltdown.md).
   - For a large enough loss,  even [LTCM Meltdown](Class%20Note%2013%20The%20[[Risk%20Management%20Lessons%20From%20Long%20Term%20Capital%20Management)|LTCM]] had the equivalent of PBA,  leading to forced sales at the bottom.
   - [LTCM Meltdown](Class%20Note%2013%20The%20[[Risk%20Management%20Lessons%20From%20Long%20Term%20Capital%20Management)|LTCM]] faced a bank-run-style collective action problem.

1. If [LTCM Meltdown](Class%20Note%2013%20The%20[[Risk%20Management%20Lessons%20From%20Long%20Term%20Capital%20Management)|LTCM]] cannot attract enough capital to meet [margin calls](Class%20Note%2013%20The%20LTCM%20Meltdown.md),  they would be forced to liquidate at the bottom.
...
1. A meltdown causes an even larger price drop when arbs ([LTCM Meltdown](Class%20Note%2013%20The%20[[Risk%20Management%20Lessons%20From%20Long%20Term%20Capital%20Management)|LTCM]] in particular) liquidate.
...
## XV. [LTCM](Class%20Note%2013%20The%20LTCM%20Meltdown.md)'s Established Position
1. Assume [LTCM Meltdown](Class%20Note%2013%20The%20[[Risk%20Management%20Lessons%20From%20Long%20Term%20Capital%20Management)|LTCM]] already established a position in the trade before date 1 and is long 20 units.
   - If [LTCM Meltdown](Class%20Note%2013%20The%20[[Risk%20Management%20Lessons%20From%20Long%20Term%20Capital%20Management)|LTCM]] were not long 20 units,  the price would be lower by 20.
...
1. Suppose the [Russian default](Class%20Note%2013%20The%20LTCM%20Meltdown.md) causes panic selling at date 1 by noise traders,  when [LTCM Meltdown](Class%20Note%2013%20The%20[[Risk%20Management%20Lessons%20From%20Long%20Term%20Capital%20Management)|LTCM]] already has a position of 20.
   - The noise trade at 1 is now -30.
   - If [LTCM Meltdown](Class%20Note%2013%20The%20[[Risk%20Management%20Lessons%20From%20Long%20Term%20Capital%20Management)|LTCM]] must liquidate immediately at date 1,  look at the meltdown in table 3:
...
1. The panic from the Russian crisis would make the price fall by 30 (from 80 to 50 on date 1) by itself.
   - By forcing [LTCM Meltdown](Class%20Note%2013%20The%20[[Risk%20Management%20Lessons%20From%20Long%20Term%20Capital%20Management)|LTCM]] to liquidate,  it makes the price fall by 50 (80 to 30).
   - The losses force a liquidation,  similar to a [bank run](../Class%206-%20Bank%20Runs/Bank%20Runs%20Deposit%20Insurance%20and%20Liquidity.md).

## XVII. Delayed Liquidation and [LTCM](Class%20Note%2013%20The%20LTCM%20Meltdown.md)
1. In practice,  [LTCM Meltdown](Class%20Note%2013%20The%20[[Risk%20Management%20Lessons%20From%20Long%20Term%20Capital%20Management)|LTCM]] was careful to get advanced assurance from margin lenders not to force immediate [margin calls](Class%20Note%2013%20The%20LTCM%20Meltdown.md).
   - This allowed them some time to meet the calls.
   - If [LTCM Meltdown](Class%20Note%2013%20The%20[[Risk%20Management%20Lessons%20From%20Long%20Term%20Capital%20Management)|LTCM]] could delay liquidation until date 2,  they could still buy 5 at date 1.

1. **Table 4: A Delayed Meltdown if [LTCM Meltdown](Class%20Note%2013%20The%20[[Risk%20Management%20Lessons%20From%20Long%20Term%20Capital%20Management)|LTCM]] Can Wait to Liquidate**:
...
1. With probability $q$,  a noise trade forces the price down to 15 because [LTCM Meltdown](Class%20Note%2013%20The%20[[Risk%20Management%20Lessons%20From%20Long%20Term%20Capital%20Management)|LTCM]] is forced out.
1. With probability $1 - q$,  there is a [news trade](.md) that pushes the price up to 75 (and then [LTCM Meltdown](Class%20Note%2013%20The%20[[Risk%20Management%20Lessons%20From%20Long%20Term%20Capital%20Management)|LTCM]] is not forced out).
1. The expected price change is:
   $$ q(15 - 55) + (1 - q)(75 - 55) = 20 - q(60). $$

1. For $q = 0.25$,  this is +5,  but for $q = 0.5$,  it is -10.
1. Assume $q = 0.5$ to learn about the front running problem faced by [LTCM Meltdown](Class%20Note%2013%20The%20[[Risk%20Management%20Lessons%20From%20Long%20Term%20Capital%20Management)|LTCM]].
