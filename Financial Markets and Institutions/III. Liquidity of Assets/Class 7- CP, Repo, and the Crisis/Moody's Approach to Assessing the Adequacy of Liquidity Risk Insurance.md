...
The Standing Committee is also soliciting the views of issuers,  investors,  and bankers on an array of alternate liquidity topics including the adequacy of [](Class%20Note%2012%20-%20Commercial%20Paper.md#Class%20Note%2012%20–%20Commercial%20Paper | Commercial%20Paper) backstop. Committee members are approaching [](Class%20Note%2012%20-%20Commercial%20Paper.md#Class%20Note%2012%20–%20Commercial%20Paper | Commercial%20Paper) issuers directly worldwide,  on a global basis,  to solicit views. In our discussions,  a majority of issuers have expressed the belief that the required amount of alternate liquidity for [](Class%20Note%2012%20-%20Commercial%20Paper.md#Class%20Note%2012%20–%20Commercial%20Paper | Commercial%20Paper) should factor:
...
Exhibit 1 shows the dramatic increase in the use of CP. The rise can be attributed to brisk growth in the use of [](Class%20Note%2012%20-%20Commercial%20Paper.md#Class%20Note%2012%20–%20Commercial%20Paper | Commercial%20Paper) as a financing tool (CP is being used for more permanent purposes in the capital structure than it has been ever before),  to dramatic growth in structured finance issuance and to growth in the financial markets in general. Yet this rise comes at a time when established backstop providers are either exiting the business,  consolidat ing,  or tightening their capital allocation standards.
...
Although there have been few actual defaults among rated [](Class%20Note%2012%20-%20Commercial%20Paper.md#Class%20Note%2012%20–%20Commercial%20Paper | Commercial%20Paper) issuers (see Exhibit 2),  the number of *near misses” emphasizes that rapidly deteriorating credits can quickly lose access to their liquidity risk insurance. It is important,  therefore,  to develop a thorough understanding of each issuer's liquidity profile.
...
- Joint venture funding requirements : Leverage, Tail Risk, Volatility Products#6.1.3 Margin requirements | margin requirements]]
...
- Potential for revenue decline considering the nature of the business (for example,   utilities generally experience little decline,   whereas declines for Forecasting) | cyclical]] industries are steeper)
