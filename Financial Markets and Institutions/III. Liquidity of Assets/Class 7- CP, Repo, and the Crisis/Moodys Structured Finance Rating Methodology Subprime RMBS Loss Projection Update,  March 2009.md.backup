...
While subprime pools are generally homogeneous in terms of their collateral characteristics,  collateral attributes such as loan type (FRM vs ARM),  geographic location and LTV can be highly predictive of performance. Therefore,  we have further enhanced our previously published,  loss-curve based methodology. While the updated approach will account for pool characteristics on a deal-by-deal basis,  the underlying assumptions for the subprime population as a whole are generally consistent with those underlying our stressed loss curve [expectations](../../../Fixed%20Income%20Asset%20Pricing/Fixed%20Income%20Lecture%20Notes/FORWARD%20RATES%20AND%20TERM%20STRUCTURE.md). Ultimately we migrated away from the loss-curve-based approach outlined in the September paper because we believe that the updated approach will more precisely distinguish between the relative risks across pools.
...
| Figure 5                                                       |                   |                    |
|----------------------------------------------------------------|-------------------|--------------------|
| Moody's [Subprime RMBS](.md) Lifetime Roll Rate Assumptions & Example |                   |                    |
...
Finally,  the portion of the pool that is not seriously delinquent on the projection date is assumed to perform better than the portion of the pool that had been seriously delinquent up to that point. This is reflected in the Default Burnout Factor (DBF) assumption. Put simply,  the DBF represents one minus the expected reduction in [default rates](../../../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%2014/Default%20Rates%20Recovery%20Rates%20and%20Credit%20Losses.md) going forward. The expected default rate on the non-seriously delinquent portion of the pool after projection date is the product of the previously calculated Default-to-Liquidation rate and the DBF. Projected losses on this portion of the pool are calculated by multiplying the projected default rate by the assumed loss severity rate.
...
4 Where loan-level data is unavailable Moody's doubles the weigh given to the recent actual severity component. 5 8% has been applied to adjust average observed severities in line with future [expectations](../../../Fixed%20Income%20Asset%20Pricing/Fixed%20Income%20Lecture%20Notes/FORWARD%20RATES%20AND%20TERM%20STRUCTURE.md). As average severities tend toward our [expectations](../../../Fixed%20Income%20Asset%20Pricing/Fixed%20Income%20Lecture%20Notes/FORWARD%20RATES%20AND%20TERM%20STRUCTURE.md) this adjustment may be reduced accordingly.

## Estimating Modification Rates

In light of the HASP plan's goals and industry-wide call to action,  as well as the incentive payments and cost-sharing it offers,  servicers are likely to seek to implement more aggressive modification terms wherever possible. The $1,  000 upfront cash incentive provided to servicers for each modification will alleviate additional costs associated with active loss mitigation efforts and could encourage servicers to modify more loans. In [forecasting](../../../Advanced%20Financial%20Analysis%20and%20Valuation/Lecture%20Notes%20Advanced%20Financial%20Analysis%20and%20Valuation/Week%202/Week%202%20Fundamentals%20Of%20Forecasting.md) modification rates under the HASP plan,  we assume that servicers will be reasonably aggressive in their modification efforts.
...
| [Default Rates](../../../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%2014/Default%20Rates%20Recovery%20Rates%20and%20Credit%20Losses.md) &  Future Losses                                                                                                                                      | AA Implied Cumulative 1 st Lien Default Rate                                                                     | 49%                            | = Z / ( 100% - X - D )               |                  |
...
In Moody's updated projections,  the 2005 vintage will ultimately lose an average of 13% of original securitized balance,  corresponding to an additional loss of 36% of the outstanding balance. 2006 vintage subprime pools will ultimately lose an average of 30% of the original securitized balance,  corresponding to an additional loss of 45% of the outstanding balance. Subprime pools issued in 2007 pools will on average lose 36% of original balance,  an additional 42% of the outstanding collateral balance. A number of factors will influence the extent to which ultimate losses differ from Moody's updated projections. Loss severities will depend in part on whether home price depreciation proceeds ahead of or behind Moody's expectation as well as the speed of the foreclosure and [liquidation process](../../../Course%20Notes/HBR%20Notes/A%20Strategic%20Perspective%20on%20Bankruptcy.md). Future default frequencies will likely be influenced by broad economic factors such as unemployment. Further economic decline would hasten the pace of new defaults,  while a strong rebound might dampen it. And,  among the largest uncertainties,  the willingness of the government to directly intervene in the housing and/or [securitization markets](../../../Course%20Notes/HBR%20Notes/HBR%20Case%20Study-%20Oaktree.md) could have substantial impact on the ultimate outcome. There will continue to be much uncertainty about the ultimate scope and effectiveness of the recently announced Homeowner Affordability and Stability Plan for at least several months,  and potentially well over a year. Given this uncertainty and the rating implications of successful,  large-scale loss mitigation efforts,  Moody's has tempered its loss [expectations](../../../Fixed%20Income%20Asset%20Pricing/Fixed%20Income%20Lecture%20Notes/FORWARD%20RATES%20AND%20TERM%20STRUCTURE.md) accordingly. If the program ultimately proves underutilized or recidivism rates exceed our estimates,  we may revise our loss projections accordingly.
...
Moody's expects significant rating migration across the [capital structure](../../../Advanced%20Financial%20Analysis%20and%20Valuation/Introduction%20to%20Corporate%20Finance.md) for virtually all 2005,  2006 and 2007 transactions. However,  the sequential nature of most principal waterfalls will ensure that the ratings of many senior bonds that are deemed highly likely to be paid in full in the near term will be confirmed. While the modification assumptions described above have had a mitigating effect on projected losses,  it is noteworthy that extensive modifications could reduce available credit support. Aggressive reductions in mortgage rates on subprime borrowers will reduce available excess spread that would have otherwise been utilized to cover pool losses and accelerate the retirement of senior securities. The level of modifications currently anticipated will likely reduce excess spread by 20-40% over the next few years,  based on our updated projections. In assigning updated ratings to [subprime RMBS](.md),  this assumed loss of excess spread will offset a material portion of the anticipated reduction in default achieved through loan modification. Overall,  the forthcoming rating changes will vary by vintage and collateral quality,  but it is likely that the vast majority of mezzanine and subordinate certificates currently rated B or above would be downgraded to ratings of Caa or below,  particularly for bonds issued in 2006 and 2007. Actions on senior bonds will differ based on payment priority and protection relative to projected losses. Given the level of losses currently projected,  a majority of senior certificates will likely be downgraded below [investment](../../../Advanced%20Investments/An%20Asset%20Allocation%20Primer.md) grade. Many,  particularly longer [duration](../../../Financial%20Markets/Fixed%20Income%20Securities%20Tools%20for%20Today's%20Markets/Chapter%205/Key%20Rates%20O1s%20Durations%20and%20Hedging.md) senior bonds from 2006 and 2007,  are expected to be downgraded to B or below.

As general guidance to [subprime RMBS](.md) ratings at the lower end of Moody's scale,  securities rated B 2 or higher are likely to be paid off in full under expected conditions. Once a security is likely to take a loss under an expected scenario,  we will typically rate it B 3 or lower. To determine those ratings,  an estimated recovery ratio is calculated using available enhancement,  including excess spread,  and the priority of principal distribution. Securities with expected recoveries of 75% to 95% are rated in the Caa range.
