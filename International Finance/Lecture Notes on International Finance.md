...
First, we would like to understand the determinants of exchange rates and international asset prices. As with generic [[Fixed Income Asset Pricing|asset pricing]], we would like to understand what drives exchange rates and international asset prices to fluctuate ex-post, what drives some currencies and assets to have higher expected [[Assets|returns]] ex-ante, and how to characterize the risk-return trade-off. The international asset prices include bond yields across countries, which, as we will see, are closely related to the [[Forwards and Futures Notes|currency]] market, as well as international equity prices, though they will receive much shallower coverage in this note.
...
Jensen’s term of  −  $\begin{array}{r}{-\frac{1}{2}v a r_{t}\big (\Delta e_{t+1}\big)\,=\,-0.5\%,}\end{array}$  , which is an order of magnitude smaller than the covariance term for many [[Forwards and Futures Notes|currency]] pairs we usually consider.
...
The effects of these additional ingredients in the [[Primary Issuance and Secondary Resale Markets|asset markets]] can be understood in reduced form as wedges. For example, suppose the households have power utilities with a [[CCAPM with Alternative Preferences|relative risk aversion]] of  $\gamma$  . Then, the real exchange rate can be written as its complete-market solution plus an asset market wedge    $\tau_{t}^{A M}$  :$$
...
$$
As such, it is equivalent to test whether the interest rate differential predicts future exchange rate movement or whether it predicts future [[Forwards and Futures Notes|currency]] excess return.
A model that seeks to tackle the risk premium puzzles should be able to explain ( 1 ) why there are unconditional differences between currencies such as the Japanese Yen vs. The Australian dollar, and ( 2 ) why the [[Interest Rate Quotations|interest rates]] vary over time and are correlated with non-trivial variations in the conditional [[Forwards and Futures Notes|currency]] expected [[Assets|returns]], in particular in the U.S. dollar. To explore the relation between the [[Forwards and Futures Notes|currency]] return predictability in the cross-section and the [[Forwards and Futures Notes|currency]] return predictability in the time series,  Hassan and Mano  [ 2019 ] conduct a decomposition of [[Lecture Notes on International Finance|currency risk premia]] into a cross-[[Forwards and Futures Notes|currency]] component, a cross-time component, and a residual component. They show that the cross-sectional and time-series patterns may be driven by different forces:
The simplest model that the data do not reject features a cross-sectional asymmetry that makes some currencies pay permanently higher expected [[Assets|returns]] than others, and larger time series variation in expected [[Assets|returns]] on the U.S. dollar than on other currencies.
# 2 .A. 5 Exchange Rate Co movements
While the exchange rate movements are disconnected from the economic [[Week 2 Fundamentals Of Forecasting|fundamentals]], they are highly correlated across countries and exhibit a factor structure. According to  Verdelhan  [ 2018 ], two common factors, carry and dollar, account for    $\mathtt{18\%}$   to  $8\mathrm{o}\%$   of the monthly exchange rate movements.
Moreover, these common factors also price the cross-section of [[Lecture Notes on International Finance|currency risk premia]] [ Lustig, Roussanov, and Verdelhan ,  2011 ]. More precisely, let  $f_{t}$   denote a common factor (which can be easily extended to a vector of factors). We regress the [[Forwards and Futures Notes|currency]] excess return or the exchange rate movement on the common factor:$$
R x_{t}^{i}=\alpha^{i}+\beta^{i}f_{t}+\varepsilon_{t}^{i}.
$$
The slope coefficient  $\beta^{i}$    measures the [[Forwards and Futures Notes|currency]]’s exposure to the factor. To the extent that the factor proxies for systematic risks, investors require a higher compensation if the [[Forwards and Futures Notes|currency]] has a higher risk exposure. Then, we expect to find a positive association between the [[Forwards and Futures Notes|currency]]’s [[Theoretical Factors|expected excess return]] and its factor loading:$$
\mathbb E[r x_{t+1}^{i}]\propto\beta^{i}.
$$
This alignment of risk exposures and risk premia, central to all [[Fixed Income Asset Pricing|asset pricing]], is also confirmed in the [[Forwards and Futures Notes|currency]] market.
2 .A. 6 [[Financial Instruments PSET Solutions|Covered Interest Rate Parity]] Violation and Convenience Yields
The exchange rate puzzles above are all related to the stochastic properties of exchange rates. A more recent literature examines [[Assets|returns]] from [[Forwards and Futures Notes|currency]] market strategies that have no risks, at least in theory. The fact that these risk-free strategies earn non-zero [[Assets|returns]] suggests violations of the no-[[Arbitrage Pricing of Derivatives|arbitrage]] condition, and could therefore shed light on the frictions and preferences faced by the investors in the [[Lecture Notes on International Finance|international financial]] markets.
The [[Financial Instruments PSET Solutions|covered interest rate parity]] (CIP) describes the relation between the forward premium and the interest rate differential, which is given by Eq. ( 2 . 1 ), reproduced below,$$
F_{t}^{i}-e_{t}^{i}=r_{t}^{i}-r_{t}^{\S}.
$$
This parity holds in friction less markets because the investors can get access to the home [[Black Scholes Derivation|risk-free rate]] by either investing in the home bond with a return of    $r_{t\,}^{\lessgtr}$  , or investing in the foreign bond and [[Key Rates O1s Durations and Hedging|hedging]] the [[PSET 3 Financial Instruments|exchange rate risk]] using the [[Forward Points in Currency|forward contract]], which has a net return of  $r_{t}^{i}-f_{t}^{i}+e_{t}^{i}$    . In the [[Exercises|absence of arbitrage]], these two risk-free rates in home [[Forwards and Futures Notes|currency]] units must be equal.
Traditionally, this is regarded as an identity since its deviation, known as the CIP deviation, will be quickly exploited by the arbitrageurs who actively trade in both the [[Forwards and Futures Notes|currency]] [[Tba and Specified Pools Markets|forward market]] and the interest rate market. Indeed, if we use the home and foreign Libor rates as proxies for the home and foreign [[Interest Rate Quotations|interest rates]]    $r_{t}$   and  $r_{t}^{*}$    , this condition holds quite tightly before the [[8. Credit Modeling and Credit Derivatives|Global Financial Crisis]]. However,  Du, Tepper, and Verdelhan  [ 2018 b ] shows that, after the crisis, this condition breaks down and there is non-trivial variations in both the time series and the cross-section of the Libor CIP deviation.
...
$$
Figure  2 . 1  plots the Libor CIP basis between the U.S. and the average developed countries, which is very close to  0  before the [[8. Credit Modeling and Credit Derivatives|Global Financial Crisis]], but has been persistently negative since then. A negative Libor CIP basis means that the dollar Libor rate is below the foreign Libor rate after adjusting for the [[PSET 3 Financial Instruments|exchange rate risk]], which makes the dollar cheaper to borrow.
Similarly, the Treasury CIP basis is defined by using the Treasury yields as proxies for the [[Interest Rate Quotations|interest rates]]  $r_{t}$   and  $r_{t}^{*}$    :$$
X_{t}^{T r e a s}\overset{\mathrm{def}}{=}r_{t}^{\Phi}-r_{t}^{i}+(f_{t}^{i}-e_{t}^{i}).
$$
Figure  2 . 1  also plots the Treasury CIP basis. Unlike the Libor CIP basis, the Treasury CIP basis has been negative both before and after the [[8. Credit Modeling and Credit Derivatives|Global Financial Crisis]]   $\mathrm{[Nu, Im,}$   and Schreger ,  2018 a ,  Jiang,  $\mathrm{Kr}$  - ish namur thy, and Lustig ,  2018 ]. In other words, the U.S. government has been able to borrow at a lower interest rate than the foreign governments, after adjusting for the [[PSET 3 Financial Instruments|exchange rate risk]]. The Treasury CIP deviation will play a central role when we discuss bond convenience yields in Chapter  4 .
 ![500](Attachments/500-13.jpg)
2 .A. 7 [[Lecture Notes on International Finance|Currency Risk Premia]] across Horizons
We can also consider the [[Forwards and Futures Notes|currency]] [[Assets|returns]] across multiple horizons, which can be achieved by either rolling over [[When Safe Proved Risky Commercial Paper During the Financial Crisis of 2007 2009|short-term debt]] positions in home and foreign currencies, or by investing in long-term
Debt positions.  Lustig, Stat hopo u los, and Verdelhan  [ 2019 ] show that the long-run UIP condition, constructed from long-run exchange rate movements and long-term bond yields, holds in [[Financial Mathematics Course|complete markets]] with stationary exchange rates, because the [[Forwards and Futures Notes|currency]] risks are correctly priced in the long-term bond yields.
Engel  [ 2016 ] shows that high interest rate currencies not only have higher expected [[Assets|returns]] in the short term, but also are stronger than can be accounted for by the path of expected real interest differentials. In other words, high [[Interest Rate Quotations|interest rates]] must predict lower [[Forwards and Futures Notes|currency]] [[Assets|returns]] in the long term. Relatedly,  Dahlquist and Pénasse  [ 2022 ], Chernov and Creal  [ 2023 ] show that the exchange rate level predicts [[Forwards and Futures Notes|currency]] [[Assets|returns]]. Thus, a coherent account of the multi-horizon [[Forwards and Futures Notes|currency]] [[Assets|returns]] involves the interest rate predicting higher [[Forwards and Futures Notes|currency]] [[Assets|returns]] and higher exchange rate levels in the short term, and the elevated exchange rate levels predicting lower [[Forwards and Futures Notes|currency]] [[Assets|returns]] in the medium-to-long term.
# 2 .B Challenges to Making Sense of Quantities and Flows
# 2 .B. 1 Global Imbalances
We start with the U.S. net external imbalances vis-à-vis the rest of the world. We consider the equity-like, riskier asset classes and the debtlike, safer asset classes separately. Let us define the net risky position as the sum of [[An Asset Allocation Primer|portfolio]] equity assets and foreign direct [[An Asset Allocation Primer|investment]] (FDI) assets minus [[An Asset Allocation Primer|portfolio]] equity liabilities and FDI liabilities, and define the net safe position as the reserve assets plus debt assets minus debt liabilities [ Gourinchas, Rey, and Sauzet ,  2019 ].
...
Second, these net asset positions have notable cyclical properties. Risky assets tend to depreciate during recessions, whereas safe assets tend to appreciate. As a result, during the  2008  [[8. Credit Modeling and Credit Derivatives|Global Financial Crisis]] and the early 2000  [[Hedge Fund Strategies|stock market]] crash, the U.S. net risky position contracted while its net safe position expanded.
Third, the U.S. net safe position has been widening steadily since mid 1980 s. Currently (end of  2021 ), it is about  $50\%$   of the U.S. GDP, with a large fraction attributable to the U.S. [[Global Fixed Income Markets|government debt]]. In
...
Changes in the U.S. external imbalances are driven by both the quantity of capital flows into and out of the U.S. and the [[Assets|returns]] on the existing assets and liabilities. When we examine the latter component, we find that the U.S. tends to earn a higher return on its external assets relative to what it pays to foreigners on its external liabilities. To describe this phenomenon, the French Minister of Finance Valéry Giscard d’Estaing coined the term “exorbitant privilege” in 1965  [ Gourinchas and Rey ,  2007 b ,  Gourinchas, Rey, and Govillot ,
 ![500](Attachments/500-2.jpg)
...
The superior return earned by the U.S. can be attributed to two factors. First, as we noted in the discussion of the [[Lecture Notes on International Finance|global imbalances]], the U.S. holds more foreign risky assets that have higher average [[Assets|returns]], whereas the foreigners hold more U.S. safe assets that have lower average [[Assets|returns]]. As a result, despite the fact that the U.S. holdings of foreign assets are lower than the foreign holdings of the U.S. assets, the U.S. manages to earn a risk premium on average because of the return differential between the riskier and the safer assets.
Second, when we compare within the class of safe assets, the U.S. is able to borrow at lower [[Interest Rate Quotations|interest rates]]. The U.S. safe assets earn convenience yields, which are often attributed to the U.S. dollar being the dominant reserve [[Forwards and Futures Notes|currency]].
These two factors both contribute to the U.S. earning a net [[An Asset Allocation Primer|portfolio]] income from the foreigners. Figure  2 . 4  plots the annual valuation change and dividend payouts from the U.S. external assets and liabilities, normalized by the U.S. GDP. These series describe the total amount of [[An Asset Allocation Primer|investment]] profits that U.S. investors receive abroad and vice versa. Their difference is the net financial gains or losses between the U.S. and the rest of the world.
We make several observations about the U.S. net financial payoff. First, on average, the payoff that U.S. receives from foreign assets exceeds the payoff that U.S. pays to foreigners on its external liabilities. The payoff includes both the dividend or [[Realized Returns|coupon payments]] and
the capital gains or losses. The U.S. has been earning consistently positive payoffs from the  1960 s to the mid  1990 s, in early  2000 s, and in some years after  2008 . Moreover, these magnitudes have been increasing since the  1960 s, possibly reflecting increases in international [[An Asset Allocation Primer|portfolio]] positions and developments in [[Lecture Notes on International Finance|international financial]] assets.
 ![500](Attachments/500-17.jpg)
...
Second, the U.S. net financial payoff is pro-cyclical. It tends to be positive during global expansions and negative during global recessions. For example, the U.S. suffered a net loss equal to    $30\%$   of the U.S. GDP on its external assets in  2008 , whereas the foreigners suffered a net loss equal to  $\mathbf{1}3\%$   of the U.S. GDP on their U.S. assets. This cyclical property is again due to the [[An Asset Allocation Primer|portfolio]] asymmetry: the U.S. tends to hold more foreign risky assets, whereas the foreigners tend to hold more U.S. safe assets. The risky assets depreciate more during recessions.
Gourinchas and Rey  [ 2022 ] refer to this cyclical property as the exorbitant duty. As we will see in Section    $7.\mathrm{A},$   we can interpret the asymmetry in [[An Asset Allocation Primer|portfolio]] holdings between the U.S. and the rest of the world as a risk-sharing or insurance arrangement, with the U.S. earning higher [[Assets|returns]] in good times and paying off the foreigners in bad times.
...
There is also a trade side that parallels the fluctuations on the [[An Asset Allocation Primer|portfolio]] side. As we will see in Section  9 .E , the trade balance ( TB ) and the [[An Asset Allocation Primer|portfolio]] [[Assets|returns]] from the income balance ( IB ) and capital gains ( CG ) jointly determine the evolution of the national accounts captured by the net foreign assets ( NFA ):$$
\Delta N F A_{t}=T B_{t}+C G_{t}+I B_{t}.
$$
An increase in the U.S. net foreign assets can be attributed to either national saving by running a higher trade surplus and saving the income abroad, or earning a higher capital gains or incomes from foreign financial assets. Conversely, holding the NFA constant, a [[Chapter 14- Capital Flows and the Current Account|trade deficit]] can be financed by profits from the [[An Asset Allocation Primer|portfolio]] side.
# 2 .B. 3 Counter cyclical Flight To Safety
There is also a quantity aspect to the exorbitant privilege, which can be illustrated by the following hypothetical example that I considered in  Jiang, Krishna mur thy, and Lustig  [ 2022 a ]. There are two [[An Asset Allocation Primer|investment]] periods. In period  1  the U.S. Treasury yield is high at  $5\%$  . In period  2  the U.S. Treasury yield is low at  $\mathbf{\sigma}_{\mathbf{1}}\%$  . Table  2 . 1  illustrates the [[Assets|returns]] and the holdings of home and foreign investors. The foreign investors buy more Treasurys when the yield is lower in period  2 , whereas the home investors buy more Treasurys when the yield is higher in period  1 . In a crude way, this assumption captures the foreigners’ counter cyclical flight to safety provided by the U.S. Treasury market: they buy U.S. Treasurys when they are expensive and offer low [[Assets|returns]], and they exit their positions when Treasury bonds are cheap and offer high [[Assets|returns]].
In this example, the time-weighted average as measured by the geometric mean of the [[Assets|returns]] over the two years is exactly the same  $z.98\%$   for the U.S. and the foreign investors. In other words, the home and the foreign investors hold the same asset and receive the same return from their Treasury portfolios in each period.
...
In our fiat [[Forwards and Futures Notes|currency]] system, being the hegemon confers a specific ability to issue large amounts of nominally safe liabilities (dollar securities), which are happily absorbed by the rest of the world. Thus, the view is that, in case of a deficit, the United States does not have to take restrictive measures, so that the dollar is not an impartial means of international exchange. This is the essence of the exorbitant privilege.
# 2 .B. 4 Twin Deficits
The U.S. external imbalances are also closely related with the U.S. government budget deficits. Figure  2 . 5  plots the U.S. government’s total [[Global Fixed Income Markets|government debt]] held by public/GDP ratio and the U.S. external liability/GDP. The first series represents the amount of debt owed by the U.S. government to the U.S. private sector and the rest of the world, whereas the second series represents the amount of debt owed by the U.S. to the rest of the world. Since the  2008  [[8. Credit Modeling and Credit Derivatives|global financial crisis]], both the U.S. government and the U.S. as a whole have been borrowing a lot more.
This comovement shows that [[International Trade Banking and Capital Markets Lecture Notes|international finance]] and government finance are closely intertwined. On the one hand, the foreign investors, private and official, have been financing a large portion of the U.S. external liabilities. To understand why this is the case, it is important to understand why they find the U.S. [[Global Fixed Income Markets|government debt]] particularly desirable. On the other hand, a large portion of the U.S. [[Global Fixed Income Markets|government debt]] has been financed by foreign investors. To evaluate the U.S. fiscal sustainability, it is also important to take a global perspective. We will consider these issues in detail in Chapters  7  and 8 .
# 2 .B. 5 Other Empirical Patterns
There are many more empirical patterns that this note does not have space to cover. For example, home bias is a salient pattern in international [[Lecture 2- Asset Allocation with Multiple Risky Assets|asset allocation]].  Lewis  [ 1999 ] provides a summary of the literature. More recently, micro-data shed new light on cross-border [[An Asset Allocation Primer|portfolio]] positions and global capital allocations.  Florez-Orrego, Maggiori, Schreger, Sun, and Tinda  [ 2023 ] provide a review of this literature.
 ![500](Attachments/500-14.jpg)
...
Miranda-Agrippino and Rey  [ 2022 ] provide a summary of the literature on the global financial cycle, which refers to the strong co movements between exchange rates, asset prices, capital flows, and the U.S. [[The Economist Regime Change|monetary policy]].  Du and Schreger  [ 2022 a ] provide a review of the literature on the CIP deviation and frictions in international capital markets.  Hassan and Zhang  [ 2021 ] provide a review of the literature on [[Forwards and Futures Notes|currency]] risks and [[Assets|returns]].
# Part II
# Understanding the Exchange Rates
# Risk Premia and Factor Structure
# Summary
• We first investigate the role of [[Forwards and Futures Notes|currency]] risk premium  $r p_{t},$   which drives both the [[Forwards and Futures Notes|currency]] [[Lecture 1- Probability Distributions of Returns|expected return]]:$$
...
E_{t}=\sum_{j=0}^{\infty}\mathbb{E}_{t}[r_{t+j}-r_{t+j}^{*}]-\sum_{j=0}^{\infty}\mathbb{E}_{t}[r p_{t+j}]+\bar{e}.
$$
• The [[Forwards and Futures Notes|currency]] risk premium is related to the [[Forwards and Futures Notes|currency]]’s loadings on the [[PSET 6- Financial Instruments|risk factors]], which give rise to a factor structure in [[Forwards and Futures Notes|currency]] [[Assets|returns]]:$$
...
$$
We first adopt a no-[[Arbitrage Pricing of Derivatives|arbitrage]] approach to organize the [[Forwards and Futures Notes|currency]] risk premium and the corresponding factor structure.
...
• Finally, we consider the long-term [[Lecture Notes on International Finance|currency risk premia]]. When markets are complete and the exchange rate is stationary, the long-run UIP condition holds:$$
E_{t}-{\bar{e}}=\operatorname*{lim}_{h\to\infty}h\bigl (r_{t}\bigl (h\bigr)-r_{t}^{*}\bigl (h\bigr)\bigr).
$$
To make sense of the exchange rate puzzles and other salient patterns in [[Lecture Notes on International Finance|international financial]] markets, we first enrich the risk premium in the baseline model. To be clear, as long as the households’
Utility function  $u (c)$   is non-linear, the [[Forwards and Futures Notes|currency]] risk premium is already present in the baseline model in Chapter  1 . As the [[Lecture Notes on International Finance|exchange rate accounting]] in Section  1 .B  shows, the [[Forwards and Futures Notes|currency]] risk premium    $r p_{t}$  affects both the [[Forwards and Futures Notes|currency]] [[Lecture 1- Probability Distributions of Returns|expected return]] and the exchange rate level.
In this chapter, we consider specific models that account for the time-series and the cross-sectional variations in the [[Forwards and Futures Notes|currency]] risk premium, and understand the properties of the implied [[Exchange Rates and the Foreign Exchange Market- An Asset Approach|exchange rate dynamics]]. As an initial step, all models presented in this chapter assume [[Financial Mathematics Course|complete markets]].
...
$$
And, equivalently, the expected [[Forwards and Futures Notes|currency]] excess return is zero,$$
\mathbb{E}_{t}\big[r x_{t+1}\big]=0.
$$
These conditions are known as the Uncovered [[Foreign Exchange Quoting Conventions|Interest Rate Parity]]. As we discussed in Section  2 , these predictions are rejected by the data. Instead, [[Forwards and Futures Notes|currency]] expected [[Assets|returns]] have large variations both in the time series and in the cross-section.
...
$$
Empirically, there are large variations in the interest rate differential, but the exchange rate appears to be a near random-walk process, which means the exchange rate movement is largely unexpected. As a result, the risk premium term    $r p_{t}$   must have significant variations. This means, to the extent that monetary policies drive a significant fraction of the variations in the [[Interest Rate Quotations|interest rates]], it must operate not through the first-order moments (i.e., the expected exchange rate movement), but through the second-order moments (i.e., the risk premium).
# 3 .A The No-Arbitrage Approach
Our first approach to modeling the [[Lecture Notes on International Finance|currency risk premia]] starts directly from the SDFs, which is known as the no-[[Arbitrage Pricing of Derivatives|arbitrage]] approach. For example,  Lustig, Roussanov, and Verdelhan  [ 2011 ] considers the following specification. The SDF of country    $i$   is$$
...
$$
As a result, when either the global shock or the country-specific shock is negative, the SDF becomes not only higher (indicating a higher marginal utility) and drives the exchange rate movement, it also becomes more volatile and thereby affects the [[Forwards and Futures Notes|currency]] risk premium.
# 3 .A. 1 Currency Return Dynamics
Define the log [[Forwards and Futures Notes|currency]] excess return as    $\boldsymbol{r}\boldsymbol{x}_{t+1}^{i/\S}\overset{\mathrm{def}}{=}\Delta e_{t+1}^{i/\S}+\boldsymbol{r}_{t}^{i}-\boldsymbol{r}_{t}^{\S}$    . Using Eq. ( 1 . 16 ), we can derive the [[Forwards and Futures Notes|currency]] risk premium as$$
...
$$
Then, the innovation in the [[Forwards and Futures Notes|currency]] excess return is given by$$
...
This result ties both the risk premia in the [[Forwards and Futures Notes|currency]] expected [[Assets|returns]] and the innovations in the realized [[Forwards and Futures Notes|currency]] [[Assets|returns]] to the underlying global and country-specific shocks. Let us first consider the global shock. For a country whose loading  $\delta^{i}$    on the global shock is high, its [[Forwards and Futures Notes|currency]] tends to appreciate during global recessions (i.e., higher  $\partial r x_{t+1}^{i/\mathbb{S}}/\partial\varepsilon_{t+1}^{w}).$  ), and to have a lower [[Forwards and Futures Notes|currency]] risk premium ex-ante (i.e., lower  $r p_{t}^{i/\Phi}$  ). Therefore, currencies with higher loading    $\delta^{i}$  are considered as safe currencies, and currencies with lower loading  $\delta^{i}$    are considered as risky currencies.
Let us then consider the country-specific shocks. Even though these shocks only reflect idiosyncratic business condition in each country and there is full risk-sharing between countries, they still affect [[Forwards and Futures Notes|currency]] [[Assets|returns]] and risk premia. The country-specific shock in country    $i$   still matters to the local representative household, because the local household has a bias towards home goods. As a result, the household’s allocation and marginal utility still loads heavily on the local shock despite there being full risk-sharing.    $\ensuremath{\boldsymbol{z}}_{t}^{i}$    captures the risk premium associated with the country-specific shock. When  $\ensuremath{\boldsymbol{z}}_{t}^{i}$    is high, country  i ’s SDF is volatile, and its [[Forwards and Futures Notes|currency]] earns a higher risk premium.
# 3 .A. 2 Interest Rate Dynamics
From the Euler equation ( 1 . 6 ), reproduced below,$$
1=\mathbb{E}_{t}\left[\exp ({m_{t+1}^{i}+r_{t}^{i}})\right],
$$
And under joint normality, the [[Black Scholes Derivation|risk-free rate]] can be expressed as$$
R_{t}^{i}=-\mathbb{E}_{t}[m_{t+1}^{i}]-\frac{1}{2}v a r_{t}(m_{t+1}^{i})=\mu_{t}^{i}-\frac{1}{2}\delta^{i}z_{t}^{w}-\frac{1}{2}\gamma z_{t}^{i}.
$$
In this expression, the second-order terms  −  $\begin{array}{r}{-\frac{1}{2}\delta^{i}z_{t}^{w}-\frac{1}{2}\gamma z_{t}^{i}}\end{array}$      are decreasing in the volatility of the SDF. In other words, when the households’ marginal utility growth is more volatile, which usually corresponds to crisis times, the households impute a higher value to the [[2. Forwards, Swaps, Futures, and Options|risk-free asset]] and lower its interest rate. This effect is usually referred to as the  precautionary saving  motive.
The non-stochastic term  $\mu_{t}^{i}$    reflects the expected growth rate of the households’ marginal utility. This term usually reflects the expected growth rate of consumption in many macro models, but, as we will see in Chapter  6 , it could also be interpreted as the monetary authority setting the interest rate to stabilize the economy. To align the [[Interest Rate Quotations|interest rates]] with [[Lecture Notes on International Finance|currency risk premia]], we assume  $\mu_{t}^{i}=\alpha+\chi z_{t}^{i}+\chi z_{t}^{w}$  .
...
Note that this positive relationship between the interest rate differential and the [[Forwards and Futures Notes|currency]] risk premium holds both across countries and over time. We next explore these two dimensions in detail.
3 .A. 3 [[Currency Carry Trade|Carry Trade]] (Cross-Sectional Variation in [[Forwards and Futures Notes|Currency]] Risk Premium) We next investigate the [[Currency Carry Trade|carry trade]]. We sort currencies into portfolios based on their [[Interest Rate Quotations|interest rates]]. We use    $H$   to denote the basket of currencies with high [[Interest Rate Quotations|interest rates]], and    $L$   to denote the basket of currencies with [[The Economist Time Is Cheap|low interest rates]]. The [[An Asset Allocation Primer|portfolio]] composition can change over time. The [[Currency Carry Trade|carry trade]] factor  hml  is defined as$$
H m l_{t+1}=\frac{1}{N_{H}}\sum_{i\in H}r x_{t+1}^{i/\P}-\frac{1}{N_{L}}\sum_{i\in L}r x_{t+1}^{i/\P},
$$
where  $N_{H}$   and    $N_{L}$   denote the number of currencies in each [[An Asset Allocation Primer|portfolio]]. We let  $\overline {{\sqrt{x_{t}^{j}} }}$  q   denote the average of  $\sqrt{x_{t}^{j}}$  q   across all currencies in [[An Asset Allocation Primer|portfolio]]  $j$  .
This [[Currency Carry Trade|carry trade]] factor has three notable properties. First, the innovation to the [[Currency Carry Trade|carry trade]] factor is a scaled version of the global shock:$$
...
$$
If we assume that the idiosyncratic volatility  $\ensuremath{\boldsymbol{z}}_{t}^{i}$    is independent across countries and has the same time-series dynamics (for example,  $\mathrm{AR (_{1})})$  , then, Eq. ( 3 . 4 ) implies that  higher  interest rate currencies tend to have  lower    $\delta^{i}.$  , and vice versa. We obtain  $\overline {{\sqrt{\delta_{t}^{L}} }}-\overline {{\sqrt{\delta_{t}^{H}} }}>0,$  q  0, and the [[Currency Carry Trade|carry trade]] factor  $h m l_{t+1}$   has a positive loading on the global shock.
Second, by being exposed to the global shock, the [[Currency Carry Trade|carry trade]] factor earns a positive risk premium on average:$$
\mathbb{E}_{t}\left[h m l_{t+1}\right]=\frac{1}{2}\left (\overline {{\delta_{t}^{L}} }-\overline {{\delta_{t}^{H}} }\right) z_{t}^{w}>0.
$$
In other words, the [[Forward Points in Currency|currency trading]] strategy that buys high interest rate currencies and sells low interest rate currencies earns a positive risk premium on average.
Finally, each [[Forwards and Futures Notes|currency]]’s loading on the [[Currency Carry Trade|carry trade]] factor allows us to measure their systematic risk exposures. Consider the conditional regression$$
...
Proposition  3 . 1 .  [[Forwards and Futures Notes|Currency]] i’s [[Currency Carry Trade|carry trade]] beta is$$
\beta_{t}^{i}=\frac{\sqrt{\delta^{\sharp}}-\sqrt{\delta^{i}}}{\sqrt{\delta_{t}^{L}}-\sqrt{\delta_{t}^{H}}}.
$$
The proof is presented in Appendix  A. 3 . Since  $\overline {{\sqrt{\delta_{t}^{L}} }}$  q   and  $\overline {{\sqrt{\delta_{t}^{H}} }}$  q   are common to all currencies, and  $\overline {{\sqrt{\delta_{t}^{L}} }}>\overline {{\sqrt{\delta_{t}^{H}} }}.$  q , then, the [[Currency Carry Trade|carry trade]] beta  $\beta_{t}^{i}$    is decreasing in the country’s loading  $\delta^{i}$   on the global shock.
This proposition connects the currencies’ risk exposures to their risk premia, incarnating the standard [[Fixed Income Asset Pricing|asset pricing]] logic that each asset’s risk exposure can be measured from its covariance with [[PSET 6- Financial Instruments|risk factors]], i.e.,$$
...
$$
Assuming that the factors are tradable. In the context of the [[Forwards and Futures Notes|currency]] market, the [[Currency Carry Trade|carry trade]] captures a risk factor:  $f_{t+1}\,=\, h m l_{t+1}$  . The [[Currency Carry Trade|carry trade]] beta    $\beta_{t}^{i}$    captures the risk exposure of [[Forwards and Futures Notes|currency]]  $i,$   and it relates to the [[Forwards and Futures Notes|currency]]’s risk premium via Eq. ( 3 . 3 ), reproduced below,$$
...
3 .A. 4 Forward Premium Puzzle (Time-Series Variation in [[Forwards and Futures Notes|Currency]] Risk Premium)
Next, we turn to the time-series pattern of the [[Forwards and Futures Notes|currency]] risk premium. Between the dollar and a given foreign [[Forwards and Futures Notes|currency]], the variation in the interest rate differential across time also predicts [[Forwards and Futures Notes|currency]] excess return. In our model, we compute the slope coefficient in this [[Week 2 Fundamentals Of Forecasting|forecasting]] regression in the following proposition:$$
R x_{t+1}^{i/\p}=\alpha^{i}+\varphi^{i}(r_{t}^{i}-r_{t}^{\p})+\varepsilon_{t+1}^{i}.
$$
Proposition  3 . 2 .  The slope coefficient from the regression of the [[Forwards and Futures Notes|currency]] excess return on the interest rate differential is given by$$
...
The proof is presented in Appendix  A. 4 . This proposition shows that the exposures to both the global and the country-specific SDF shocks induce co movements between the interest rate differential and the [[Forwards and Futures Notes|currency]] excess return. Specifically, a country’s interest rate declines when the global SDF volatility goes up and, if we assume  $\begin{array}{r}{\frac{1}{2}\gamma-\chi>0,}\end{array}$   0, when its idiosyncratic SDF volatility goes up. Both SDF components generate a positive slope coefficient in this regression, which rationalizes the UIP violation in the data.
Similarly, we can replace the [[Forwards and Futures Notes|currency]] excess return on the lefthand side of the regression with the exchange rate movement:$$
...
$$
Which is also positive if    $\textstyle{\frac{1}{2}}\gamma-\chi>0$  . In other words, when  $\chi\,>\, 0$  , the interest rate differential does not fully reflect the [[Forwards and Futures Notes|currency]] risk premium that is driven by the idiosyncratic SDF volatility in this model, so that the expected exchange rate movement also co-moves with the risk premium.
...
$$
for  $0<\zeta<1/2$  . In this case, while the [[Forwards and Futures Notes|currency]] risk premium loads on    ${\textstyle\frac{1}{2}}\left (\delta^{\oplus}-\delta^{i}\right)$    times the global shock’s volatility  $z_{t}^{w}$  , i.e.,$$
R p_{t}^{i/\S}\stackrel{\mathrm{def}}{=}\mathbb{E}_{t}\left[r x_{t+1}^{i/\S}\right]=\frac{1}{2}\left (\delta^{\S}-\delta^{i}\right) z_{t}^{w}+\frac{1}{2}\gamma\left (z_{t}^{\S}-z_{t}^{i}\right),
$$
...
$$
Which does not fully reflect this global component of the [[Forwards and Futures Notes|currency]] risk premium.
...
Lustig and Richmond  [ 2020 ],  Aloosh and Bekaert  [ 2021 ] construct [[Forwards and Futures Notes|currency]] base factors. For country  $i,$   it is the average of its bilateral exchange rate movement against foreign currencies 1 :$$
\Delta\bar{e}_{t}^{i}=\frac{1}{N}\sum_{i=1}^{N}\Delta e_{t}^{i/j}.
$$
This construct conveniently captures a [[Forwards and Futures Notes|currency]]’s average exchange rate movement. For example, the dollar index is commonly used in practice to reflect the overall strength of the U.S. dollar, and the dollar’s base factor    $\Delta\overline {{e}} _{t}^{\S}$    is the unweighted version of the dollar index.
1  Some authors use an alternative definition  $\begin{array}{r}{\Delta\bar{e}_{t}^{i}=\frac{1}{N-1}\sum_{i\neq j}\Delta e_{t}^{i/j}}\end{array}$  . Since −  $\Delta e_{t}^{i/i}\,=\, 0,$   0, these two definitions of [[Forwards and Futures Notes|currency]] base factors only differ by a constant scalar  $N/(N-1)$  . We use the definition in the main text since it computes simpler averages.
...
$$
Which measures [[Forwards and Futures Notes|currency]]  i ’s exposures to the global shock  $\varepsilon_{t+1}^{w}$    and to its own idiosyncratic shock  $\varepsilon_{t+1}^{i},$  , in a way that is invariant to the choice of the base [[Forwards and Futures Notes|currency]]  $j$  . As such, if we want to study the variation in the dollar, the dollar’s base factor might be more informative than the dollar’s bilateral exchange rate against an individual foreign [[Forwards and Futures Notes|currency]].
For example, the conditional and the unconditional variances of the [[Forwards and Futures Notes|currency]] base factor can be expressed as$$
...
$$
Which uncovers this [[Forwards and Futures Notes|currency]]’s idiosyncratic variance  $\ensuremath{\boldsymbol{z}}_{t}^{i}$    and its exposure to the global shock  $\delta^{i}$  .
...
$$
The proof is presented in Appendix  A. 5 . We note that the only foreign country  $j.$  -specific variable in this expression is its exposure to the systematic risk,  $\delta^{j}$  . In particular, its idiosyncratic risk  $\dot{\boldsymbol{z}}_{t}^{j}$    does not show up in this expression, because the [[Forwards and Futures Notes|currency]] base factor  $\Delta\overline {{e}} _{t+1}^{i}$    is not exposed to any individual foreign country’s idiosyncratic shock. Hence, for a given home [[Forwards and Futures Notes|currency]]  $i,$   the regression coefficient  $\varphi^{i/j}$    measures the difference in the systematic risk exposure between countries  $i$   and  $j,$   i.e.,  $\left (\sqrt{\delta^{i}}-\sqrt{\delta^{j}}\right)$    .
# 3 .A. 6 Other Works
Lustig, Roussanov, and Verdelhan  [ 2014 ],  Verdelhan  [ 2018 ] study a richer [[Pricing Factors in a One-Period Framework|factor model]] of exchange rates with two common factors, one of which is related to the [[Forwards and Futures Notes|currency]] [[Currency Carry Trade|carry trade]] that we study in this section, and the other is related to the U.S. dollar. To generate this structure, the SDF is exposed to both common factors:$$
...
$$
where the common shock  $\varepsilon_{t+1}^{w}$    is tied to the [[Forwards and Futures Notes|currency]] [[Currency Carry Trade|carry trade]] return and the other common shock  $\varepsilon_{t+1}^{g}$    is tied to the U.S. dollar. The loadings are time-varying, with the loadings on the dollar shock and on the idiosyncratic shock both tied to a local state variable  $\ensuremath{\boldsymbol{z}}_{t}^{i}$    and the loading on the [[Currency Carry Trade|carry trade]] shock tied to a global state variable  $z_{t}^{w}$  .
...
$$
Then, assuming [[Financial Mathematics Course|complete markets]], we can obtain the exchange rate from$$
\begin{array}{r}{\Delta e_{t+1}^{i/\mathbb{S}}=m_{t+1}^{i}-m_{t+1}^{\mathbb{S}}.}\end{array}
$$
This setting has the advantage of connecting exchange rates to asset prices in domestic bond and [[An Introduction to Equity Markets|equity markets]], as the state vector  $z_{t+1}^{i}$  can be used to price these financial assets following the affine [[The Vasicek Model|term structure]] model [ Chernov and Creal ,  2023 ]. We will discuss this class of affine models in Section  8 .E .
Finally, this no-[[Arbitrage Pricing of Derivatives|arbitrage]] approach provides a useful framework to account for the time-series and the cross-sectional variations in exchange rate movements and [[Lecture Notes on International Finance|currency risk premia]] using global and idiosyncratic SDF shocks in [[Financial Mathematics Course|complete markets]]. As such, it could be applied to all complete-market models that we study in this section.
# 3 .B Currency Risk Premia in the Time Series
The no-[[Arbitrage Pricing of Derivatives|arbitrage]] approach offers us an accounting framework to break down the variations that come from country-specific and global shocks. It imposes some discipline on how these shocks give rise to variations in exchange rates and [[Lecture Notes on International Finance|currency risk premia]], and helps us organize the exchange rate puzzles. However, it does not answer where these shocks come from. We need more structures to understand the origins of these shocks. In this and the next sections, we consider two such models. One is based on the long-run risks and emphasizes the time-series variations in [[Lecture Notes on International Finance|currency risk premia]], and the other is based on the trade network and emphasizes the crosssectional variations in [[Lecture Notes on International Finance|currency risk premia]].
# 3 .B. 1 Households
...
$$
The [[Long-Run Risks and Epstein-Zin Utility|consumption growth]] shock  $\varepsilon_{g, t+1},$   the long-run growth shock  $\varepsilon_{x, t+1},$   and the long-run growth volatility shock  $\varepsilon_{w, t+1}$   are jointly normal. We assume that long-run and short-run consumption shocks are correlated:    $c o v_{t}\big (\varepsilon_{g, t+1},\varepsilon_{x, t+1}\big)\,=\,\nu$  . For simplicity, we assume  $c o v_{t}\big (\varepsilon_{x, t+1},\varepsilon_{w, t+1}\big)=0,$  ,  $c o v_{t}\big (\varepsilon_{g, t+1},\varepsilon_{w, t+1}\big)=0$  .
...
$$
Which depends on not only the log [[Long-Run Risks and Epstein-Zin Utility|consumption growth]]    $\Delta c_{t+1},$   but also the log return on the wealth [[An Asset Allocation Primer|portfolio]]  $r_{t+1}^{c}$  . The following proposition shows that the log wealth-consumption ratio and the log SDF are linear functions of the state variables after the log-linear iz ation.
...
$$
 (
The proof is presented in Appendix  A. 6 . To interpret this result, we provide a simple [[Credit Markets Session 4|calibration]] of the model following  Bansal and Sh alias to vich  [ 2007 ]. The parameter values are reported in Table  3 . 1 . The only modification is that we assume the correlation between long-run and short-run consumption shocks, i.e.,    $c o v_{t}\big (\varepsilon_{g, t+1},\varepsilon_{x, t+1}\big)=$   $\nu_{,}$  , to be negative.
...
It is worth noting that this model does not start with endowment or production processes and household optimization that generate endogenous consumption processes. Instead, the consumption processes are assumed to be exogenous. Subsequent works such as Colacito and Croce  [ 2013 ],  Colacito, Croce, Ho, and Howard  [ 2018 b ] embed the [[Long-Run Risks and Epstein-Zin Utility|long-run risk]] in the endowment or production processes instead of the consumption processes. While these alternative settings bring the model closer to the baseline model we considered in Section  1 .A , it also makes the model more difficult to solve and requires us to rely on numerical solutions.
In this [[Long-Run Risks and Epstein-Zin Utility|long-run risk]] model we considered, the exogenous variables include the short-run [[Long-Run Risks and Epstein-Zin Utility|consumption growth]] shocks, the long-run
 ![500](Attachments/500-18.jpg)
[[Long-Run Risks and Epstein-Zin Utility|Consumption growth]] shocks, and the variance shocks:$$
...
\Delta e_{t+1}=m_{t+1}-m_{t+1}^{*}.
$$
3 .B. 3 [[Exchange Rates and the Foreign Exchange Market- An Asset Approach|Exchange Rate Dynamics]]
Now that we obtain a simple solution of the SDF, we are ready to characterize the [[Exchange Rates and the Foreign Exchange Market- An Asset Approach|exchange rate dynamics]].
Proposition  3 . 5 .  Assuming [[Financial Mathematics Course|complete markets]], the real exchange rate movement is$$
\begin{align}
\Delta e_{t+1} =\ 
...
\end{align}
$$
The [[Forwards and Futures Notes|currency]] risk premium is$$
...
$$
The proof is presented in Appendix  A. 7 . When the markets are complete, we have a simple mapping from the SDF shocks to exchange rate movements. Specifically, as negative home short-run and long-run consumption shocks and positive home volatility shocks raise the marginal utilities of home households, they lead to home [[Forwards and Futures Notes|currency]] appreciation. In comparison, the home [[Forwards and Futures Notes|currency]]’s risk premium only depends on the second-order moments, and it is decreasing in home consumption volatility and increasing in foreign consumption volatility.
The interest rate differential also loads negatively on home consumption volatility, which is also driven by a higher precautionary saving when home consumption volatility is high. In this way, the [[Valuing European Option Using the Heston Model in QuantLib Python|stochastic volatility]] drives common movements in [[Lecture Notes on International Finance|currency risk premia]] and [[What Really Is the Cross-Currency Basis|interest rate differentials]], giving rise to an explanation of the forward premium puzzle.
Finally, the correlation between long-run and short-run consumption shocks  $\nu$   plays a key role in the Backus-Smith coefficient. Consider the following benchmark: suppose the [[Long-Run Risks and Epstein-Zin Utility|consumption growth]] process has no long-run growth or [[Valuing European Option Using the Heston Model in QuantLib Python|stochastic volatility]]:  $\Delta c=\mu_{g}+\sigma_{g}\varepsilon_{g, t+1}$  . Then, the Backus-Smith coefficient is$$
...
In our [[Credit Markets Session 4|calibration]], the term  $\begin{array}{r l r}&{}&{\frac{\varphi_{e}\left (1-\theta\right) W_{x}}{v a r_{t}\left (\sigma_{t}^{*}\varepsilon_{g, t+1}^{*}-\sigma_{t}\varepsilon_{g, t+1}\right)}\left (\sigma_{t}^{2}+\sigma_{t}^{*2}\right)}\end{array}$    is always positive. So, a negative correlation between long-run and short-run consumption shocks  $\nu$   lowers the Backus-Smith coefficient below    $\gamma$  . In fact, this correlation is negative enough in our [[Credit Markets Session 4|calibration]], which gives rise to a negative Backus-Smith coefficient. In other words, when the long-run consumption shock goes in the opposite direction than the short-run consumption shock, it disentangles the link between the spot [[Long-Run Risks and Epstein-Zin Utility|consumption growth]] and marginal utilities: a higher short-run [[Long-Run Risks and Epstein-Zin Utility|consumption growth]] at the expense of lowering long-run growth is bad news. It raises marginal utilities and leads to [[Forwards and Futures Notes|currency]] appreciation.
This is the key mechanism emphasized by  Colacito and Croce [ 2013 ], who also provide a reason for the negative correlation: an increase in the home households’ long-run [[Long-Run Risks and Epstein-Zin Utility|consumption growth]] leads to an increase in their continuation utility and a decline in their marginal utility. With perfect risk-sharing, the social planner should reduce the spot consumption allocated to the home country, leading to a decline in the home households’ short-run [[Long-Run Risks and Epstein-Zin Utility|consumption growth]]. At the same time, these resources flow to the foreign country that receives relatively worse news.
# 3 .B. 4 Other Works
Colacito and Croce  [ 2011 ],  Bansal and Sh alias to vich  [ 2013 ] consider similar settings with exogenous ly given consumption dynamics. Bansal and Sh alias to vich  [ 2013 ] further consider the [[War Economies and Hyperinflation|inflation]] dynamics, which allows them to price nominal bonds and exchange rates. Colacito and Croce  [ 2013 ],  Colacito, Croce, Ho, and Howard  [ 2018 b ] embed this setting in endowment economies with long-run risks and recursive preferences.  Colacito, Croce, Gavazzoni, and Ready  [ 2018 a ] introduce heterogeneity in the risk loadings of different countries’ long-run consumption shocks.
Parallel to the [[Long-Run Risks and Epstein-Zin Utility|long-run risk]] model, other models have also been proposed to describe the dynamics of [[Lecture Notes on International Finance|currency risk premia]], such as [[CCAPM with Alternative Preferences|habit formation]] [ Verdelhan ,  2010 ,  Heyerdahl-Larsen ,  2014 ,  Stathopoulos ,  2017 ], demand shocks [ Pavlova and Rigobon ,  2007 ], rare disasters [ Farhi and Gabaix ,  2016 ].
# 3 .C Currency Risk Premia in the Cross-Section
The literature on [[International Trade Banking and Capital Markets Lecture Notes|international finance]] has also provided several mechanisms that generate persistent differences in [[Lecture Notes on International Finance|currency risk premia]] across currencies. These mechanisms help explain the [[Currency Carry Trade|carry trade]] and the factor structure in [[Forwards and Futures Notes|currency]] [[Assets|returns]]. In this section, we consider such a mechanism based on the [[International Trade Banking and Capital Markets Lecture Notes|global trade]] network [ Richmond ,  2019 ] and  Jiang and Richmond  [ 2023 b ] in particular. This approach is based on a large literature in macro that studies production networks [ Long Jr and Plosser ,  1983 ,  Foerster, Sarte, and Watson ,  2011 ,  Gabaix ,  2011 ,  Acemoglu, Carvalho, Ozdaglar, and Tahbaz-Salehi ,  2012 ,  Chaney ,  2014 ,  Baqaee and Farhi ,  2019 ].
...
$$
So that the production function has constant [[Assets|returns]] to scale. We collect the production parameters for intermediate goods  $w_{i j}$   into a matrix  W .
...
The households have log preferences over their [[Pareto-Optimality in Some Incomplete Markets|aggregate consumption]], and discount future utility at rate  $\beta$  . The utility function is$$
\sum_{t=1}^{\infty}\delta^{t}\log{\overline {{c}} _{t}^{i}}.
$$
The households have access to complete [[Financial Markets and Institutions Lecture Notes|financial markets]], where they can trade contingent claims with the households in any country.
...
Since the households have access to the [[Financial Mathematics Course|complete markets]], the competitive equilibrium can be characterized by the solution to a social planner’s problem. Within period  $t,$   the social planner’s Lagrangian is$$
...
The proof is presented in Appendix  A. 8 . This result shows that the structure of the [[International Trade Banking and Capital Markets Lecture Notes|global trade]] network, summarized by the network profile matrix  $H\;=\; V (I-W)^{-1}$  , plays an important role in transmitting both the supply shocks   $(a)$   and the demand shocks  $(d)$  . The network profile matrix combines the production trade network  $W$   and the consumption trade network    $V$  . The term    $(I-W)^{-1}$  is commonly known as the Leontief inverse, which summarizes the transmission of the productivity shocks. Loosely speaking,  $(I-W)^{-1}\,=\, I+W+W^{2}+W^{3}+.\,.,$   where    $W$   reflects the transmission from the exporting country to the importing country, and  $W^{k}$    for  $k>1$   reflects the transmission of shocks due to higher order linkages.
Taking a [[Convexity|first-order approximation]], we can express the active households’ log [[Long-Run Risks and Epstein-Zin Utility|consumption growth]] as a linear function of the supply shocks  $\Delta\log a$   and the demand shocks    $\Delta d$  :$$
\Delta\log\bar{c}\approx H\left (\Delta\log a-\frac{\theta}{H^{\prime}\pi}\big (I-W^{\prime}\big)^{-1}\Delta d\right),
$$
Where  $\frac{1}{H^{\prime}\pi}$    is a diagonal matrix whose element    $(i, i)$   is  $\frac{1}{\{H^{\prime}\pi\}_{i}}$  . This expression shows that each country’s [[Long-Run Risks and Epstein-Zin Utility|consumption growth]] is driven by a combination of [[Currency Appreciation and Depreciation|demand and supply]] shocks of, potentially, all other countries globally. The specific combination of shocks that a country is exposed to is primarily determined by the structure of [[International Trade Banking and Capital Markets Lecture Notes|global trade]] linkages summarized by the network profile matrix  $H$  . This common exposure to country-level shocks that arises due to trade linkages gives rise to international co movements.
3 .C. 6 Characterizing Consumption and Exchange Rate Co movements
We are interested in characterizing international co movements in [[Long-Run Risks and Epstein-Zin Utility|consumption growth]] and exchange rates. We define the bilateral log real exchange rate between countries  $i$   and  $j,\, e_{t}^{i/j}.$  , as the log price of country  $j^{\prime}{\bf s}$   consumption bundle per unit of country  i ’s consumption bundle. An increase in  $e_{t}^{i/j}$  implies an appreciation of country  i ’s real exchange rate relative to country  $j^{\prime}$  ’s. Since markets are complete, the bilateral exchange rate movement is determined by the difference in the growth rates of marginal utilities:$$
\Delta e_{t}^{i/j}=\Delta\log\bar{c}_{t}^{j}-\Delta\log\bar{c}_{t}^{i}.
$$
We define each country’s  [[Forwards and Futures Notes|currency]] base factor ,  $\Delta\overline {{e}} _{i t},$   as the equalweighted average log real exchange rate change against all countries, including itself:$$
...
Proposition  3 . 7 .  (a) Closer countries have more correlated active household [[Long-Run Risks and Epstein-Zin Utility|consumption growth]]:$$
c o v\left (\Delta\log\overline {{c}} _{t}^{i},\Delta\log\overline {{c}} _{t}^{j}\right)=\mathcal{C}(i,j).
$$$(b)$   Closer countries have more correlated [[Forwards and Futures Notes|currency]] base factors and less volatile bilateral real exchange rate movements:$$
...
$$
(c) The variance of country i’s [[Forwards and Futures Notes|currency]] base factor is$$
v a r\left (\Delta\overline {{e}} _{t}^{i}\right)=-2\overline {{\mathcal{C}} }(i)+\mathcal{C}(i, i)+\kappa^{e}.
$$
Fixing its closeness to itself  $\mathcal{C}(i, i)$  , the country’s [[Forwards and Futures Notes|currency]] base factor is less volatile if it has a higher average closeness.
...
3 .C. 7 [[Lecture Notes on International Finance|Currency Risk Premia]] and Endogenous Common Factors
We set the U.S. dollar as the base [[Forwards and Futures Notes|currency]].
Proposition  3 . 8 .  [[Forwards and Futures Notes|Currency]] i’s [[Theoretical Factors|expected excess return]] is$$
...
$$
The proof is presented in Appendix  A. 10 . This result shows that, fixing the base [[Forwards and Futures Notes|currency]], a [[Forwards and Futures Notes|currency]]  i ’s risk premium is decreasing in its closeness to itself, i.e.,    $\mathcal{C}(i, i)$  . Following  Richmond  [ 2019 ], we may call this object country    $i^{\prime}$  s trade centrality. The trade centrality summarizes how this country’s position and relation to other countries in the trade network affects its [[Forwards and Futures Notes|currency]] risk premium. A country with a large  $\mathcal{C}(i, i)$   is a central country and has a low [[Forwards and Futures Notes|currency]] risk premium, whereas a country with a small  $\mathcal{C}(i, i)$   is a peripheral country and has a high [[Forwards and Futures Notes|currency]] risk premium.
...
\right],
$$
Which implies that country  1  is the most central country because it provides essential production input to all other countries, and country  4  is the most peripheral country because it is very reliant on country  1 ’s export. Accordingly, country  1 ’s shock is the most systematic and as a result it has the lowest [[Forwards and Futures Notes|currency]] risk premium.
...
# 3 .C. 8 Other Works
Other works explain cross-country differences in [[Lecture Notes on International Finance|currency risk premia]] based on different mechanisms, such as size [ Martin ,  2011 ,  Hassan ,  2013 ], commodity goods [ Ready, Roussanov, and Ward ,  2017 b , a ], and financial inter mediation and risk-bearing capacity [ Maggiori , 2017 ,  Wir i ad in at a ,  2018 ,  Fang ,  2021 ].
...
This discussion centers on the implication of log preferences for the households’ within-period choices. Log preferences also have important implications for the households’ inter temporal choices. As we will see in Section  9 .A , the households with log preferences are “myopic” in terms of assessing the time-varying [[An Asset Allocation Primer|investment]] opportunities.
# 3 .D Currency Risk Premia in the Long Run
So far we have been focusing on the [[Forwards and Futures Notes|currency]] risk premium and [[Forwards and Futures Notes|currency]] factor structure in one-period [[Assets|returns]]. In this section, we turn to the long-run [[Forwards and Futures Notes|currency]] risk premium and the long-term bond yields. This approach builds on works related to the permanent and the transitory components of the SDFs, such as  Alvarez and Jermann [ 2005 ],  Hansen and Scheinkman  [ 2009 ],  Backus, Boyar chen ko, and Chernov  [ 2018 ],  Lustig, Stat hopo u los, and Verdelhan  [ 2019 ]. We start with some additional notations. First, we introduce the multiperiod bonds. Let    $r_{t}(h)$   denote the log yield on the risk-free bond with maturity  $h$  . The bond price is given by$$
P_{t}(h)=\exp (-r_{t}(h) h).
$$
...
$$
It is useful to compare two different multi-horizon [[Forward Points in Currency|currency trading]] strategies from period 0 to period  $h$  . In the first strategy, the home households buy the foreign one-period bond and sell the home one-period bond in each period  $t$  . The cumulative log return from
This strategy is$$
...
The representative households’ [[Utility Indices|preference]] is$$
...
$$
If two countries share the same martingale component of the [[Definitions and Immediate Consequences|pricing kernel]], then the resulting exchange rate is stationary up to a deterministic time trend. In this case,$$
...
$$
We can think of Eq. ( 3 . 20 ) as the  long-run uncovered [[Foreign Exchange Quoting Conventions|interest rate parity]] (long-run UIP)  condition. This condition is related to the oneperiod UIP condition:$$
E_{t}-\mathbb{E}_{t}[e_{t+1}]=r_{t}-r_{t}^{*}.
$$
In Section  1 .B  Eq. ( 1 . 12 ), we show that the one-period UIP condition fails, and an additional risk premium term  $r p_{t}$   is required on the right-hand side. In comparison, Eq. ( 3 . 20 ) shows that, when the exchange rate is stationary, the uncertainty in the exchange rate level over the infinite horizon vanishes from the [[Arbitrage Pricing of Derivatives|pricing]] perspective, leading to zero risk premium. As a result, the exchange rate’s deviation from the long-run mean is only determined by the long-term bond yield differential.
Moreover, if we compare this result with the [[Lecture Notes on International Finance|exchange rate accounting]] formula in Proposition  1 . 2 , reproduced below,$$
E_{t}-\bar{e}=\sum_{j=0}^{\infty}\mathbb{E}_{t}[r_{t+j}-r_{t+j}^{*}]-\sum_{j=0}^{\infty}\mathbb{E}_{t}[r p_{t+j}],
$$
we can see that the infinite-horizon bond yield incorporates information about both the future short rates and the future [[Lecture Notes on International Finance|currency risk premia]], i.e.,$$
...
$$
If we further decompose the infinite-horizon bond yield into an expected [[An Overview of the Vasicek Short Rate Model|short rate]] component and a yield spread component, the bond yield spread differential is related to the [[Forwards and Futures Notes|currency]] risk premium:$$
...
$$
In this equation, the left-hand side is the cumulative excess return of holding the home bond until maturity minus that of holding the foreign bond, and the right-hand side is the [[Forwards and Futures Notes|currency]] risk premium derived from rolling over one-period bond positions across countries. This equation shows that these two risk premium measures in the bond market and in the [[Forwards and Futures Notes|currency]] market are closely related, provided that markets are complete and the exchange rate is stationary.
...
$$
While the home SDF is a [[Some Discrete-Time Stochastic Processes|random walk]] (plus a deterministic drift), the foreign SDF is set up so that the foreign [[An Overview of the Vasicek Short Rate Model|short rate]] responds to the exchange rate level. Assuming    $\phi\,>\, 0.$  , the foreign central bank lowers the local one-period interest rate  $r_{t}^{*}(1)\,=\,\mu-\phi e_{t}$   −  when the home [[Forwards and Futures Notes|currency]] is strong, which creates an expected appreciation of the foreign [[Forwards and Futures Notes|currency]].
In [[Financial Mathematics Course|complete markets]], the exchange rate movement is$$
...
$$
This model allows us to solve the long-term bond yields in closed form. The home country’s bond yields have a flat [[The Vasicek Model|term structure]]:$$
...
#  $3.D.4$  [[Arbitrage Pricing of Derivatives|Pricing]] Permanent Cash Flows
...
$$
We choose to study the claim to endowment because its [[Preview of the Book|cash flow]] in log is co integrated with the permanent component of the log SDF after removing a deterministic trend. Note that$$
...
$$
We can show that    $m c_{t}^{P}/\sigma_{P}-(\log{y_{t}}-\mu t)/\nu_{P}$   −  −  is a stationary process. In comparison, the [[Preview of the Book|cash flow]] of a long-term bond is not co integrated with the permanent component of the log SDF.
The risk premia of the endowment strip and the long-term bond is defined as the [[Theoretical Factors|expected excess return]] of holding the asset for one period. They are characterized by the following proposition.
...
$$
The proof is presented in Appendix  A. 12 . By comparing the infinite-horizon risk premia on the bond and the endowment strip, we can see that the bond risk premium does not load on the quantity of the permanent risk,  $\sigma_{P,}$  , in the limit, whereas the endowment risk premium does. In most [[Financial Mathematics Course|asset pricing models]], the quantity of permanent risk is very large [ Alvarez and Jermann ,  2005 ] and the risk aversion parameter    $\gamma$   is above  $1/2,$  , which generate a much higher [[PSET 7- Kohler|discount rate]] on the endowment strip than on the bond. As we will see in Section  8 .E , if other cash flows (such as the equity dividend or government tax) are co integrated with the endowment and hence with the permanent component of the SDF, then, their risk premia should converge to that of the endowment strip in the limit as well.
We notice that this risk premium does not depend on the transitory component of the SDF as well as the transitory component of the [[Preview of the Book|cash flow]]. In fact, for any [[Preview of the Book|cash flow]] stream that is co integrated with the endowment, the risk premium on its infinite-horizon strip is also equal to  $\scriptstyle\operatorname*{lim}_{h\to\infty}r x_{t}^{y}(h)$  . Similarly, for any [[Preview of the Book|cash flow]] stream that is stationary, the risk premium on its infinite-horizon strip is equal to that of the infinite-horizon bond. We will use this result when considering the government’s fiscal cash flows in Chapter  8 .
# 4 Convenience Yields
# Summary
...
$$
• This wedge affects both the [[Forwards and Futures Notes|currency]] [[Lecture 1- Probability Distributions of Returns|expected return]]:$$
...
$$
• Under additional assumptions about the [[Class Note 10 Liquidity and Class Note 10 Liquidity and Liquidity Managementliquidity management|liquidity]] benefits of the [[Forwards and Futures Notes|currency]] forward, the convenient yield can be measured from the Treasury CIP deviation    $x_{t}^{T r e a s}$  :$$
\lambda_{t}^{*}=-\frac{1}{1-\beta^{*}}x_{t}^{T r e a s}.
$$
In this chapter, we consider an additional ingredient that drives [[Forwards and Futures Notes|currency]] [[Assets|returns]], the bond convenience yields, which reflect the currencies’ non-pecuniary qualities including [[Class Note 10 Liquidity and Class Note 10 Liquidity and Liquidity Managementliquidity management|liquidity]], safety, and the ability to pledge as collateral.
This view is supported by the near-[[Arbitrage Pricing of Derivatives|arbitrage]] spreads observed in the data, which show that certain currencies and assets earn different [[Assets|returns]] despite having similar payoffs. For example, a large literature has found that the yields on U.S. Treasury debt are traded below other benchmark [[Interest Rate Quotations|interest rates]] [ Longstaff ,  2004 ,  Krishna mur thy and Vissing-Jorgensen ,  2012 ,  Nagel ,  2016 ,  Van Binsbergen, Diamond, and Grotteria ,  2022 ]. The U.S. Treasury also appears more expensive than
TIPS [ Flecken stein, Longstaff, and Lustig ,  2014 ], corporate bonds [ Bai and Collin-Dufresne ,  2019 ], foreign sovereign bonds [ Du,  $\operatorname{Im},$   and Schreger ,  2018 a ,  Jiang, Krishna mur thy, and Lustig ,  2018 ,  2021 a ,  Koijen and Yogo ,  2020 ], and [[Key Rates O1s Durations and Hedging|duration]]-matched stocks [ Van Binsbergen , 2020 ]. We refer to the lower yield earned by the U.S. Treasury as the convenience yield. Moreover, the convenience yield is not specific to the U.S. Treasury, as other safe assets such as high-grade dollar corporate bonds and bank deposits also appear to earn lower yields [ Liao ,  2020 ,  Gutierrez, Ivashina, and Salomao ,  2021 ].
To model these convenience yields, let  $r_{t}$   denote the log Treasury yield in the home country, and let  $\rho_{t}$   denote the log yield of a benchmark risk-free bond that does not contain the non-pecuniary benefits. Both rates are one-period. The benchmark [[Black Scholes Derivation|risk-free rate]] exactly satisfies the households’ Euler equation:$$
1=\mathbb{E}_{t}\left[\exp (m_{t+1}+\rho_{t})\right].
$$
As the Treasury is more expensive, the Treasury yield is lower than the benchmark [[Black Scholes Derivation|risk-free rate]]:$$
R_{t}<\rho_{t},
$$
...
$$
This convenience yield describes the amount of risk-adjusted [[Lecture 1- Probability Distributions of Returns|expected return]] that the households are willing to give up in order to hold the Treasury debt. This equation will be the central equation that organizes our discussion of the convenience yields in this chapter.
...
In contrast, a special asset that carries a convenience yield generates a wedge in the Euler equation as in Eq. ( 4 . 1 ). In our analysis below, we will show that the convenience yield and the [[Forwards and Futures Notes|currency]] risk premium will drive variations in the exchange rate level and the [[Forwards and Futures Notes|currency]] [[Lecture 1- Probability Distributions of Returns|expected return]] through different channels.
# 4 .A An Illustrative Model
We assume that home bond generates non-pecuniary utilities when it is held by either home or foreign households. As a concrete example, we think about the home country as the U.S., the home risk-free bond as the U.S. Treasury, and the home [[Forwards and Futures Notes|currency]] as the dollar in this model.
Specifically, recall that    $b_{H, t}$   is the market value of the bond and  $r_{t}$   is the [[Black Scholes Derivation|risk-free rate]]. The home investors’ utility is derived over consumption and the market value of home bond holdings:$$
...
We assume that households face the same endowment processes and the same [[Financial Markets and Institutions Lecture Notes|financial markets]] as in Section  1 .A . The only difference is the presence of a government in each country, which plays the role of the safe asset issuer. Specifically, we assume that the home country’s government borrows a one-period risk-free bond with par value  $\bar{b}_{t}$  in period  $t,$   and pays it back in period  $t+1$  . The government pays the proceeds from the bond issuance as a transfer to the domestic households in period    $t,$  , and raises tax from the domestic households to pay off the debt in period    $t+1$  . The household budget in period  $t$  is$$
...
\mathbb{E}_{0}\left[\sum_{t=0}^{\infty}\delta^{t}\big (u^{*}\big (c_{t}\big)+v\big (b_{H, t}^{*};\theta_{t}^{*}\big)\big)\right],
$$
Where the market value    $b_{H, t}^{*}$    of foreign households’ bond holding is also in the home (real) [[Forwards and Futures Notes|currency]] units. We define the foreign households’ convenience yield as$$
...
The model implies the following  14  equations in each period, one of which is redundant since the market clearing adds up to the sum of households’ [[The One-Period Framework|budget constraints]]. For the Home country in period  $t_{.}$  ,$$
...
$$
Which look like the original Euler equations ( 1 . 6 )–( 1 . 9 ) that we derived in Section  1 .B  for risk-free bonds without convenience yields. However, a key difference makes these two cases  not observationally equivalent : the home and foreign investors may have different convenience yields  $\lambda_{t}$   and  $\lambda_{t}^{*}$  . In this case, the home investors effectively perceive a home [[Black Scholes Derivation|risk-free rate]] without convenience yield equal to  $\rho_{t}\,=\, r_{t}+\lambda_{t},$   whereas the foreign investors effectively perceive a different home [[Black Scholes Derivation|risk-free rate]] without convenience yield equal to  $\tilde{\rho}_{t}=r_{t}+\lambda_{t}^{*}$  . Therefore, we cannot map the setting with bond convenience yields back to the baseline model without bond convenience yields by modifying the bond yields.
...
\exp\!\left (-\lambda_{t}\right)=\mathbb{E}_{t}\left[\exp\!\left (m_{t+1}+r_{t}\right)\right].
$$
Since the home households’ SDF and convenience yield are assumed to be unaffected, this Euler equation implies that the dollar [[Black Scholes Derivation|risk-free rate]]  $r_{t}$   does not change.
...
$$
An increase in their convenience yield  $\lambda_{t}^{*}$    lowers their risk-neutral [[Lecture 1- Probability Distributions of Returns|expected return]] on holding home risk-free bonds. Since the dollar [[Black Scholes Derivation|risk-free rate]] does not change, the exchange rate has to adjust to e qui lib rate this Euler equation. In particular, the dollar needs to appreciate today and create an expected depreciation to generate the lower [[Lecture 1- Probability Distributions of Returns|expected return]].
...
$$
we learn that the dollar exchange rate movement also raises the [[Lecture 1- Probability Distributions of Returns|expected return]] on purchasing foreign [[Forwards and Futures Notes|currency]] bonds from the home perspective. Since the home households do not derive a convenience yield on foreign bonds that can adjust, all adjustment must happen in the dollar’s [[Forwards and Futures Notes|currency]] risk premium. In our equilibrium, this happens via endogenous changes in the cyclical it y and volatility of the dollar. Thus, these four Euler equations require endogenous responses in both first moments (i.e., exchange rate level and [[Lecture 1- Probability Distributions of Returns|expected return]]) as well as second moments (i.e., [[Forwards and Futures Notes|currency]] cyclical it y and volatility) in response to the shock to the convenience yield. As such, although the convenience yield and the risk premium are conceptually different, they could be correlated in practice.
# 4 .B. 2 Accounting for the Currency Expected Return
For the discussion in this section, we assume the random variables are jointly normally distributed. First, we can derive the [[Covered Interest Rate Parity|home interest rate]] expression:$$
...
$$
Recall that the  expected log excess return  of the home [[Forwards and Futures Notes|currency]] against the foreign [[Forwards and Futures Notes|currency]] is defined as$$
R x_{t+1}=\Delta e_{t+1}+r_{t}-r_{t}^{*}.
$$
Then, the Euler equations imply the following result:
Proposition  4 . 1 .  The home [[Forwards and Futures Notes|currency]]’s expected log excess return is determined jointly by the home [[Forwards and Futures Notes|currency]]’s risk premium and the home bond’s convenience yield:$$
\mathbb{E}_{t}\big[r x_{t+1}\big]=r p_{t}-\lambda_{t}^{*},
$$
Where   $\begin{array}{r l}{r p_{t}\overset{d e f}{=}-c o v_{t}\big (m_{t+1}^{*},\Delta e_{t+1}\big)-\frac{1}{2}v a r_{t}\big (\Delta e_{t+1}\big)}\end{array}$   is the [[Forwards and Futures Notes|currency]] risk premium.
If we compare this result to the benchmark case in Proposition 1 . 10 , we note that the [[Forwards and Futures Notes|currency]] [[Theoretical Factors|expected excess return]] now depends on both the [[Forwards and Futures Notes|currency]] risk premium and the convenience yield. These two components of the [[Forwards and Futures Notes|currency]] [[Theoretical Factors|expected excess return]] are conceptually different: the risk premium is the compensation for the [[Forwards and Futures Notes|currency]]’s risk exposures, whereas the convenience yield reflects the non-pecuniary benefits that investors derive from holding the bonds issued in this [[Forwards and Futures Notes|currency]]. Of course, the [[Forwards and Futures Notes|currency]] risk premium and the convenience yield could be correlated, as recessions tend to increase risk premia as well as demand for safe assets. That said, they are two conceptually distinct channels that affect the [[Forwards and Futures Notes|currency]] [[Lecture 1- Probability Distributions of Returns|expected return]] and, as we will see next, the exchange rate level.
...
$$
Combined together, these expressions imply that the home and foreign investors need to agree on the combination of the equilibrium [[Forwards and Futures Notes|currency]] risk premium and the convenience yield from their different perspectives:$$
...
Proposition  4 . 2 .  The exchange rate level is equal to the sum of expected [[Forward Rate|future interest rate]] differentials, the sum of expected future convenience yields, the sum of expected future [[Lecture Notes on International Finance|currency risk premia]], and the long-run exchange rate level:$$
E_{t}=\sum_{j=0}^{\infty}\mathbb{E}_{t}[r_{t+j}-r_{t+j}^{*}]+\sum_{j=0}^{\infty}\mathbb{E}_{t}[\lambda_{t+j}^{*}]-\sum_{j=0}^{\infty}\mathbb{E}_{t}[r p_{t+j}]+\bar{e}.
$$
In other words, if today’s home [[Forwards and Futures Notes|currency]] is stronger than its longrun mean, it is either because the home [[Forwards and Futures Notes|currency]] is offering a higher interest rate than the foreign [[Forwards and Futures Notes|currency]], or it has a higher convenience yield, or because it has a lower risk premium (i.e., a lower [[PSET 7- Kohler|discount rate]]).
Similar to the [[Lecture Notes on International Finance|exchange rate accounting]] in Section  1 .B , we can also use this formula to decompose the exchange rate innovation:$$
...
$$
As the home bond carries a convenience yield, the home households’ Euler equation implies that it is lower than the home [[Black Scholes Derivation|risk-free rate]]$\rho_{t}$   by exactly  $\lambda_{t}$  . In comparison, the foreign bond does not carry a convenience yield, so the foreign bond yield    $r_{t}^{*}$    is equal to the foreign [[Black Scholes Derivation|risk-free rate]]  $\rho_{t}^{*}$  .
...
$$
Which implies that the variations in the exchange rate level are driven by the variations in the [[Black Scholes Derivation|risk-free rate]] differentials (which carry no convenience yields), in the [[Lecture Notes on International Finance|currency risk premia]], and in the  difference between the convenience yields that home and foreign households derive from holding the home bond.
This expression shows why it is natural to focus on the case in which home and foreign households derive different convenience yields, i.e.,  $\lambda_{t}\ \neq\ \lambda_{t}^{*}$    . If the home and foreign households have the identical convenience yield, i.e.,  $\lambda_{t}=\lambda_{t}^{*}.$  , then, the exchange rate level is determined only by the [[Black Scholes Derivation|risk-free rate]] differentials and the [[Lecture Notes on International Finance|currency risk premia]], both of which are driven by the SDFs via$$
...
Building on the discussion of the [[Foreign Exchange Markets and Exchange Rate Determination|exchange rate determination]], let us consider [[Financial Mathematics Course|complete markets]] as a special case. In the model we specified in Section  4 .A , we additionally assume that the home and foreign households can trade the complete set of contingent claims. In the meanwhile, these households still derive non-pecuniary benefits from holding the dollar risk-free bond, so the model is still different from the baseline model in Section  1 .C .
...
$$
Which is similar to the equilibrium condition under [[Financial Mathematics Course|complete markets]] that the home and foreign households’ marginal utilities over consumption are also equalized (after unit conversion by the exchange rate  $\exp (e_{t})$   and multiplication with the Pareto weights    $\pi$   and  $1-\pi)$  :$$
\pi u^{\prime}(c_{t})=(1-\pi) u^{\prime}(c_{t}^{\ast})\exp (e_{t}).
$$
As such, [[Lecture Notes on International Finance|incomplete markets]] are an essential ingredient to make the convenience yields matter for exchange rates. We will further explore the interaction between [[Lecture Notes on International Finance|incomplete markets]] and convenience yields in Section  5 .D .
# 4 .C Measuring the Convenience Yields
Having described the role convenience yields play in [[Exchange Rates and the Foreign Exchange Market- An Asset Approach|exchange rate dynamics]], we face the obvious question of how they are measured empirically. As indicated in Section  2 .A. 6 , the convenience yields manifest themselves in many interest rate spreads. In this section, we discuss this issue in the context of the Treasury basis, which follows Jiang, Krishna mur thy, and Lustig  [ 2021 a ].
Recall that a dollar forward allows investors to lock in the dollar exchange rate at a fixed rate  $f_{t}$   in the next period. Now, consider the following trading strategy. In period  $t,$   an investor converts  1  unit of dollar to  $\exp (e_{t})$   units of the foreign [[Forwards and Futures Notes|currency]], and purchase foreign risk-free bonds. At the same time, the investor enters a [[Forwards and Futures Notes|currency]] [[Forward Points in Currency|forward contract]] to lock in the dollar exchange rate at  $f_{t}$   in period  $t+1$   for   $\exp\!\left (e_{t}+r_{t}^{*}\right)$   units of foreign [[Forwards and Futures Notes|currency]].
Then, in period  $t+1.$  , the investor has  $\exp (e_{t}+r_{t}^{*})$   units of foreign [[Forwards and Futures Notes|currency]], which are then converted back to  $\exp (-f_{t}+e_{t}+r_{t}^{*})$   units of dollar using the [[Forward Points in Currency|forward contract]]. This strategy generates a return of  $\exp (-f_{t}+e_{t}+r_{t}^{*})$   per dollar invested. Since the investor does not hold the actual dollar risk-free bond but still earns a [[A Preview of Alternative Formulations|risk-free return]] in dollar terms, we regard this combination of foreign risk-free bond and [[Forwards and Futures Notes|currency]] [[Forward Points in Currency|forward contract]] as a  synthetic dollar bond .
...
$$
When the dollar risk-free bond has a convenience yield, its [[Black Scholes Derivation|risk-free rate]]  $r_{t}$   is lower than the synthetic dollar yield, i.e.,    $\left (r_{t}^{*}-f_{t}+e_{t}\right)$    − , leading to a negative dollar Treasury basis:$$
...
To restore the actual convenience yield level, we need to estimate the scaling coefficients  $\beta$   and  $\beta^{*}$  .  Jiang, Krishna mur thy, and Lustig [ 2021 a ] provide an estimate based on the implied [[Exchange Rates and the Foreign Exchange Market- An Asset Approach|exchange rate dynamics]] derived in Section  4 .B . Assuming that [[Forwards and Futures Notes|currency]] risk premium does not respond to a convenience yield shock, they find that the  $\beta^{*}$  coefficient has to be around  0 . 9  to match the variations in the Treasury basis with those in the observed exchange rate movement. This parameter estimate means that  $90\%$   of the convenience yield is about the dollar, and    $\mathbf{\tau_{10}\%}$   is about the U.S. Treasury. In other words, the synthetic dollar position contains  $90\%$   of the convenience yield on the dollar risk-free bond, and the Treasury basis only measures  $1-0.9\,=\, 10\%$   of the convenience yield. To recover the convenience yield level, we need to lever up the observed Treasury basis by  10 times. As the Treasury basis is on average    $-20$   basis points per annum in the sample, the implied convenience yield has to be  $z\%$   per annum on average, which is much greater than any near-[[Arbitrage Pricing of Derivatives|arbitrage]] interest rate spreads.
# 4 .C. 1 Treasury CIP vs. Libor CIP
This argument also helps us understand the Libor basis, which is the spread between the dollar Libor rate and the synthetic dollar rate based on the foreign Libor rate and the [[Forwards and Futures Notes|currency]] forward:$$
X_{t}^{L i b o r}\stackrel{\mathrm{def}}{=}l i b o r_{t}-\big (l i b o r_{t}^{*}-f_{t}+e_{t}\big).
$$
Unlike the Treasury basis, the Libor basis was very close to zero before the [[8. Credit Modeling and Credit Derivatives|Global Financial Crisis]], and widened afterwards [ Du, Tepper, and Verdelhan ,  2018 b ]. This pattern suggests that the dollar Libor and the synthetic position based on the foreign Libor and the [[Forwards and Futures Notes|currency]] forward have a similar level of convenience yields before the crisis, i.e.,$$
...
$$
This is not a coincidence if there are [[An Asset Allocation Primer|investment]] banks who are indifferent between the two positions and actively [[Arbitrage Pricing of Derivatives|arbitrage]] any spread between the Libor market and the [[Forwards and Futures Notes|currency]] [[Tba and Specified Pools Markets|forward market]]. As such, both the dollar Libor and the synthetic dollar bond earn the same, non-zero convenience yield  $\beta^{*}\lambda_{t}^{*}$    , so that their spread, i.e., the Libor basis  $x_{t}^{L i b o r}.$  , is zero.
After the crisis, likely due to regulatory constraints, the dollar Libor now contains a higher level of convenience yield, and banks face higher costs to [[Arbitrage Pricing of Derivatives|arbitrage]] this spread.   As a result, the dollar Libor has a higher level of convenience yield than the synthetic dollar bond, leading to a negative Libor basis:$$
...
$$
2  There is a debate about whether the post-crisis regulations distort the interest rate market or the [[Forwards and Futures Notes|currency]] [[Tba and Specified Pools Markets|forward market]] [ Augustin, Chernov, Schmid, and Song ,  2020 ].
With  $\gamma^{*}>\beta^{*}$  ,$$
...
$$
The same argument can be applied to other types of interest rate spreads. The key point is that, when both [[Interest Rate Quotations|interest rates]] contain certain amount of convenience yields, the spread only measures a fraction of the convenience yields. It is useful to think about these bonds as containing different shades of  dollarness .
...
Analysis with one-period bond. In this section, we broaden our perspective by considering how the convenience yield on the short-term bond also affects the [[Arbitrage Pricing of Derivatives|pricing]] of the long-term bond. Because the longterm Treasury bonds will eventually become short-term Treasury bills as they mature, if the investors do not differentiate between on-the-run and off-the-run bonds, then, the convenience yield on the short-term bonds will also affect the [[Arbitrage Pricing of Derivatives|pricing]] of the long-term bonds. To develop this logic, we first focus on the domestic households’ perspective and understand how the convenience yields affect the long-term bond prices. Then, we study how the home and foreign households trade the long-term bonds with each other and understand how the convenience yields and bond risk premia jointly determine the exchange rate level.
...
In this more general model, the long-term bonds price in both their own convenience yields in the current period their expected convenience yields as their maturities decline in the future. Interestingly, after the  2008  [[8. Credit Modeling and Credit Derivatives|Global Financial Crisis]], the long-term Treasury bonds are traded at a discount relative to other risk-free assets, reflecting an “inconvenience yield” [ Duffie ,  2020 ,  He, Nagel, and Song , 2022 ,  Du, Hébert, and Li ,  2023 ]. This negative yield spread can be understood as a negative marginal utility investors derive from holding the long-term Treasury bonds, or, equivalently, a positive balance sheet cost.
...
$$
Jiang, Krishna mur thy, Lustig, and Sun  [ 2021 b ] show that, if the cumulative wedge  $\scriptstyle\sum_{k=1}^{t}\eta_{k}$   is a [[Some Discrete-Time Stochastic Processes|random walk]], the cumulative SDF differential  $\scriptstyle\sum_{k=1}^{t}\left (m_{k}-m_{k}^{*}\right)$   −  needs to have a permanent component that exactly offsets the [[Some Discrete-Time Stochastic Processes|random walk]] component in the wedge in order to generate a stationary exchange rate. This means that the home and foreign SDFs will not share the same permanent component. Instead, they have to diverge from each other for the exchange rate to be stationary.
...
# 5 Incomplete Markets
# Summary
• [[Lecture Notes on International Finance|Incomplete markets]] also lead to a wedge between the exchange rate movement and the SDF differential:$$
\Delta e_{t+1}=m_{t+1}-m_{t+1}^{*}+\eta_{t+1}.
$$
• This wedge affects the exchange rate volatility, cyclical it y, and [[Forwards and Futures Notes|currency]] risk premium. • This wedge also gives rise to international spill-over across countries.
• Market incompleteness is a precondition for convenience yields to impact the [[Exchange Rates and the Foreign Exchange Market- An Asset Approach|exchange rate dynamics]], and convenience yields enrich the effects of market incompleteness on the [[Exchange Rates and the Foreign Exchange Market- An Asset Approach|exchange rate dynamics]].
...
\Delta e_{t+1}=m_{t+1}-m_{t+1}^{*}+\eta_{t+1}.
$$
In this section, we first develop a full [[Real Interest Rates and Aggregate Production|general equilibrium model]] with [[Lecture Notes on International Finance|incomplete markets]] that gives rise to the above wedge  $\eta_{t+1}$  . We then take a different, no-[[Arbitrage Pricing of Derivatives|arbitrage]] approach that focuses only on the Euler equations. While incomplete spanning leads to deviations from the complete-market characterization of the [[Exchange Rates and the Foreign Exchange Market- An Asset Approach|exchange rate dynamics]] ( 1 . 15 ), it still respects the Euler equations for the assets that are tradable by both countries’ households. For example, if home and foreign
...
$$
Where  $u\mathopen{}\mathclose\bgroup\left (c_{t}\aftergroup\egroup\right)~=~\gamma_{t}\log (c_{t})$   and the [[Pareto-Optimality in Some Incomplete Markets|aggregate consumption]] is again a Cobb-Douglas aggregation of the home and foreign goods:    $c_{t}~=$   $(c_{H, t})^{\alpha}(c_{F, t})^{(1-\alpha)}$  . Relative to the baseline model, here we additionally have a stochastic term    $\gamma_{t}$   which captures demand shocks. We assume that    $\gamma_{t}$   follows$$
D\gamma_{t}=0 d t+\gamma_{t}\omega d Z_{t}^{\gamma},
$$
Which guarantees that  $\gamma_{t}$   is a strictly positive [[Stochastic Processes Definition Notation and Te|adapted stochastic process]] and a martingale.
...
The home household’s [[An Asset Allocation Primer|portfolio]] choice problem is$$
...
$$
Similarly, noting that the log [[Utility Indices|preference]] allows separation between the consumption choice and the numéraire, i.e.,$$
\log c_{t}^{*}=\log\tilde{c}_{t}^{*}+e_{t},
$$
Where the exchange rate    $e_{t}$   is unaffected by the decision of the competitive households, we can express foreign household’s [[An Asset Allocation Primer|portfolio]] choice problem as$$
...
$$
In this way, under the log [[Utility Indices|preference]], the [[Prerequisites|optimization problems]] are formally equivalent to a familiar single-good consumptioninvestment problem [ Pavlova and Rigobon ,  2012 ].
Next, to deal with the market incompleteness, we follow  He and Pearson  [ 1991 ] to convert the above home household’s dynamic [[An Asset Allocation Primer|portfolio]] choice problem to a static variation al problem:$$
...
$$
Where   $\exp\!\left (m_{\nu, t}\right)$   denotes an appropriate home SDF. In [[Lecture Notes on International Finance|incomplete markets]], multiple SDFs are consistent with no [[Arbitrage Pricing of Derivatives|arbitrage]], giving rise to an infinite number of the static budget constraint. To characterize this family of SDFs, let  $\lambda_{t}$   denote the home country [[Exercises|market price of risk]],$$
...
$$
Where  $\mathcal{A}[\boldsymbol{w}_{t}]$   is the infinitesimal generator of the [[The Ornstein-Uhlenbeck (OU) Process|stochastic process]]  $w_{t}$  .
...
$$
Where  $I_{3}$   is  $^\textit{a 3}$  -dimensional [[Prerequisites|identity matrix]].
The proof is presented in Appendix  A. 15 . The first term on the right-hand side of Eq. ( 5 . 4 ) as is the [[Exercises|mean-variance]] efficient [[An Asset Allocation Primer|portfolio]], because it is the solution of a myopic [[Exercises|mean-variance]] investor. The second term is referred to as the [[Key Rates O1s Durations and Hedging|hedging]] [[An Asset Allocation Primer|portfolio]], because, as we will see in Section    $9.\mathrm{A},$   it hedges the variations in the [[An Asset Allocation Primer|investment]] opport unities. Without the demand shock  $\gamma_{t},\sigma_{3, t}=0,$  , and the [[Key Rates O1s Durations and Hedging|hedging]] [[An Asset Allocation Primer|portfolio]] is zero as in the standard log cases.
...
$$
And consumption-[[An Asset Allocation Primer|investment]] policies$$
...
In the presence of [[Lecture Notes on International Finance|incomplete markets]], the equilibrium allocation is [[Pareto-Optimality and Representative Individual|Pareto optimal]]. We need to employ a fictitious representative agent with stochastic weights [ Cuoco and He ,  1994 ], which reflect the effects of market incompleteness. This fictitious representative agent
...
$$
We next use the no-[[Arbitrage Pricing of Derivatives|arbitrage]] valuation principle to obtain the valuation of the untraded stocks and the equilibrium wealth.
...
$$
As Eq. ( 5 . 6 ) shows, [[Lecture Notes on International Finance|incomplete markets]] enrich the dynamics of the economy with an additional state variable    $\pi_{t,}$  , which is determined by the wealth distribution and the discount rates. As such, path dependence naturally arises from incomplete-market models, as the wealth distribution is not easily determined by the current state variables, but rather reflects the history of the shocks to the economy.
...
$$
( 2 ) When such equilibrium exists, the log [[Exchange Rates and the Foreign Exchange Market- An Asset Approach|exchange rate dynamics]] follow$$
D e_{t}=\kappa_{t}d t+\sigma_{t}d Z_{t},
$$
Where$$
...
$$
( 4 ) We can then express the [[Exercises|market price of risk]]  $\lambda_{t},$   and the [[Interest Rate Quotations|interest rates]]  $r_{t}$   and  $r_{t}^{*}$    as functions of exogenous state variables.$$
...
$$
Compared to the incomplete-market solution, the Pareto weight  $\pi$   in the complete-market case is a constant. After further simplification, we characterize the [[Exchange Rates and the Foreign Exchange Market- An Asset Approach|exchange rate dynamics]] in the following proposition.
...
The [[Real Interest Rates and Aggregate Production|general equilibrium model]] above demonstrates one particular case in which the exchange rate obeys Eq. ( 5 . 1 ), reproduced below,$$
\Delta e_{t+1}=m_{t+1}-m_{t+1}^{*}+\eta_{t+1}.
$$
If we relax the assumption of  $\log$   [[Utility Indices|preference]], the model becomes much more difficult to solve in closed form. In this section, we develop an alternative, no-[[Arbitrage Pricing of Derivatives|arbitrage]] approach to study the properties of the [[Exchange Rates and the Foreign Exchange Market- An Asset Approach|exchange rate dynamics]] under [[Lecture Notes on International Finance|incomplete markets]]. This approach is based on  Backus, Foresi, and Telmer  [ 2001 ],  Brandt, Cochrane, and Santa-Clara  [ 2006 ],  Lustig and Verdelhan  [ 2019 ],  Jiang, Krishna mur thy, Lustig, and Sun  [ 2021 b ],  Jiang  [ 2023 b ].
This approach does not take a stance on the specification of preferences and economic shocks. We only require risk-free bonds to be freely traded across countries, which seems to be a reasonable assumption at least for certain agents in developed economies. We focus on the four Euler equations ( 1 . 6 )-( 1 . 9 ) that characterize the home and foreign investors’ valuation of the home and foreign risk-free bonds. The [[Financial Markets and Institutions Lecture Notes|financial markets]] for other assets, such as the equities and long-term bonds, may or may not be traded. In this sense, this no-[[Arbitrage Pricing of Derivatives|arbitrage]] approach provides a general characterization of the [[Exchange Rates and the Foreign Exchange Market- An Asset Approach|exchange rate dynamics]] under incomplete spanning.
...
$$
In this equation,    $m_{t+1}+\eta_{t+1}$   expresses the foreign households’ SDF in the home numéraire, which prices the home [[Black Scholes Derivation|risk-free rate]].
...
$$
(c) The conditional [[Forwards and Futures Notes|currency]] risk premium can be expressed as$$
...
[[Lecture Notes on International Finance|Incomplete markets]] also shift the [[Forwards and Futures Notes|currency]] risk premium  $\mathbb{E}_{t}\big[r x_{t+1}\big]$  by  $\mathbb{E}_{t}[\eta_{t+1}]$  . The Euler equations do not rule out the possibility that  $\mathbb{E}_{t}[\eta_{t+1}]$   is nonzero, as long as it satisfies Eq. ( 5 . 10 ) and ( 5 . 11 ). Moreover, because    $\mathbb{E}_{t}[\eta_{t+1}]$   is known ex-ante in period  $t,$  , increasing the [[Forwards and Futures Notes|currency]] risk premium comes at the cost of introducing exchange rate predictability.
Finally, in [[Lecture Notes on International Finance|incomplete markets]], the exchange rate cyclical it y is still e exchange rate variance:    $c o v_{t}\big (m_{t+1}-m_{t+1}^{*},\Delta e_{t+1}\big)\,=$   $v a r_{t}\big (\Delta e_{t+1}\big)$  . However, because the exchange rate variance can be lower, market incompleteness can shrink the exchange rate cyclical it y towards zero as well. That said, as the exchange rate cyclical it y has to be positive, [[Lecture Notes on International Finance|incomplete markets]] alone cannot generate a pro cyclical exchange rate.
Lustig and Verdelhan  [ 2019 ] further point out a trade-off between resolving the exchange rate volatility puzzle and the [[Forwards and Futures Notes|currency]] risk premium puzzle. The Euler equations impose restrictions on the joint dynamics of the exchange rate movement, the SDF, and    $\eta_{t+1}$  . When we rely on a volatile  $\eta_{t+1}$   to reduce the exchange rate volatility and cyclical it y, we also shrink the [[Forwards and Futures Notes|currency]] risk premium. To see this dilemma, recall from Proposition  1 . 1 , which is valid in complete and [[Lecture Notes on International Finance|incomplete markets]], that the [[Forwards and Futures Notes|currency]] risk premium can be expressed as$$
\log\mathbb{E}_{t}[\exp (r x_{t+1})]=-c o v_{t}\big (m_{t+1}^{*},\Delta e_{t+1}\big).
$$
When a volatile    $\eta_{t+1}$   term lowers the exchange rate volatility and the covariance between the SDF and the exchange rate movement, it also reduces the [[Forwards and Futures Notes|currency]] risk premium.
...
In this subsection, we develop a different decomposition of the exchange rate movement that is useful for interpreting the effects of market incompleteness on the [[Exchange Rates and the Foreign Exchange Market- An Asset Approach|exchange rate dynamics]], which is based on  Jiang  [ 2023 b ]. For exposition al convenience, we again assume that all shocks are jointly normal.
...
$$
(c) Using the Euler equations  ( 1 . 6 ) – ( 1 . 9 ) , the conditional [[Forwards and Futures Notes|currency]] risk premium can be expressed as$$
...
This proposition generalizes  Brandt, Cochrane, and Santa-Clara [ 2006 ] by asking how much lower the pass-through coefficients  $y_{t}$  and  $z_{t}$   have to be in order to match the exchange rate volatility. If we plug the empirical restriction ( 5 . 14 ) into Eq. ( 5 . 16 ), and additionally assume that the home and foreign SDFs have the same variance, i.e.,    $\sigma_{t}^{2}\ =\ v a r_{t}\big (m_{t+1}\big)\ =\ v a r_{t}\big (m_{t+1}^{*}\big).$  , and that the cross-country SDF correlation is    $c o r r_{t}\big (m_{t+1}, m_{t+1}^{*}\big)\ =\ 0.3,$   0.3, which is close to the average cross-country correlation in [[Long-Run Risks and Epstein-Zin Utility|consumption growth]] among developed countries, then, we can graphically represent the two equations in Proposition  5 . 6  in Figure  5 . 1 . Specifically, Eq. ( 5 . 15 ) requires the coefficients to lie within the red ellipse, and Eq. ( 5 . 16 ) requires the coefficients to lie above the blue line. The intersection of these two regions is very small and close to    $(0,0)$  .
...
Market incompleteness also has implications for multi-[[Forwards and Futures Notes|currency]] dynamics. As a benchmark, let us first understand the intuition from complete-market models. It suffices to consider only three countries, which we denote by 0, 1, 2. We refer to country 0 as the home country, and countries 1 and 2 as the two foreign countries. The bilateral exchange rate movements between the home country and the two foreign countries are given by$$
\begin{array}{r l}&{\Delta e_{t+1}^{0/1}=m_{t+1}^{(0)}-m_{t+1}^{(1)},}\\ &{\Delta e_{t+1}^{0/2}=m_{t+1}^{(0)}-m_{t+1}^{(2)}.}\end{array}
$$
First, Triangular [[Arbitrage Pricing of Derivatives|arbitrage]] means that the bilateral exchange rates between two foreign countries are directly implied from their bilateral exchange rates with the home country:$$
...
$$
The following proposition shows that these equations give rise to additional restrictions on the [[Exchange Rates and the Foreign Exchange Market- An Asset Approach|exchange rate dynamics]] [ Jiang ,  2023 b ].
...
The complete-market case is an exception:  $m_{t+1}^{(0)}-m_{t+1}^{(i)}-\Delta e_{t+1}^{0/i}=$      0 satisfies all the conditions above trivially. Perhaps this is why we are used to studying only the bilateral dynamics between the home country and each foreign country in the complete-market setting, which is no longer sufficient when markets are incomplete, as the Euler equations between the two foreign countries impose additional restrictions on the [[Exchange Rates and the Foreign Exchange Market- An Asset Approach|exchange rate dynamics]].
What do these additional restrictions imply for the [[Exchange Rates and the Foreign Exchange Market- An Asset Approach|exchange rate dynamics]]? To answer this question, we first study a specific threecountry model, and then we generalize the results using the noarbitrage approach.
# 5 .C. 2 Motivating Example for the Spill-Over Effects
Let us consider a three-country extension of the  Pavlova and Rigobon [ 2012 ] model we considered in Section  5 .A . Again, we consider three countries labeled as 0, 1 and 2. Each country    $i$   has a unique variety of local goods, and a representative agent with log [[Utility Indices|preference]] scaled by a demand shock  $\gamma_{t}^{(i)}$  :$$
\mathbb{E}\left[\int_{0}^{T}\exp (-\rho t)\gamma_{t}^{(i)}\log c_{t}^{(i)}\right],
$$
And the [[Pareto-Optimality in Some Incomplete Markets|aggregate consumption]] is a Cobb-Douglas aggregate of the three countries’ local goods. Specifically, let    $c_{j, t}^{(i)}$    denote country    $i^{\prime}$  s agent’s consumption of country  $j^{\prime}{\bf s}$   goods, then,$$
...
This example illustrates an important difference between complete and [[Lecture Notes on International Finance|incomplete markets]]. When markets are incomplete, not only does the bilateral exchange rate movement deviate from the two countries’ marginal utility growth differential, i.e.,  $\Delta e_{t+1}\,=\, m_{t+1}\,-$   $m_{t+1}^{*}$    fails, but the bilateral exchange rate also depends on shocks to the third country. A natural question is whether this international spill-over effect is a general feature of [[Lecture Notes on International Finance|incomplete markets]], which is explored in the next section.
5 .C. 3 General Characterization of the Spill-Over Effects (TODO) 5 .D [[Lecture Notes on International Finance|Incomplete Markets]] vs. Convenience Yields (TODO)
# 6 Monetary and Fiscal Policies
# Summary
• We develop a stylized model in the New Keynesian tradition. In this model, when prices are flexible, monetary and fiscal policies have no real effects: they do not affect consumption and real exchange rate. They only affect [[War Economies and Hyperinflation|inflation]], which affects the nominal interest rate and the [[The Foreign Exchange Market Annotations|nominal exchange rate]].
...
$$
6 .A. 1 [[Lecture Notes on International Finance|Exchange Rate Accounting]]
Next, let us relate these concepts to the [[Lecture Notes on International Finance|exchange rate accounting]] [[Exercises|exercises]] in Section  1 .B  and  4 .B . Starting from the Euler equation for the nominal bond return, we have$$
...
$$
Denotes the [[War Economies and Hyperinflation|inflation]] risk premium. This expression shows that the nominal interest rate  $i_{t}$   can be decomposed into the real interest rate  $r_{t}$   , the [[Real and Nominal Interest Rates and Term Struc|expected inflation rate]]    $\mathbb{E}_{t}[\pi_{t+1}],$  , and the [[War Economies and Hyperinflation|inflation]] risk premium    $i r p_{t}$  .
Define the nominal [[Forwards and Futures Notes|currency]] excess return as$$
R X_{t+1}=\Delta\mathcal{E}_{t+1}+i_{t}-i_{t}^{*}.
$$
Then, we obtain the nominal version of Proposition  1 . 1 .
Proposition  6 . 1 .  The home [[Forwards and Futures Notes|currency]]’s expected log excess return is determined by the covariance between the log foreign SDF and log exchange rate movement minus a Jensen’s term:$$
...
Let    $p_{t}(h)$   and  $p_{t}(f)$   denote the home-[[Forwards and Futures Notes|currency]] prices of varieties  $h$  and  $f$  . Let  $P_{H, t}$   and  $P_{F, t}$   denote the home-[[Forwards and Futures Notes|currency]] prices of the home and foreign bundles  $c_{H, t}(j)$   and    $c_{F, t}(j)$  , which can be shown to be the CES indices with elasticity   $1/\rho$  :$$
P_{H, t}=\left (\int_{0}^{1}p_{t}(h)^{1-\rho}d h\right)^{1/(1-\rho)},\qquad P_{F, t}=\left (\int_{0}^{1}p_{t}(f)^{1-\rho}d f\right)^{1/(1-\rho)}.
$$
Similarly, let    $P_{t}$   denote the home-[[The Foreign Exchange Market Annotations|currency price]] of the [[Pareto-Optimality in Some Incomplete Markets|aggregate consumption]] basket in the home country. This utility-based CPI can be expressed as$$
...
$$
Having specified the household preferences and the within-period solution, we now turn to the households’ budget constraint and their inter temporal solution. Home household  $j$   owns the [[An Asset Allocation Primer|portfolio]] of home firms and provides labor to the firms. It earns a nominal wage  $W_{t}$   and receives a nominal dividend    $D_{t}(j)$   from the firms. It also pays tax    $\tau_{t}(j)$   to the government and purchases consumption    $c_{t}(j)$  , both denoted in real terms.
The [[Financial Markets and Institutions Lecture Notes|financial markets]] are complete. Let  $\sigma_{t}$   denote the state of the economy at time  $t$  . Let  $\Theta (\sigma_{t+1}|\sigma_{t})$   denote the time $\cdot t$   home-[[The Foreign Exchange Market Annotations|currency price]] for one unit of home [[Forwards and Futures Notes|currency]] delivered at time    $t+1$   contingent on the state being  $\sigma_{t+1}$  . At time  $t,$   home household  $j$   holds
  $\Omega_{t}\big (\sigma_{t+1}, j\big)$   unit of the Arrow-Debreu security that pays off in state
  $\sigma_{t+1}$  .    $\Theta^{*}(\sigma_{t+1}|\sigma_{t})$   is similarly defined as the time $\cdot t$   foreign-[[The Foreign Exchange Market Annotations|currency price]] for one unit of foreign [[Forwards and Futures Notes|currency]] delivered at time    $t+1$   contingent on the state being  $\sigma_{t+1},$   and  $\Omega_{t}^{*}\big (\sigma_{t+1}, j\big)$   is the quantity of this security held by home household  $j$  .
Let   $\mathrm{exp}(\mathcal{E}_{t})$   denote the [[The Foreign Exchange Market Annotations|nominal exchange rate]], in the unit of home [[Forwards and Futures Notes|currency]] per foreign [[Forwards and Futures Notes|currency]]. A higher [[The Foreign Exchange Market Annotations|nominal exchange rate]] means a stronger foreign [[Forwards and Futures Notes|currency]]. Then, the individual household’s budget constraint at time  $t$   and state    $\sigma_{t}$   is$$
...
M_{t+1}=M_{t+1}+\pi_{t+1}.
$$
Since the markets are complete, we can show that the [[The Foreign Exchange Market Annotations|nominal exchange rate]] movement equals the ratio between the two countries’ nominal SDFs:$$
...
Change rate level is pinned down by  $P_{0}c_{0}(j)=\exp (\mathcal{E}_{0}) P_{0}^{\ast}c_{0}^{\ast}(j)$   at time 0 . Since the market is complete, this assumption amounts to taking a stance on the two countries’ wealth distribution at time  0 . Then, the [[The Foreign Exchange Market Annotations|nominal exchange rate]] satisfies$$
...
Third, governments only issue one-period debt in local [[Forwards and Futures Notes|currency]] units. The [[Global Fixed Income Markets|government debt]] does not default on its notional value, but its real value can vary due to [[War Economies and Hyperinflation|inflation]]. It is therefore equivalent
To a claim that pays off one unit of local [[Forwards and Futures Notes|currency]] in every state. Let  $Q_{t+1}$   denote the quantity of outstanding home [[Global Fixed Income Markets|government debt]] that is issued at time  $t$   and due at time  $t+1$  . Let  $i_{t}$   denote the home nominal interest rate. The government budget condition in nominal terms is$$
...
$$
Which is equivalent to requiring that the present value of government surpluses grows slower than the real [[PSET 7- Kohler|discount rate]]:$$
...
$$
The nominal interest rate  $i_{t}$   pins down the expected [[War Economies and Hyperinflation|inflation]] under the [[Risk-Neutral Probabilities|risk-neutral expectation]]. A higher nominal interest rate generates a higher  expected  [[War Economies and Hyperinflation|inflation]].
How does the monetary authority implement this interest rate target? Recall Eq. ( 6 . 4 ), reproduced below,$$
Q_{t}+P_{t}g_{t}=P_{t}\tau_{t}+Q_{t+1}\exp (-i_{t}).
$$
When the monetary authority raises the nominal interest rate  $i_{t},$   if the [[The Economist Regime Change|fiscal policy]]   $(\tau_{t}, g_{t})$   and the current price level   $\left (P_{t}\right)$   remain the same, then, the government has to issue a higher nominal amount of debt  $Q_{t+1}$  . This higher nominal amount of debt then raises the price level  $P_{t+1}$   in the next period via$$
...
$$
If the government commits to the same    $\tau_{t},\, g_{t}$   and real quantity of debt  $q_{t+1},$  , then, a higher  $i_{t}$   triggers a higher [[War Economies and Hyperinflation|inflation]]    $\pi_{t+1}$   in the next period.
...
$$
Note that  $Q_{t+1}$   denotes the quantity of the home [[Global Fixed Income Markets|government debt]] that is due at time  $t+1$  . The market clearing condition ( 6 . 7 ) requires that the total amount of home [[Forwards and Futures Notes|currency]] that both countries’ households receive from their holdings of Arrow-Debreu securities in state  $\sigma_{t+1}$   is equal to the amount of nominal debt the home government pays back at time    $t+1$  .
6 .B. 6 Macro Synthesis
The exogenous variables include the productivity levels, the [[Interest Rate Quotations|interest rates]], and the government surpluses:$$
...
$$
And  1  equation for the [[The Foreign Exchange Market Annotations|nominal exchange rate]],$$
...
$$
And the (risk-neutral) expected [[War Economies and Hyperinflation|inflation]] satisfies$$
...
In terms of the [[The Economist Regime Change|monetary policy]], a higher nominal interest rate  $i_{t}$   leads to a higher future [[War Economies and Hyperinflation|inflation]]    $\boldsymbol{\pi}_{t+1}.$  , but it does not affect the real rate  $r_{t},$   since the real rate only depends on the consumption dynamics:$$
\exp (-r_{t})=\mathbb{E}_{t}\left[\exp (m_{t+1})\right]=\mathbb{E}_{t}\left[\delta\frac{c_{t}}{c_{t+1}}\right].
$$
In terms of the [[The Economist Regime Change|fiscal policy]], neither tax  $\tau_{t}$   nor spending  $g_{t}$   affect consumption. For given productivity levels, a higher real government spending  $g_{t}$   in centi viz es the households to work more and produce just enough goods to fund the spending while keeping the consumption level constant. A higher real tax  $\tau_{t,}$  , on the other hand, does not affect the equilibrium labor and output—that is, whether the government decides to raise tax or raise debt to fund its spending is
...
The home [[Forwards and Futures Notes|currency]] appreciates in real terms (i.e., lower  $e_{t}$  ) when the home productivity declines (i.e., lower  $z_{t}$  ) and when the home government spending-to-consumption ratio increases (i.e., higher  $g_{t}/c_{t})$  . In particular, since consumption is decreasing in spending, a higher home government spending leads to an even higher home spending-to-consumption ratio. Then, holding the tax revenue constant, a higher home government surplus is associated with a lower home government spending and hence home [[Forwards and Futures Notes|currency]]  depreciation .
...
$$
Our derivation below focuses on the case of  Producer [[Forwards and Futures Notes|Currency]] [[Arbitrage Pricing of Derivatives|Pricing]] , under which case exports are priced and invoiced in the
Domestic (producer’s) [[Forwards and Futures Notes|currency]]. Then, the price of the home firms’ production sold in the foreign country is set according to$$
...
$$
In other words, under Producer [[Forwards and Futures Notes|Currency]] [[Arbitrage Pricing of Derivatives|Pricing]], the local-[[The Foreign Exchange Market Annotations|currency price]] of the local consumption bundle (e.g.,  $P_{H, t}$  ) is fixed and the local-[[The Foreign Exchange Market Annotations|currency price]] of the foreign consumption bundle (e.g.,  $P_{F,t.}$  ) comoves with the exchange rate.
Alternatively, some models assume  Local [[Forwards and Futures Notes|Currency]] [[Arbitrage Pricing of Derivatives|Pricing]] , under which case exports are priced and invoiced in the foreign (importers’) [[Forwards and Futures Notes|currency]]. Then, the price of the home firms’ production sold in the foreign country is set according to$$
...
$$
Compared to the case of Producer [[Forwards and Futures Notes|Currency]] [[Arbitrage Pricing of Derivatives|Pricing]], in this case the exchange rate    $\mathcal{E}_{t}$   goes into the expectation operator, which is consistent with the assumption that the price is fixed at the consumers’ (i.e. the foreign households’) [[Forwards and Futures Notes|currency]] unit. As a result, both the localcurrency price of the local consumption bundle (e.g.,  $P_{H,t.}$  ) and the local-[[The Foreign Exchange Market Annotations|currency price]] of the foreign consumption bundle (e.g.,  $P_{F, t,}$  ) are fixed. The solution in this case is discussed in  Jiang  [ 2022 ].
6 .D. 2 Equilibrium Consumption and [[Macroeconomic Models of Business Cycles|Aggregate Demand]]
The sticky prices imply slow adjustments in the price level. As a result, movements in the [[The Foreign Exchange Market Annotations|nominal exchange rate]] lead to movements in the real exchange rate. This idea has been central in many international macro models since the seminal work by Mundell-Fleming in the  1960 s. In the context of this model, we formalize this idea by first relating the real consumption and the real exchange rate movement to the nominal shocks.
...
The proof is presented in Appendix  A. 23 . A useful way to understand the equilibrium outcome under sticky prices is to regard the equilibrium nominal consumption  $P_{t}c_{t}$   and  $P_{t}^{*}c_{t}^{*}$    as the  [[Macroeconomic Models of Business Cycles|aggregate demand]]  of the home and foreign households, which directly respond to monetary and fiscal policies. In fact, this proposition shows that they are sufficient statistics for determining the real consumption and the real exchange rate.
More concretely, an expansion ary monetary or [[The Economist Regime Change|fiscal policy]] in the home country stimulates the [[Macroeconomic Models of Business Cycles|aggregate demand]] by raising the nominal household expenditure    $P_{t}c_{t}$  . As the price level is slow to adjust, this nominal shock also raises the real household expenditure  $c_{t}$  . Due to the home bias in consumption (i.e.,  $\alpha>1/2,$  ), even though [[Financial Mathematics Course|complete markets]] facilitate full risk-sharing, the proposition shows that the home consumption  $c_{t}$   is more exposed to the home [[Macroeconomic Models of Business Cycles|aggregate demand]]  $P_{t}c_{t},$   and the foreign consumption  $c_{t}^{*}$    is more exposed to the foreign [[Macroeconomic Models of Business Cycles|aggregate demand]]    $P_{t}^{*}c_{t}^{*}$  . The real exchange rate, determined by the relative [[Appendix 22.C Risk-Neutral Pricing and Marginal Utility in the Binomial Model|marginal utility of consumption]], is also affected by the nominal household expenditures.
Next, we consider monetary and fiscal policies separately and trace out exactly how they impact the [[Macroeconomic Models of Business Cycles|aggregate demand]] as summarized by the nominal household expenditure    $P_{t}c_{t}$   and    $P_{t}^{*}c_{t}^{*}$    .
# 6 .D. 3 Real Effects of Monetary Policy
Let us first consider the home country’s [[The Economist Regime Change|monetary policy]]. Unlike the case of flexible prices, in which the nominal interest rate policy has no real effects, sticky prices transmit nominal interest rate shocks to real rates and affect households’ [[The Organization of This Book|consumption and investment decisions]]. Given Eq. ( 6 . 2 ), reproduced below,$$
I_{t}=r_{t}+\mathbb{E}_{t}[\pi_{t+1}]+i r p_{t},
$$
The nominal interest rate  $i_{t}$   is equal to the real interest rate plus the expected [[War Economies and Hyperinflation|inflation]] plus the [[War Economies and Hyperinflation|inflation]] risk premium. When the prices are sticky, expected [[War Economies and Hyperinflation|inflation]] and [[War Economies and Hyperinflation|inflation]] risk premium do not respond fully to an increase in the nominal interest rate. As a result, a nominal interest rate shock moves the real interest rate as well.
Specifically in our setting, the Euler equation$$
1=\mathbb{E}_{t}\left[\exp (M_{t+1}+i_{t})\right]
$$
Implies the following inter temporal relationship between the nominal interest rate and the current and future [[Macroeconomic Models of Business Cycles|aggregate demand]]:$$
\frac{1}{P_{t}c_{t}}=\exp (i_{t})\mathbb{E}_{t}\left[\delta\frac{1}{P_{t+1}c_{t+1}}\right].
$$
We consider the case in which the expected inverse future [[Macroeconomic Models of Business Cycles|aggregate demand]]    $\mathbb{E}_{t}\left[\delta\frac{1}{P_{t+1}c_{t+1}}\right]$  h i is constant, which we will later show is without loss of generality in this model. Then, Eq. ( 6 . 14 ) implies that the nominal interest rate  $i_{t}$   directly affects today’s [[Macroeconomic Models of Business Cycles|aggregate demand]]  $P_{t}c_{t}$  . If the monetary authority in the home country raises the nominal interest rate by  $\mathbf{\sigma}_{\mathbf{1}}\%$  , today’s [[Macroeconomic Models of Business Cycles|aggregate demand]]  $P_{t}c_{t}$   will shrink by  $\mathbf{\sigma}_{\mathbf{1}}\%$  . Similarly, a higher nominal interest rate in the foreign country lowers the foreign [[Macroeconomic Models of Business Cycles|aggregate demand]]. Plugging in this relationship to Proposition  $6.4,$  , we obtain the following result [ Corsetti and Pesenti , 2007 ]:
Proposition  6 . 5 .  When the monetary authorities set the [[Real and Nominal Interest Rates and Term Struc|nominal interest rates]] in home and foreign countries, the equilibrium consumption is$$
...
$$
The [[Equilibrium Interest Rate Models|equilibrium real interest rate]] is$$
...
$$
The proof is presented in Appendix  A. 24 . This proposition has an intuitive interpretation. When the home country’s monetary authority raises the nominal interest rate, it depresses the [[Macroeconomic Models of Business Cycles|aggregate demand]] and lowers the equilibrium consumption in the home country. Due to international risk-sharing through [[Financial Mathematics Course|complete markets]], the consumption loads on both home and foreign [[Real and Nominal Interest Rates and Term Struc|nominal interest rates]]. That said, the effect of the home nominal interest rate on home consumption is still stronger due to the home bias in the goods market (i.e.,    $\alpha>1/2$  ).
Moreover, since prices are sticky, a higher nominal interest rate also leads to a higher real interest rate and a strong domestic [[Forwards and Futures Notes|currency]] in real terms. By the following Euler equation,$$
R_{t}=-\log\delta-\log\mathbb{E}_{t}\big[c_{t}/c_{t+1}\big],
$$
The real interest rate is inversely related to the expected [[Long-Run Risks and Epstein-Zin Utility|consumption growth]]. So, the increase in the real interest rate is also consistent with an increase in the expected [[Long-Run Risks and Epstein-Zin Utility|consumption growth]], which is made possible by a decline in today’s consumption.
Finally, as the home consumption declines when the home country’s monetary authority raises the nominal interest rate, the home households’ marginal utility increases and appreciates the home [[Forwards and Futures Notes|currency]] in both nominal and real terms. In this way, our model reproduces a positive relationship between the local nominal interest rate and the real strength of the [[Forwards and Futures Notes|currency]], which goes back a long way to some of the seminal papers in the international macro literature [ Mundell ,  1963 ,  Fleming ,  1962 ,  Dornbusch ,  1976 ,  Frankel ,  1979 ].
# 6 .D. 4 Real Effects of Fiscal Policy
Next, let us shift our focus on the home country’s [[The Economist Regime Change|fiscal policy]]. Given  $\exp\bigl (m_{t, t+k}\bigr)\,=\,\delta^{k}c_{t}/c_{t+k},$   it is useful to express the present value of government surpluses as the current surplus plus the sum of discounted expected future surpluses.$$
...
$$
All else equal, a higher current consumption    $c_{t}$   implies a lower real [[PSET 7- Kohler|discount rate]] and increases the present value of future government surpluses. As a result, the present value of current and future surpluses  $\begin{array}{r l}{\!\!\!\!\!\!\!\!\!\!\!\!\!\!\!\!\!\mathbb{E}_{t}\left[\sum_{k=0}^{\infty}\exp (m_{t, t+k}) s_{t+k}\right]}& {{}} \end{array}$   is increasing in  $c_{t}$  .
For tract ability, we consider the simple case in which future consumption and surpluses are i.i.d. Then,    $\begin{array}{r}{\mathbb{E}_{t}\left[\sum_{k=1}^{\infty}\delta^{k}\frac{s_{t+k}}{c_{t+k}}\right]}\end{array}$  h i is equal to a constant that we denote by  $A$  , which allows us to express the home country’s nominal [[Macroeconomic Models of Business Cycles|aggregate demand]] as$$
P_{t}c_{t}=\frac{Q_{t}c_{t}}{s_{t}+c_{t}A}.
$$
Likewise, we define  $\begin{array}{r}{A^{*}\ {\stackrel{\mathrm{def}}{=}}\ \mathbb{E}_{t}\left[\sum_{k=1}^{\infty}\delta^{k}{\frac{s_{t+k}^{*}}{c_{t+k}^{*}}}\right],}\end{array}$  h i , and express the foreign country’s nominal [[Macroeconomic Models of Business Cycles|aggregate demand]] as$$
P_{t}^{*}c_{t}^{*}=\frac{Q_{t}^{*}c_{t}^{*}}{s_{t}^{*}+c_{t}^{*}A^{*}}.
$$
Plug the expressions ( 6 . 15 ) and ( 6 . 16 ) for the [[Macroeconomic Models of Business Cycles|aggregate demand]] into Proposition    $6.4,$  , we obtain$$
...
If we take a [[Convexity|first-order approximation]] around  $s_{t}\,=\, s_{t}^{*}\,=\,\bar{s}$   and  $c_{t}=c_{t}^{*}=\bar{c},$  , then, we obtain a linear equation system with a simple solution [ Jiang ,  2022 ]:
Proposition  6 . 6 .  Under a [[Convexity|first-order approximation]], the equilibrium consumption is$$
...
$$
when the current surplus  $s_{t}$   increases, the present value of government surpluses on the right-hand side of this equation will increase. However, on the left-hand side, the debt quantity    $Q_{t}$   is determined in the previous period, and the price index  $P_{t}$   is sticky. Therefore, to e qui lib rate this inter temporal government budget constraint, the real interest rate captured by  $m_{t, t+k}$   on the right-hand side has to rise to lower the present value of future surpluses and offset the increase in the current surplus. In this way, a higher U.S. surplus increases the U.S. real interest rate and, by Proposition  1 . 2 , appreciates the dollar’s real exchange rate. Similar to the case with monetary shocks, to engineer the increase in the U.S. real interest rate, the U.S. consumption has to decline in this period and create an increase in the expected [[Long-Run Risks and Epstein-Zin Utility|consumption growth]]. As a result, a positive fiscal shock that increases the government surplus  $s_{t}$   in the home country leads to a higher home real interest rate and a stronger home [[Forwards and Futures Notes|currency]] in real terms.
Notably, this result is  opposite  to what we obtained under flexible prices. Specifically, Proposition  6 . 3  shows that, with a positive curvature parameter    $\nu$   for labor, a higher government spending in the home country  $g_{t,}$  , which corresponds to a  lower  government surplus  $s_{t},$   crowds out the local households’ private consumption, increases their marginal utility, and therefore appreciates the home [[Forwards and Futures Notes|currency]] in real terms.
This is also the Mundell-Fleming view of the [[The Economist Regime Change|fiscal policy]]: a fiscal expansion, in the form of higher government spending, shifts up the [[Macroeconomic Models of Business Cycles|IS curve]] and puts an upward pressure on the local interest rate, which attracts capital inflows and appreciates the local [[Forwards and Futures Notes|currency]]. In comparison, imposing the inter temporal government budget constraint ( 6 . 5 ) generates an opposite valuation effect that depreciates the local [[Forwards and Futures Notes|currency]] when the surplus declines or government spending increases.
...
$$
Note that the nominal quantity of [[Global Fixed Income Markets|government debt]]  $Q_{t+1}$   is chosen by the government in period  $t,$   so it is known in period  $t$  . Then, we can express the home nominal interest rate as$$
...
\begin{array}{r l r}&{}&{\log c_{t}=\kappa_{t-1}^{c}+\alpha\log\left (\cfrac{c_{t}}{s_{t}+c_{t}A}\right)+(1-\alpha)\log\left (\cfrac{c_{t}^{*}}{s_{t}^{*}+c_{t}^{*}A^{*}}\right),}\\ &{}&{\log c_{t}^{*}=\kappa_{t-1}^{c^{*}}+(1-\alpha)\log\left (\cfrac{c_{t}}{s_{t}+c_{t}A}\right)+\alpha\log\left (\cfrac{c_{t}^{*}}{s_{t}^{*}+c_{t}^{*}A^{*}}\right),}\end{array}
$$
We obtain    $4$   four equations with  6  unknowns: the [[Real and Nominal Interest Rates and Term Struc|nominal interest rates]]  $i_{t}$   and  $i_{t}^{*}$    , the government surpluses  $s_{t}$   and  $s_{t}^{*}.$  , and the equilibrium consumption  $c_{t}$   and  $c_{t}^{*}$    . So, the monetary policies which set the [[Real and Nominal Interest Rates and Term Struc|nominal interest rates]] and the fiscal policies which set the government surpluses cannot be both exogenous. For example, in our discussion of the [[The Economist Regime Change|monetary policy]] above, the nominal interest rate policies will determine both the equilibrium consumption and the government surpluses that the fiscal authority needs to accommodate. Conversely, in our discussion of the [[The Economist Regime Change|fiscal policy]] above, the government surplus policies will determine both the equilibrium consumption and the [[Real and Nominal Interest Rates and Term Struc|nominal interest rates]] that the monetary authority needs to accommodate.
Another way to frame this result is to note that the observed macroeconomic data can be mapped to either a model in which the monetary policies are active and determines the path of the [[Real and Nominal Interest Rates and Term Struc|nominal interest rates]] as well as the necessary responses in government surpluses, or a model in which the fiscal policies are active and determines the path of the government surpluses as well as the necessary responses in [[Real and Nominal Interest Rates and Term Struc|nominal interest rates]].  Cochrane  [ 2021 ] offers a more detailed discussion of this  observational equivalence .
Throughout our discussion above, we have left out one degree of freedom, which is the growth rate of the [[Global Fixed Income Markets|government debt]] quantity  $\Delta\log Q_{t+1}$  . For given nominal interest rate  $i_{t}$   and real government surplus  $s_{t,}$  , varying the nominal quantity of [[Global Fixed Income Markets|government debt]] has no real effects. Given Eq. ( 6 . 18 ), reproduced below,$$
I_{t}=\log\left (\frac{s_{t}+c_{t}A}{c_{t}}\right)-\log\mathbb{E}_{t}\left[\delta\frac{s_{t+1}+c_{t+1}A}{c_{t+1}}\right]+\Delta\log Q_{t+1},
$$
And given$$
...
$$
We can see that a higher nominal [[Global Fixed Income Markets|government debt]] growth    $\Delta\log Q_{t+1}$  leads to a higher nominal interest rate by the same magnitude. It does not affect the real consumption  $c_{t}$   and hence the real rate  $r_{t}$  . Rather, it moves one-to-one with the [[War Economies and Hyperinflation|inflation]]    $\pi_{t+1}$  . Since  $\Delta\log Q_{t+1}$
Is known in period    $t,$   a higher nominal debt growth creates  expected [[War Economies and Hyperinflation|inflation]].
As such, we can think of the nominal quantity of [[Global Fixed Income Markets|government debt]]  $Q_{t}$   as another policy instrument separate from the nominal interest rate  $i_{t}$   and the real government surplus  $s_{t}$  . However, this additional instrument does not affect the real economy, but only affects the expected  [[War Economies and Hyperinflation|inflation]]. In comparison, the nominal interest rate  $i_{t}$   and the real government surplus  $s_{t}$   create  surprise  [[War Economies and Hyperinflation|inflation]], which is what is required to deliver real effects in this model.
# 6 .E. 2 Active vs. Passive Monetary and Fiscal Policies
The sticky-price model above generates a very stark result: in each period, an active [[The Economist Regime Change|monetary policy]] requires full cooperation from the fiscal side, and an active [[The Economist Regime Change|fiscal policy]] requires full cooperation from the monetary side. In other words, implementing one policy leaves no room for the other. A natural question is whether this result can be relaxed when we consider more general forms of price stickiness and government policies.
Leeper  [ 1991 ] provides an answer to this question in a fairly general class of linearized models, which allows less extreme forms of price stickiness. He shows that the policy responses can be characterized by two regions: in the  monetary dominance  region, the monetary shock is exogenous and requires the [[The Economist Regime Change|fiscal policy]] to accommodate the shock; in the  fiscal dominance  region, the fiscal shock is exogenous and requires the [[The Economist Regime Change|monetary policy]] to adjust to accommodate the shock. As we relax the assumption of [[Accrued Interest|full price]] stickiness for one period, there is some space for the monetary rate to respond to [[War Economies and Hyperinflation|inflation]], and some space for the fiscal surplus to respond to the level of outstanding debt. However, a strong monetary response to [[War Economies and Hyperinflation|inflation]] constrains the extent to which the fiscal authority can respond to the debt level, and vice versa.
In light of this discussion, the standard New Keynesian framework can be understood as assuming that the [[The Economist Regime Change|monetary policy]] is active and the fiscal authority accommodates the monetary shocks. As  Leeper [ 2010 ] puts it,  “most macro economists were raised on the belief that [[War Economies and Hyperinflation|inflation]] is determined by [[The Economist Regime Change|monetary policy]], especially in the long run. Full stop... Central bankers need a broader perspective on price level determination—to at least understand and acknowledge that there is another channel through which [[War Economies and Hyperinflation|inflation]] can be determined. The broader perspective is important because the new Keynesian/old monetarist view implicitly embeds a dirty little secret: for [[The Economist Regime Change|monetary policy]] to successfully control [[War Economies and Hyperinflation|inflation]], [[The Economist Regime Change|fiscal policy]] must behave in a particular, circumscribed manner.”
In particular, the ac com mo dative fiscal stance can be engineered by the expectation that future government surpluses will adjust to stabilize the debt level, as opposed to requiring today’s government surplus to adjust right away in response to monetary shocks. As long as the investors’ and households’ fiscal [[FORWARD RATES AND TERM STRUCTURE|expectations]] are anchored to this expectation, [[War Economies and Hyperinflation|inflation]] and, by the same argument, the real exchange rate can be understood in terms of the monetary shocks as we have seen in Proposition  6 . 5 . However, when the agents stop believing that the fiscal authority is committed to the ac com mo dative stance, then, its [[The Economist Regime Change|fiscal policy]] can undermine the ability of [[The Economist Regime Change|monetary policy]] to control [[War Economies and Hyperinflation|inflation]] and drive real economic outcomes on its own.
# 6 .E. 3 Discussions
In this chapter, we have made two extreme assumptions: ( 1 ) prices are fully sticky for one period, and ( 2 ) monetary and fiscal authorities cannot trade off their policies inter temporally. In exchange, we are able to derive [[Chapter 40 - Pricing Fixed Income Options: Black’s Model and MCS|closed-form solutions]] to characterize the equilibrium responses in consumption and the exchange rate. To consider these issues quantitatively, we may need to relax these assumptions and work with numerical models. For example, we may consider a setting in which prices are only partially sticky, which gives rise to a more realistic Phillips Curve. In addition, the monetary and fiscal responses can have richer time-series patterns.  Galí  [ 2015 ] provides a good reference on the monetary side, and  Cochrane  [ 2023 ] provides a good reference on the fiscal side.
The fiscal-[[Forwards and Futures Notes|currency]] linkage can be applied to studying not only the exchange rate variations in normal times, but also [[Forwards and Futures Notes|currency]] crashes in crisis times [ Burnside, Eichenbaum, and Rebelo ,  2006 ].  Burnside, Eichenbaum, and Rebelo  [ 2001 ] show that prospective fiscal deficits that drive [[Forwards and Futures Notes|currency]] crisis can be in the form of implicit bailout guarantees to failing [[HKS The Banking Industry|banking]] systems. See  Burnside, Eichenbaum, and Rebelo  [ 2016 ] for a review of the [[Forwards and Futures Notes|currency]] crisis models.
Moreover, the model in this chapter only investigates how monetary and fiscal shocks affect the real exchange rate by influencing the real interest rate. It is very likely that monetary and fiscal policies also drive variations in risk premia and convenience yields, which lead to exchange rate variations through different channels. For example,  Caramp and Singh  [ 2020 ] studies how the [[The Economist Regime Change|monetary policy]] impacts [[Class Note 10 Liquidity and Class Note 10 Liquidity and Liquidity Managementliquidity management|liquidity]] premia.  Croce, Nguyen, and Schmid  [ 2012 b ],  Croce, Kung, Nguyen, and Schmid  [ 2012 a ],  Jiang  [ 2021 ] study how fiscal policies affect risk premia.  Chernov, Schmid, and Schneider  [ 2020 ], Liu, Schmid, and Yaron  [ 2020 ] study how fiscal policies affect default premia and [[Class Note 10 Liquidity and Class Note 10 Liquidity and Liquidity Managementliquidity management|liquidity]] premia.
Finally, these theoretical arguments are also relevant for under standing [[Forwards and Futures Notes|currency]] unions such as the Eurozone. In a [[Forwards and Futures Notes|currency]] union, as the nominal interest rate and the [[The Foreign Exchange Market Annotations|nominal exchange rate]] are pegged across the member countries, they can only adjust in response to union-wide monetary or fiscal shocks, but they cannot simultaneously adjust in response to country-specific shocks. As a result, the convenience yields and their cross-country variations thereof have to play an important role as the shock absorber.  Jiang, Lustig, Van Nieuwe r burgh, and Xiaolan  [ 2020 c ] provide a detailed theoretical and empirical discussion.
# Part III
...
• We examine two complementary views of the architecture: the insurance provision view that emphasizes the U.S.’ role as the world’s banker or insurance provider, and the safe asset view that emphasizes the foreign demand for dollar safe assets. Both views emphasize the centrality of the U.S. in the global [[Financial Markets and Institutions Lecture Notes|financial markets]], but they have different implications for the U.S. external imbalances and the dollar exchange rate.
...
Starting from this chapter, we will shift our focus from the exchange rates to international [[An Asset Allocation Primer|portfolio]] positions and capital flows. In this case, studying the Euler equations alone is no longer sufficient, and general equilibrium models become necessary to model the financial quantities. We will begin with the most important asymmetry in the [[Lecture Notes on International Finance|international financial]] system: the U.S. vs. The rest of the world.
What is the international monetary system? A prototype [[Contemporary Financial Intermediation Notes|financial system]] involves households who save and consume, firms or entre pre ne urs who produce, and financiers who intermediate the funds between the households and firms. These financiers can be the banks or many types of shadow banks. They provide funds to the firms by investing in their risky projects, and they provide saving vehicles to the households by taking safe deposits. In doing so, these financiers engage in the safety, [[Class Note 10 Liquidity and Class Note 10 Liquidity and Liquidity Managementliquidity management|liquidity]], and maturity transformations.
This model of [[Contemporary Financial Intermediation Notes|financial system]] also applies at the global level, with the U.S. playing the central role as the financiers who intermediate capital flows to the rest of the world and earn a premium from the inter mediation process. Other countries, on the other hand, play the
...
This core-periphery structure gives rise to two salient patterns in the data: [[Lecture Notes on International Finance|global imbalances]] and exorbitant privilege. We have had a discussion of these patterns in Chapter  2 . In this chapter, we consider two complementary ways to model these patterns.
...
U^{*}\mathopen{}\mathclose\bgroup\left (c_{t}^{*}\aftergroup\egroup\right)=\frac{1}{1-\gamma^{*}}\mathopen{}\mathclose\bgroup\left (c_{t}^{*}\aftergroup\egroup\right)^{1-\gamma^{*}},
$$
with  $\gamma^{*}\,>\,\gamma$  . As in Section  $4,$   we interpret the home country as the U.S. This difference in risk aversion can be motivated by difference in financial developments. For example, the more developed financial sector in the U.S. may face weaker [[Class Note 10 Liquidity and Class Note 10 Liquidity and Liquidity Managementliquidity management|liquidity]] or financing constraints and thus have higher perceived risk appetite [ Maggiori ,  2017 ]. Similarly,  Chien and Naknoi  [ 2015 ] develop a model with heterogeneous agents in which the U.S. has a larger mass of sophisticated traders than the foreign countries.
The macro synthesis of this model is nearly identical to the baseline model in Section  1 .A  with [[Financial Mathematics Course|complete markets]]. The only difference is that the home and foreign households have different risk aversion.
...
The social planner approach allows us to derive the equilibrium allocations and prices in [[Financial Mathematics Course|complete markets]]. We are also interested in how the households trade to implement this equilibrium. In this subsection, we convert the problem to a [[The Continuous-Time Framework|continuous-time setting]] in order to derive the [[An Asset Allocation Primer|portfolio]] choice in the decentralized competitive equilibrium. Time is finite with horizon    $T$  . The representative home households maximize$$
...
Then, to compute the home and foreign households’ [[An Asset Allocation Primer|portfolio]] choices, we need to take a stance on the set of assets that we use to replicate the [[Epstein-Zin Recursive Utility|wealth dynamics]]. Because the markets are complete, there are infinitely many sets of assets that span the endowment
shock. We choose the home risk-free bond and the world equity claim to construct the replicating portfolios. Let  $x_{t}$   denote the weight on world equity in home households’ [[An Asset Allocation Primer|portfolio]], and let  $\boldsymbol{x}_{t}^{*}$    denote the weight on world equity in foreign households’ [[An Asset Allocation Primer|portfolio]]. Then, we match the home households’ [[Epstein-Zin Recursive Utility|wealth dynamics]], i.e.,$$
D a_{t}=\mu_{a, t}d t+\sigma_{a, t}d W_{t}
$$
from Eq. ( 7 . 1 ) with the dynamics implied from consumption and the [[Pricing Forwards, Futures, Bonds, Swaps, Swaptions, Caps and Floors under No-Arbitrage and Risk-Neutral Pricing|replicating portfolio]], i.e.,$$
D a_{t}=a_{t}\left (x_{t}\frac{d s_{t}+(p_{t}y_{t}+p_{t}^{\ast}\exp (-e_{t}) y_{t}^{\ast}) d t}{s_{t}}+(1-x_{t}) r_{t}d t\right)-c_{t}d t,
$$
To obtain the [[An Asset Allocation Primer|portfolio]] choice    $x_{t}$  .
...
$$
Similarly, we match the foreign households’ [[Epstein-Zin Recursive Utility|wealth dynamics]], i.e.,$$
D{\left (a_{t}^{*}\exp (-e_{t})\right)}=\mu_{a^{*}, t}d t+\sigma_{a^{*}, t}d W_{t},
$$
with the dynamics implied from consumption and the [[Pricing Forwards, Futures, Bonds, Swaps, Swaptions, Caps and Floors under No-Arbitrage and Risk-Neutral Pricing|replicating portfolio]], i.e.,$$
A_{t}^{*}\exp (-e_{t})\left (x_{t}^{*}\frac{d s_{t}+(p_{t}y_{t}+p_{t}^{*}\exp (-e_{t}) y_{t}^{*}) d t}{s_{t}}+(1-x_{t}^{*}) r_{t}d t\right)-c_{t}^{*}d t,
$$
To obtain the [[An Asset Allocation Primer|portfolio]] choice    $\boldsymbol{x}_{t}^{*}$    .
...
This divergence in [[An Asset Allocation Primer|portfolio]] choice happens because the market prices of risk increase in bad times. We define the market prices of risk  $\lambda_{t}$   and  $\lambda_{t}^{*}$    as the vol at ili ties of the home and foreign SDFs:$$
...
$$
which are plotted in Figure  7 . 6  and both display clearly counter cy clical behaviors. The higher market prices of risk in bad low endowment states further magnify the difference in risk aversion between the U.S. and foreign households, which leads to further divergence in their [[An Asset Allocation Primer|portfolio]] choices. This counter cyclical behavior of the market prices of risk also provides a motivation for the more reduced-form specification of the SDFs that we considered in Eq. ( 3 . 1 ) and ( 3 . 2 ) in Section  3 .A .
...
The insurance provision view provides a powerful tool for understanding the asymmetry in [[An Asset Allocation Primer|portfolio]] holdings and [[Some Stylized Empirical Facts About Asset Retur|asset returns]] between the U.S. and the rest of the world. It offers a rational, riskbased explanation for why the U.S. enjoys the exorbitant privilege.
...
We consider a simple case in which the [[Global Fixed Income Markets|government debt]] supply is constant and, the bond demand shock  $\theta_{H, t}^{*}$    is exogenous. The exogenous variables are the endowments and the foreign households’ dollar asset preferences:$$
...
Proposition  7 . 2 .  The exchange rate level is equal to the expected [[Long-Run Risks and Epstein-Zin Utility|consumption growth]] differential and the expected convenience yield differential:$$
...
Take the foreign households as an example. Recessions lower their wealth and reduce their holdings of the dollar safe assets. Given their downward-sloping demand curve for dollar safe assets, they impute a higher convenience yield and accept a lower [[Lecture 1- Probability Distributions of Returns|expected return]] to hold the U.S. bond. To e qui lib rate their demand with the U.S. households, the dollar has to appreciate to generate an expected depreciation, which leads to a lower [[Lecture 1- Probability Distributions of Returns|expected return]] to hold the U.S. bond from the foreign perspective. In this way, the demand for safe assets connects wealth decline to local [[Inflationary Depressions and Currency Crises 1|currency depreciation]]. If the wealth declines more than consumption in recessions, this channel based on marginal utilities over bonds could overturn the completemarket channel based on marginal utilities over consumption, and generate pro cyclical exchange rates.
...
$$
This wealth effect is the key distinguishing feature of the safe asset view, as it disentangles the response in the U.S. wealth  $a_{t}$   from the response in the U.S. net foreign assets    $n f a_{t}$  . On the one hand, the U.S. buys some foreign bonds from the foreign country and sells some dollar bonds to the foreign country. In a flight-to-dollar episode, the dollar appreciates and the U.S. suffers a loss on its external [[An Asset Allocation Primer|portfolio]], leading to a decline in the U.S. NFA. On the other hand, the U.S. receives a higher sei gni or age revenue from issuing the dollar bonds, which increases the U.S. wealth despite its loss on the external [[An Asset Allocation Primer|portfolio]].
...
Having presented the two views of the reserve [[Forwards and Futures Notes|currency]] paradigm, we next discuss several important issues related to the stability of the international monetary system. This discussion is based on a large body of literature on the international monetary system.
# 7 .D. 1 Triffin’s Dilemma
In the Bretton-Woods system with a  de-jure  dollar standard, foreign countries peg their currencies to the U.S. dollar, and the U.S. in turn pegs the dollar to the price of gold.  Triffin  [ 1960 ] foresaw an emerging imbalance. He argued that, as the world demand for dollar reserve assets grew with the world economy, the U.S. will inevitably run out of gold backing for its supply of reserve assets. Eventually, the erosion of backing will lead to a run on the dollar and the collapse of the international monetary system. This is the famous  Triffin dilemma , which highlights the tension between providing [[Class Note 10 Liquidity and Class Note 10 Liquidity and Liquidity Managementliquidity management|liquidity]] demanded by a growing world economy and maintaining the value of the reserve [[Forwards and Futures Notes|currency]].
In response to Triffin’s critique of the Bretton-Woods system,  Despres, Kindle berger, and Salant  [ 1966 ] propose the famous  minority view , which holds that the U.S., equipped with the deepest and most liquid [[Financial Markets and Institutions Lecture Notes|financial markets]] in the world, is a natural world banker which provides liquid assets to the world. Like banks, this inter mediation process can be stable for a long period of time. While this U.S.-asworld-banker view survives and exerts a strong influence on the modern literature, Triffin proved to be prescient. The U.S. ran out of its gold backing for its growing dollar liabilities in the early  1970 s. As a result, it was forced to devalue the dollar relative to gold in  1971 and eventually abandon convertibility from the dollar to gold in  1973 . Exchange rates became free-floating and the Bretton-Woods system collapsed.
In today’s world, we live with a  de-facto  dollar standard. Both the insurance provision view and the safe asset view hold that the world has a strong demand for dollar reserve assets, whose backing is provided by revenue streams of firms and governments instead of gold. One can in fact argue that this is an extraordinary feat of financial engineering, as the U.S. managed to manufacture reserve assets backed by risky (pro-cyclical) cash flows instead of steady collateral s such as gold. In this sense, as  Gourinchas, Rey, and Sauzet  [ 2019 ] point out,  “Triffin’s analysis, however, was incomplete because, despite the abandonment of the dollar-gold parity, the dominance of the dollar has increased since the collapse of the Bretton Woods system. Paradoxically, once free from the shackle of a fixed gold parity, the use of the US dollar as an international [[Forwards and Futures Notes|currency]] soared to unprecedented levels. Yet, as we argue, the financial fra gili ties inherent in a hegemonic system have not disappeared: The Triffin dilemma is still with us, albeit in a subtly different form.”
...
Yield and the risk premium terms, we can expect the variations in the exchange rate to absorb the shocks to the autonomous interest rate policies. In comparison, the  impossible duo  view emphasizes the risk premium terms  $r p_{t+j}$   and the convenience yield terms  $\lambda_{t+j}^{*},$  , which affect not only exchange rates but also domestic financial and [[US Debt Crisis and Adjustment (2007–2011)|economic conditions]]. Even with floating exchange rates, [[The Economist Regime Change|monetary policy]] responses are needed to address the influences of these external factors. As a result, monetary policies are not truly independent if the capital accounts are open and allow the risk premium and convenience yield shocks to spill over.
# 8 Government Debt and Fiscal Sustainability
# Summary
• If we look backward, the market value of [[Global Fixed Income Markets|government debt]] is determined by past debt, primary surpluses, and debt [[Assets|returns]]:$$
...
$$
• If we look forward, the market value of [[Global Fixed Income Markets|government debt]] is backed by the present value of future primary surpluses:$$
...
• In the case of the U.S. and past reserve asset issuers, the market value of [[Global Fixed Income Markets|government debt]] may exceed its fiscal backing, leading to a public debt valuation puzzle.
...
$$
Where  $S_{t}$   is the government primary surplus in nominal terms,    $Q_{t}$   is the nominal face value of the debt, and  $i_{t}$   is the log nominal [[Black Scholes Derivation|risk-free rate]].
In this section, we study the valuation of [[Global Fixed Income Markets|government debt]] and issues related to fiscal sustainability in greater details. We consider more general cases in which the government can issue different types contingent claims, including the long-term bonds. Let  $D_{t}$   denote the market value of aggregate [[Global Fixed Income Markets|government debt]] [[An Asset Allocation Primer|portfolio]], and let$\exp (R_{t}^{D})$   denote its cum-coupon return. Then, the government budget condition can be expressed as$$
...
Before we formally analyze this general case, let us consider a simple personal loan example. Suppose I borrow  $\S_{\mathrm{100,000}}$   today at the [[Continuously Compounding Interest|annual interest rate]] of  $5\%$   to purchase a house. The loan [[Key Rates O1s Durations and Hedging|duration]] is  10  years, with constant payment each year. A simple calculation shows that the constant payment is  $\S_{12,950}$   each year. Table  8 . 1  reports the detailed loan schedule.
Table  8 . 1 : Personal Loan Example
 ![500](Attachments/500-22.jpg)
...
The second interpretation is based on  forward-looking valuation : my outstanding balance of   $\S 56,\mathrm{o}69$   at the beginning of year  6  also reflects the present value of my remaining payments in the future. From the bank’s perspective, my personal loan is valued at  $\S_{5}6{,}\mathrm{o}69$  because this value describes the present value of the remaining  5 payments discounted at the interest rate of  $5\%$  . This [[PSET 7- Kohler|discount rate]], by the way, does not have to equal to the [[Black Scholes Derivation|risk-free rate]] if the bank believes that I may default on the loan. In this way, my outstanding loan balance in a given year can be interpreted both as the result of past borrowing and payments, and as the discounted present value of future promised payments.
The analysis of [[Global Fixed Income Markets|government debt]] is similar to this example of personal loan. The only key difference is that the analysis of [[Global Fixed Income Markets|government debt]] tends to have an infinite horizon as the government is supposed to be long-lasting, whereas the personal finance products tend to have a pre-determined horizon. We next examine the backward-looking and forward-looking approaches to [[Global Fixed Income Markets|government debt]] following  Jiang, Lustig, Van Nieuwe r burgh, and Xiaolan  [ 2023 a ].
# 8 .A Backward-Looking Accounting
One strand of the literature adopts a backward-looking approach by imputing variation in the debt/GDP ratio to the history of primary surpluses, output growth, [[War Economies and Hyperinflation|inflation]], and [[Interest Rate Quotations|interest rates]]. Specifically, by iterating backward Eq. ( 8 . 1 ), we can write the debt today as a function of cumulative past [[Assets|returns]] and past primary deficits [ Hall and Sargent ,  2011 ].
Proposition  8 . 1 .  (a) The market value of [[Global Fixed Income Markets|government debt]] can be expressed as$$
...
We can further simplify this result by considering a steady state in which debt [[Assets|returns]], growth rates, and surplus/GDP ratios are all constants. Then, the steady-state debt/GDP ratio can be expressed as$$
...
$$
Where    $r^{D}=R^{D}-\pi$   denotes the real return to the bond [[An Asset Allocation Primer|portfolio]] and  $x=X-\pi$   denotes the real growth rate.
First, consider the case in which the debt [[Assets|returns]] are higher than the GDP growth, i.e.,    $r^{D}\;>\; x$  . For a positive amount of debt, i.e.,  $d>0$  , the government has to run a budget surplus in perpetuity, i.e.,  $s>0$  , to pay off the interest and sustain the same debt/GDP level.
Then, consider the case in which the debt [[Assets|returns]] are lower than the GDP growth, i.e.,    $r^{D}<x$  . The literature usually denotes this condition by  $r<g$  . In this case, the government can roll over its debt in perpetuity while running steady-state deficits, i.e.,    $s<0$  .  Blanchard [ 2019 ] uses this logic to argue that the U.S. has an infinite debt capacity as long as the interest rate is lower than the GDP growth rate. In this environment, in fact, the government can start with an arbitrary amount of [[Global Fixed Income Markets|government debt]]. If it just rolls over its debt by raising more debt to pay the interests due, then, the [[Global Fixed Income Markets|government debt]] quantity rises at the interest rate  $r^{D}$  , while the GDP grows at a higher rate of  $x$  . If we wait long enough, the [[Global Fixed Income Markets|government debt]]/GDP ratio will decline to zero, making it easy for the government to eventually raise a one-time tax as a small fraction of the GDP and pay down the debt.
It is also straight forward to consider bond convenience yields in this calculation. In the absence of convenience yields, the debt return is equal to the [[Black Scholes Derivation|risk-free rate]],    $r^{D}\,=\, r$  . In the presence of convenience yields, the government is able to finance its debt at a rate lower than the [[Black Scholes Derivation|risk-free rate]]:$$
R^{D}=r-\lambda,
$$
...
In this sense, the law of motion for [[Global Fixed Income Markets|government debt]] is less “mechanical” than the law of motion for economic quantities such as the capital stock. The capital stock depends on depreciation and investments, and large adjustments in these economic quantities are subject to adjustment cost. Adjustments in the debt return, in comparison, reflect changes in investors’ [[FORWARD RATES AND TERM STRUCTURE|expectations]] and risk preferences and can be much faster and greater. As a result, in the next section we turn to the valuation tools developed in finance, which are exactly about understanding how asset prices respond to uncertainty in the future.
# 8 .B Forward-Looking Valuation
As in the backward-looking accounting, here we also start with Eq. ( 8 . 1 ). We consider a useful special case in which the government issues nominal bonds up to tenor  $H$  . So, the market value of the entire [[Global Fixed Income Markets|government debt]] [[An Asset Allocation Primer|portfolio]] can be expressed as$$
...
Proposition  8 . 2 .  Even when the [[Global Fixed Income Markets|government debt]] is default able, the market value of [[Global Fixed Income Markets|government debt]] is equal to the present value of future government surpluses plus a trans versa lit y term:$$
D_{t}=\mathbb{E}_{t}\left[\sum_{k=1}^{\infty}\mathrm{exp}\big (M_{t, t+k}\big) S_{t+k}\right]+\operatorname*{lim}_{k\to\infty}\mathbb{E}_{t}\left[\mathrm{exp}\big (M_{t, t+k}\big) D_{t+k}\right].
$$
...
$$
We refer to the present value of future government surpluses    $P_{t}^{T}-P_{t}^{G}$    − as the fiscal capacity. When the trans versa lit y condition holds, the fiscal capacity determines the market valuation of the aggregate [[Global Fixed Income Markets|government debt]] [[An Asset Allocation Primer|portfolio]].
We offer three economic interpretations of this relationship. First, it is worth noting that the [[Preview of the Book|cash flow]] stream of government surpluses  $S_{t}$   can be replicated by simply trading the [[Global Fixed Income Markets|government debt]]: if an investor buys all new [[Global Fixed Income Markets|government debt]] issuances and receives the [[Global Fixed Income Markets|government debt]] coupons and repayments, then, his or her [[Preview of the Book|cash flow]] is exactly equal to the government surpluses. As such, Proposition 8 . 2  shows that the aggregate [[Global Fixed Income Markets|government debt]] [[An Asset Allocation Primer|portfolio]] can be priced by any investors who can trade this strategy, even when the markets are incomplete and there are multiple SDFs that price the tradable asset space.
In fact, for investors who can trade [[Global Fixed Income Markets|government debt]], they should agree on the valuation of [[Global Fixed Income Markets|government debt]] even when they have different SDFs. For investors  $i$   and  $j$   with SDFs  $M_{t, t+k}^{i}$    and    $M_{t, t+k}^{j},$  respectively, we have$$
...
$$
If this equality does not hold, these two investors should trade with each other using the [[Global Fixed Income Markets|government debt]] [[An Asset Allocation Primer|portfolio]].
Second, this result implies that, in order to back up  $D_{t}$   dollars’ worth of debt, the government needs to generate a positive present value from its future primary surpluses. Conversely, when the present value of primary surpluses increases in period  $t_{,}$  , the [[Global Fixed Income Markets|government debt]] appreciates in value and generates a higher return    $R_{t}^{D}$  . That is, Eq. ( 8 . 9 ) implies$$
D_{t-1}(\mathbb{E}_{t}-\mathbb{E}_{t-1})\left[\exp (R_{t}^{D})\right]=(\mathbb{E}_{t}-\mathbb{E}_{t-1})\left[(P_{t}^{T}+T_{t})-(P_{t}^{G}+G_{t})\right],
$$
Where   $\exp\!\left (R_{t}^{D}\right)$   denotes the holding return of the aggregate government bond [[An Asset Allocation Primer|portfolio]]:$$
...
$$
Where  $d_{t}$   and  $s_{t}$   are the real market value of [[Global Fixed Income Markets|government debt]] and the real primary surplus, and    $m_{t, t+k}$   is the real SDF which is related to the nominal SDF via Eq. ( 6 . 1 ).
# 8 .B. 1 Incorporating the Convenience Yields
We can further generalize this result with convenience yields. The convenience yield    $\lambda_{t}(h)$   is the expected [[Assets|returns]] on government bonds of maturity    $h$   that investors are willing to forgo. As in Chapter    $4,$   the convenience yield is a wedge in the standard Euler equation:$$
...
Proposition  8 . 3 .  When there is convenience yield on [[Global Fixed Income Markets|government debt]] and possible government default, the market value of [[Global Fixed Income Markets|government debt]] is equal to the present value of future government surpluses and future sei gni or age revenues plus a trans versa lit y term:$$
...
$$
Similarly, we can regard the claims to tax revenues and government spending as financial securities, and define their cum-dividend [[Assets|returns]] as$$
...
$$
Then, we obtain the following result characterizing these claims’ expected [[Assets|returns]] and systematic risk exposures [ Jiang, Lustig, Van Nieuwerburgh, and Xiaolan ,  2020 b ].
Proposition  8 . 4 .  (a) The expected [[Assets|returns]] on the aggregate [[Global Fixed Income Markets|government debt]] [[An Asset Allocation Primer|portfolio]], the claim to tax revenues, and the claim to government spending satisfy$$
...
$$$(b)$   The betas of the aggregate [[Global Fixed Income Markets|government debt]] [[An Asset Allocation Primer|portfolio]], the claim to tax revenues, and the claim to government spending satisfy$$
\frac{D_{t}+P_{t}^{G}}{D_{t}}\beta_{t}^{T}=\beta_{t}^{D}+\frac{P_{t}^{G}}{D_{t}}\beta_{t}^{G}.
$$
The proof is presented in Appendix  A. 31 . This proposition resembles the [[Liquidity Preference Market Segmentation and P|Modigliani]]-Miller Theorem in [[Corporate Finance Lecture Notes|corporate finance]], which states
That, within a firm, its equity is a levered claim on the [[Risk Neutral Pricing of Options|underlying asset]]. As a result, the return beta and the risk premium on the firm asset are equal to the weighted average of those on the firm’s equity and debt claims:$$
\frac{D+E}{D}\beta_{t}^{A}=\beta_{t}^{D}+\frac{E}{D}\beta_{t}^{E},
$$
Where  $D$   is the market value of debt and  $E$   is the ex-dividend market value of equity. Similarly, the government holds the claim to tax revenues and splits up these cash flows to debt holders and recipients of government spending. As a result, the return beta and the risk premium on the tax claim are equal to the weighted average of those on the [[Global Fixed Income Markets|government debt]] and the spending claim.
...
If the government decides to make its [[How Countries Go Broke-Chapter 15 & Chapter 16|debt risk]]-free, which implies a zero debt beta  $\beta_{t}^{D}=0.$   0, then, Proposition  $8.4$   implies$$
\beta_{t}^{T}=\frac{P_{t}^{G}}{D_{t}+P_{t}^{G}}\beta_{t}^{G}.
$$
With a positive amount of outstanding debt, i.e.,  $D_{t}\,>\, 0_{,}$  , and a procyclical tax claim, i.e.,  $\beta_{t}^{T}>0.$   0, then, the spending beta has to be even higher than the tax beta. That is, the government spending has to be more pro cyclical than the tax revenue in order to manufacture risk-free [[Global Fixed Income Markets|government debt]]. In other words, the risk-free debt is manufactured by transferring more risk to the taxpayers.
Conversely, insuring taxpayers by lowering tax or raising government spending in bad times implies high debt beta or low spending beta, which renders the [[Global Fixed Income Markets|government debt]] risky by requiring a high debt beta.
...
Moreover, we can extend this trade-off result to the case of convenience yields. In this case, the debt return can be expressed as a weighted average of the [[Assets|returns]] on the tax, spending, and sei gni or age claims:$$
...
$$
This is a feature, not a bug. Suppose the tax, spending, and seigniorage claims all have the same [[PSET 7- Kohler|discount rate]]. Then, as long as the weights sum up to  1 , a linear combination of these claims also has the same [[PSET 7- Kohler|discount rate]]. The presence of the bond convenience yield introduces a “missing weight,” which allows the debt to have a lower [[PSET 7- Kohler|discount rate]]  $R_{t+1}^{D}$  . More precisely, we can write Eq. ( 8 . 12 ) as$$
...
$$
On the left-hand side, the debt return is adjusted by a factor of  $K_{t}/\big (P_{t}^{T}+P_{t}^{K}-P_{t}^{G}\big)$    , which reflects the size of the convenience yield. On the right-hand side, the weights are normalized to sum up to  1 . When the convenience yield is higher and generates a high seigniorage revenue    $K_{t},$   the debt return  $R_{t+1}^{D}$    can be lower than the weighted average of the tax, spending, and sei gni or age [[Assets|returns]].
Proposition  8 . 5 .  (a) The expected [[Assets|returns]] on the aggregate [[Global Fixed Income Markets|government debt]] [[An Asset Allocation Primer|portfolio]], the claims to tax revenues, government spending, and sei gni or age revenues satisfy$$
...
$$
(b) The betas of the aggregate [[Global Fixed Income Markets|government debt]] [[An Asset Allocation Primer|portfolio]] and the claims to tax revenues, government spending, and sei gni or age revenues satisfy$$
...
$$
The proof is presented in Appendix  A. 32 . Part (a) shows that the [[Lecture 1- Probability Distributions of Returns|expected return]] on the debt is tied to a weighted average of the expected [[Assets|returns]] on the tax, spending, and sei gni or age claims. However, the presence of convenience yield introduces a wedge that is increasing in the convenience yield and hence the sei gni or age revenue    $K_{t}$  : a higher convenience yield allows the [[PSET 7- Kohler|discount rate]] on the debt to be lower than the weighted average.
However, on the risk domain, we still obtain a tight constraint on how the government insures the taxpayers and the debt holders. As a special case, suppose the government commits to keeping its [[How Countries Go Broke-Chapter 15 & Chapter 16|debt risk]]-free, i.e.,    $\beta_{t}^{D}=0$   0. Then, part (b) simplifies to$$
...
Propositions  8 . 2  and  8 . 3  describe the valuation  $D_{t}$   of the entire [[Global Fixed Income Markets|government debt]] [[An Asset Allocation Primer|portfolio]], defined as the sum of individual government bonds’ values:$$
D_{t}=\sum_{h=1}^{H}Q_{t}\mathopen{}\mathclose\bgroup\left (h\aftergroup\egroup\right) P_{t}\mathopen{}\mathclose\bgroup\left (h\aftergroup\egroup\right).
$$
Let us first consider the determination of these individual government bonds’ values. We continue to assume that the government bonds are denominated in local currencies, promise nominal payments, and could potentially default. As the government bonds are default able, their yields are not necessarily the same as the nominal risk-free rates, which we denote by  $i_{t}(h)$  . Let us use    $i_{t}^{T r e a s}(h)$   to denote the yield of the [[Global Fixed Income Markets|government debt]] with maturity  $h,$   which satisfies$$
I_{t}^{T r e a s}(h)\stackrel{\mathrm{def}}{=}-\frac 1 h\log P_{t}(h).
$$
This [[Global Fixed Income Markets|government debt]] yield can be decomposed into a risk-free component, a default spread component, and a convenience yield component:$$
I_{t}^{T r e a s}(h)=\rho_{t}(h)+\delta_{t}(h)-c_{t}(h),
$$
Where the risk-free component reflects the benchmark [[PSET 7- Kohler|discount rate]] implied from the SDF:$$
\rho_{t}(h)\ensuremath{\stackrel{\mathrm{def}}{=}}-\frac 1 h\log\mathbb{E}_{t}[\exp (M_{t, t+h})],
$$
The default spread component captures the [[Risk-Neutral Probabilities|risk-neutral expectation]] of sovereign default,$$
...
$$
Moreover, while the [[Black Scholes Derivation|risk-free rate]] is risk-free in local [[Forwards and Futures Notes|currency]] units, it could carry a [[Forwards and Futures Notes|currency]] risk premium. For the case of  $h=1$  ,
According to Section  1 .B  applied to nominal exchange rates    $\mathcal{E}_{t}$   and [[Interest Rate Quotations|interest rates]]  $\rho_{t}$   and  $\rho_{t}^{*}$    , under joint normality,$$
...
$$
Which implies that the nominal home [[Black Scholes Derivation|risk-free rate]]  $\rho_{t}$   relative to a foreign benchmark  $\rho_{t}^{*}$    is decreasing in the home [[Forwards and Futures Notes|currency]]’s expected nominal appreciation  $\mathbf{\mathbb{E}}_{t}\big[\Delta\mathcal{E}_{t+1}\big],$  , and increasing in the home [[Forwards and Futures Notes|currency]]’s risk premium  $\begin{array}{r}{R P_{t}=-c o v_{t}\big (M_{t+1}^{*},\Delta\mathcal{E}_{t+1}\big)-\frac{1}{2}v a r_{t}\big (\Delta\mathcal{E}_{t+1}\big).}\end{array}$  .  As such, government bonds compensate investors for not only [[Quantitative Trading Strategies Lecture Notes|credit risk]] but also [[PSET 3 Financial Instruments|exchange rate risk]].
How do we connect this determination of individual bond prices to the valuation of the aggregate [[Global Fixed Income Markets|government debt]] [[An Asset Allocation Primer|portfolio]]? While the inter temporal government budget condition in Propositions  8 . 2 and  8 . 3  imposes a restriction on the aggregate [[Global Fixed Income Markets|government debt]] [[An Asset Allocation Primer|portfolio]], the government can still carve out different types of liabilities subject to this restriction in aggregate. This is again similar to the [[Corporate Finance Lecture Notes|corporate finance]] context, in which the company with a certain type of assets can issue different types of equity and debt liabilities subject to the [[Liquidity Preference Market Segmentation and P|Modigliani]]-Miller restriction. That said, when the government surpluses and sei gni or age revenues fluctuate, the valuation of the individual bonds needs to respond, resulting in changes in any of the [[Black Scholes Derivation|risk-free rate]]  $\rho_{t},$   the default spread  $\delta_{t},$   and the convenience yield  $c_{t}$  components.
...
The households can trade the outstanding [[Global Fixed Income Markets|government debt]]. Let  $d_{t}$   denote the households’ [[Global Fixed Income Markets|government debt]] [[An Asset Allocation Primer|portfolio]] and let   $\exp (r_{t}^{D})$  denote its nominal return.$$
...
$$
The proof is in Appendix  A. 33 . This proposition shows that the households optimally choose not to “leave money on the table” in the infinite horizon, which means to increase their savings  $d_{t}$   in the government bond [[An Asset Allocation Primer|portfolio]] at a rate higher than their [[PSET 7- Kohler|discount rate]]  $\delta^{t}u^{\prime}(c_{t})$  . The households do not borrow an infinite amount of money by short-selling the [[Global Fixed Income Markets|government debt]], either, which is ruled out by the no-short-sale constraint. This result emphasizes that the transversality condition is usually imposed by the households’ optimal decision, just like the Euler equation ( 8 . 13 ).
Moreover, while this set-up considers only one type of assets in which households can deposit their savings, the extension to multiple assets is straight-forward. Let  $a_{t}$   denote the households’ total savings and  $d_{t}$   denote the households’ holdings of one asset that we denote as the [[Global Fixed Income Markets|government debt]]. Then, our derivation shows that the
Trans versa lit y condition holds at the [[An Asset Allocation Primer|portfolio]] level:$$
\operatorname*{lim}_{t\rightarrow\infty}\mathbb{E}_{0}\left[\delta^{t}u^{\prime}(c_{t}) a_{t}\right]=0.
$$
Now, suppose the households’ trans versa lit y condition for the [[Global Fixed Income Markets|government debt]] is violated, i.e.,$$
...
$$
We use  $\lambda_{t}$   to denote the convenience yields at time    $t_{,}$  , which, as we see in Section  $4.\mathrm{A},$   is determined by the ratio between the marginal utility of bond holding and the [[Appendix 22.C Risk-Neutral Pricing and Marginal Utility in the Binomial Model|marginal utility of consumption]]:$$
...
$$
Which implies that a lower GDP growth leads to a higher marginal utility. By the Euler equation for risk-free debt, the one-period log [[Black Scholes Derivation|risk-free rate]] is a constant:    $R^{f}=i$  .
...
$$
which converges to zero as  $k\rightarrow\infty$  if the [[PSET 7- Kohler|discount rate]] is higher than the GDP growth rate, i.e.,$$
I+\gamma\sigma>X+\frac{1}{2}\sigma^{2}.
$$
We note that the [[PSET 7- Kohler|discount rate]] is the benchmark [[Black Scholes Derivation|risk-free rate]]  $i$   implied from the SDF plus the risk premium term    $\gamma\sigma$  . The growth rate is the log growth rate    $X$   plus the Jensen’s term  ${\textstyle\frac{1}{2}}\sigma^{2}$  .
We assume that the government commits to issuing one-period risk-free debt. The government also commits to a simple [[The Economist Regime Change|fiscal policy]], with a constant spending/GDP ratio  $\bar{\gamma}\ =\ G_{t}/Y_{t}$   and a constant debt/GDP ratio  $\bar{\delta}=D_{t}/Y_{t}$  .
...
$$
Given the trans versa lit y condition holds, the [[Global Fixed Income Markets|government debt]] value is the sum of the values of the surplus strips:$$
...
I+\gamma\sigma>X+\frac{1}{2}\sigma^{2}.
$$
In this case, discounting growing surpluses and future debt at the [[Black Scholes Derivation|risk-free rate]]  $i~<~X$   would not produce the right answer for the valuation of the current debt.
However, this is not a free lunch: the beta constraint characterized by Proposition  8 . 4  still binds: in order to keep [[How Countries Go Broke-Chapter 15 & Chapter 16|debt risk]]-free, the government needs to raise taxes or lower spending in high marginal utility states.
...
$$
We need to model the joint dynamics of the SDF    $M_{t, t+k}$   and the fiscal cash flows    $T_{t+k}$   and  $G_{t+k}$  .  Jiang, Lustig, Van Nieuwe r burgh, and Xiaolan  [ 2019 ] adopts the affine [[The Vasicek Model|term structure]] framework, which has been used in various [[Fixed Income Asset Pricing|asset pricing]] settings to understand stock and bond prices [ Duffie and Kan ,  1996 ,  Dai and Singleton ,  2000 ,  Ang and Piazzesi ,  2003 ,  Lustig, Van Nieuwe r burgh, and Verdelhan ,  2013 , Chernov and Creal ,  2023 ].
Specifically, let  $z_{t}$   denote the vector of state variables demeaned by their average value, which includes the [[Interest Rate Quotations|interest rates]], stock dividends and price/dividend ratios, and the fiscal cash flows. This vector follows a Gaussian first-order VAR:$$
...
This VAR setting allows us to model [[FORWARD RATES AND TERM STRUCTURE|expectations]] of cash flows. We also choose a flexible SDF that assumes no [[Arbitrage Pricing of Derivatives|arbitrage]]. The log nominal SDF  $M_{t+1}$   is conditionally normal:$$
M_{t+1}=-i_{t}(1)-\frac{1}{2}\Lambda_{t}^{\prime}\Lambda_{t}-\Lambda_{t}^{\prime}\varepsilon_{t+1}.
$$
The real SDF is    $m_{t+1}\;=\; M_{t+1}+\pi_{t+1},$   which is also conditionally normal. The priced sources of risk are the same as the innovations in the state vector    $\varepsilon_{t+1}$  . These innovations are associated with a [[Exercises|market price of risk]] vector  $\Lambda_{t}$   of the affine form:$$
\Lambda_{t}=\Lambda_{0}+\Lambda_{1}z_{t},
$$
Where  $\Lambda_{0}$   collects the average prices of risk and    $\Lambda_{1}$   governs the time variation in risk premia. [[Fixed Income Asset Pricing|Asset pricing]] in this model amounts to taking a stance on the market prices of risk in  $\Lambda_{0}$   and    $\Lambda_{1}$  .
If the state vector  $z_{t}$   contains the [[An Overview of the Vasicek Short Rate Model|short rate]], [[War Economies and Hyperinflation|inflation]], GDP growth, the stock dividend/GDP ratio, and the [[Chapter 16 - Black–Scholes Model|stock price]]/dividend ratio, this SDF generates affine solutions for the value of the aggregate [[Hedge Fund Strategies|stock market]] and the [[The Vasicek Model|term structure]] of nominal and [[Real Interest Rates and Aggregate Production|real interest rates]]. We also include fiscal variables in the state vector in order to price the fiscal cash flows.
Let    $i_{t}\big (h\big)\ \stackrel{\mathrm{def}}{=}\ \big (1/h\big)\log P_{t}\big (h\big)$   denote the nominal [[Black Scholes Derivation|risk-free rate]] with maturity  $h$  . For notational convenience, let  $e_{i}$   denote the vector  $(0,\cdot\cdot\cdot, 1,\cdot\cdot\cdot, 0)^{\prime}$    that selects the variable corresponding to the [[An Overview of the Vasicek Short Rate Model|short rate]], and let  $i_{0}(1)$   denote the mean value of the [[An Overview of the Vasicek Short Rate Model|short rate]]. Then,$$
I_{t}(1)=e_{i}^{\prime}z_{t}+i_{0}(1).
$$
Similarly, let    $e_{\Delta d},\, e_{x},$   and    $e_{\pi}$   denote vectors that select the variables corresponding to the growth in the dividend/GDP ratio, the real GDP growth, and the [[War Economies and Hyperinflation|inflation]], respectively.
...
$$
And let  $p d_{t}^{m}(h)$   denote the [[Lecture 4- Investor Sentiment|price-dividend ratio]] of the [[Hedge Fund Strategies|stock market]]:$$
P d_{t}^{m}\bigl (h\bigr)=\log\bigl (P_{t}^{m}\bigl (h\bigr)/D i v_{t}\bigr).
$$
Then, the cum-dividend valuation of the [[Hedge Fund Strategies|stock market]] can be expressed as$$
...
(b) The dividend strip’s log [[Lecture 4- Investor Sentiment|price-dividend ratio]] is also affine in the state vector:$$
...
$$
The proof is in Appendix  A. 35 . Our key assumption behind this proposition is that the SDF that prices stocks and bonds can also price the fiscal cash flows. As we discussed earlier in Eq. ( 8 . 10 ), any investors who can trade the aggregate [[Global Fixed Income Markets|government debt]] [[An Asset Allocation Primer|portfolio]] have to agree on how they price the primary surpluses. Moreover, by assuming that there is no market segmentation between the stock and bond markets, we allow the market price of permanent risks implied from the [[Hedge Fund Strategies|stock market]] to also inform the [[Arbitrage Pricing of Derivatives|pricing]] of the fiscal cash flows. In other words, we set up the VAR dynamics to allow co integration between the GDP, the aggregate [[Hedge Fund Strategies|stock market]] dividend, and the government tax and spending strips. As a result, the [[Arbitrage Pricing of Derivatives|pricing]] of the long-term fiscal cash flows is governed by the same market prices of risk that price the long-term stock dividends.
To develop this argument further, let us consider the [[Arbitrage Pricing of Derivatives|pricing]] of infinite-horizon cash flows. In the limit, the nominal yield converges to a certain value, with$$
...
Proposition  8 . 9 .  (a) In the infinite horizon, the long-run nominal yield and bond [[Lecture 1- Probability Distributions of Returns|expected return]] are$$
...
( 8 . 16 ) is a special case of Eq. ( 8 . 15 ), obtained when the [[Preview of the Book|cash flow]] does not grow, i.e., by setting    $e_{\Delta d}+e_{x}+e_{\pi}=0.$  .
...
Denote the [[War Economies and Hyperinflation|inflation]]-and-growth-adjusted debt return.  Cochrane [ 2022 ] derives a log-linearized return equation implied by the government budget constraint:$$
\widetilde{r}_{t+1}=\kappa v_{t+1}-v_{t}+s_{t+1},
$$
 E
Where    $\kappa=\exp (-(R-x-\pi))$   is a constant, and  $s_{t+j}=\kappa\cdot s y_{t+j}/\exp (\bar{v})$  is    $\kappa$   times the primary surplus/GDP ratio scaled by the average debt/GDP ratio. This formula is similar to the log-linear iz ation for stock [[Assets|returns]] in  Campbell and Shiller  [ 1988 ]:$$
...
By iterating this equation forward    $T$   times and taking [[FORWARD RATES AND TERM STRUCTURE|expectations]], we obtain$$
...
$$
which is a linearized version of the inter temporal government budget condition ( 8 . 6 ). It provides a way to evaluate the [[Global Fixed Income Markets|government debt]] as a fraction of GDP, i.e.,  $v_{t},$   based on the [[FORWARD RATES AND TERM STRUCTURE|expectations]] of future surpluse  $s_{t+j},$   future adjusted debt [[Assets|returns]]  $\widetilde{r}_{t+j},$   and future debt/GDP level  v  $v_{t+T}$  .
This relationship holds both ex-ante and ex-post. Without taking [[FORWARD RATES AND TERM STRUCTURE|expectations]], we can express this result as a variance decomposition exercise:$$
V a r (v_{t})=c o v\left (v_{t},\sum_{j=1}^{T}\kappa^{j-1}\left (s_{t+j}-\widetilde{r}_{t+j}\right)\right)+c o v (v_{t},\kappa^{T}v_{t+T}),
$$
Which states that the debt/GDP ratio varies only because it predicts future surpluses, future [[Assets|returns]], or the future debt/GDP ratio.
...
$$
To implement this model, we could use statistical tools (such as the VAR model or the local projection method) to construct conditional [[FORWARD RATES AND TERM STRUCTURE|expectations]] of  $s_{t+j}$   and  $\widetilde{r}_{t+j}$   and build the debt/GDP value from these [[FORWARD RATES AND TERM STRUCTURE|expectations]].
...
debt/GDP ratio    $v_{t}$   is justified by higher surpluses  $s_{t+j}$   in the future.  Jiang, Lustig, Van Nieuwe r burgh, and Xiaolan  [ 2021 c ] use a simple local projection method to construct conditional [[FORWARD RATES AND TERM STRUCTURE|expectations]] of not only future sur  and [[Assets|returns]]   $(s_{t+j}$   and  $\widetilde{r}_{t+j},$  ), but also future debt/GDP ratio (  $(v_{t+j})$  ). They find that, after addressing a small-sample bias, the variations in the current debt/GDP ratio are explained by the variations in the future debt/GDP ratio  10  years later instead of by future [[Week 2 Fundamentals Of Forecasting|fundamentals]] (i.e., future surpluses and [[Assets|returns]]) in the next  10  years.
# 8 .E. 3 Bias in Subjective Expectations
One explanation for the result in  Jiang, Lustig, Van Nieuwe r burgh, and Xiaolan  [ 2021 c ] is biased beliefs. While the econometric ian does not expect higher surpluses or lower [[Assets|returns]] when the debt/GDP ratio rises, bond investors may. More precisely, note that the same linearized decomposition works under the subjective measure, too:$$
...
Specifically, if the investors systematically over-predict surpluses or under-predict [[Assets|returns]] when the debt/GDP ratio increases, this forecast error term can impute a unit root in the debt/GDP ratio under the econometric ian’s measure    $\mathbb{E}$  . At the same time, under the investors’ subjective beliefs measure  $\mathbb{F}.$  , the debt/GDP ratio may remain stationary. In this case, we obtain$$
...
Abstract away from variations in growth-adjusted [[Assets|returns]] by setting  $\tilde{r}_{t+j}=0$   under both measures and let  $\kappa=1$   which is consistent with the primary surplus being zero on average.
...
$$
Which implies that the debt/output ratio is a [[Some Discrete-Time Stochastic Processes|random walk]]:$$
...
$$
With a coefficient    $b\ >\ 0$  . Under this measure, the [[Global Fixed Income Markets|government debt]]/output ratio is priced according to$$
...
$$
Which implies that the valuation of [[Global Fixed Income Markets|government debt]] is fully driven by the investors’ belief bias    $\left (\mathbb{F}_{t}-\mathbb{E}_{t}\right)$  , w vides an economic interpretation of the trans versa lit y term  $\mathbb{E}_{t}\big[v_{t+T}\big]$   under the econometrician’s measure.
...
Our discussion shows that the issue of [[Global Fixed Income Markets|government debt]] valuation and sustainability is more complicated. Investors are willing to offer extra fiscal capacity to the world’s safe asset supplier beyond what is warranted by its fiscal [[Week 2 Fundamentals Of Forecasting|fundamentals]] and sei gni or age revenues. When the safe asset supplier’s relative [[Week 2 Fundamentals Of Forecasting|fundamentals]] deteriorate, this extra fiscal backing is withdrawn by bond investors who then focus only on the country’s [[Week 2 Fundamentals Of Forecasting|fundamentals]].
3  More broadly, the strategic coordination issues between governments and policymakers enrich the [[Probability Space|possible outcomes]] in the international economy. Besides the classical tariff war studied by the [[Chapter 2-The Principle Of Comparative Advantage|international trade]] literature, recent papers study the strategic interaction along multiple fronts, including monetary policies [ Egorov and Mukhin , 2019 ], trade and monetary policies [ Auray, Devereux, and Eyquem ,  2019 ], trade and containment policies [ Acharya, Jiang, Richmond, and von Thadden , 2020 ], bank regulation [ Clayton and Schaab ,  2022 ], and geopolitics [ Clayton, Maggiori, and Schreger ,  2023 ]. A common theme is the emphasis on the exchange rate as both a policy instrument and a coordinated outcome.
# 9 Portfolio Choice and Asset Demand
# Summary
• The standard [[Fixed Income Asset Pricing|asset pricing]] literature models [[An Asset Allocation Primer|portfolio]] choices as the [[Exercises|mean-variance]] trade-off plus additional dynamic [[Key Rates O1s Durations and Hedging|hedging]] terms:$$
X_{t}=\gamma^{-1}\Sigma_{t}^{-1}\mathbb{E}_{t}[r_{t+1}]+\mathrm{d y n a m i c~h e d g i n g~t e r m s}.
$$
• Alternatively, the demand system approach models [[An Asset Allocation Primer|portfolio]] choices based on asset prices, characteristics, and latent demand terms:$$
X_{t}=\frac{\exp\!\big (\alpha\log p_{t}+\beta\Xi_{t}+\kappa_{t}\big)}{1+\sum_{k}\exp\!\big (\alpha\log p_{t}+\beta\Xi_{t}+\kappa_{t}\big)}.
$$
• These [[An Asset Allocation Primer|portfolio]] choices are closely related to each country’s external imbalances and net foreign assets.
Central in any account of the international monetary system is how the investors in different countries choose their portfolios, how their portfolios differ in ex-ante characteristics and in ex-post [[Assets|returns]], and how the capital flows due to investments and payouts allocate resources across countries. Answers to these questions inform us about how the international monetary system is organized, which countries play a central role, and the benefits and costs of being at the central location.
In this chapter, we will go over the traditional [[Exercises|mean-variance]] approach to [[An Asset Allocation Primer|portfolio]] choice as well as more recent developments using a different demand system approach. We will also discuss specifications and applications of these approaches adapted for studying these international instead of domestic [[An Asset Allocation Primer|portfolio]] choices. Finally, we relate the households’ equilibrium [[An Asset Allocation Primer|portfolio]] choices on the finance side to important quantities on the macro side such as net foreign assets and [[The Balance of Payments|balance of payments]].
# 9 .A The Mean-Variance Approach
This set-up follows the standard  [[Credit Markets Session 5|Merton]]  [ 1969 ] [[An Asset Allocation Primer|portfolio]] problem with multiple assets. For tract ability, we assume households have power utility and a finite horizon    $T$  . This set-up is otherwise similar to the domestic economy considered in Chapter  1 , which is populated by a representative household. The household maximizes expected lifetime utility:$$
\mathbb{E}_{0}\left[\sum_{t=0}^{T}\delta^{t}\frac{c_{t}^{1-\gamma}}{1-\gamma}\right].
$$
The household can trade a set of financial assets. Let    $w_{t}$   denote the wealth before consumption, and let  $a_{t}$   denote its total asset under management after consumption. Risky assets are indexed by  $\iota\in$   $\{1,2,\dots, N\},$  , and there is an asset that is risk-free in real terms. Let  $x_{t}(\iota)$   denote the households’ [[An Asset Allocation Primer|portfolio]] share on the asset    $\iota,$   and let  $\exp\!\left (r_{t+1}(\iota)\right)$   denote the asset’s real return. Let  $\exp (r_{t}^{f})$   denote the [[2. Forwards, Swaps, Futures, and Options|risk-free asset]]’s real return. Then, the [[An Asset Allocation Primer|portfolio]]-level return can be expressed as$$
...
$$
Let  $z_{t}$   denote the vector of state variables that determine the distribution of [[Assets|returns]]. We define the value function as$$
...
$$
This is a generic set up of a [[An Asset Allocation Primer|portfolio]] choice model. See  Back [ 2010 ] for more details, or  Duffie  [ 2010 ] for a continuous-time formulation. To fully solve this model, we need to rely on specific assumptions of [[Risk Preferences|investor preferences]] and asset return dynamics. When the investors have power utility, we obtain the following character iz ations for [[An Asset Allocation Primer|portfolio]] demand.
...
(b) The optimal [[An Asset Allocation Primer|portfolio]] allocation satisfies$$
X_{t}=\arg\operatorname*{max}_{x_{t}}\mathbb{E}_{t}\left[f_{t+1}(z_{t+1})\frac{\exp ((1-\gamma) r_{t+1}^{p})}{1-\gamma}\right],
$$
Where the log [[An Asset Allocation Primer|portfolio]] return  $r_{t+1}^{p}$    depends on the [[An Asset Allocation Primer|portfolio]] choice  $x_{t}$  .
The proof is in Appendix  A. 37 . Eq. ( 9 . 1 ) implies that, when the investors maximize their expected [[An Asset Allocation Primer|portfolio]] return  $r_{t+1}^{p},$  , they also pay attention to the expected evolution of the state variable  $z_{t+1}$  . Consequently, the optimal [[An Asset Allocation Primer|portfolio]] choice    $x_{t}$   depends on the expected future state.
# 9 .A. 1 The Case of Constant Investment Opportunity
To derive [[Chapter 40 - Pricing Fixed Income Options: Black’s Model and MCS|closed-form solutions]], the literature uses either continuoustime math or linear iz ation to further simplify the problem. A popular choice is to approximate the [[An Asset Allocation Primer|portfolio]] return via log-linear iz ation as proposed by  Campbell and Viceira  [ 2002 ], which approximates the log [[An Asset Allocation Primer|portfolio]] return by$$
R_{t+1}^{p}\approx r_{t}^{f}+x_{t}^{\prime}\big (r_{t+1}-r_{t}^{f}+\frac{1}{2}\sigma_{t}^{2}\big)-\frac{1}{2}x_{t}^{\prime}\Sigma_{t}x_{t},
$$
Where  $\Sigma_{t}$   denotes the conditional variance-covariance matrix of the log [[Assets|returns]], and    $\sigma_{t}^{2}$    is the vector containing the diagonal elements of  $\Sigma_{t}$  .
With this approximation formula, we can now solve the [[An Asset Allocation Primer|portfolio]] choice problem when the state variable is a constant, i.e.,  $z_{t}\;=\;\bar{z},$  which implies that the [[Some Stylized Empirical Facts About Asset Retur|asset returns]] are i.i.d. and  $f_{t+1}(z_{t+1})$   is a constant.
Proposition  9 . 2 .  When the [[Some Stylized Empirical Facts About Asset Retur|asset returns]] are i.i.d. and normally distributed, the optimal [[An Asset Allocation Primer|portfolio]] choice is$$
X_{t}=\gamma^{-1}\Sigma_{t}^{-1}\left (\mathbb{E}[r_{t+1}]+\frac{1}{2}\sigma_{t}^{2}-r_{t}^{f}\right).
$$
The proof is in Appendix  A. 38 . This formula ( 9 . 2 ) recovers the classical [[Exercises|mean-variance]] trade-off in [[An Asset Allocation Primer|portfolio]] choice theory. In the numerator,  $\mathbb{E}[r_{t+1}]-r_{t}^{f}$    denotes the assets’ expected excess [[Assets|returns]] in  $\log,$   and    $\textstyle{\frac{1}{2}}\sigma_{t}^{2}$    captures the Jensen’s term adjustment, so that the
Sum    $\begin{array}{r}{\mathbb{E}[r_{t+1}]+\frac{1}{2}\sigma_{t}^{2}-r_{t}^{f}}\end{array}$      captures the assets’ expected excess [[Assets|returns]] in level, which is exact when [[Assets|returns]] are normally distributed or in continuous time. In the denominator,  $\Sigma_{t}$   is the covariance matrix of [[Some Stylized Empirical Facts About Asset Retur|asset returns]] and  $\gamma$   is the risk aversion coefficient. Therefore, the optimal [[An Asset Allocation Primer|portfolio]] favors assets that have high expected excess [[Assets|returns]] and low variance and covariance with other assets.
# 9 .A. 2 Special Cases with Time-varying Investment Opportunity
When the state variable  $z_{t}$   is time-varying, the problem becomes more difficult in general. Here we discuss two special cases. First, Campbell and Viceira  [ 2002 ] consider a case in which the [[Black Scholes Derivation|risk-free rate]] is time-varying but the risky assets’ variances and risk premia are constant. In this case, the optimal [[An Asset Allocation Primer|portfolio]] choice is$$
...
$$
This solution contains two terms. The first term is similar to the solution under i.i.d. [[Assets|returns]] derived above, which depends on the assets’ excess [[Assets|returns]] and variance-covariance matrix. The second term is commonly known as the [[Key Rates O1s Durations and Hedging|hedging]] term, as the investors buy certain assets to hedge shocks to future [[An Asset Allocation Primer|investment]] opportunities. In this case, since risk premia are constant, variations in future [[An Asset Allocation Primer|investment]] opportunities are only driven by variations in the [[Black Scholes Derivation|risk-free rate]]. Specifically, a surprise reduction in expected future risk-free rates represents a negative shock to future [[An Asset Allocation Primer|investment]] opportunities. When the risk aversion coefficient    $\gamma>1.$  , investors would like to load up more on assets that offer higher [[Assets|returns]] when expected future risk-free rates go down.
...
$$
Which does not depend on the state variable. In this sense, investors with log utility are  myopic , as they choose portfolios like one-period investors. They do not pay attention to how different assets’ [[Assets|returns]] respond to shocks to future [[An Asset Allocation Primer|investment]] opportunities. These investors also have a predetermined wealth-consumption ratio, which is a constant when the horizon  $T$   is infinite.
Moreover, with log utility (i.e.,    $\gamma=1$  ), Eq. ( 9 . 3 ) in the first special case becomes    $x_{t}=\bar{\Sigma_{t}^{-1}}\left (\bar{\mathbb{E}_{t}}[r_{t+1}]-r_{t}^{f}+\frac{1}{2}\sigma_{t}^{2}\right)$    . The optimal [[An Asset Allocation Primer|portfolio]] allocation no longer loads on the term that hedges the variations
In future [[Interest Rate Quotations|interest rates]], and the myopic investors only focus on the [[Exercises|mean-variance]] trade-off.
9 .B Applications of the [[Exercises|Mean-Variance]] Approach (TODO)
9 .C The Demand System Approach
Eq. ( 9 . 2 ) offers an intuitive way to think about the [[An Asset Allocation Primer|portfolio]] allocation problem as a [[Exercises|mean-variance]] trade-off. While this approach has been powerful and universal, several challenges stand out. First, estimating the expectation and the variance-covariance matrix of [[Some Stylized Empirical Facts About Asset Retur|asset returns]] is empirically challenging. As the assets’ risk characteristics and investors’ risk appetite are time-varying, the moments estimated from the past return data do not necessarily represent the distribution of future [[Assets|returns]].
Second, investor demand for different assets and asset classes appears to be less elastic than what standard models imply. For example, according to  Koijen and Yogo  [ 2021 ], “a [[Credit Markets Session 4|calibration]] of the [[2. Forwards, Swaps, Futures, and Options|capital asset pricing model]] (CAPM) implies a demand elasticity for individual stocks that exceeds    $_{5,\mathrm {{OOO}} ,^{\prime\prime}}$   whereas empirical estimates of the demand elasticity are closer to  1  or lower [ Gabaix and Koijen , 2021 ], which is three orders of magnitude smaller.
In response to these challenges,  Koijen and Yogo  [ 2019 ] turn to a complementary approach based on demand systems. Instead of deriving the optimal [[An Asset Allocation Primer|portfolio]] choice from the [[Exercises|mean-variance]] tradeoff, their starting point is that the households allocate their wealth based on the assets’ characteristics. In this section, we study the most basic demand system model based on logit demand functions.
# 9 .C. 1 Logit Demand
...
Investor    $n$   chooses to invest in asset    $\iota$   if    $u_{n, t}\bigl (\iota\bigr)\ \geq\ u_{n, t}\bigl (j\bigr)$   for all  $j$  . The term  $\varepsilon_{n, t}(\iota)$   captures the investor’s personal [[Utility Indices|preference]]. If this term is i.i.d. and follows the standard logit distribution with a cumulative [[Verification of Central Limit Theorem|distribution function]]    $\Phi (\varepsilon)\,=\,\exp (-\exp (-\varepsilon))$  , then, we can aggregate across all investors and derive the amount of funds invested in asset  $\iota$   to be$$
...
Alternatively,  Koijen and Yogo  [ 2019 ] propose a mapping from the standard [[Exercises|mean-variance]] [[An Asset Allocation Primer|portfolio]] allocation problem in Section  9 .A  to the demand system. They do so by imposing a factor structure to the variance-covariance matrix of [[Some Stylized Empirical Facts About Asset Retur|asset returns]], allowing the factor loadings to depend on the [[Assets|asset characteristics]], and adopting a particular form of approximation.
...
To close the model, we need to take a stance on the total amount of funds the households have for investments. Let us denote this total asset under management by  $a_{t}$  . In some models,  $a_{t}$   is exogenous ly determined; in other models,    $a_{t}$   depends on previous [[An Asset Allocation Primer|investment]] outcomes. For example, it makes sense to use the same law of motion for the asset under management as in the traditional [[An Asset Allocation Primer|portfolio]] model in Section  9 .A :
1  For asset-level characteristics, see Daniel and Titman  [ 1997 ] and the subsequent covariance vs. Characteristics debate. Investor-level characteristics such as personalities [ Jiang, Peng, and Yan ,  2023 b ] and recall bias [ Jiang, Liu, Peng, and Yan ,  2022 b ] could affect [[An Asset Allocation Primer|portfolio]] allocations.$$
A_{t}=a_{t-1}\left (\sum_{\iota}x_{t-1}(\iota)\exp (r_{t}(\iota))\right)+s_{t},
$$
Which requires us to model  $s_{t}$   representing how much the households save into their [[An Asset Allocation Primer|investment]] account after consumption. In the case that the households consume more than their income, the flow term  $s_{t}$   could be negative. Section  9 .E  discusses these flows in more details.
...
$$
On the left-hand side,    $p-c^{\prime}(q (p))$   is the issuer’s mark-up defined as the [[A Preview of Alternative Formulations|asset price]] minus the marginal cost. This result implies that the issuer sets the mark-up according to the demand elasticity.
Yet in other cases, the asset supply can be fully elastic, which means that the issuer can supply an arbitrary quantity of the asset at a given price. For example, this could apply to open-end [[Breaking the Buck|money market funds]] whose underlying holdings are liquid and safe assets with a deep market. In this case, when there is a shock to investor demand, the market clears by quantity adjustment instead of by [[Bid-Ask Prices with Adverse SelectionPrivate Information|price adjustment]].
...
To interpret this result, note that we expect  $\alpha\,<\, 0$   as demand is decreasing in price. Then, the demand elasticity is increasing in the magnitude    $|\alpha|.$  , a higher value of which means that the households’ demand is more sensitive to the price. Magnitude-wise, suppose this asset is only  $\mathbf{\sigma}_{\mathbf{1}}\%$   of the total market cap, and    $\alpha\,=\,-1,$  , so that a    $\mathbf{\sigma_{1}\%}$  increase in [[A Preview of Alternative Formulations|asset price]] roughly leads to a  $\mathbf{\sigma}_{\mathbf{1}}\%$   reduction in investor demand. Then, the demand elasticity is  1 . 99 , which is already at the higher end of the distribution of empirical estimates.
The demand elasticity is also decreasing in the [[An Asset Allocation Primer|portfolio]] share  $x_{t}(\iota)$  , which means an asset with a larger size has fewer alternatives to substitute with. This is a desirable feature of the asset demand system, because reserve assets in high demand such as the U.S. Treasury tend to face a more inelastic demand curve [ Choi, Dang, Kirpalani, and Perez ,  2023 ]. If our asset demand system correctly captures the high market share in either the [[Assets|asset characteristics]]  $\Xi_{t}(\iota)$   or the latent demand    $\kappa_{t}(\iota)$  , then, we also make its demand curve more inelastic than other assets.
...
$$
And the [[Macroeconomic Models of Business Cycles|aggregate demand]] elasticity is simply a weighted average of individual investors’ demand elastic i ties:$$
...
The outside asset plays an important role in pinning down the equilibrium solution in this asset demand system. While this point is more general, let us consider a simple case in which there is one investor, one inside asset, and no outside asset. Then, regardless of the desirability of the asset, the [[An Asset Allocation Primer|portfolio]] share allocated towards this asset is always    $x_{t}=1$  . We also assume that the asset quantity is  $q_{t}=1$  and the asset pays no dividend. Then, the market clearing condition implies:$$
P_{t}=p_{t}q_{t}=a_{t}x_{t}=a_{t},
$$
And the investor’s [[Epstein-Zin Recursive Utility|wealth dynamics]] follows$$
A_{t}=a_{t-1}{\frac{p_{t}}{p_{t-1}}}+s_{t}.
$$
We assume the wealth  $a_{t-1}$   and the [[A Preview of Alternative Formulations|asset price]]  $p_{t-1}$   in the last period are both  1 . In this case, if the saving  $s_{t}\;=\; 0,$  , the market clearing condition and the investor’s [[Epstein-Zin Recursive Utility|wealth dynamics]] are consistent with any [[A Preview of Alternative Formulations|asset price]]  $p_{t}$  . If the saving  $s_{t}\,\neq\, 0$  , then, there will be no [[A Preview of Alternative Formulations|asset price]] that is consistent with the market clearing condition and the investor’s [[Epstein-Zin Recursive Utility|wealth dynamics]]. Both cases are pathological.
In comparison, if we add the outside option, the [[An Asset Allocation Primer|portfolio]] choice becomes$$
...
$$
And, assuming that the outside option pays no return, the investor’s [[Epstein-Zin Recursive Utility|wealth dynamics]] follows$$
A_{t}=a_{t-1}\left (\left (1-x_{t-1}\right)+x_{t-1}{\frac{p_{t}}{p_{t-1}}}\right)+s_{t}=\left (\left (1-x_{t-1}\right)+x_{t-1}p_{t}\right)+s_{t}.
$$
We assume  $\alpha~=~-1$   and    $x_{t-1}\;=\; 1/\sqrt{2}$  2. Then, this [[A Primer on Probability Theory and Stochastic  Modelling|system of equations]] has only one root with a positive [[A Preview of Alternative Formulations|asset price]], with,$$
P_{t}=\sqrt{2}-1,\qquad a_{t}=2-\sqrt{2},\qquad x_{t}=1/\sqrt{2},
$$
when  $s_{t}\,=\, 0$  , and, consistent with our intuition, the [[A Preview of Alternative Formulations|asset price]]  $p_{t}$  is increasing in the saving    $s_{t}$  . The [[Squam Lake Group Introduction|introduction]] of the outside asset makes the demand function for the book value of the inside asset downward-sloping in the [[A Preview of Alternative Formulations|asset price]], i.e.,$$
...
In this section, we consider a two-tier demand system that  Koijen and Yogo  [ 2020 ],  Jiang, Richmond, and Zhang  [ 2022 c , d ] use to study the [[Lecture Notes on International Finance|international financial]] market. We consider a simplified case in which there are only two countries and two asset classes.
...
$$
Where  $x_{n, t}(\ell)$   denotes the [[An Asset Allocation Primer|portfolio]] share of the entire asset class  $\ell,$  and  $x_{n, t}(\iota|\ell)$   denotes the [[An Asset Allocation Primer|portfolio]] share of the issuer country  $\iota$   within asset class    $\ell$  . This two-tier structure offers a richer structure to model the cross-sectional heterogeneity in the demand for different asset classes and countries separately.
...
$$
Captures the desirability of this asset    $(\iota,\ell)$  . We refer to the [[Forwards and Futures Notes|currency]] of the home country as the dollar. We use  $p_{t}(\iota,\ell)$   to denote the [[A Preview of Alternative Formulations|asset price]] in the local [[Forwards and Futures Notes|currency]] units, and  $e_{t}(\iota)$   to denote the log exchange rate of the local [[Forwards and Futures Notes|currency]] per dollar. Then,  $p_{t}(\iota,\ell)\exp (e_{t}(n)-e_{t}(\iota))$  captures the price of the asset from the issuer country    $\iota$   in the units of the local [[Forwards and Futures Notes|currency]] in the investor country    $n$  . For simplicity, we ignore the asset-specific characteristics  $\Xi_{t}(\iota)$  . We allow the latent demand  $\kappa_{n, t}(\iota,\ell)$   to be specific to the investor  $n$  .
...
$$
For all issuer country  $\iota$   representing the set of insider assets and asset class  $\ell$  . We do not impose a market clearing condition on the outside asset, which is assumed to have an infinitely elastic supply at a fixed local-[[The Foreign Exchange Market Annotations|currency price]] and desirability.
Finally, as emphasized by  Jiang, Richmond, and Zhang  [ 2022 c , d ], the investor country  $n$  ’s wealth responds endogenous ly to the [[Some Stylized Empirical Facts About Asset Retur|asset returns]]. Let    $a_{t}$   denote the dollar value of its wealth, which follows the following law of motion:$$
A_{n, t}=a_{n, t-1}\left (\sum_{\ell}\sum_{\iota\geq 0}x_{n, t-1}(\iota,\ell)\exp (r_{t}(\iota,\ell))\right)+s_{n, t},
$$
Where, for simplicity, we assume that the assets pay no dividends, and their dollar-denominated [[Assets|returns]] are given by their capital gains:$$
...
$$
We take the saving  $s_{n, t},$  , the asset quantity  $q_{t}(\iota,\ell)$  , and the latent demand  $\kappa_{n, t}(\iota,\ell)$   as exogenous ly given. The [[An Asset Allocation Primer|portfolio]] choices  $x_{n, t}(\iota,\ell),$  , the market clearing conditions, and the wealth law of motion jointly determine the equilibrium asset prices, exchange rates, and capital flows.
# 9 .D. 1 Macro Synthesis
We study the competitive equilibrium in which the [[An Asset Allocation Primer|portfolio]] choices follow the logit demand, the wealth follows the given law of motion, and the markets for all inside assets clear.
...
$$
The model implies the following  22  equations, including  8  for [[An Asset Allocation Primer|portfolio]] choices:$$
...
$$
Similarly, foreign households’ [[An Asset Allocation Primer|portfolio]] shares satisfy  $\begin{array}{r}{\sum_{\iota}x_{H, t}^{*}(\iota)+}\end{array}$   $\textstyle\sum_{\iota}x_{F, t}^{*}(\iota)\,=\, 1$   1. For simplicity, we will omit the foreign households’ expressions whenever they are symmetric.
We use  $a_{t}$   and    $a_{t}^{*}$    to denote the home and foreign households’ wealth. In this case, it is simpler to denote both in home [[Forwards and Futures Notes|currency]] units. We define the home households’ net foreign assets   $(n f a)$   as the difference between their holdings of foreign assets (i.e., their external assets) minus the foreigners’ holdings of their domestic assets (i.e., their external liabilities):$$
...
$$
Let    $p_{t}(\iota)$   and    $p_{t}^{*}(\iota)$   denote the asset prices, and let    $d i v_{t}(\iota)$   and  $d i v_{t}^{*}(\iota)$   denote the dividend or interest payouts, all in home [[Forwards and Futures Notes|currency]] terms. We use  $r_{t}(\iota)$   to denote the cum-dividend [[Assets|returns]] in log:$$
\exp (r_{t}(\iota))=\frac{p_{t}(\iota)+d i v_{t}(\iota)}{p_{t-1}(\iota)}.
$$
In this section, we further break down the cum-dividend [[Assets|returns]] into the ex-dividend component  $\rho_{t}(\iota)$   (i.e., capital gains) and the dividend yield component  ${d_{t}}(\iota)^{3}$  :$$
...
$$
3  Throughout the note, we use  $r_{t}$   to de- note [[Assets|returns]] in log. Here it is easier to deviate from this notational convention and instead use  $\rho_{t}$   and  $d_{t}$   to denote components of [[Assets|returns]] in level.
Intuitively, household wealth accumulates as a result of realized financial [[Assets|returns]] from existing positions as well as new financial savings added to their accounts. Let  $s_{t}$   denote the new financial savings from period    $t-1$   to    $t$   in home [[Forwards and Futures Notes|currency]] terms. Then, we obtain the standard law of motion for home household wealth:$$
...
Finally, let  $q_{t}(\iota)$   denote the notional quantity of the asset, and let  $m_{t}(\iota)$   denote the total market value (i.e., [[Price-to-Sales Ratios in Stock Valuation|market capitalization]]). The market clearing condition for each asset can be expressed as$$
...
market. If we also take a stance on how the households decide their [[An Asset Allocation Primer|portfolio]] shares    $x_{H, t}$   and  $x_{F,t.}$  , then, we can solve the equilibrium asset prices, household wealth and, household [[An Asset Allocation Primer|portfolio]] positions.  Jiang, Richmond, and Zhang  [ 2022 c ] provides one such example in which the [[An Asset Allocation Primer|portfolio]] allocation decisions are modeled by demand systems.
...
$$
And this equation is known as the  [[The Balance of Payments|balance of payments]] identity . In this equation,    $t b$   denotes the trade balance,  $i b$   the income balance, and    $c g$  the capital gains.
All of these balance of payment items are connected to our investor [[An Asset Allocation Primer|portfolio]] formulation above. In particular, the income balance captures earnings on foreign investments minus payments made to foreign investors:$$
...
We have the following result that maps the standard elements in the [[The Balance of Payments|balance of payments]] identity to d is aggregated bilateral [[An Asset Allocation Primer|portfolio]] choices.
...
• First, [[Primary Issuance and Secondary Resale Markets|asset markets]] can be segmenta ted between countries. Local households may not be able to directly hold foreign assets, and they rely on financiers to intermediate the cross-border capital flows. The financiers face financial constraints, which connect the [[An Asset Allocation Primer|portfolio]] imbalances they have to absorb to the risk premium they charge on foreign assets and currencies for providing this inter mediation service.
• Second, [[Primary Issuance and Secondary Resale Markets|asset markets]] can be segmented within a country. Some households may not have access to the [[Financial Markets and Institutions Lecture Notes|financial markets]], which disconnects the [[Pareto-Optimality in Some Incomplete Markets|aggregate consumption]] from the [[Arbitrage Pricing of Derivatives|pricing]] of financial assets and exchange rates.
10 .A A Model of [[Lecture Notes on International Finance|International Financial]] Inter mediation
In this section, we consider an international real [[Business Cycles- Introduction, Characteristics, and History|business cycle]] (IRBC) model in which home and foreign households cannot trade any assets directly with each other, and specialized financiers are required to intermediate the cross-border capital flows. This model is adapted from  Itskhoki and Mukhin  [ 2021 ], whose key mechanism builds on  Jeanne and Rose  [ 2002 ],  Gabaix and Maggiori  [ 2015 ]. This model extends our baseline model in Chapter  1  in two ways. First, it replaces the endowment economy with a production economy, with standard features such as capital accumulation. Second, and more importantly, it models segmented markets and [[Financial Intermediation as Delegated Monitoring|financial intermediation]].
10 .A. 1 Households
...
We use the home households’ consumption bundle as the numéraire. Recall that  $p_{t}$   is the price of the home good in this numéraire. We use  $k_{t}$   to denote the capital stock,  $z_{t}$   to denote the households’ gross [[An Asset Allocation Primer|investment]],  $q_{t}$   to denote the rental rate of capital. The home households’ budget constraint is$$
...
The noise traders buy and sell currencies to satisfy their [[Class Note 10 Liquidity and Class Note 10 Liquidity and Liquidity Managementliquidity management|liquidity]] demand. We assume that there is a measure    $n$   of identical noise traders. In period    $t,$   they hold  $n_{t}$   units of the home risk-free bond and  $n_{t}^{*}$    units of the foreign risk-free bond. They have a zero-cost [[An Asset Allocation Primer|portfolio]], which means their positions in the home and foreign bonds have the same market value with opposite signs:$$
...
$$
Where    $r x_{t+1}\stackrel{\mathrm{def}}{=}\Delta e_{t+1}+r_{t}-r_{t}^{\ast}$   −   is the home [[Forwards and Futures Notes|currency]]’s [[Theoretical Factors|expected excess return]] in log.  Itskhoki and Mukhin  [ 2021 ] consider the continuoustime limit of this problem, in which the optimal solution is given by$$
D_{t}^{*}=-\frac{\mathbb{E}_{t}\big[r x_{t+1}\big]+\frac{1}{2}v a r_{t}\big (\Delta e_{t+1}\big)}{\omega v a r_{t}\big (\Delta e_{t+1}\big)},
$$
This solution is identical to the myopic investors’ optimal [[An Asset Allocation Primer|portfolio]] choice we derived in Section  9 . 2 . Eq. ( 10 . 3 ) connects the [[Forwards and Futures Notes|currency]]’s [[Theoretical Factors|expected excess return]] to the financiers’ [[An Asset Allocation Primer|portfolio]] position. These financiers absorb excess positive or negative positions in the bond market, and they charge a risk premium for providing this service. In particular, if they have a positive position in the home bond and a negative position in the foreign bond (i.e.,  $d_{t}^{*}<0,$   0), they demand a higher [[Lecture 1- Probability Distributions of Returns|expected return]] on the home bond to earn a positive [[Lecture 1- Probability Distributions of Returns|expected return]] on their [[An Asset Allocation Primer|portfolio]]. Conversely, if they have a negative position in the home bond and a positive position in the foreign bond (i.e.,  $d_{t}^{*}\,>\, 0,$   0), they demand a higher [[Lecture 1- Probability Distributions of Returns|expected return]] on the foreign bond to earn a positive [[Lecture 1- Probability Distributions of Returns|expected return]] on their [[An Asset Allocation Primer|portfolio]]. In this way, their optimality condition ( 10 . 3 ) implies a tight link between their [[An Asset Allocation Primer|portfolio]] position and the [[Forwards and Futures Notes|currency]]’s [[Lecture 1- Probability Distributions of Returns|expected return]].
This mechanism of inter mediation in the [[Forwards and Futures Notes|currency]] market follows from  Gabaix and Maggiori  [ 2015 ], who provide a different microfoundation in which these [[Bid-Ask Prices with Adverse SelectionPrivate Information|liquidity traders]] are risk-neutral but face a financial friction to incur [[An Asset Allocation Primer|portfolio]] imbalances, and this friction is greater when the exchange rate is more volatile. This setting gives rise to an expression similar to Eq. ( 10 . 3 ).
With this optimality condition, we can derive the [[Forwards and Futures Notes|currency]] [[Theoretical Factors|expected excess return]] in equilibrium.
Proposition  10 . 1 .  After log-linear iz ation, the [[Forwards and Futures Notes|currency]] [[Theoretical Factors|expected excess return]] is given by$$
...
$$
The proof is in Appendix  A. 40 . This proposition relates the required excess return to hold the home [[Forwards and Futures Notes|currency]] to the equilibrium quantity of imbalances absorbed that the financiers need to absorb, which, by market clearing, is further determined by the bond demand of the noise traders   $\left (\psi_{t}\right)$   and that of the local households  $b_{H, t}$  .
Moreover, we can derive an [[Lecture Notes on International Finance|exchange rate accounting]] formula similar to Proposition  4 . 2 . In this log-linearized model, as we ignore the second-order terms, we effectively attribute all [[Forwards and Futures Notes|currency]] expected excess [[Assets|returns]] to the Euler equation wedge as opposed to the [[Forwards and Futures Notes|currency]] risk premium. We obtain$$
...
$$
Since the intermediary holds a zero-cost bond [[An Asset Allocation Primer|portfolio]] (see Eq. ( 10 . 1 )), and so does the noise traders (see Eq. ( 10 . 2 )), and the bonds are in zero supply, then, the market clearing condition implies that the home and foreign households combined must also hold a zerocost bond [[An Asset Allocation Primer|portfolio]]:$$
...
$$
The model implies the following  $\mathbf{x}$   equations in each period, one of which is redundant because the market clearing adds up to the sum of households’ [[The One-Period Framework|budget constraints]]. These  28  equations include  2 consumption aggregation equations,$$
...
$$
2  [[The One-Period Framework|budget constraints]] for households,$$
...
$$
Both Eq. ( 10 . 8 ) and Eq. ( 10 . 9 ) add a wedge to the [[Exchange Rates and the Foreign Exchange Market- An Asset Approach|exchange rate dynamics]], which breaks the tight link between the exchange rate and the households’ marginal utilities. The difference is that, in the model with market segmentation, the wedge is driven by the [[An Asset Allocation Primer|portfolio]] imbalances born by the financiers, whereas in the model with convenience yields, the wedge is driven by the households’ demand for safe assets.
...
# 10 .B. 3 Other Works
Bruno and Shin  [ 2015 a , b ] emphasize the role of global banks, who tap dollar funding from financial centers and lend to local banks in foreign countries. When the dollar appreciates, [[Forwards and Futures Notes|currency]] mismatch weakens the local banks’ balance sheets and contracts their risktaking capacity. As a result, the dollar’s strength impacts global financial conditions and generates dollar shortage in foreign countries. Greenwood, Hanson, Stein, and Sunderam  [ 2020 ],  Gourinchas, Ray, and Vayanos  [ 2022 ] develop models with financiers who trade in both the [[Forwards and Futures Notes|currency]] market and the home and foreign long-term bond markets. The variation in their risk-taking capacity leads to co movements in exchange rates and bond term premia.
The deviation from [[Financial Instruments PSET Solutions|covered interest rate parity]] as we discussed in Section  2 .A. 6  is also a natural place to consider market segmentation and financial inter mediation. The key mechanism usually involves constrained financiers and other sectors’ imbalanced [[Key Rates O1s Durations and Hedging|hedging]] demand [ Borio, Iqbal, McCauley, McGuire, and Sushko ,  2018 ,  Andersen, Duffie, and Song ,  2019 ,  Avdjiev, Du, Koch, and Shin ,  2019 ,  Liao and Zhang ,  2020 ,  Amador, Bianchi, Bocola, and Perri ,  2020 ,  Cenedese, Della Corte, and Wang ,  2021 ,  Rime, Schrimpf, and Syrstad ,  2022 ]
The presence of financial frictions also makes it possible for the [[Squam Lake Group Introduction|policy interventions]] to improve outcomes and mitigate frictions. See Fanelli and Straub  [ 2020 ],  Bocola and Lorenzoni  [ 2020 ],  Itskhoki and Mukhin  [ 2022 ]. In the context of the model in Section  10 .A , if the policymaker can lower the exchange rate volatility, or at least convince the financiers that the policy maker is committed to interventions that lower the exchange rate volatility, then, the financiers will require a lower [[Forwards and Futures Notes|currency]] risk premium to absorb a given amount of [[An Asset Allocation Primer|portfolio]] imbalances, which, by Eq. ( 10 . 4 ), will indeed make the exchange rate less volatile.
# 10 .C A Model of Domestic Financial Inter mediation
Next, we consider a different type of inter mediation, which focuses on the market segmentation within a country. To be clear, the  2008 [[8. Credit Modeling and Credit Derivatives|global financial crisis]] has spurred a large macro-finance literature on domestic financial inter mediation. What we focus on here is only one specific type that is useful for thinking about [[Exchange Rates and the Foreign Exchange Market- An Asset Approach|exchange rate dynamics]].
...
$$
2  inactive households’ [[The One-Period Framework|budget constraints]],$$
...
Assume the households have [[The Simple Multi-Period Ccapm|CRRA utility]] with parameter    $\gamma$  . Below, we take the steady state variables as given and  $\log$   linearize the system, which includes  4  consumption aggregation equations,$$
...
$$
We can easily solve this system of linear equations. The solutions are given by the following proposition. For convenience, we define each country’s [[Pareto-Optimality in Some Incomplete Markets|aggregate consumption]] as  $c_{t}=\phi c_{t}(a)+(1-\phi) c_{t}(i)$  and    $c_{t}^{*}=\phi c_{t}^{*}(a)+(1-\phi) c_{t}^{*}(i)$   − .
...
$$
The proof is in Appendix  A. 41 . This model separates the exchange rate and the [[Pareto-Optimality in Some Incomplete Markets|aggregate consumption]] by introducing market segmentation. On the one hand, as the active households have access to the [[Financial Mathematics Course|complete markets]], their [[Long-Run Risks and Epstein-Zin Utility|consumption growth]] is tightly connected to the exchange rate movement. On the other hand, the inactive households are insulated from the [[Financial Markets and Institutions Lecture Notes|financial markets]]. However, their consumption still accounts for a large share of the [[Pareto-Optimality in Some Incomplete Markets|aggregate consumption]], leading to a disconnect between the [[Pareto-Optimality in Some Incomplete Markets|aggregate consumption]] and the exchange rate.
...
Proposition  10 . 3 .  Under these additional assumptions, the exchange rate and the [[Exercises|aggregate consumption growth]] differential can be expressed as$$
...
$$
The proof is in Appendix  A. 42 . If there is no inactive households, i.e.,  $\phi\:=\: 1.$  , then, the [[Long-Run Risks and Epstein-Zin Utility|consumption growth]] and exchange rate are perfectly correlated:    $c o r r_{t}\big (\hat{e}_{t+1},\hat{c}_{t+1}^{*}-\hat{c}_{t+1}\big)\ =\ 1$     1. We obtain the complete-market benchmark in which a low home [[Long-Run Risks and Epstein-Zin Utility|consumption growth]] is associated with a high home marginal utility growth and thus a home [[Forwards and Futures Notes|currency]] appreciation.
...
In this case, the model resolves the Backus-Smith puzzle by reinterpreting the cyclical it y of the households’ marginal utilities: a high endowment shock for the entire country is actually a bad, high marginal utility state for the  active  households who are the marginal investors in the [[Forwards and Futures Notes|currency]] market, even though it is good news for the  average  household which includes the inactive households. As a result, while the Backus-Smith correlation is still positive for the active households’ consumption, it is negative for the [[Pareto-Optimality in Some Incomplete Markets|aggregate consumption]]. As this difference in the cyclical it y of household marginal utility is central to the model’s mechanism, it would be interesting to empirically identify the active and inactive households and examine the properties of their profits, losses, and consumption.
This view also implies that the active households to have the opposite cyclical it y in their marginal utility growth relative to the domestic [[Business Cycles- Introduction, Characteristics, and History|business cycle]]. These active households usually represent [[Financial Intermediation as Delegated Monitoring|financial intermediaries]] who invest in the risky assets on behalf of the inactive households. According to  Hassan  [ 2013 ]’s interpretation, the active households underwrite a nominal risk-free bond denominated in the local [[Forwards and Futures Notes|currency]] to the inactive households. In good times, low [[War Economies and Hyperinflation|inflation]] makes the nominal bond valuable, which benefits the inactive households at the expense of the active households. If the active households are sufficiently levered, then, they could lose wealth in good times, leading to a pro cyclical marginal utility with respect to the domestic [[Business Cycles- Introduction, Characteristics, and History|business cycle]].  Alvarez, Atkeson, and Kehoe  [ 2002 ,  2009 ] provide a micro foundation for this dynamics, in which the identities of active and inactive households are endogenous ly determined by the households’ holdings.
# 10 .C. 5 Other Works
Market segmentation and financial inter mediation have been studied extensively in the macro-finance literature.  He and Krishna mur thy [ 2013 ],  Brunner meier and Sannikov  [ 2014 ] present two prominent models of financial frictions in closed economies. In the international literature,  Chien and Naknoi  [ 2015 ] propose a segmented market model in which not all households can participate in the equity market, but the participation rate is higher in the U.S.  Maggiori  [ 2017 ] also considers a model with credit constraints for [[Financial Intermediation as Delegated Monitoring|financial intermediaries]], in which the U.S. intermediaries are less constrained. In these models, the U.S. as a whole loads up more aggregate risk than the foreign country, which speaks to the asymmetry in global [[An Asset Allocation Primer|portfolio]] allocation we discussed in Chapter  7 .  Chien, Lustig, and Naknoi [ 2020 ] use a similar segmented market mechanism to resolve the exchange rate volatility puzzle we discussed in Section  2 .A. 1 , that the exchange rate movement can be smooth even when the SDFs are volatile and the macro [[Week 2 Fundamentals Of Forecasting|fundamentals]] are only weakly correlated, and  Dou and Verdelhan  [ 2015 ] use segmented markets to explain the volatility of international capital flows.  Fang and Liu  [ 2021 ] also consider a two-country model with within-country [[Financial Intermediation as Delegated Monitoring|financial intermediation]], with the key ingredient being the value-at-risk (VaR) constraint. The model speaks quantitatively to the exchange rate volatility, cyclicality, risk premium, and the deviations from the [[Financial Instruments PSET Solutions|covered interest rate parity]].
Jiang and Richmond  [ 2023 b ] introduce global production network to this model with active and inactive households. The transfer shock from active to inactive households can be interpreted as a demand shock that is transmitted in the [[International Trade Banking and Capital Markets Lecture Notes|global trade]] network, which, as we saw in Section  3 .C , plays an important role in shaping the comovements of exchange rates.
...
$$
Which shows that  $\beta_{t}^{i}$    is the [[Currency Carry Trade|carry trade]] loading on    $h m l_{t+1}$
...
Proof.  Assuming [[Financial Mathematics Course|complete markets]], the real exchange rate movement is$$
...
$$
And the [[Forwards and Futures Notes|currency]] risk premium is$$
...
$$
We can apply a [[Convexity|first-order approximation]] at    $d=0$  , and obtain$$
...
Proof.  The covariance of [[Long-Run Risks and Epstein-Zin Utility|consumption growth]] follows directly from Eq. ( 3 . 11 ):$$
c o v\big (\Delta\log\overline {{c}} _{t}^{i},\Delta\log\overline {{c}} _{t}^{j}\big)=\mathcal{C}\big (i, j\big).
$$
The moments of exchange rates follow from the covariance of [[Long-Run Risks and Epstein-Zin Utility|consumption growth]]. In particular, the covariance between the changes in [[Forwards and Futures Notes|currency]] base factors is$$
...
$$
As shown in Section  1 .B , the log interest rate and [[Forwards and Futures Notes|currency]] risk premium are given by:$$
...
Proof.  ( 1 ) The first-order condition for the home household’s [[An Asset Allocation Primer|portfolio]] choice problem ( 5 . 2 ) is:$$
\exp\!\big ({-}\delta t\big)\frac{\gamma_{t}}{c_{t}}=\zeta_{H}\exp\!\big (m_{\nu_{H}, t}\big),
$$
Where the Lagrange multiplier  $\zeta_{H}$   is such that the budget constraint evaluated at the [[Dynamic Programming|optimal consumption]] expenditure,  $c_{t},$   is satisfied with equality:$$
...
$$
( 2 ) Let  $\lambda_{t}^{*}$    denote the [[Exercises|market price of risk]] from the viewpoint of a foreign consumer in the foreign numéraire:$$
...
Then, we can write foreign household’s static variation al [[An Asset Allocation Primer|portfolio]] choice problem in their local numéraire:$$
...
$$
The first-order condition for the foreign household’s [[An Asset Allocation Primer|portfolio]] choice problem is:$$
\exp (-\delta t)\frac{\gamma^{*}}{c_{t}^{*}}=\zeta_{F}\exp\bigl (m_{\nu_{F}^{*}, t}^{*}\bigr),
$$
Where   $\exp (m_{\nu_{F}^{*}, t}^{*})$   denotes the foreign country state price density that bounds all the [[The One-Period Framework|budget constraints]], and the Lagrangian multiplier    $\zeta_{F}$  is such that the budget constraint evaluated at the [[Dynamic Programming|optimal consumption]] expenditure  $c_{t}^{*}$    is satisfied with equality$$
...
Proof.  ( 1 ) By no [[Arbitrage Pricing of Derivatives|arbitrage]], home household’s wealth in the home numéraire at time  $t$   is:$$
...
$$
Notice that in [[Lecture Notes on International Finance|incomplete markets]], the matrix    $\sigma_{t}^{\prime}\sigma_{t}$   is not a full-rank square matrix, and the above [[A Primer on Probability Theory and Stochastic  Modelling|system of equations]] contains three equations in one unknown. It has a solution if and only if its righthand side lies in the   $\mathtt{S p a n}(\sigma_{t})$  . This implies a restriction:$$
...
$$
To obtain the optimal [[An Asset Allocation Primer|portfolio]] of the home country household, we apply the operator  $-\frac{\sigma_{t}^{\prime}}{|\sigma_{t}|^{2}}$   to both sides of ( A. 10 ). | |$$
...
$$
For the foreign households, the first-order condition for the foreign household’s static variation al [[An Asset Allocation Primer|portfolio]] choice problem in the home numéraire is:$$
\exp\!\big (-\delta t\big)\frac{\gamma^{*}}{\tilde{c}_{t}^{*}}=\tilde{\zeta}_{F}\exp\!\big (m_{\tilde{\nu}_{F}, t}\big),
$$
Where   $\exp\!\big (m_{\tilde{\nu}_{F}, t}\big)$   denotes an appropriate home country state price density that bounds all the [[The One-Period Framework|budget constraints]] of the foreign household, and  $\tilde{\zeta}_{F}$   is the Lagrange multiplier such that the budget constraint evaluated at the [[Dynamic Programming|optimal consumption]] expenditure,  $\tilde{c}_{t}^{*}.$  , is satisfied with equality:$$
E\left[\int_{0}^{T}\exp (m_{\tilde{\nu}_{F}, t})\big (\tilde{c}_{t}^{*}-p_{t}^{*}\exp (-e_{t}) y_{t}^{*}\big) d t\right]=\tilde{w}_{0}^{*}.
$$
By no [[Arbitrage Pricing of Derivatives|arbitrage]], foreign household’s wealth in the home numéraires at time  $t$   is:$$
...
$$
In [[Lecture Notes on International Finance|incomplete markets]], the matrix  $\sigma_{t}^{\prime}\sigma_{t}$   has a solution if and only if its right hand side lies in Span  $(\sigma_{t})$  . This entails a restriction:$$
...
$$
where we apply operator  $\left (I_{3}-\frac{\sigma_{t}^{\prime}\sigma_{t}}{\|\sigma_{t}\|^{2}}\right)$   to both sides of ( A. 14 ). ∥ ∥ To get the optimal [[An Asset Allocation Primer|portfolio]] choice for the foreign household, we apply the operator  $\frac{\hat{\sigma_{t}^{\prime}}}{\lVert\sigma_{t}\rVert^{2}}$   from right to both sides of ( A. 14 ).$$
...
$$
We substitute the solutions of  $c_{H, t}, c_{F, t}, c_{H, t}^{*}, c_{F, t}^{*}$    into the above gradients of    $\nabla u\left (c_{H, t}, c_{H, t}^{*}\right)$    to get the state price density that bound all the [[The One-Period Framework|budget constraints]] of the home consumers.$$
...
Similarly, we can then derive the home country state price density that bounds all the [[The One-Period Framework|budget constraints]] of the foreign consumers as:$$
...
$$
Therefore, the foreign [[Chapter 16 - Black–Scholes Model|stock price]] in the foreign numéraire is:$$
...
$$
There are two ways to proceed in evaluating the above conditional [[FORWARD RATES AND TERM STRUCTURE|expectations]]. The first is to assume that  $\pi$   is a martingale and then verify that it is indeed the case in equilibrium. However, lowe can only prove that it is a local martingale. In special cases, we can impose some other regularity conditions on the [[Utility Indices|preference]] shifts to guarantee that    $\pi_{t}$   is a martingale but, in general, it is not an immediate result. An alternative approach is to use the following, less direct, argument based on market clearing. Plug the first-order conditions$$
...
$$
Then, we can conclude that the home [[Chapter 16 - Black–Scholes Model|stock price]] in the home numéraire is:$$
...
$$
Plug in Eq. ( A. 22 ) and ( A. 23 ) to obtain the [[Black-Scholes Model|drift and volatility]] of [[Verifying Martingale Property with Q|stock price dynamics]]$$
...
$$
( 4 ) The [[Interest Rate Quotations|interest rates]] and the home country [[Exercises|market price of risk]] processes can be derived from the dynamics of  $\exp\!\big (m_{\nu_{H}, t}\big)$  . We apply Ito’s Lemma to  $\exp\!\big (m_{\nu_{H}, t}\big)$   and match its drift and diffusion terms to obtain  $r_{t}$   and  $\lambda_{t}$  .$$
...
$$
Matching the [[Black-Scholes Model|drift and volatility]] terms of the log exchange rate, we have$$
...
$$
Under [[Financial Mathematics Course|complete markets]], we have a unique home country state price density:$$
...
$$
Then, the [[Exchange Rates and the Foreign Exchange Market- An Asset Approach|exchange rate dynamics]] is back in the benchmark [[Financial Mathematics Course|complete markets]] case:$$
D e_{t}^{c m}=d m_{t}^{c m}-d m_{t}^{*, c m}
$$
...
$$
Then, the [[A Primer on Probability Theory and Stochastic  Modelling|system of equations]] becomes$$
...
$$
Multiply both sides by nominal SDF  $\exp\bigl (M_{t+1}\bigr)$   and take [[FORWARD RATES AND TERM STRUCTURE|expectations]] conditional on time  $t$  :$$
...
$$
Where we use the [[Fixed Income Asset Pricing|asset pricing]] equations    $\mathbb E_{t}[\exp (M_{t+1})]=P_{t}(1),$  , and  $\mathbb{E}_{t}[\exp (M_{t+1}) P_{t+1}(h-1)]=P_{t}(h).$  . Similarly, the time  $t+2$   constraints imply:$$
...
$$
We use  $\chi_{t}$   as an indicator for default. The [[The One-Period Framework|budget constraints]] now become:$$
...
$$
Multiply both sides by nominal SDF  $\exp\!\left (M_{t+1}\right)$   and take [[FORWARD RATES AND TERM STRUCTURE|expectations]] conditional on time  $t$  :$$
\sum_{h=1}^{H}Q_{t}(h) P_{t}(h)=\mathbb{E}_{t}\left[\exp (M_{t+1}) S_{t+1}\right]+\mathbb{E}_{t}\left[\exp (M_{t+1})\sum_{h=1}^{H}Q_{t+1}(h) P_{t+1}(h)\right]
$$
Where we use the [[Fixed Income Asset Pricing|asset pricing]] equations    $\mathbb E_{t}[\exp (M_{t+1})(1-\chi_{t+1})]=$   $P_{t}(1)$  , and    $\mathbb{E}_{t}[\exp (M_{t+1}) P_{t+1}(h-1)(1-\chi_{t+1})]=P_{t}(h)$  .
...
$$
Where we use the [[Fixed Income Asset Pricing|asset pricing]] equations    $\mathbb E_{t}[\exp (M_{t+1})(1-\chi_{t+1})]=$   $P_{t}(1) e^{-\lambda_{t}(1)}$  , and  $\mathbb E_{t}[\exp (M_{t+1}) P_{t+1}(h-1)(1-\chi_{t+1})]=P_{t}(h) e^{-\lambda_{t}(h)}.$  .
Similarly, consider the time    $t+2$   budget constraint. Multiply both sides by nominal SDF  $\exp\!\left (M_{t+1, t+2}\right)$   and take [[FORWARD RATES AND TERM STRUCTURE|expectations]] conditional on time  $t+1$  :$$
...
$$
Is true for  $n~=~\ell$  . For  $n\ =\ \ell+1,$  , consider the time    $t+\ell+1$  budget constraint. Similarly, multiply both sides by nominal SDF  $\exp (M_{t+\ell, t+\ell+1})$   and take [[FORWARD RATES AND TERM STRUCTURE|expectations]] conditional on time    $t+\ell$  :$$
...
$$
Divide both sides by  $D_{t}$   and take [[FORWARD RATES AND TERM STRUCTURE|expectations]] to get part (a). Similarly,$$
...
(b) Denote the time t log [[Lecture 4- Investor Sentiment|price-dividend ratio]] on the stock dividend strip that pays    $D i v_{t+h}$   at time    $t+h$   as  $p d_{t}^{m}(h)$  . The Euler equation is$$
\exp (p d_{t-1}^{m}(h+1))=\mathbb{E}_{t}[\exp (M_{t}+p d_{t}^{m}(h)+\Delta\log D i v_{t})],
$$
where  $\Delta\log D i v_{t}\,=\,\Delta\log d_{t}+x_{t}+\pi_{t},$   i.e., the log nominal divi- dend growth is the sum of the log growth of dividend-GDP ratio, log growth of real GDP and [[War Economies and Hyperinflation|inflation]]. Conjecture that$$
P d_{t}^{m}(h)=A^{m}(h)+B^{m}(h)^{\prime}z_{t}.
$$
...
$$
The [[Lecture 1- Probability Distributions of Returns|expected return]] of holding the long-term bond from time  $t$   to  $t+1$   is$$
...
expectation term in the objective function, the optimal [[An Asset Allocation Primer|portfolio]] can be solved for independently of the [[Dynamic Programming|optimal consumption]], i.e.$$
...
Proof.  When the [[Some Stylized Empirical Facts About Asset Retur|asset returns]] are i.i.d., the optimal [[An Asset Allocation Primer|portfolio]] choice is given by$$
...
$$
Next, consider the inactive households’ consumption aggregation equations their within-period solution and plug in their [[The One-Period Framework|budget constraints]] to get:$$
...
Arash Aloosh and Geert Bekaert. [[Forwards and Futures Notes|Currency]] factors.  Management Science ,  2021 .
...
Fernando Alvarez, Andrew Atkeson, and Patrick J Kehoe. Money, [[Interest Rate Quotations|interest rates]], and exchange rates with endogenous ly segmented markets.  Journal of political Economy ,  110 ( 1 ): 73 – 112 ,  2002 .
Fernando Alvarez, Andrew Atkeson, and Patrick J Kehoe. If exchange rates are random walks, then almost everything we say about [[The Economist Regime Change|monetary policy]] is wrong.  American Economic Review ,  97 ( 2 ): 339 – 345 ,  2007 .
Fernando Alvarez, Andrew Atkeson, and Patrick J Kehoe. Timevarying risk, [[Interest Rate Quotations|interest rates]], and exchange rates in general equilibrium.  The Review of Economic Studies ,  $7^{6\left (3\right): 8}5^{1-8}7^{8},$  ,  2009 .
...
Andrew Ang and Monika Piazzesi. A no-[[Arbitrage Pricing of Derivatives|arbitrage]] vector autoregres- sion of [[The Gauss Model|term structure dynamics]] with macroeconomic and latent variables.  Journal of Monetary economics ,  50 ( 4 ): 745 – 787 ,  2003 .
Cristina Arellano. [[Default Risk and Credit Derivatives 183|Default risk]] and income fluctuations in emerging economies.  American economic review ,  98 ( 3 ): 690 – 712 ,  2008 .
...
Patrick Augustin, Mikhail Chernov, Lukas Schmid, and Dongho Song. The [[The Vasicek Model|term structure]] of cip violations. Technical report, National Bureau of Economic Research,  2020 .
Patrick Augustin, Mikhail Chernov, Lukas Schmid, and Dongho Song. Benchmark [[Interest Rate Quotations|interest rates]] when the government is risky. Journal of Financial Economics ,  140 ( 1 ): 74 – 100 ,  2021 .
...
Stefan Avdjiev, Wenxin Du, Catherine Koch, and [[Reflections On Modern Bank Runs a Case Study of Northern Rock|Hyun Song Shin]]. The dollar, bank [[Lecture 6-Leverage, Tail Risk, Volatility Products|leverage]], and deviations from [[Interest Rates, Carry Trades, and Exchange Rate Movements|covered interest parity]].  American Economic Review: Insights ,  1 ( 2 ): 193 – 208 ,  2019 .
Kerry Back.  [[Fixed Income Asset Pricing|Asset pricing]] and [[An Asset Allocation Primer|portfolio]] choice theory . Oxford University Press,  2010 .
David Backus, Nina Boyar chen ko, and Mikhail Chernov. Term structures of asset prices and [[Assets|returns]].  Journal of Financial Economics ,  129 ( 1 ): 1 – 23 ,  2018 .
...
David K Backus, Silverio Foresi, and Chris I Telmer. [[SOFR Derivative Pricing Using a Short Rate Model|Affine term structure models]] and the forward premium anomaly.  The Journal of Finance ,  56 ( 1 ): 279 – 304 ,  2001 .
Jennie Bai and Pierre Collin-Dufresne. The cds-bond basis.  Financial Management ,  48 ( 2 ): 417 – 439 ,  2019 .
Ravi Bansal and Ivan Sh alias to vich. [[Lecture 7-Risk and Return of Bonds|Risk and return]] in bond, [[Forwards and Futures Notes|currency]] and [[An Introduction to Equity Markets|equity markets]].  Manuscript, Duke University ,  2007 .
Ravi Bansal and Ivan Sh alias to vich. A long-run risks explanation of predictability puzzles in bond and [[Forwards and Futures Notes|currency]] markets.  The Review of Financial Studies ,  26 ( 1 ): 1 – 33 ,  2013 .
...
Katharina Bergant, Gian Maria Milesi-Ferretti, and Martin Schmitz. Cross-Border [[An Asset Allocation Primer|Investment]] in Emerging Market Bonds: Stylized Facts and Security-Level Evidence from Europe . Centre for Economic Policy Research,  2023 .
...
Steven T Berry. Estimating discrete-choice models of [[Porter's Five Forces|product differentiation]].  The RAND Journal of Economics , pages  242 – 262 ,  1994 .
Olivier Blanchard. Public debt and [[The Economist Time Is Cheap|low interest rates]].  American Economic Review ,  109 ( 4 ): 1197 – 1229 ,  2019 .
...
Claudio EV Borio, Mobeen Iqbal, Robert N McCauley, Patrick McGuire, and Vladyslav Sushko. The failure of [[Interest Rates, Carry Trades, and Exchange Rate Movements|covered interest parity]]:   $\mathrm{Fx}$   [[Key Rates O1s Durations and Hedging|hedging]] demand and costly balance sheets.  2018 .
Michael W Brandt, John H Cochrane, and Pedro Santa-Clara. International [[Purpose and Structure of Financial Markets 1|risk sharing]] is better than you think, or exchange rates are too smooth.  Journal of Monetary Economics ,  53 ( 4 ): 671 – 698 ,  2006 .
...
Valentina Bruno and [[Reflections On Modern Bank Runs a Case Study of Northern Rock|Hyun Song Shin]]. Capital flows and the risktaking channel of [[The Economist Regime Change|monetary policy]].  Journal of monetary economics ,  71 : 119 – 132 ,  2015 a.
Valentina Bruno and [[Reflections On Modern Bank Runs a Case Study of Northern Rock|Hyun Song Shin]]. Cross-border [[HKS The Banking Industry|banking]] and global [[Class Note 10 Liquidity and Class Note 10 Liquidity and Liquidity Managementliquidity management|liquidity]].  The Review of Economic Studies ,  82 ( 2 ): 535 – 564 , 2015 b.
Craig Burnside, Martin Eichenbaum, and Sergio Rebelo. Prospective deficits and the [[The Battle to Defend Hong Kong’s Financial Stability|asian currency crisis]].  Journal of political Economy , 109 ( 6 ): 1155 – 1197 ,  2001 .
Craig Burnside, Martin Eichenbaum, and Sergio Rebelo. Government finance in the wake of [[Forwards and Futures Notes|currency]] crises.  Journal of Monetary Economics ,  53 ( 3 ): 401 – 440 ,  2006 .
Craig Burnside, Martin Eichenbaum, and Sergio Rebelo. [[Forwards and Futures Notes|Currency]] crises models. In  [[HKS The Banking Industry|Banking]] Crises: Perspectives from The New Palgrave Dictionary , pages  79 – 83 . Springer,  2016 .
...
Ricardo J Caballero, Emmanuel Farhi, and Pierre-Olivier Gourinchas. [[Lecture Notes on International Finance|Global imbalances]] and policy wars at the zero lower bound.  The Review of Economic Studies ,  88 ( 6 ): 2570 – 2621 ,  2021 .
John Y Campbell and Richard H Clarida. The dollar and [[Real Interest Rates and Aggregate Production|real interest rates]]. In  Carnegie-Rochester Conference Series on Public Policy , volume  27 , pages  103 – 139 . Elsevier,  1987 .
John Y Campbell and Robert J Shiller. The dividend-price ratio and [[FORWARD RATES AND TERM STRUCTURE|expectations]] of future dividends and discount factors.  The Review of Financial Studies ,  1 ( 3 ): 195 – 228 ,  1988 .
John Y Campbell and Luis M Viceira.  Strategic [[Lecture 2- Asset Allocation with Multiple Risky Assets|asset allocation]]: [[An Asset Allocation Primer|portfolio]] choice for long-term investors . Clarendon Lectures in Economic,  2002 .
Nicolas Caramp and Sanjay R Singh. Bond premium cyclical it y and [[Class Note 10 Liquidity and Class Note 10 Liquidity and Liquidity Managementliquidity management|liquidity]] traps.  Available at SSRN  3529769 ,  2020 .
Gino Cenedese, Pasquale Della Corte, and Tianyu Wang. [[Forwards and Futures Notes|Currency]] mispricing and dealer balance sheets.  The Journal of Finance ,  76 ( 6 ): 2763 – 2803 ,  2021 .
Thomas Chaney. The network structure of [[Chapter 2-The Principle Of Comparative Advantage|international trade]].  American Economic Review ,  104 ( 11 ): 3600 – 3634 ,  2014 .
Zefeng Chen and Zhengyang Jiang. The [[Class Note 10 Liquidity and Class Note 10 Liquidity and Liquidity Managementliquidity management|liquidity]] premium of digital payment vehicle.  Available at SSRN  4006574 ,  2022 .
...
Mikhail Chernov and Drew Creal. International yield curves and [[Forwards and Futures Notes|currency]] puzzles.  The Journal of Finance ,  78 ( 1 ): 209 – 245 ,  2023 .
...
YiLi Chien and Kanda Naknoi. The risk premium and long-run [[Lecture Notes on International Finance|global imbalances]].  Journal of Monetary Economics ,  76 : 299 – 315 ,  2015 .
...
Christopher Clayton and Andreas Schaab. Multinational banks and [[Bank Runs Deposit Insurance and Liquidity|financial stability]].  The Quarterly Journal of Economics ,  137 ( 3 ): 1681 – 1736 ,  2022 .
...
John H Cochrane. The fiscal theory of the price level: An [[Squam Lake Group Introduction|introduction]] and [[Overview of Financial Markets|overview]].  Journal of Economic Perspectives ,  2021 .
John H Cochrane. The fiscal roots of [[War Economies and Hyperinflation|inflation]].  Review of Economic Dynamics ,  45 : 22 – 40 ,  2022 .
John H Cochrane.  The fiscal theory of the price level . Princeton University Press,  2023 .
Ric Colacito, Mariano M Croce, Federico Gavazzoni, and Robert Ready. [[Forwards and Futures Notes|Currency]] [[PSET 6- Financial Instruments|risk factors]] in a recursive multi country economy. The Journal of Finance ,  73 ( 6 ): 2719 – 2756 ,  2018 a.
...
Riccardo Colacito and Mariano M Croce. International [[Fixed Income Asset Pricing|asset pricing]] with recursive preferences.  The Journal of Finance ,  68 ( 6 ): 2651 – 2686 , 2013 .
Harold L Cole and Maurice Obstfeld. Commodity trade and international [[Purpose and Structure of Financial Markets 1|risk sharing]]: How much do [[Financial Markets and Institutions Lecture Notes|financial markets]] matter?  Journal of monetary economics ,  28 ( 1 ): 3 – 24 ,  1991 .
Antonio Coppola, Arvind Krishna mur thy, and Chenzi Xu. [[Class Note 10 Liquidity and Class Note 10 Liquidity and Liquidity Managementliquidity management|Liquidity]], debt denomination, and [[Forwards and Futures Notes|currency]] dominance. Technical report, National Bureau of Economic Research,  2023 .
...
Domenico Cuoco and Hua He. Dynamic equilibrium in infinitedimensional economies with incomplete [[Financial Markets and Institutions Lecture Notes|financial markets]].  Unpublished manuscript ,  1994 .
...
Qiang Dai and Kenneth J Singleton. Specification analysis of a ne [[Financial Mathematics Course|term structure models]].  Journal of Finance ,  55 ( 5 ): 1943 – 1978 ,  2000 .
Kent Daniel and Sheridan Titman. Evidence on the characteristics of cross sectional variation in stock [[Assets|returns]].  The Journal of Finance ,  52 ( 1 ): 1 – 33 ,  1997 .
Emile Despres, Charles P Kindle berger, and Walter S Salant. The dollar and world [[Class Note 10 Liquidity and Class Note 10 Liquidity and Liquidity Managementliquidity management|liquidity]]: a minority view.  [[The Economist Fewer Or Even None|The Economist]] ,  6 ,  1966 .
...
William Diamond, Zhengyang Jiang, and Yiming Ma. The reserve supply channel of unconventional [[The Economist Regime Change|monetary policy]].  Jacobs Levy Equity Management Center for Quantitative Financial Research Paper , 2020 .
Rudiger Dornbusch. [[FORWARD RATES AND TERM STRUCTURE|Expectations]] and [[Exchange Rates and the Foreign Exchange Market- An Asset Approach|exchange rate dynamics]]. Journal of political Economy ,  84 ( 6 ): 1161 – 1176 ,  1976 .
...
Wenxin Du and Jesse Schreger. [[Lecture 8- Inflation & Sovereign Default Risk|Sovereign risk]], [[Forwards and Futures Notes|currency]] risk, and corporate balance sheets.  The Review of Financial Studies ,  35 ( 10 ): 4587 – 4629 ,  2022 b.
Wenxin Du, Joanne Im, and Jesse Schreger. The us treasury premium. Journal of International Economics ,  112 : 167 – 181 ,  2018 a.
Wenxin Du, Alexander Tepper, and Adrien Verdelhan. Deviations from [[Financial Instruments PSET Solutions|covered interest rate parity]].  The Journal of Finance ,  73 ( 3 ): 915 – 957 ,  2018 b.
Wenxin Du, Carolin E Pflueger, and Jesse Schreger. Sovereign debt portfolios, bond risks, and the credibility of [[The Economist Regime Change|monetary policy]].  The Journal of Finance ,  75 ( 6 ): 3097 – 3138 ,  2020 .
...
Darrell Duffie.  Dynamic [[Mean-Variance Efficient Returns and Pricing Fac|asset pricing theory]] . Princeton University Press,  2010 .
Darrell Duffie. Still the world’s safe haven? Redesigning the us treasury market after the covid 19  crisis.  2020 .
Darrell Duffie and Rui Kan. A yield-[[Pricing Factors in a One-Period Framework|factor model]] of [[Interest Rate Quotations|interest rates]]. Mathematical finance ,  6 ( 4 ): 379 – 406 ,  1996 .
...
Konstantin Egorov and Dmitry Mukhin. Optimal [[The Economist Regime Change|monetary policy]] under dollar [[Arbitrage Pricing of Derivatives|pricing]]. In  Meeting Papers , volume  1510 ,  2019 .
Ivar Ekeland and José Alexandre Scheinkman. Trans versa lit y conditions for some infinite horizon discrete time [[Prerequisites|optimization problems]].  Mathematics of operations research ,  11 ( 2 ): 216 – 229 ,  1986 .
Charles Engel. Exchange rates, [[Interest Rate Quotations|interest rates]], and the risk premium. American Economic Review ,  106 ( 2 ): 436 – 474 ,  2016 .
Charles Engel and Kenneth D West. Exchange rates and [[Week 2 Fundamentals Of Forecasting|fundamentals]].  Journal of political Economy ,  113 ( 3 ): 485 – 517 ,  2005 .
Larry G. Epstein and Stanley E. Zin. Risk aversion, and the temporal behavior of consumption and [[Some Stylized Empirical Facts About Asset Retur|asset returns]]: a theoretical framework.  Econometric a ,  57 ( 4 ): 937 ,  1989 .
...
Xiang Fang. Intermediary [[Lecture 6-Leverage, Tail Risk, Volatility Products|leverage]] and the [[Forwards and Futures Notes|currency]] risk premium. Available at SSRN  3290317 ,  2021 .
...
Kenneth A Froot and Tarun Ramadorai. [[Forwards and Futures Notes|Currency]] [[Assets|returns]], intrinsic value, and institutional-investor flows.  The Journal of Finance ,  60 ( 3 ): 1535 – 1566 ,  2005 .
...
Xavier Gabaix and Matteo Maggiori. International [[Class Note 10 Liquidity and Class Note 10 Liquidity and Liquidity Managementliquidity management|liquidity]] and [[Exchange Rates and the Foreign Exchange Market- An Asset Approach|exchange rate dynamics]].  The Quarterly Journal of Economics ,  130 ( 3 ): 1369 – 1420 ,  2015 .
Jordi Galí.  [[The Economist Regime Change|Monetary policy]], [[War Economies and Hyperinflation|inflation]], and the [[Business Cycles- Introduction, Characteristics, and History|business cycle]]: an [[Squam Lake Group Introduction|introduction]] to the new Keynesian framework and its applications . Princeton University Press,  2015 .
Elena Gerko and Hélene Rey. [[The Economist Regime Change|Monetary policy]] in the capitals of capital.  Journal of the European Economic Association ,  15 ( 4 ): 721 – 745 , 2017 .
...
Gita Gopinath and Jeremy C Stein. [[HKS The Banking Industry|Banking]], trade, and the making of a dominant [[Forwards and Futures Notes|currency]].  The Quarterly Journal of Economics ,  136 ( 2 ): 783 – 830 ,  2021 .
Pierre-Olivier Gourinchas and Helene Rey. [[Lecture Notes on International Finance|International financial]] adjustment.  Journal of political economy ,  115 ( 4 ): 665 – 703 ,  2007 a.
...
Pierre-Olivier Gourinchas, Helene Rey, and Kai Truempler. The [[Squam Lake Group Letter|financial crisis]] and the geography of wealth transfers.  Journal of International Economics ,  88 ( 2 ): 266 – 283 ,  2012 .
Pierre-Olivier Gourinchas, Hélene Rey, and Maxime Sauzet. The international monetary and [[Contemporary Financial Intermediation Notes|financial system]].  Annual Review of Economics ,  11 : 859 – 893 ,  2019 .
Pierre-Olivier Gourinchas, Walker Ray, and Dimitri Vayanos. A preferred-habitat model of term premia, exchange rates, and [[The Economist Regime Change|monetary policy]] spillovers. Technical report, National Bureau of Economic Research,  2022 .
...
George J Hall and Thomas J Sargent. [[Analysis of Fixed Income Securities|Interest rate risk]] and other determinants of post-wwii us [[Global Fixed Income Markets|government debt]]/gdp dynamics. American Economic Journal: Macroeconomics ,  3 ( 3 ): 192 – 214 ,  2011 .
...
Tarek A Hassan. Country size, [[Forwards and Futures Notes|currency]] unions, and international [[Some Stylized Empirical Facts About Asset Retur|asset returns]].  The Journal of Finance ,  68 ( 6 ): 2269 – 2308 ,  2013 .
Tarek A Hassan and Rui C Mano. Forward and spot exchange rates in a multi-[[Forwards and Futures Notes|currency]] world.  The Quarterly Journal of Economics ,  134 ( 1 ): 397 – 450 ,  2019 .
Tarek A Hassan and Tony Zhang. The economics of [[Forwards and Futures Notes|currency]] risk. Annual Review of Economics ,  13 : 281 – 307 ,  2021 .
Hua He and Neil D Pearson. Consumption and [[An Asset Allocation Primer|portfolio]] policies with [[Lecture Notes on International Finance|incomplete markets]] and short-sale constraints: The infinite dimensional case.  Journal of Economic Theory ,  54 ( 2 ): 259 – 304 ,  1991 .
Zhiguo He and Arvind Krishna mur thy. Intermediary [[Fixed Income Asset Pricing|asset pricing]]. American Economic Review ,  103 ( 2 ): 732 – 770 ,  2013 .
...
Zhengyang Jiang. Fiscal cyclical it y and [[Lecture Notes on International Finance|currency risk premia]].  The Review of Financial Studies ,  35 ( 3 ): 1527 – 1552 ,  2022 .
...
Zhengyang Jiang and Robert Richmond. Convenience yields and [[Financial Mathematics Course|asset pricing models]].  Available at SSRN  4007377 ,  2022 .
...
Zhengyang Jiang, Hanno Lustig, Stijn Van Nieuwe r burgh, and Mindy Z Xiaolan. Manufacturing risk-free [[Global Fixed Income Markets|government debt]]. Technical report, National Bureau of Economic Research,  2020 b.
Zhengyang Jiang, Hanno N Lustig, Stijn Van Nieuwe r burgh, and Mindy Z Xiaolan. Bond convenience yields in the eurozone [[Forwards and Futures Notes|currency]] union.  Columbia Business School Research Paper Forthcoming , 2020 c.
...
Zhengyang Jiang, Hanno Lustig, Stijn Van Nieuwe r burgh, and Mindy Z Xiaolan. What drives variation in the [[US Markets|us debt]]/output ratio? The dogs that didn’t bark. Technical report, National Bureau of Economic Research,  2021 c.
...
Zhengyang Jiang, Robert J Richmond, and Tony Zhang. A [[An Asset Allocation Primer|portfolio]] approach to [[Lecture Notes on International Finance|global imbalances]]. Technical report, National Bureau of Economic Research,  2022 c.
...
Zhengyang Jiang, Hanno Lustig, Stijn Van Nieuwe r burgh, and Mindy Z Xiaolan. Fiscal capacity: An [[Fixed Income Asset Pricing|asset pricing]] perspective. Annual Review of Financial Economics ,  15 ,  2023 a.
Zhengyang Jiang, Cameron Peng, and Hongjun Yan. Personality differences and [[Chapter 1 Introduction to Securities Trading and Markets|investment decision]]-making. Technical report, National Bureau of Economic Research,  2023 b.
Rohan Kekre and Moritz Lenel. The flight to safety and international [[Purpose and Structure of Financial Markets 1|risk sharing]]. Technical report, National Bureau of Economic Research,  2021 .
...
Sun Yong Kim. The dollar, [[The Economist Regime Change|fiscal policy]] and the us safety puzzle. Available at SSRN  4204972 ,  2022 .
Ralph SJ Koijen and Motohiro Yogo. A demand system approach to [[Fixed Income Asset Pricing|asset pricing]].  Journal of Political Economy ,  127 ( 4 ): 1475 – 1515 ,  2019 .
...
Robert Kollmann. Consumption, real exchange rates and the structure of international [[Primary Issuance and Secondary Resale Markets|asset markets]].  Journal of International money and finance ,  14 ( 2 ): 191 – 211 ,  1995 .
Arvind Krishna mur thy and Annette Vissing-Jorgensen. The [[Macroeconomic Models of Business Cycles|aggregate demand]] for treasury debt.  Journal of Political Economy ,  120 ( 2 ): 233 – 267 ,  2012 .
...
Gordon Liao and Tony Zhang. The [[Key Rates O1s Durations and Hedging|hedging]] channel of [[Foreign Exchange Markets and Exchange Rate Determination|exchange rate determination]].  [[International Trade Banking and Capital Markets Lecture Notes|International finance]] discussion paper , ( 1283 ),  2020 .
Gordon Y Liao. Credit migration and [[Financial Instruments PSET Solutions|covered interest rate parity]]. Journal of Financial Economics ,  138 ( 2 ): 504 – 525 ,  2020 .
...
Francis A Longstaff. The flight-to-[[Class Note 10 Liquidity and Class Note 10 Liquidity and Liquidity Managementliquidity management|liquidity]] premium in us treasury bond prices.  The Journal of Business ,  77 ( 3 ): 511 – 526 ,  2004 .
Francis A Longstaff, Jun Pan, Lasse H Pedersen, and Kenneth J Singleton. How sovereign is sovereign [[Quantitative Trading Strategies Lecture Notes|credit risk]]?  American Economic Journal: Macroeconomics ,  3 ( 2 ): 75 – 103 ,  2011 .
...
Hanno Lustig and Adrien Verdelhan. The cross section of foreign [[Lecture Notes on International Finance|currency risk premia]] and [[Long-Run Risks and Epstein-Zin Utility|consumption growth]] risk.  American Economic Review ,  97 ( 1 ): 89 – 117 ,  2007 .
Hanno Lustig and Adrien Verdelhan. Does incomplete spanning in [[Lecture Notes on International Finance|international financial]] markets help to explain exchange rates? American Economic Review ,  109 ( 6 ): 2208 – 2244 ,  2019 .
Hanno Lustig, Nikolai Roussanov, and Adrien Verdelhan. Common [[PSET 6- Financial Instruments|risk factors]] in [[Forwards and Futures Notes|currency]] markets.  The Review of Financial Studies ,  24 ( 11 ): 3731 – 3777 ,  2011 .
Hanno Lustig, Stijn Van Nieuwe r burgh, and Adrien Verdelhan. The wealth-consumption ratio.  The Review of [[Fixed Income Asset Pricing|Asset Pricing]] Studies ,  $3 (\mathtt{I})$  : 38 – 94 ,  2013 .
Hanno Lustig, Nikolai Roussanov, and Adrien Verdelhan. Countercyclical [[Lecture Notes on International Finance|currency risk premia]].  Journal of Financial Economics ,  111 ( 3 ): 527 – 553 ,  2014 .
Hanno Lustig, Andreas Stat hopo u los, and Adrien Verdelhan. The [[The Vasicek Model|term structure]] of [[Forwards and Futures Notes|currency]] [[Currency Carry Trade|carry trade]] risk premia.  American Economic Review ,  109 ( 12 ): 4142 – 4177 ,  2019 .
Matteo Maggiori. Financial inter mediation, international [[Purpose and Structure of Financial Markets 1|risk sharing]], and reserve currencies.  American Economic Review ,  107 ( 10 ): 3038 – 3071 ,  2017 .
...
Robert C [[Credit Markets Session 5|Merton]]. Lifetime [[An Asset Allocation Primer|portfolio]] selection under uncertainty: The continuous-time case.  The review of Economics and Statistics , pages 247 – 257 ,  1969 .
Silvia Miranda-Agrippino and Hélene Rey. World [[Primary Issuance and Secondary Resale Markets|asset markets]] and the global financial cycle. Technical report, National Bureau of Economic Research,  2015 .
...
Brian R Mitchell.  International [[Moody's Corporate Default and Recovery Rates,  1920-2008|historical statistics]]  1750 - 2005 : Americas . Springer,  2007 .
...
Stefan Nagel. The [[Class Note 10 Liquidity and Class Note 10 Liquidity and Liquidity Managementliquidity management|liquidity]] premium of near-money assets.  The Quarterly Journal of Economics ,  131 ( 4 ): 1927 – 1971 ,  2016 .
...
Maurice Obstfeld. International [[Class Note 10 Liquidity and Class Note 10 Liquidity and Liquidity Managementliquidity management|liquidity]]: the fiscal dimension. Technical report, National Bureau of Economic Research,  2011 .
Jun Pan and Kenneth J Singleton. [[Default Rates Recovery Rates and Credit Losses|Default and recovery]] implicit in the [[The Vasicek Model|term structure]] of sovereign cds spreads.  The Journal of Finance ,  63 ( 5 ): 2345 – 2384 ,  2008 .
Anna Pavlova and Roberto Rigobon. Asset prices and exchange rates. The Review of Financial Studies ,  20 ( 4 ): 1139 – 1180 ,  2007 .
Anna Pavlova and Roberto Rigobon. Equilibrium portfolios and external adjustment under [[Lecture Notes on International Finance|incomplete markets]]. In  AFA  2009  San Francisco Meetings Paper ,  2012 .
...
Robert Ready, Nikolai Roussanov, and Colin Ward. After the tide: Commodity currencies and [[International Trade Banking and Capital Markets Lecture Notes|global trade]].  Journal of Monetary Economics ,  85 : 69 – 86 ,  2017 a.
Robert Ready, Nikolai Roussanov, and Colin Ward. Commodity trade and the [[Currency Carry Trade|carry trade]]: A tale of two countries.  The Journal of Finance , 72 ( 6 ): 2629 – 2684 ,  2017 b.
Hélène Rey. Dilemma not trilemma: the global financial cycle and [[How Countries Go Broke-Chapter 12 to Chapter 14|monetary policy independence]]. Technical report, National Bureau of Economic Research,  2015 .
Robert J Richmond. Trade network centrality and [[Lecture Notes on International Finance|currency risk premia]].  The Journal of Finance ,  74 ( 3 ): 1315 – 1361 ,  2019 .
Dagfinn Rime, Andreas Schrimpf, and Olav Syrstad. [[Interest Rates, Carry Trades, and Exchange Rate Movements|Covered interest parity]] [[Arbitrage Pricing of Derivatives|arbitrage]].  The Review of Financial Studies ,  35 ( 11 ): 5185 – 5227 , 2022 .
...
Maxime Sauzet. Asset prices, global portfolios, and the [[Lecture Notes on International Finance|international financial]] system.  Global Portfolios, and the [[Lecture Notes on International Finance|International Financial]] System (February  2 ,  2023 ) ,  2022 .
...
Andreas Stat hopo u los. Asset prices and [[Purpose and Structure of Financial Markets 1|risk sharing]] in open economies.  The Review of Financial Studies ,  30 ( 2 ): 363 – 415 ,  2017 .
...
Jules H Van Binsbergen. [[Key Rates O1s Durations and Hedging|Duration]]-based stock valuation: Reassessing [[Hedge Fund Strategies|stock market]] performance and volatility. Technical report, National Bureau of Economic Research,  2020 .
Jules H Van Binsbergen, William F Diamond, and Marco Grotteria. Risk-free [[Interest Rate Quotations|interest rates]].  Journal of Financial Economics ,  143 ( 1 ): 1 – 29 , 2022 .
Adrien Verdelhan. A habit-based explanation of the [[PSET 3 Financial Instruments|exchange rate risk]] premium.  The Journal of Finance ,  65 ( 1 ): 123 – 146 ,  2010 .
Adrien Verdelhan. The share of systematic variation in bilateral exchange rates.  The Journal of Finance ,  73 ( 1 ): 375 – 418 ,  2018 .
Ursula Wir i ad in at a.  External debt, [[Forwards and Futures Notes|currency]] risk, and international [[The Economist Regime Change|monetary policy]] transmission . The University of Chicago,  2018 .
