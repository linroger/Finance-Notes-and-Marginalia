...
| Most issues being in the 4-7 year range. | 
 ...
 | Coupon: | Payable annually. Vast majority are "straights,     that is,     at a fixed coupon. Approximately a quarter of issues are at a variable coupon linked to a spread over  Basis Swap Markets#London Interbank Offered Rate (LIBOR) | LIBOR]]  (or some other benchmark) known as floating rate notes. | 
