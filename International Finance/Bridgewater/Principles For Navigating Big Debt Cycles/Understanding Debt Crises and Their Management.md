...
- Over time,  as these cycles of expansion and contraction occur repeatedly,  the conditions are created for a big,  long-term debt crisis.md).
...
- Economies whose growth is significantly supported by debt-financed building of fixed investments,  real estate,  and infrastructure are particularly susceptible to large Forecasting) | cyclical]] swings because the fast rates of building those long-lived assets are not sustainable.
...
- Contributing further to the Forecasting) | cyclicality]] of emerging countries’ economies are changes in their competitiveness due to relative changes in their incomes.
- **Initial Advantages:**
...
- Realizing that credit growth is dangerously fast,  the central banks tighten Risk and Return of Bonds#7.6 Asset price reactions to monetary policy surprises | monetary policy]] to contain it,  which often accelerates the decline (though it would have happened anyway,  just a bit later).
...
- Even after a debt crisis.md) is resolved,  it is unlikely that the entities that borrowed too much can generate the same level of spending in the future that they had before the crisis.
...
**The key to creating a “beautiful deleveraging” (a reduction in debt/income ratios accompanied by acceptable inflation/War%20Economies%20and%20Hyperinflation.md) and growth rates) lies in striking the right balance between them.** In this happy scenario,  debt-to-income ratios decline at the same time that economic activity and financial asset prices improve,  gradually bringing the nominal growth rate of incomes back above the nominal interest rate.

**Political Challenges**

These levers shift around who benefits and who suffers,  and over what amount of time. Policy makers are put in the politically difficult position of having to make those choices. As a result,  they are rarely appreciated,  even when they handle the debt crisis.md) well.
...
Since there was about a 75 percent correlation between the amounts of their foreign debts and the amounts of inflation/War%20Economies%20and%20Hyperinflation.md) that they experienced (which is not surprising,  since having a lot of their debts denominated in foreign currency was a cause of their depressions being inflationary),  it made sense to group those that had more foreign currency debt with those that had inflationary depressions.
...
- Over the last century,  the US has gone through a long-term debt crisis.md) twice—once during the boom of the 1920s and the Great Depression of the 1930s,  and again during the boom of the early 2000s and the financial crisis starting in 2008.
...
**Dynamics of the Long-Term Debt Cycle**
...
- **Restructuring Debt Outside Bankruptcy | Debt Restructuring ]]:**
- At such times,  there needs to be a Restructuring Debt Outside Bankruptcy | Debt Restructuring ]] in which claims on future spending (i.e.,  debt) are reduced relative to what they are claims on (i.e.,  money).
...
- Restructuring Debt Outside Bankruptcy | Debt Restructuring ]] and austerity dominate,  without being balanced by adequate stimulation (especially money printing and currency depreciation).
- **Rising Debt Burdens:**
...
- Inflationary depressions classically occur in countries that are reliant on foreign capital flows.
...
- When those foreign capital flows slow,  credit creation turns into credit contraction.
- **Currency Declines and Inflation/War%20Economies%20and%20Hyperinflation.md):**
- In an inflationary deleveraging,  capital withdrawal dries up lending and liquidity at the same time that currency declines produce inflation/War%20Economies%20and%20Hyperinflation.md).
