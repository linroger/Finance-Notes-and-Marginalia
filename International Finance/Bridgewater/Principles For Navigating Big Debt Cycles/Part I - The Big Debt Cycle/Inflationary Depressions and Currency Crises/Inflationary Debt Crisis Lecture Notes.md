...
[^1]: **Overview of Inflationary Debt Crises**
   - Inflationary debt crises are characterized by the devaluation of currency and rising inflation/War%20Economies%20and%20Hyperinflation.md).
...
[^1]: **Debt Holders' Expectations**
   ...
   - They are sensitive to:
	 - Inflation/War%20Economies%20and%20Hyperinflation.md) rates affecting purchasing power.
...
[^1]: **Trade-offs in Monetary Policy**
   - Central banks manage inflation/War%20Economies%20and%20Hyperinflation.md) and growth by adjusting interest rates and liquidity.
...
[^1]: **Impact of Demand on Currency/Debt**
   - Increased demand for a country's currency/debt:
	 ...
	 - Leads to lower inflation/War%20Economies%20and%20Hyperinflation.md) and higher growth,  assuming stable money and credit supply.
   - Decreased demand has the opposite effect:
	 - Currency/debt prices fall.
	 - Inflation/War%20Economies%20and%20Hyperinflation.md) rises and growth slows.
...
[^1]: **Mechanism of Inflation/War%20Economies%20and%20Hyperinflation.md) in Depressions**
   - Currency weakness leads to inflation/War%20Economies%20and%20Hyperinflation.md) during depressions.
   - The cycle ends when:
	 - Debts are defaulted or money is created to ease the squeeze.
	 - Debt service requirements are reduced (e.g.,  forbearance).
	 - Currency depreciates more than inflation/War%20Economies%20and%20Hyperinflation.md),  improving competitiveness.
...
[^1]: **Characteristics of Vulnerable Countries**
   ...
   - Large foreign debt.
   - Large and increasing budget/current account deficits.
   - Negative real interest rates.
   - History of high inflation/War%20Economies%20and%20Hyperinflation.md) and negative returns.
...
[^1]: **Potential for Inflationary Depressions in Reserve-Currency Countries**
   - Even reserve-currency countries can experience capital outflows.
	 - This affects the trade-off between inflation/War%20Economies%20and%20Hyperinflation.md) and growth.
   - Allowing higher inflation/War%20Economies%20and%20Hyperinflation.md) to maintain growth can:
...
[^1]: **Healthy Upswing**
   - Favorable capital flows due to strong fundamentals.
...
[^1]: **Positive,  Self-Reinforcing Cycle**
   ...
   - Central bank benefits:
	 - More growth per unit of inflation/War%20Economies%20and%20Hyperinflation.md).
...
[^1]: **Emergence of the Bubble**
   - Bubbles form during virtuous cycles of strong capital flows and economic conditions.md).
...
[^1]: **Indicators of an Inflating Bubble**
   - High foreign capital flows,  averaging around 10% of GDP.
...
[^1]: **Mechanisms Leading to Long Positions in Local Currency**
   - Sustained bull markets lead multinational entities to long positions in local currency through various channels:
	 ...
	 - Imports rise faster than exports,  worsening the current account.
...
[^1]: **Archetype Charts and Economic Activity**
   - Charts illustrate debt and current account trends in 27 inflationary deleveraging cases.
...
[^1]: **Bubble Phase Characteristics**
   ...
   - The current account deteriorates by about 2% of GDP.
...
[^1]: **Differentiation of Cases**
   - Cases are categorized based on:
	 ...
	 - Severity of economic outcomes.
	   ...
	   - Increases in unemployment and inflation/War%20Economies%20and%20Hyperinflation.md).
...
[^1]: **Correlation with Economic Pain**
   - Countries with high external reliance and significant asset bubbles:
	 ...
	 - Faced sharp increases in unemployment and inflation/War%20Economies%20and%20Hyperinflation.md).
...
[^1]: **Cycle Reversal Dynamics**
   - A mirror-opposite cycle from the upswing is set in motion:
	 ...
	 - Further weakening of capital flows and asset prices.
...
[^1]: **Role of Trade Balances and Capital Flows**
   ...
   - Adverse shifts in capital flows are more critical.
...
- Tightening of Risk and Return of Bonds#7.6 Asset price reactions to monetary policy surprises | monetary policy]] locally or abroad.
...
[^1]: **Ineffectiveness of Currency Defenses**
   - These measures often fail because:
	 ...
	 - They do not achieve the necessary currency and interest rate levels for sustainable economic conditions.md).
...
- Tightening Risk and Return of Bonds#7.6 Asset price reactions to monetary policy surprises | monetary policy]] to support the currency increases the interest rate differential.
...
- After unsustainable currency support (e.g.,  expending reserves,  tightening Risk and Return of Bonds#7.6 Asset price reactions to monetary policy surprises | monetary policy]],  imposing controls),  policymakers typically let the currency decline.
...
[^1]: **Profit Margins and Export Competitiveness**
   ...
   - Sets the stage for increased income from abroad through more competitive exports.
...
[^1]: **Inflationary Impact of Currency Declines**
   - Currency weakness leads to higher prices for imported goods,  contributing to inflation/War%20Economies%20and%20Hyperinflation.md).
   - Much of the increased cost is passed on to consumers,  resulting in a sharp rise in inflation/War%20Economies%20and%20Hyperinflation.md).
...
[^1]: **Gradual vs. One-Off Devaluation**
   - Gradual and persistent currency declines lead to expectations of continued depreciation.
	 ...
	 - Makes inflation/War%20Economies%20and%20Hyperinflation.md) more persistent,  feeding an inflation/War%20Economies%20and%20Hyperinflation.md) psychology.
   - A large,  one-off devaluation is generally preferable.
	 ...
	 - Higher inflation/War%20Economies%20and%20Hyperinflation.md) is less likely to be sustained.
...
[^1]: **Inflation/War%20Economies%20and%20Hyperinflation.md) Dynamics**
   - Currency declines lead to higher import costs,  driving up inflation/War%20Economies%20and%20Hyperinflation.md).
   - Inflation/War%20Economies%20and%20Hyperinflation.md) typically rises by 15%,  peaking around 30%.
   - Elevated inflation/War%20Economies%20and%20Hyperinflation.md) persists for about two years from the peak.
...
[^1]: **Achieving Currency Balance**
   ...
   - This balance is achieved through trade adjustments and,  more importantly,  capital flows.
...
[^1]: **Targeted Liquidity Provision**
   - Printing money to provide liquidity can prevent a debt crisis.md) and manage capital flight.
...
[^1]: **Indicators of Economic Bottoming**
   - Import collapse improves the current account by about 8% of GDP.
...
[^1]: **Currency and Inflation/War%20Economies%20and%20Hyperinflation.md) Dynamics**
   - As interest rates fall,  the forward currency price rallies relative to the spot.
   - Currency stabilization leads to reduced inflation/War%20Economies%20and%20Hyperinflation.md),  reaching pre-crisis levels in about two years.
...
[^1]: **Current Account Surplus Emergence**
   - The collapse in imports typically shifts the current account from a deficit to a surplus.
...
- Tight Risk and Return of Bonds#7.6 Asset price reactions to monetary policy surprises | monetary policy]] aligns domestic demand with falling incomes.
...
[^1]: **Currency Management**
   ...
   - Initial devaluation is small,  leading to further devaluations.
	 - This expectation causes higher interest rates and inflation/War%20Economies%20and%20Hyperinflation.md).

[^1]: **Closing External Imbalances**
- Loose Risk and Return of Bonds#7.6 Asset price reactions to monetary policy surprises | monetary policy]] favors domestic conditions,  delaying necessary adjustments.
...
[^1]: **Definition and Characteristics**
   - Hyperinflations involve extreme inflation/War%20Economies%20and%20Hyperinflation.md) levels,  where prices of goods and services more than double annually.
...
[^1]: **Capital Outflows and Inflation/War%20Economies%20and%20Hyperinflation.md)**
   - The required capital outflows were so significant that inflation/War%20Economies%20and%20Hyperinflation.md) problems were inevitable.
...
[^1]: **Currency Decline and Inflation/War%20Economies%20and%20Hyperinflation.md) Psychology**
   - As the currency declines and money printing increases,  inflationary psychology sets in.
   - Currency depreciation leads to capital flight,  creating a feedback loop of inflation/War%20Economies%20and%20Hyperinflation.md) and money printing.
...
[^1]: **Shift in Investor Behavior**
   - Investors prefer real assets (e.g.,  gold) and foreign currencies to hedge against inflation/War%20Economies%20and%20Hyperinflation.md).
...
[^1]: **Persistent Inflation/War%20Economies%20and%20Hyperinflation.md) and Investor Behavior**
   - Continual currency declines lead to persistent inflation/War%20Economies%20and%20Hyperinflation.md),  reinforcing inflation/War%20Economies%20and%20Hyperinflation.md) psychology.
   - Investors' behavior shifts,  further fueling the inflation/War%20Economies%20and%20Hyperinflation.md) spiral.

[^1]: **Wage-Cost Spiral**
   - Inflation/War%20Economies%20and%20Hyperinflation.md) pressures spread to wages,  creating a wage-cost spiral.
   - Workers demand higher wages to maintain purchasing power,  further driving inflation/War%20Economies%20and%20Hyperinflation.md).
...
[^1]: **Compelled Wage Increases and Price Adjustments**
   ...
   - Wage indexing contracts exacerbate this cycle by automatically adjusting wages with inflation/War%20Economies%20and%20Hyperinflation.md).

[^1]: **Vicious Cycle of Inflation/War%20Economies%20and%20Hyperinflation.md) and Currency Depreciation**
...
[^1]: **Behavioral Shifts in Savers and Investors**
   ...
   - Inflation/War%20Economies%20and%20Hyperinflation.md) prompts bank depositors to demand quick access to funds.
...
[^1]: **Capital Withdrawal and Financial Illiquidity**
   - High inflation/War%20Economies%20and%20Hyperinflation.md) and money printing lower real interest rates,  making it cheap to short cash.
...
[^1]: **Consequences of Liquidity Provision**
   - Liquidity enables continued borrowing and investment abroad,  fueling inflation/War%20Economies%20and%20Hyperinflation.md) and depreciation.
   - Investors seek inflation/War%20Economies%20and%20Hyperinflation.md) hedges like real assets or gold.
...
[^1]: **Foreign Investor Demands and Debt Service**
   ...
   - Currency declines and inflation/War%20Economies%20and%20Hyperinflation.md) increase debt service costs,  complicating economic stimulation.
...
[^1]: **Escalating Inflation/War%20Economies%20and%20Hyperinflation.md) and Currency Declines**
   - Feedback mechanisms intensify inflation/War%20Economies%20and%20Hyperinflation.md) and currency declines.
...
[^1]: **Impact on Financial Wealth**
   - Hyperinflation erodes financial wealth as assets fail to keep pace with inflation/War%20Economies%20and%20Hyperinflation.md).
...
[^1]: **Basic Investment Principles.md)**
...
[^1]: **Equities and Bonds**
   - Investing in equities becomes risky as inflation/War%20Economies%20and%20Hyperinflation.md) transitions to hyperinflation.
